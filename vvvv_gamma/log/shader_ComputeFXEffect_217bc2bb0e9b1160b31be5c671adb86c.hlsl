...
*****     Stages      *****
***************************
@G    Compute => bada57f56e7f3d6123f7e01b58753fbe
//
...
//
#line 1402 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_217bc2bb0e9b1160b31be5c671adb86c.hlsl"
...
#line 463
  dp3 r11.z, r11.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r11.z <- <Luminance_id56 return value>

#line 705
  mov r11.xy, cb1[8].wwww

#line 697
  mad r11.xyz, r11.xyzx, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id480 return value>.x; r11.y <- <Compute_id480 return value>.y; r11.z <- <Compute_id480 return value>.z
