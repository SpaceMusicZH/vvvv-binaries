...
@C    InputValue_id378 => ShaderFX.InputValueFloat
...
@R    DynamicTexture_id371 => ObjectTexture_fx7 [Stage: Compute, Slot: (7-7)]
...
*****     Stages      *****
***************************
@G    Compute => e8aa95f18604be0a056533e2f1317c8a
//
...
//   float InputValue_id378;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicTexture_id371              texture  float4          2d             t7      1 
...
//
#line 1533 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_d2ad7e549cc1bbda37ec98d7cdfb117f.hlsl"
...
const static float Value_id372 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float3 SMVector3Join_ShaderFXResult_31_id291;
    float3 Input_32_id296;
    float3 Multiply_33_id299;
    float3 Input_34_id303;
    float3 Plus_35_id306;
    float3 Input_36_id310;
    float3 Plus_37_id313;
    float4 SMVideoBufferSelector_ShaderFXResult_1_id107;
    float SMCalcLuminance_ShaderFXResult_2_id115;
    float Multiply_38_id145;
    float Multiply_39_id149;
    float Multiply_40_id153;
    float3 SMVector3Join_ShaderFXResult_41_id157;
    float3 Input_42_id162;
    float3 Multiply_43_id165;
    float3 Input_44_id169;
    float3 Plus_45_id172;
    float3 Input_46_id176;
    float3 Plus_47_id179;
    float3 Input_48_id183;
    float3 Multiply_49_id186;
    float Input_50_id204;
    float Multiply_51_id207;
    float Multiply_52_id211;
    float Multiply_53_id215;
    float3 SMVector3Join_ShaderFXResult_54_id219;
    float3 Input_55_id224;
    float3 Multiply_56_id227;
    float3 Input_57_id231;
    float3 Plus_58_id234;
    uint Input_3_id356;
    ...
    float Input_11_id377;
    float4 Lerp_12_id380;
};
struct CS_INPUT 
{
...
Texture2D DynamicTexture_id371;
float3 Compute_id427(inout CS_STREAMS streams)
{
    return streams.Input_57_id231;
}
float3 Compute_id425(inout CS_STREAMS streams)
{
    return streams.Multiply_56_id227;
}
...
{
    return streams.SMVector3Join_ShaderFXResult_54_id219;
}
...
{
    return streams.Input_48_id183;
}
float3 Compute_id277(inout CS_STREAMS streams)
{
    return streams.Plus_47_id179;
}
...
{
    return DynamicTexture_id371.SampleLevel(DynamicSampler_id128, Compute_id127(streams), Compute_id125());
}
...
{
    streams.Plus_58_id234 = Compute_id430(streams);
}
void Compute_id450(inout CS_STREAMS streams)
{
    streams.Input_57_id231 = Compute_id423();
}
void Compute_id448(inout CS_STREAMS streams)
{
    streams.Multiply_56_id227 = Compute_id422(streams);
}
void Compute_id446(inout CS_STREAMS streams)
{
    streams.Input_55_id224 = Compute_id415();
}
void Compute_id444(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_54_id219 = Compute_id414(streams);
}
void Compute_id442(inout CS_STREAMS streams)
{
    streams.Multiply_53_id215 = Compute_id406(streams);
}
void Compute_id440(inout CS_STREAMS streams)
{
    streams.Multiply_52_id211 = Compute_id400(streams);
}
void Compute_id438(inout CS_STREAMS streams)
{
    streams.Multiply_51_id207 = Compute_id394(streams);
}
void Compute_id436(inout CS_STREAMS streams)
{
    streams.Input_50_id204 = Compute_id387();
}
...
{
    streams.Multiply_49_id186 = Compute_id282(streams);
}
void Compute_id316(inout CS_STREAMS streams)
{
    streams.Input_48_id183 = Compute_id275();
}
void Compute_id314(inout CS_STREAMS streams)
{
    streams.Plus_47_id179 = Compute_id274(streams);
}
...
{
    streams.Input_44_id169 = Compute_id259();
}
void Compute_id306(inout CS_STREAMS streams)
{
    streams.Multiply_43_id165 = Compute_id258(streams);
}
void Compute_id304(inout CS_STREAMS streams)
{
    streams.Input_42_id162 = Compute_id251();
}
void Compute_id302(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_41_id157 = Compute_id250(streams);
}
void Compute_id300(inout CS_STREAMS streams)
{
    streams.Multiply_40_id153 = Compute_id242(streams);
}
void Compute_id298(inout CS_STREAMS streams)
{
    streams.Multiply_39_id149 = Compute_id236(streams);
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.Multiply_38_id145 = Compute_id230(streams);
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_30_id134 = Compute_id224(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.TextureValue_28_id126 = Compute_id201(streams);
}
void Compute_id290()
{
}
...
{
    streams.Plus_37_id313 = Compute_id576(streams);
}
void Compute_id610(inout CS_STREAMS streams)
{
    streams.Input_36_id310 = Compute_id569();
}
void Compute_id608(inout CS_STREAMS streams)
{
    streams.Plus_35_id306 = Compute_id568(streams);
}
void Compute_id606(inout CS_STREAMS streams)
{
    streams.Input_34_id303 = Compute_id561();
}
void Compute_id604(inout CS_STREAMS streams)
{
    streams.Multiply_33_id299 = Compute_id560(streams);
}
void Compute_id602(inout CS_STREAMS streams)
{
    streams.Input_32_id296 = Compute_id553();
}
void Compute_id600(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_31_id291 = Compute_id552(streams);
}
void Compute_id598(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_30_id134 = Compute_id544(streams);
}
void Compute_id596(inout CS_STREAMS streams)
{
    streams.TextureValue_28_id126 = Compute_id521(streams);
}
void Compute_id594()
{
}
...
{
    streams.Lerp_12_id380 = Compute_id140(streams);
}
void Compute_id161(inout CS_STREAMS streams)
{
    streams.Input_11_id377 = Compute_id131();
}
...
{
    return streams.Multiply_49_id186;
}
