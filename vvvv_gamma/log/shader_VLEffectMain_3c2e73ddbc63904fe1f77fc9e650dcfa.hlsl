...
//
//   } Lights_id184[8];                 // Offset:  464 Size:   252 [unused]
//   int LightCount_id185;              // Offset:  716 Size:     4 [unused]
//   
...
//
//   } Lights_id187[8];                 // Offset:  720 Size:   508 [unused]
...
//
#line 1458 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_3c2e73ddbc63904fe1f77fc9e650dcfa.hlsl"
...
@G    Pixel => 6fa80ccf66518f7d9ad736505822bc57
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  480
//
//   } Lights_id184[8];                 // Offset:  464 Size:   252
//   int LightCount_id185;              // Offset:  716 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset:  768
//
//   } Lights_id187[8];                 // Offset:  720 Size:   508
//   float4 _padding_PerDraw_Lighting;  // Offset: 1232 Size:    16 [unused]
//
// }
//
...
//
#line 1525 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_3c2e73ddbc63904fe1f77fc9e650dcfa.hlsl"
...
#line 571
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id172 return value>.x; r8.y <- <FresnelSchlick_id172 return value>.y; r8.z <- <FresnelSchlick_id172 return value>.z
...
#line 567
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id188 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id188 return value>

#line 686
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id190 return value>
...
#line 682
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id202 return value>
...
#line 1096
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id529 return value>.x; r7.y <- <ComputeDirectLightContribution_id529 return value>.y; r7.z <- <ComputeDirectLightContribution_id529 return value>.z
...
#line 1083
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id243 return value>
...
#line 571
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id172 return value>.x; r13.y <- <FresnelSchlick_id172 return value>.y; r13.z <- <FresnelSchlick_id172 return value>.z
...
#line 567
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id188 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id188 return value>

#line 686
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id190 return value>
...
#line 682
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id202 return value>
...
#line 1061
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id255 return value>
...
#line 571
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id172 return value>.x; r16.y <- <FresnelSchlick_id172 return value>.y; r16.z <- <FresnelSchlick_id172 return value>.z
...
#line 567
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id188 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id188 return value>

#line 686
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id190 return value>
...
#line 682
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id202 return value>
...
#line 320
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id103 return value>
...
#line 571
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id172 return value>.x; r15.y <- <FresnelSchlick_id172 return value>.y; r15.z <- <FresnelSchlick_id172 return value>.z
...
#line 567
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id188 return value>
  mad r3.w, r10.z, r5.w, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id188 return value>

#line 686
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id190 return value>
...
#line 314
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id113 return value>
...
#line 761
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id351 return value>.x; r0.z <- <Compute_id351 return value>.y; r0.w <- <Compute_id351 return value>.z

#line 986
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id530 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id530 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id530 return value>.z
...
#line 746
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t6.xyzw, s0, r0.x  // r1.x <- <Compute_id301 return value>.x; r1.y <- <Compute_id301 return value>.y; r1.z <- <Compute_id301 return value>.z
...
mov o0.w, cb1[0].w
ret 
// Approximately 556 instruction slots used
***************************
*************************/
...
float GetAngularAttenuation_id115(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float4 Compute_id315()
{
    return InputValue_id201;
}
float ComputeAttenuation_id116(float3 PositionWS, float3 AngleOffsetAndInvSquareRadius, float3 DirectionWS, float3 position, inout float3 lightVectorNorm)
{
    ...
    float attenuation = GetDistanceAttenuation_id114(lightVectorLength, lightInvSquareRadius);
    attenuation *= GetAngularAttenuation_id115(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    return attenuation;
}
...
float3 FresnelSchlick_id172(float3 f0, float3 f90, float lOrVDotH)
{
...
{
    streams.Input_2_id217 = Compute_id339();
}
void Compute_id330(inout PS_STREAMS streams)
{
    streams.Input_1_id208 = Compute_id327();
}
void Compute_id318(inout PS_STREAMS streams)
{
    streams.Input_0_id200 = Compute_id315();
}
float4 EvaluateSphericalHarmonics_id126(float3 sphericalColors[TOrder_id190 * TOrder_id190], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id117(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id116(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float3 FresnelSchlick_id178(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id172(f0, 1.0f, lOrVDotH);
}
...
float4 Compute_id301(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id296(float3 direction)
{
    return EvaluateSphericalHarmonics_id126(SphericalColors_id193, direction);
}
...
float3 Compute_id351(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id230.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
void PrepareDirectLightCore_id109(inout PS_STREAMS streams, int lightIndex)
{
...
{
    return NormalDistributionGGX_id202(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id413(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id190(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id383(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id178(f0, streams.LdotH_id77);
}
...
void ResetStream_id205()
{
}
void AfterLightingAndShading_id500()
{
}
void AfterLightingAndShading_id481()
{
}
void PrepareEnvironmentLight_id314(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id311(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id296(sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id301(streams, sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id530(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id351(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id474(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor * streams.envLightDiffuseColor_id47;
}
void PrepareEnvironmentLight_id306(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id277(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id84 = ComputeShadow_id110(streams, streams.PositionWS_id22.xyz, lightIndex);
...
void PrepareDirectLights_id250()
{
}
...
void PrepareDirectLights_id242(inout PS_STREAMS streams)
{
    PrepareLightData_id84(streams);
}
float3 ComputeDirectLightContribution_id529(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id383(streams, specularColor);
    float geometricShadowing = Compute_id413(streams);
    float normalDistribution = Compute_id443(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id473(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
int GetLightCount_id217()
{
    return LightCount_id86;
}
int GetMaxLightCount_id218()
{
...
void PrepareForLightingAndShading_id497()
{
}
void PrepareForLightingAndShading_id478()
{
}
void PrepareMaterialForLightingAndShading_id204(inout PS_STREAMS streams)
{
...
void ResetLightStream_id203(inout PS_STREAMS streams)
{
...
void Compute_id561(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id203(streams);
    PrepareMaterialForLightingAndShading_id204(streams);

    {
        PrepareForLightingAndShading_id478();
    }

    {
        PrepareForLightingAndShading_id497();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id213();
        const int maxLightCount = GetMaxLightCount_id218();
        int count = GetLightCount_id217();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id473(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id529(streams);
            }
        }
    }

    {
        PrepareDirectLights_id242(streams);
    ...
    {
        PrepareEnvironmentLight_id306(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id474(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id530(streams);
        }
    }
    ...
    {
        PrepareEnvironmentLight_id314(streams);
    ...
    {
        AfterLightingAndShading_id481();
    }

    {
        AfterLightingAndShading_id500();
    }
}
void Compute_id545(inout PS_STREAMS streams)
{
    float metalness = Compute_id350(streams).r;
...
{
    float glossiness = Compute_id338(streams).r;
...
{
    float4 colorBase = Compute_id326(streams);
