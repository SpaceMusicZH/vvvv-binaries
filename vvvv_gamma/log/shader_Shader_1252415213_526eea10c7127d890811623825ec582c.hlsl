...
***** Compiler Parameters *****
***************************
@P EffectName: Shader_1252415213
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Shader_1252415213 => 9748688330db8150e6b0bba0e44c189e
...
//
#line 151 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_Shader_1252415213_526eea10c7127d890811623825ec582c.hlsl"
...
//
#line 145 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_Shader_1252415213_526eea10c7127d890811623825ec582c.hlsl"
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    float4 result_371 = float4(1, 0, 0, 1);
    streams.ColorTarget_id2 = result_371;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    float4 result_367 = mul(streams.Position_id14, WorldViewProjection_id34);
    streams.ShadingPosition_id0 = result_367;
