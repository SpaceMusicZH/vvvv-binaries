...
//
#line 1250 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a08e143503496a5b46a5f3903591d336.hlsl"
...
@G    Pixel => 0d5d2d3d618d4bd4e1bd9ced461cd387
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1322 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a08e143503496a5b46a5f3903591d336.hlsl"
...
#line 511
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id157 return value>.x; r8.y <- <FresnelSchlick_id157 return value>.y; r8.z <- <FresnelSchlick_id157 return value>.z
...
#line 684
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id311 return value>.x; r0.z <- <Compute_id311 return value>.y; r0.w <- <Compute_id311 return value>.z
...
#line 669
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r6.xyzx, t6.xyzw, s0, r0.x  // r3.x <- <Compute_id261 return value>.x; r3.y <- <Compute_id261 return value>.y; r3.z <- <Compute_id261 return value>.z
...
{
    streams.Input_2_id212 = Compute_id299();
}
void Compute_id290(inout PS_STREAMS streams)
{
    streams.Input_1_id203 = Compute_id287();
}
void Compute_id278(inout PS_STREAMS streams)
{
    streams.Input_0_id195 = Compute_id275();
}
float4 EvaluateSphericalHarmonics_id111(float3 sphericalColors[TOrder_id185 * TOrder_id185], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
{
    return EvaluateSphericalHarmonics_id111(SphericalColors_id188, direction);
}
...
float3 Compute_id311(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id225.SampleLevel(LinearSampler_id123, float2(glossiness, nDotV), 0);
...
{
    return NormalDistributionGGX_id187(streams.alphaRoughness_id71, streams.NdotH_id77);
}
float Compute_id373(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id175(streams.alphaRoughness_id71, streams.NdotL_id50, streams.NdotV_id73);
}
float3 Compute_id343(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id163(f0, streams.LdotH_id78);
}
...
void PrepareEnvironmentLight_id271(inout PS_STREAMS streams)
{
    ...
    float3 sampleDirection = mul(streams.normalWS_id20, (float3x3)SkyMatrix_id191);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id48 = Compute_id256(sampleDirection).rgb * Intensity_id192 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id49 = Compute_id261(streams, sampleDirection).rgb * Intensity_id192 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.y;
}
float3 ComputeEnvironmentLightContribution_id490(inout PS_STREAMS streams)
{
    ...
    return Compute_id311(specularColor, streams.alphaRoughness_id71, streams.NdotV_id73) * streams.envLightSpecularColor_id49;
}
...
void PrepareEnvironmentLight_id266(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id183 * streams.matAmbientOcclusion_id58;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id70;
    return diffuseColor / PI_id224 * streams.lightColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id66.x;
}
...
void Compute_id521(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id74 += directLightingContribution * PI_id224 + environmentLightingContribution;
