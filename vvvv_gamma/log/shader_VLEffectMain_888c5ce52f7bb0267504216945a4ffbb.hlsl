...
@C    constantColor_id201 => Material.DiffuseValue
...
@R    ShadowMapTexture_id90 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (0-0)]
@R    LightClusters_id176 => LightClustered.LightClusters [Stage: Pixel, Slot: (1-1)]
@R    LightIndices_id177 => LightClustered.LightIndices [Stage: Pixel, Slot: (2-2)]
@R    PointLights_id181 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (3-3)]
@R    SpotLights_id182 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (4-4)]
...
//
#line 1251 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_888c5ce52f7bb0267504216945a4ffbb.hlsl"
...
@G    Pixel => e47f44d65ad4330e25999f87627ac05a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 constantColor_id201;        // Offset:    0 Size:    16
//
// }
//
// cbuffer PerView
...
// ShadowMapTexture_id90             texture  float4          2d             t0      1 
// LightClusters_id176               texture   uint2          3d             t1      1 
// LightIndices_id177                texture    uint         buf             t2      1 
// PointLights_id181                 texture  float4         buf             t3      1 
// SpotLights_id182                  texture  float4         buf             t4      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 1323 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_888c5ce52f7bb0267504216945a4ffbb.hlsl"
...
#line 495
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r8.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.y, r8.zwzz, t0.xxxx, s0, r3.w  // r5.y <- <SampleTextureAndCompare_id68 return value>
...
#line 495
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r10.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id68 return value>

#line 575
  mad r3.y, r4.z, r5.x, r3.y

#line 495
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r9.xyxx, t0.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id68 return value>
...
#line 495
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t0.xxxx, s0, r3.w  // r3.w <- <SampleTextureAndCompare_id68 return value>
...
#line 495
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r8.xyxx, t0.xxxx, s0, r2.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r8.zwzz, t0.xxxx, s0, r2.z  // r4.w <- <SampleTextureAndCompare_id68 return value>
...
#line 495
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r10.xyxx, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id68 return value>
...
#line 966
  ...
  mul r2.xyz, r2.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id258 return value>.x; r2.y <- <ComputeDirectLightContribution_id258 return value>.y; r2.z <- <ComputeDirectLightContribution_id258 return value>.z
...
#line 779
mov r3.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r3.xyzw, t1.xyzw  // r0.x <- streams.lightData_id174.x; r0.y <- streams.lightData_id174.y

#line 957
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id184 return value>
...
#line 935
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id196 return value>
...
#line 901
  mul r6.xyz, r2.wwww, cb0[r1.w + 30].xyzx
  mul r6.xyz, r3.wwww, r6.xyzx  // r6.x <- streams.lightColorNdotL_id45.x; r6.y <- streams.lightColorNdotL_id45.y; r6.z <- streams.lightColorNdotL_id45.z
...
#line 507
  add r6.xyz, -r0.xyzx, cb0[r1.w + 45].xyzx  // r6.x <- lightVector.x; r6.y <- lightVector.y; r6.z <- lightVector.z
...
#line 307
  mul r2.w, r2.w, cb0[r1.w + 47].z  // r2.w <- factor
...
#line 405
  dp3 r3.w, -cb0[r1.w + 46].xyzx, r6.xyzx  // r3.w <- cd

#line 406
  mad_sat r3.w, r3.w, cb0[r1.w + 47].x, cb0[r1.w + 47].y  // r3.w <- attenuation
...
#line 879
  mul r6.xyz, r2.wwww, cb0[r1.w + 48].xyzx
  mul r6.xyz, r3.wwww, r6.xyzx  // r6.x <- streams.lightColorNdotL_id45.x; r6.y <- streams.lightColorNdotL_id45.y; r6.z <- streams.lightColorNdotL_id45.z
...
float4 EvaluateSphericalHarmonics_id127(float3 sphericalColors[TOrder_id191 * TOrder_id191], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id118(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id117(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id23.xyz, lightVectorNorm);
...
{
    return EvaluateSphericalHarmonics_id127(SphericalColors_id194, direction);
}
...
void PrepareEnvironmentLight_id252(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id48 = Compute_id237(sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id49 = Compute_id242(streams, sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.y;
}
...
void PrepareDirectLight_id218(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id85 = ComputeShadow_id111(streams, streams.PositionWS_id23.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id45 *= ComputeTextureProjection_id112(streams.PositionWS_id23.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id69, streams.normalWS_id20);
    streams.lightSpecularColorNdotL_id46 *= ComputeSpecularTextureProjection_id113(streams.PositionWS_id23.xyz, reflectionVectorWS, lightIndex);
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id70;
    return diffuseColor / PI_id204 * streams.lightColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id66.x;
}
...
void PrepareMaterialForLightingAndShading_id145(inout PS_STREAMS streams)
{
...
void ResetLightStream_id144(inout PS_STREAMS streams)
{
...
void Compute_id300(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id144(streams);
    PrepareMaterialForLightingAndShading_id145(streams);
    ...
    streams.shadingColor_id74 += directLightingContribution * PI_id204 + environmentLightingContribution;
