...
@C    ToeCoeffs_id75 => ToneMapMikeDayOperatorShader.ToeCoeffs.ToneMapOperator.Transforms[0]
@C    ShoulderCoeffs_id76 => ToneMapMikeDayOperatorShader.ShoulderCoeffs.ToneMapOperator.Transforms[0]
@C    MiddleCrossOver_id77 => ToneMapMikeDayOperatorShader.MiddleCrossOver.ToneMapOperator.Transforms[0]
...
@S    ToneMapMikeDayOperatorShader => 13c4b552870999874e16adc165b8cc47
***************************
*****     Stages      *****
***************************
...
//
#line 210 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_f6a642ed500e2ae7a045afb7632fea94.hlsl"
...
@G    Pixel => fe214defeda71e77d92ad3d69561a2c9
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 ToeCoeffs_id75;             // Offset:   80 Size:    16
//   float4 ShoulderCoeffs_id76;        // Offset:   96 Size:    16
//   float MiddleCrossOver_id77;        // Offset:  112 Size:     4
//   float KeyValue_id82;               // Offset:  116 Size:     4 [unused]
//      = 0x3e3851ec 
//   float LuminanceLocalFactor_id83;   // Offset:  120 Size:     4 [unused]
//      = 0x00000000 
//   float LuminanceAverageGlobal_id84; // Offset:  124 Size:     4
//   float Contrast_id85;               // Offset:  128 Size:     4
//      = 0x00000000 
//   float Brightness_id86;             // Offset:  132 Size:     4
//      = 0x00000000 
//   float Exposure_id87;               // Offset:  136 Size:     4 [unused]
//      = 0x3f800000 
//
// }
//
...
//
#line 179 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_f6a642ed500e2ae7a045afb7632fea94.hlsl"
...
#line 175
exp r0.y, cb0[7].w  // r0.y <- avgLuminance

#line 178
mad r1.xyz, r0.yyyy, cb0[8].yyyy, r1.xyzx
...
#line 141
lt r1.xyz, r0.xyzx, cb0[7].xxxx
movc r2.xyzw, r1.xxxx, cb0[5].xyzw, cb0[6].xyzw  // r2.x <- coeffs.x; r2.y <- coeffs.y; r2.z <- coeffs.z; r2.w <- coeffs.w; r2.x <- coeffs.x; r2.y <- coeffs.y; r2.z <- coeffs.z; r2.w <- coeffs.w

#line 142
mad r0.xw, r2.xxxy, r0.xxxx, r2.zzzw  // r0.x <- fraction.x; r0.w <- fraction.y; r0.x <- fraction.x; r0.w <- fraction.y

#line 143
div o0.x, r0.x, r0.w

#line 141
movc r2.xyzw, r1.yyyy, cb0[5].xyzw, cb0[6].xyzw
movc r1.xyzw, r1.zzzz, cb0[5].xyzw, cb0[6].xyzw  // r1.x <- coeffs.x; r1.y <- coeffs.y; r1.z <- coeffs.z; r1.w <- coeffs.w; r1.x <- coeffs.x; r1.y <- coeffs.y; r1.z <- coeffs.z; r1.w <- coeffs.w

#line 142
mad r0.xz, r1.xxyx, r0.zzzz, r1.zzwz  // r0.z <- fraction.y; r0.z <- fraction.y
mad r0.yw, r2.xxxy, r0.yyyy, r2.zzzw  // r0.w <- fraction.y; r0.y <- fraction.x

#line 143
div o0.yz, r0.yyxy, r0.wwzw
...
cbuffer Globals 
{
    ...
    float4 ToeCoeffs_id75;
    float4 ShoulderCoeffs_id76;
    float MiddleCrossOver_id77;
...
float Remap_id5(float x)
{
    float4 coeffs = (x < MiddleCrossOver_id77) ? ToeCoeffs_id75 : ShoulderCoeffs_id76;
    float2 fraction = coeffs.xy * x + coeffs.zw;
    return fraction.x / fraction.y;
}
float4 Compute_id9(float4 color)
{
    return float4(Remap_id5(color.r), Remap_id5(color.g), Remap_id5(color.b), color.a);
}
