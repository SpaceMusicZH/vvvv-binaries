...
@C    InputValue_id177 => ShaderFX.InputValueFloat4
@C    InputValue_id185 => ShaderFX.InputValueFloat
@C    InputValue_id194 => ShaderFX.InputValueFloat.i1
...
*****     Stages      *****
***************************
@G    Vertex => 9ba851bbd29ad994e6af55737873aee8
//
...
//
#line 1002 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_9d2f3f9d472bf19c08cc74b10fe01ea8.hlsl"
...
@G    Pixel => a011ec339c4e666f328790013010131d
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 InputValue_id177;           // Offset:    0 Size:    16
//   float InputValue_id185;            // Offset:   16 Size:     4
//   float InputValue_id194;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 1078 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_9d2f3f9d472bf19c08cc74b10fe01ea8.hlsl"
...
#line 703
  mul r11.xyz, r4.wwww, cb2[r2.w + 27].xyzx  // r11.x <- streams.lightColorNdotL_id46.x; r11.y <- streams.lightColorNdotL_id46.y; r11.z <- streams.lightColorNdotL_id46.z
...
#line 290
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id73 return value>
...
mov r0.yw, r5.yyyz  // r0.y <- streams.NdotV_id74; r0.w <- streams.lightIndex_id98
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r2.w, r1.w, r0.x
  breakc_nz r2.w
...
#line 497
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r0.wwww, t2.yzwx  // r2.w <- realLightIndex

#line 498
  iadd r0.w, r0.w, l(1)  // r0.w <- streams.lightIndex_id98

#line 500
  ishl r4.w, r2.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r4.wwww, t4.xyzw  // r13.x <- spotLight1.x; r13.y <- spotLight1.y; r13.z <- spotLight1.z
...
#line 353
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r15.xyz, r15.xyzx, r5.wwww, r7.xyzx  // r15.x <- <FresnelSchlick_id143 return value>.x; r15.y <- <FresnelSchlick_id143 return value>.y; r15.z <- <FresnelSchlick_id143 return value>.z
...
#line 349
  ...
  div r8.w, r4.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id159 return value>
  mad r5.w, r0.y, r6.w, r5.w
  div r5.w, r0.y, r5.w  // r5.w <- <VisibilityhSchlickGGX_id159 return value>

#line 417
  mul r5.w, r5.w, r8.w
  mul r4.w, r0.y, r4.w
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 413
  mul r2.w, r2.w, r2.w
  mul r2.w, r2.w, l(3.141593)
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id173 return value>
...
#line 856
endloop   // r0.w <- streams.lightIndex_id98
...
#line 475
mad r0.xyz, r3.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id284 return value>.x; r0.y <- <Compute_id284 return value>.y; r0.z <- <Compute_id284 return value>.z

#line 618
mul r5.xyz, r0.xyzx, cb2[43].xyzx  // r5.x <- <ComputeEnvironmentLightContribution_id463 return value>.x; r5.y <- <ComputeEnvironmentLightContribution_id463 return value>.y; r5.z <- <ComputeEnvironmentLightContribution_id463 return value>.z

#line 868
mad r5.xyz, r4.xyzx, cb2[43].xyzx, r5.xyzx  // r5.x <- environmentLightingContribution.x; r5.y <- environmentLightingContribution.y; r5.z <- environmentLightingContribution.z
...
#line 459
mul r0.w, r3.w, cb2[52].w  // r0.w <- mipLevel

#line 460
sample_l_indexable(texturecube)(float,float,float,float) r2.xyz, r7.xyzx, t5.xyzw, s0, r0.w  // r2.x <- <Compute_id234 return value>.x; r2.y <- <Compute_id234 return value>.y; r2.z <- <Compute_id234 return value>.z
...
const static bool TInvert_id191 = true;
...
cbuffer PerMaterial 
{
    float4 InputValue_id177;
    float InputValue_id185;
...
{
    streams.Input_2_id193 = Compute_id272();
}
void Compute_id263(inout PS_STREAMS streams)
{
    streams.Input_1_id184 = Compute_id260();
}
void Compute_id251(inout PS_STREAMS streams)
{
    streams.Input_0_id176 = Compute_id248();
}
float4 EvaluateSphericalHarmonics_id97(float3 sphericalColors[TOrder_id108 * TOrder_id108], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id88(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id87(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id24.xyz, lightVectorNorm);
...
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id74(light, streams.PositionWS_id24.xyz, lightVectorNorm);
...
{
    return EvaluateSphericalHarmonics_id97(SphericalColors_id111, direction);
}
...
float3 Compute_id284(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id206.SampleLevel(LinearSampler_id142, float2(glossiness, nDotV), 0);
...
{
    return NormalDistributionGGX_id173(streams.alphaRoughness_id72, streams.NdotH_id78);
}
float Compute_id346(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id161(streams.alphaRoughness_id72, streams.NdotL_id51, streams.NdotV_id74);
}
float3 Compute_id316(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id149(f0, streams.LdotH_id79);
}
...
float Compute_id269(inout PS_STREAMS streams)
{
    ...
    return Compute_id266(streams);
}
float4 Compute_id257(inout PS_STREAMS streams)
{
...
void AfterLightingAndShading_id433()
{
}
void AfterLightingAndShading_id414()
{
}
...
void PrepareEnvironmentLight_id244(inout PS_STREAMS streams)
{
    ...
    float3 sampleDirection = mul(streams.normalWS_id21, (float3x3)SkyMatrix_id172);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id49 = Compute_id229(sampleDirection).rgb * Intensity_id173 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id50 = Compute_id234(streams, sampleDirection).rgb * Intensity_id173 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
float3 ComputeEnvironmentLightContribution_id463(inout PS_STREAMS streams)
{
    ...
    return Compute_id284(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
float3 ComputeEnvironmentLightContribution_id407(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id210(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id86 = ComputeShadow_id81(streams, streams.PositionWS_id24.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id82(streams.PositionWS_id24.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id21);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id83(streams.PositionWS_id24.xyz, reflectionVectorWS, lightIndex);
}
...
void PrepareDirectLight_id197(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id51 = max(dot(streams.normalWS_id21, streams.lightDirectionWS_id44), 0.0001f);
    streams.shadowColor_id86 = ComputeShadow_id70(streams, streams.PositionWS_id24.xyz, lightIndex);
    streams.lightColorNdotL_id46 = streams.lightColor_id45 * streams.lightAttenuation_id48 * streams.shadowColor_id86 * streams.NdotL_id51 * streams.lightDirectAmbientOcclusion_id52;
    streams.lightSpecularColorNdotL_id47 = streams.lightColorNdotL_id46;
...
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id316(streams, specularColor);
    float geometricShadowing = Compute_id346(streams);
    float normalDistribution = Compute_id376(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id47 * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
float3 ComputeDirectLightContribution_id406(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id205 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareDirectLight_id186(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id51 = max(dot(streams.normalWS_id21, streams.lightDirectionWS_id44), 0.0001f);
    streams.shadowColor_id86 = ComputeShadow_id64(streams, streams.PositionWS_id24.xyz, lightIndex);
    streams.lightColorNdotL_id46 = streams.lightColor_id45 * streams.lightAttenuation_id48 * streams.shadowColor_id86 * streams.NdotL_id51 * streams.lightDirectAmbientOcclusion_id52;
    streams.lightSpecularColorNdotL_id47 = streams.lightColorNdotL_id46;
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id65(streams.PositionWS_id24.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id21);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id66(streams.PositionWS_id24.xyz, reflectionVectorWS, lightIndex);
}
...
void PrepareForLightingAndShading_id430()
{
}
void PrepareForLightingAndShading_id411()
{
}
...
void Compute_id494(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id411();
    }

    {
        PrepareForLightingAndShading_id430();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id406(streams);
            }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id407(streams);
        }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id205 + environmentLightingContribution;
    streams.shadingColorAlpha_id76 = streams.matDiffuse_id55.a;

    {
        AfterLightingAndShading_id414();
    }

    {
        AfterLightingAndShading_id433();
    }
}
void Compute_id478(inout PS_STREAMS streams)
{
    float metalness = Compute_id283(streams).r;
...
{
    float glossiness = Compute_id271(streams).r;
...
{
    float4 colorBase = Compute_id259(streams);
...
{
    return float4(EncodeNormal_id57(streams.normalWS_id21), 1);
}
...
void PSMain_id3(inout PS_STREAMS streams)
{
    ...
    streams.ColorTarget2_id4 = Compute_id50(streams);
    streams.ColorTarget3_id5 = Compute_id51();
}
