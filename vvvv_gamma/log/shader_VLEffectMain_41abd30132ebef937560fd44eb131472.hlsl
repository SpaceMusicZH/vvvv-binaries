...
@G    Pixel => 58e6687640b940a530de1a07c8a48a72
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 608
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r8.xyxx, t1.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id62 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.y, r8.zwzz, t1.xxxx, s0, r3.w  // r5.y <- <SampleTextureAndCompare_id62 return value>
...
#line 608
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r10.xyxx, t1.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id62 return value>

#line 701
  mad r3.y, r4.z, r5.x, r3.y

#line 608
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r9.xyxx, t1.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id62 return value>
...
#line 608
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t1.xxxx, s0, r3.w  // r3.w <- <SampleTextureAndCompare_id62 return value>
...
#line 608
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r8.xyxx, t1.xxxx, s0, r2.z  // r3.w <- <SampleTextureAndCompare_id62 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r8.zwzz, t1.xxxx, s0, r2.z  // r4.w <- <SampleTextureAndCompare_id62 return value>
...
#line 608
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r10.xyxx, t1.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id62 return value>
