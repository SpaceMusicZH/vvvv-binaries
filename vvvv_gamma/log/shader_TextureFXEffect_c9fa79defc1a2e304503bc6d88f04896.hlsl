...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlendMixer_TextureFX [{BlendResult = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_1> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_1>}]}, {Fader = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_0>}]}]
...
@P BlendResult: mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_1> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_1>}]
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 229 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_c9fa79defc1a2e304503bc6d88f04896.hlsl"
...
@G    Pixel => 6306ada7e8b7b32eb1b1be5d60677567
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 181 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_c9fa79defc1a2e304503bc6d88f04896.hlsl"
add r0.x, cb0[1].x, cb0[1].x  // r0.x <- mix
...
#line 183
mad_sat r0.y, cb0[1].x, l(2.000000), l(-1.000000)  // r0.y <- mixFront
...
#line 186
mul r1.xyzw, r0.zzzz, cb0[0].xyzw  // r1.x <- interPart.x; r1.y <- interPart.y; r1.z <- interPart.z; r1.w <- interPart.w
...
{
    streams.Input_0_id95 = Compute_id40();
}
void Compute_id34(inout PS_STREAMS streams)
{
    streams.Input_1_id89 = Compute_id31();
}
float Compute_id46(inout PS_STREAMS streams)
{
