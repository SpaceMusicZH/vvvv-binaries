...
@R    VoxelVolume_id200 => SMVideoBufferSelector_ShaderFX.VoxelVolume [Stage: Compute, Slot: (3-3)]
...
*****     Stages      *****
***************************
@G    Compute => d49de3832659dbd5cbe8327112f36666
//
...
//   int3 VoxelCounts_id201;            // Offset:  144 Size:    12 [unused]
//   int3 PlacementCounts_id202;        // Offset:  160 Size:    12 [unused]
//   float2 SamplerOffset_id203;        // Offset:  176 Size:     8 [unused]
//   float2 SamplerScale_id204;         // Offset:  184 Size:     8 [unused]
//      = 0x3f800000 0x3f800000 
//   uint PlacementLevelCount_id205;    // Offset:  192 Size:     4 [unused]
//      = 0x00100000 
//
// }
//
...
//
#line 1534 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_f013f5e4c7f8b322d945f786c4371252.hlsl"
...
#line 679
  mul r12.yz, r14.xxxx, cb1[3].xxxx  // r12.z <- <Compute_id343 return value>

#line 868
  ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r13.xy, vThreadID.x, l(0), t3.xyxx  // r13.x <- m.x

#line 660
  mul r12.w, r13.y, cb1[3].x  // r12.w <- <Compute_id363 return value>
...
{
    return streams.g_52_id207;
}
float4 Compute_id354(inout CS_STREAMS streams)
{
...
{
    return Compute_id354(streams).g;
}
...
{
    streams.g_52_id207 = Compute_id357(streams);
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id199 = Compute_id57(streams);
}
void Compute_id397(inout CS_STREAMS streams)
{
    streams.Multiply_51_id195 = Compute_id349(streams);
}
...
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id199 = Compute_id69(streams);
}
...
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id199 = Compute_id63(streams);
}
void Compute_id134()
{
}
