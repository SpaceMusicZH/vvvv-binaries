...
*****     Sources     *****
***************************
@S    LambertianPrefilteringSHNoComputePass2 => a6f8131e0afbcb3f885d109288259113
...
//
#line 149 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_LambertianPrefilteringSHNoComputePass2_4260941ce61eb073584036c7c3703eb2.hlsl"
...
//
#line 129 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_LambertianPrefilteringSHNoComputePass2_4260941ce61eb073584036c7c3703eb2.hlsl"
...
{
    float4 result = 0;
    result += Texture0_id14.Sample(PointSampler_id43, streams.TexCoord_id62, int2(-1, 0));
    result += Texture0_id14.Sample(PointSampler_id43, streams.TexCoord_id62, int2(0, 0));
    result += Texture0_id14.Sample(PointSampler_id43, streams.TexCoord_id62, int2(0, -1));
    result += Texture0_id14.Sample(PointSampler_id43, streams.TexCoord_id62, int2(-1, -1));
    return result;
}
