...
*****     Stages      *****
***************************
@G    Compute => 80549afe3db1dd2fa2a83b5cb1d0f824
//
...
//
#line 1437 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_fae081eb692a8cb11554a965e08681e9.hlsl"
...
#line 633
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyw, r6.xzxx, t3.xywz, s0, l(0.000000)  // r12.x <- <Compute_id193 return value>.x; r12.y <- <Compute_id193 return value>.y; r12.w <- <Compute_id193 return value>.z

#line 367
  dp3 r1.w, r12.xywx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r1.w <- <Luminance_id51 return value>

#line 624
  mul r1.w, r0.w, r1.w  // r1.w <- <Compute_id222 return value>

#line 596
  mad r12.xyw, r1.wwww, cb1[0].xyxz, cb1[1].xyxz  // r12.x <- <Compute_id258 return value>.x; r12.y <- <Compute_id258 return value>.y; r12.w <- <Compute_id258 return value>.z

#line 588
  add r12.xyw, r12.xyxw, cb1[2].xyxz  // r12.x <- <Compute_id266 return value>.x; r12.y <- <Compute_id266 return value>.y; r12.w <- <Compute_id266 return value>.z

#line 580
  mul r13.xyz, r12.xywx, cb1[3].xyzx  // r13.x <- <Compute_id274 return value>.x; r13.y <- <Compute_id274 return value>.y; r13.z <- <Compute_id274 return value>.z

#line 1415
  ld_structured_indexable(structured_buffer, stride=12)(mixed,mixed,mixed,mixed) r14.xyz, l(2), l(0), t0.xyzx
  mov r9.w, r10.x
  mad r9.xyz, -r12.xywx, cb1[3].xyzx, r9.yzwy
  mad r9.xyz, r14.xyzx, r9.xyzx, r13.xyzx  // r9.x <- m.Dim.x; r9.y <- m.Dim.y; r9.z <- m.Dim.z

#line 561
  mul r12.y, r12.z, cb1[3].w  // r12.y <- <Compute_id367 return value>
...
{
    return Compute_id356(streams).b;
}
...
{
    streams.b_47_id194 = Compute_id359(streams);
}
