...
@C    Lights_id197 => LightPointGroup.Lights.directLightGroups[3]
...
@C    WorldToShadow_id203 => ShadowMapReceiverPointCubeMap.WorldToShadow.directLightGroups[3]
@C    InverseWorldToShadow_id204 => ShadowMapReceiverPointCubeMap.InverseWorldToShadow.directLightGroups[3]
@C    DepthBiases_id205 => ShadowMapReceiverPointCubeMap.DepthBiases.directLightGroups[3]
@C    OffsetScales_id206 => ShadowMapReceiverPointCubeMap.OffsetScales.directLightGroups[3]
@C    DepthParameters_id207 => ShadowMapReceiverPointCubeMap.DepthParameters.directLightGroups[3]
@C    LightCount_id209 => DirectLightGroupPerDraw.LightCount.directLightGroups[4]
@C    Lights_id211 => LightSpotGroup.Lights.directLightGroups[4]
@C    ShadowMapTextureSize_id213 => ShadowMap.TextureSize.directLightGroups[4]
@C    ShadowMapTextureTexelSize_id214 => ShadowMap.TextureTexelSize.directLightGroups[4]
@C    WorldToShadowCascadeUV_id218 => ShadowMapReceiverBase.WorldToShadowCascadeUV.directLightGroups[4]
@C    InverseWorldToShadowCascadeUV_id219 => ShadowMapReceiverBase.InverseWorldToShadowCascadeUV.directLightGroups[4]
@C    ViewMatrices_id220 => ShadowMapReceiverBase.ViewMatrices.directLightGroups[4]
@C    DepthRanges_id221 => ShadowMapReceiverBase.DepthRanges.directLightGroups[4]
@C    DepthBiases_id222 => ShadowMapReceiverBase.DepthBiases.directLightGroups[4]
@C    OffsetScales_id223 => ShadowMapReceiverBase.OffsetScales.directLightGroups[4]
@C    _padding_PerDraw_Lighting => _padding_PerDraw_Lighting
cbuffer PerMaterial [Size: 16]
@C    ParticleSize_id150 => SMBoxImpostor_ShaderFX.ParticleSize
@C    InputValue_id248 => ShaderFX.InputValueFloat
@C    InputValue_id257 => ShaderFX.InputValueFloat.i1
...
@C    AmbientLight_id227 => LightSimpleAmbient.AmbientLight.environmentLights[0]
@C    SphericalColors_id232 => SphericalHarmonicsEnvironmentColor.SphericalColors.lightDiffuseColor.environmentLights[1]
@C    MipCount_id233 => RoughnessCubeMapEnvironmentColor.MipCount.lightSpecularColor.environmentLights[1]
@C    SkyMatrix_id235 => LightSkyboxShader.SkyMatrix.environmentLights[1]
@C    Intensity_id236 => LightSkyboxShader.Intensity.environmentLights[1]
...
@R    ShadowMapTexture_id198 => ShadowMap.ShadowMapTexture.directLightGroups[3] [Stage: None, Slot: (-1--1)]
@R    ShadowMapTexture_id212 => ShadowMap.ShadowMapTexture.directLightGroups[4] [Stage: None, Slot: (-1--1)]
@R    ShadowMapTexture_id212 => ShadowMap.ShadowMapTexture.directLightGroups[4] [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id149 => SMBoxImpostor_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id149 => SMBoxImpostor_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id240 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id240 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id269 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id269 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    SpotLights_id194 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    CubeMap_id234 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
@R    CubeMap_id234 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
...
@R    ShadowMapTexture_id212 => ShadowMap.ShadowMapTexture.directLightGroups[4] [Stage: Pixel, Slot: (1-1)]
@R    ParticlesBuffer_id240 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (2-2)]
@R    EnvironmentLightingDFG_LUT_id269 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (3-3)]
@R    ShadowMapTexture_id160 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (4-4)]
@R    LightClusters_id188 => LightClustered.LightClusters [Stage: Pixel, Slot: (5-5)]
@R    LightIndices_id189 => LightClustered.LightIndices [Stage: Pixel, Slot: (6-6)]
@R    PointLights_id193 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (7-7)]
@R    SpotLights_id194 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (8-8)]
@R    CubeMap_id234 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (9-9)]
...
//
#line 2007 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_e977a33d6a538437d0789325d6332ecb.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
//   } Lights_id197;                    // Offset:  464 Size:    28 [unused]
//   float2 ShadowMapTextureSize_id199; // Offset:  496 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  504 Size:     8 [unused]
//   float4x4 WorldToShadow_id203[6];   // Offset:  512 Size:   384 [unused]
//   float4x4 InverseWorldToShadow_id204[6];// Offset:  896 Size:   384 [unused]
//   float DepthBiases_id205;           // Offset: 1280 Size:     4 [unused]
//   float OffsetScales_id206;          // Offset: 1296 Size:     4 [unused]
//   float2 DepthParameters_id207;      // Offset: 1312 Size:     8 [unused]
//   int LightCount_id209;              // Offset: 1320 Size:     4 [unused]
//   
...
//
//   } Lights_id211;                    // Offset: 1328 Size:    60 [unused]
//   float2 ShadowMapTextureSize_id213; // Offset: 1392 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id214;// Offset: 1400 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id218;// Offset: 1408 Size:    64 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id219;// Offset: 1472 Size:    64 [unused]
//   float4x4 ViewMatrices_id220;       // Offset: 1536 Size:    64 [unused]
//   float2 DepthRanges_id221;          // Offset: 1600 Size:     8 [unused]
//   float DepthBiases_id222;           // Offset: 1616 Size:     4 [unused]
//   float OffsetScales_id223;          // Offset: 1632 Size:     4 [unused]
...
//      = 0x3dcccccd 
//   float InputValue_id248;            // Offset:    4 Size:     4 [unused]
//   float InputValue_id257;            // Offset:    8 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id227;         // Offset: 1408 Size:    12 [unused]
//   float3 SphericalColors_id232[9];   // Offset: 1424 Size:   140 [unused]
//   float MipCount_id233;              // Offset: 1564 Size:     4 [unused]
//   float4x4 SkyMatrix_id235;          // Offset: 1568 Size:    64 [unused]
//   float Intensity_id236;             // Offset: 1632 Size:     4 [unused]
...
//
#line 1972 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_e977a33d6a538437d0789325d6332ecb.hlsl"
...
@G    Pixel => eb089146c3c4fb0609bca97e8441f707
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  480
//
//   } Lights_id197;                    // Offset:  464 Size:    28
//   float2 ShadowMapTextureSize_id199; // Offset:  496 Size:     8
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  504 Size:     8
//   float4x4 WorldToShadow_id203[6];   // Offset:  512 Size:   384
//   float4x4 InverseWorldToShadow_id204[6];// Offset:  896 Size:   384 [unused]
//   float DepthBiases_id205;           // Offset: 1280 Size:     4
//   float OffsetScales_id206;          // Offset: 1296 Size:     4
//   float2 DepthParameters_id207;      // Offset: 1312 Size:     8
//   int LightCount_id209;              // Offset: 1320 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset: 1376
//
//   } Lights_id211;                    // Offset: 1328 Size:    60
//   float2 ShadowMapTextureSize_id213; // Offset: 1392 Size:     8
//   float2 ShadowMapTextureTexelSize_id214;// Offset: 1400 Size:     8
//   float4x4 WorldToShadowCascadeUV_id218;// Offset: 1408 Size:    64
//   float4x4 InverseWorldToShadowCascadeUV_id219;// Offset: 1472 Size:    64 [unused]
//   float4x4 ViewMatrices_id220;       // Offset: 1536 Size:    64 [unused]
//   float2 DepthRanges_id221;          // Offset: 1600 Size:     8 [unused]
//   float DepthBiases_id222;           // Offset: 1616 Size:     4
//   float OffsetScales_id223;          // Offset: 1632 Size:     4
//   float4 _padding_PerDraw_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
...
//      = 0x3dcccccd 
//   float InputValue_id248;            // Offset:    4 Size:     4
//   float InputValue_id257;            // Offset:    8 Size:     4
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id227;         // Offset: 1408 Size:    12
//   float3 SphericalColors_id232[9];   // Offset: 1424 Size:   140
//   float MipCount_id233;              // Offset: 1564 Size:     4
//   float4x4 SkyMatrix_id235;          // Offset: 1568 Size:    64
//   float Intensity_id236;             // Offset: 1632 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
// Resource bind info for ParticlesBuffer_id240
// {
//
//   struct SMGridParticle
//   {
...
// ShadowMapTexture_id212            texture  float4          2d             t1      1 
// ParticlesBuffer_id240             texture  struct         r/o             t2      1 
// EnvironmentLightingDFG_LUT_id269    texture  float4          2d             t3      1 
// ShadowMapTexture_id160            texture  float4          2d             t4      1 
// LightClusters_id188               texture   uint2          3d             t5      1 
// LightIndices_id189                texture    uint         buf             t6      1 
// PointLights_id193                 texture  float4         buf             t7      1 
// SpotLights_id194                  texture  float4         buf             t8      1 
// CubeMap_id234                     texture  float4        cube             t9      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
// PerMaterial                       cbuffer      NA          NA            cb1      1 
// PerView                           cbuffer      NA          NA            cb2      1 
//
...
//
#line 1956 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_e977a33d6a538437d0789325d6332ecb.hlsl"
...
#line 761
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t4.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id129 return value>
...
#line 761
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id129 return value>

#line 910
  mad r5.w, r6.z, r8.w, r5.w

#line 761
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t4.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id129 return value>
...
#line 761
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t4.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id129 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t4.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id129 return value>
...
#line 761
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t4.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id129 return value>
...
#line 880
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r9.xyz, r9.xyzx, r3.wwww, r5.xyzx  // r9.x <- <FresnelSchlick_id267 return value>.x; r9.y <- <FresnelSchlick_id267 return value>.y; r9.z <- <FresnelSchlick_id267 return value>.z
...
#line 876
  ...
  div r5.w, r1.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id283 return value>
  mad r3.w, r6.y, r4.w, r3.w
  div r3.w, r6.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id283 return value>

#line 1042
  mul r3.w, r3.w, r5.w
  mul r1.w, r6.y, r1.w
  div r1.w, r3.w, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id285 return value>
...
#line 1038
  ...
  div r2.w, r3.w, r2.w  // r2.w <- <NormalDistributionGGX_id297 return value>
...
#line 1495
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id651 return value>.x; r7.y <- <ComputeDirectLightContribution_id651 return value>.y; r7.z <- <ComputeDirectLightContribution_id651 return value>.z
...
ftoi r8.xy, r0.xyxx
mov r8.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r8.xyzw, t5.xyzw  // r0.x <- streams.lightData_id186.x; r0.y <- streams.lightData_id186.y

#line 1482
and r1.w, r0.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id338 return value>
...
#line 880
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r14.xyz, r14.xyzx, r5.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id267 return value>.x; r14.y <- <FresnelSchlick_id267 return value>.y; r14.z <- <FresnelSchlick_id267 return value>.z
...
#line 876
  ...
  div r11.w, r4.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id283 return value>
  mad r5.w, r6.w, r7.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id283 return value>

#line 1042
  mul r5.w, r5.w, r11.w
  mul r4.w, r6.w, r4.w
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id285 return value>
...
#line 1038
  ...
  div r3.w, r5.w, r3.w  // r3.w <- <NormalDistributionGGX_id297 return value>
...
#line 1460
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id350 return value>
...
#line 880
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r17.xyz, r17.xyzx, r4.wwww, r11.xyzx  // r17.x <- <FresnelSchlick_id267 return value>.x; r17.y <- <FresnelSchlick_id267 return value>.y; r17.z <- <FresnelSchlick_id267 return value>.z
...
#line 876
  ...
  div r6.w, r3.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id283 return value>
  mad r4.w, r14.y, r5.w, r4.w
  div r4.w, r14.y, r4.w  // r4.w <- <VisibilityhSchlickGGX_id283 return value>

#line 1042
  mul r4.w, r4.w, r6.w
  mul r3.w, r14.y, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id285 return value>
...
#line 1038
  mul r2.w, r2.w, r2.w
  mul r2.w, r2.w, l(3.141593)
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id297 return value>
...
#line 820
    sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r15.xyxx, t0.xxxx, s1, r1.w  // r2.w <- <SampleTextureAndCompare_id177 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t0.xxxx, s1, r1.w  // r3.w <- <SampleTextureAndCompare_id177 return value>
...
#line 820
    sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t0.xxxx, s1, r1.w  // r3.w <- <SampleTextureAndCompare_id177 return value>
...
#line 820
    sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t0.xxxx, s1, r1.w  // r1.w <- <SampleTextureAndCompare_id177 return value>
...
#line 1200
  else   // Prior locations: r10.x <- streams.matDiffuseVisible_id69.x; r10.y <- streams.matDiffuseVisible_id69.y; r10.z <- streams.matDiffuseVisible_id69.z; r11.x <- streams.matSpecularVisible_id71.x; r11.y <- streams.matSpecularVisible_id71.y; r11.z <- streams.matSpecularVisible_id71.z; r14.x <- streams.alphaRoughness_id70; r14.y <- streams.NdotV_id72; r8.z <- lightDelta.z; r6.z <- faceIndex; r1.w <- depth
...
#line 1504
  ...
  rsq r0.x, r0.x
  mul r9.xyz, r0.xxxx, r9.xyzx  // r9.x <- streams.H_id75.x; r9.y <- streams.H_id75.y; r9.z <- streams.H_id75.z

#line 1505
  dp3_sat r0.x, r1.xyzx, r9.xyzx  // r0.x <- streams.NdotH_id76

#line 1506
  dp3_sat r1.w, r7.xyzx, r9.xyzx  // r1.w <- streams.LdotH_id77
...
#line 880
  ...
  mul r2.w, r2.w, r2.w
  mul r1.w, r1.w, r2.w
  mad r9.xyz, r9.xyzx, r1.wwww, r5.xyzx  // r9.x <- <FresnelSchlick_id267 return value>.x; r9.y <- <FresnelSchlick_id267 return value>.y; r9.z <- <FresnelSchlick_id267 return value>.z
...
#line 876
  ...
  div r3.w, r0.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id283 return value>
  mad r1.w, r6.y, r2.w, r1.w
  div r1.w, r6.y, r1.w  // r1.w <- <VisibilityhSchlickGGX_id283 return value>

#line 1042
  mul r1.w, r1.w, r3.w
  mul r0.y, r6.y, r0.y
  div r0.y, r1.w, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id285 return value>
...
#line 1038
  ...
  div r0.x, r1.w, r0.x  // r0.x <- <NormalDistributionGGX_id297 return value>
...
#line 382
  mul r0.x, r0.x, r0.x  // r0.x <- <SmoothDistanceAttenuation_id191 return value>
...
#line 583
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.xyxx, t1.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id205 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r13.zwzz, t1.xxxx, s1, r8.z  // r4.w <- <SampleTextureAndCompare_id205 return value>
...
#line 583
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t1.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id205 return value>
...
#line 880
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r7.xyz, r7.xyzx, r0.zzzz, r5.xyzx  // r7.x <- <FresnelSchlick_id267 return value>.x; r7.y <- <FresnelSchlick_id267 return value>.y; r7.z <- <FresnelSchlick_id267 return value>.z
...
#line 876
  ...
  div r2.w, r0.y, r2.w  // r2.w <- <VisibilityhSchlickGGX_id283 return value>
  mad r0.z, r6.y, r1.w, r0.z
  div r0.z, r6.y, r0.z  // r0.z <- <VisibilityhSchlickGGX_id283 return value>

#line 1042
  mul r0.z, r0.z, r2.w
  mul r0.y, r6.y, r0.y
  div r0.y, r0.z, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id285 return value>
...
#line 1038
  mul r0.x, r0.x, r0.x
  mul r0.x, r0.x, l(3.141593)
  div r0.x, r0.z, r0.x  // r0.x <- <NormalDistributionGGX_id297 return value>
...
#line 1117
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id473 return value>.x; r0.z <- <Compute_id473 return value>.y; r0.w <- <Compute_id473 return value>.z

#line 1385
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id652 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id652 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id652 return value>.z
...
#line 1102
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t9.xyzw, s0, r0.x  // r1.x <- <Compute_id423 return value>.x; r1.y <- <Compute_id423 return value>.y; r1.z <- <Compute_id423 return value>.z
...
const static int TFilterSize_id179 = 7;
const static int TMaxLightCount_id196 = 1;
const static int TLightCount_id202 = 1;
const static int TFilterSize_id208 = 7;
const static int TMaxLightCount_id210 = 1;
const static int TCascadeCountBase_id216 = 1;
const static int TLightCountBase_id217 = 1;
const static bool TCascadeDebug_id225 = false;
const static int TFilterSize_id226 = 5;
const static int TOrder_id229 = 3;
const static int TOrder_id231 = 3;
const static bool TInvert_id254 = true;
const static bool TIsEnergyConservative_id266 = false;
static const float PI_id268 = 3.14159265358979323846;
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id239;
    float Input_1_id247;
    float Input_2_id256;
...
cbuffer PerDraw 
{
    ...
    PointLightData Lights_id197[TMaxLightCount_id196];
    float2 ShadowMapTextureSize_id199;
    float2 ShadowMapTextureTexelSize_id200;
    float4x4 WorldToShadow_id203[TLightCount_id202 * 6];
    float4x4 InverseWorldToShadow_id204[TLightCount_id202 * 6];
    float DepthBiases_id205[TLightCount_id202];
    float OffsetScales_id206[TLightCount_id202];
    float2 DepthParameters_id207[TLightCount_id202];
    int LightCount_id209;
    SpotLightData Lights_id211[TMaxLightCount_id210];
    float2 ShadowMapTextureSize_id213;
    float2 ShadowMapTextureTexelSize_id214;
    float4x4 WorldToShadowCascadeUV_id218[TCascadeCountBase_id216 * TLightCountBase_id217];
    float4x4 InverseWorldToShadowCascadeUV_id219[TCascadeCountBase_id216 * TLightCountBase_id217];
    float4x4 ViewMatrices_id220[TCascadeCountBase_id216 * TLightCountBase_id217];
    float2 DepthRanges_id221[TCascadeCountBase_id216 * TLightCountBase_id217];
    float DepthBiases_id222[TLightCountBase_id217];
    float OffsetScales_id223[TLightCountBase_id217];
...
cbuffer PerView 
{
    ...
    float3 AmbientLight_id227;
    float3 SphericalColors_id232[TOrder_id231 * TOrder_id231];
    float MipCount_id233;
    float4x4 SkyMatrix_id235;
    float Intensity_id236;
...
Texture2D ShadowMapTexture_id212;
StructuredBuffer<SMGridParticle> ParticlesBuffer_id149;
StructuredBuffer<SMGridParticle> ParticlesBuffer_id240;
Texture2D EnvironmentLightingDFG_LUT_id269;
...
TextureCube CubeMap_id234;
float4 Project_id170(float4 vec, float4x4 mat)
{
...
float SmoothDistanceAttenuation_id191(float squaredDistance, float lightInvSquareRadius)
{
    float factor = squaredDistance * lightInvSquareRadius;
    float smoothFactor = saturate(1.0f - factor * factor);
    return smoothFactor * smoothFactor;
}
float Get3x3FilterKernel_id179(float2 base_uv, float2 st, out float3 kernel[4])
{
    float2 uvW0 = (3 - 2 * st);
    float2 uvW1 = (1 + 2 * st);
...
float Get5x5FilterKernel_id178(float2 base_uv, float2 st, out float3 kernel[9])
{
    float2 uvW0 = (4 - 3 * st);
    float2 uvW1 = 7;
    float2 uvW2 = (1 + 3 * st);
...
float SampleThickness_id180(float3 shadowSpaceCoordinate, float3 pixelPositionWS, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    const float shadowMapDepth = ShadowMapTexture_id198.SampleLevel(LinearBorderSampler_id114, shadowSpaceCoordinate.xy, 0).r;
    float thickness;
    if (isOrthographic)
    {
    ...
    {
        float4 shadowmapPositionWorldSpace = Project_id170(float4(shadowSpaceCoordinate.xy, shadowMapDepth, 1.0), inverseWorldToShadowCascadeUV);
        thickness = distance(shadowmapPositionWorldSpace.xyz, pixelPositionWS.xyz);
    }
    return (thickness);
}
float Get7x7FilterKernel_id176(float2 base_uv, float2 st, out float3 kernel[16])
{
    float2 uvW0 = (5 * st - 6);
...
float Get3x3FilterKernel_id207(float2 base_uv, float2 st, out float3 kernel[4])
{
    float2 uvW0 = (3 - 2 * st);
    float2 uvW1 = (1 + 2 * st);
    float2 uv0 = (2 - st) / uvW0 - 1;
    float2 uv1 = st / uvW1 + 1;
    kernel[0] = float3(base_uv + uv0 * ShadowMapTextureTexelSize_id214, uvW0.x * uvW0.y);
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW1.y);
    kernel[3] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id214, uvW1.x * uvW1.y);
    return 16.0;
}
float Get5x5FilterKernel_id206(float2 base_uv, float2 st, out float3 kernel[9])
{
    float2 uvW0 = (4 - 3 * st);
    float2 uvW1 = 7;
    float2 uvW2 = (1 + 3 * st);
    ...
    kernel[0] = float3(base_uv + uv0 * ShadowMapTextureTexelSize_id214, uvW0.x * uvW0.y);
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv2.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW2.x * uvW0.y);
    kernel[3] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW1.y);
    kernel[4] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id214, uvW1.x * uvW1.y);
    kernel[5] = float3(base_uv + float2(uv2.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW2.x * uvW1.y);
    kernel[6] = float3(base_uv + float2(uv0.x, uv2.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW2.y);
    kernel[7] = float3(base_uv + float2(uv1.x, uv2.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW2.y);
    kernel[8] = float3(base_uv + uv2 * ShadowMapTextureTexelSize_id214, uvW2.x * uvW2.y);
    return 144.0;
}
float SampleTextureAndCompare_id205(float2 position, float positionDepth)
{
    return ShadowMapTexture_id212.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id115, position, positionDepth);
}
float Get7x7FilterKernel_id204(float2 base_uv, float2 st, out float3 kernel[16])
{
    float2 uvW0 = (5 * st - 6);
    float2 uvW1 = (11 * st - 28);
    float2 uvW2 = -(11 * st + 17);
    ...
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv2.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW2.x * uvW0.y);
    kernel[3] = float3(base_uv + float2(uv3.x, uv0.y) * ShadowMapTextureTexelSize_id214, uvW3.x * uvW0.y);
    kernel[4] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW1.y);
    kernel[5] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id214, uvW1.x * uvW1.y);
    kernel[6] = float3(base_uv + float2(uv2.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW2.x * uvW1.y);
    kernel[7] = float3(base_uv + float2(uv3.x, uv1.y) * ShadowMapTextureTexelSize_id214, uvW3.x * uvW1.y);
    kernel[8] = float3(base_uv + float2(uv0.x, uv2.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW2.y);
    kernel[9] = float3(base_uv + float2(uv1.x, uv2.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW2.y);
    kernel[10] = float3(base_uv + uv2 * ShadowMapTextureTexelSize_id214, uvW2.x * uvW2.y);
    kernel[11] = float3(base_uv + float2(uv3.x, uv2.y) * ShadowMapTextureTexelSize_id214, uvW3.x * uvW2.y);
    kernel[12] = float3(base_uv + float2(uv0.x, uv3.y) * ShadowMapTextureTexelSize_id214, uvW0.x * uvW3.y);
    kernel[13] = float3(base_uv + float2(uv1.x, uv3.y) * ShadowMapTextureTexelSize_id214, uvW1.x * uvW3.y);
    kernel[14] = float3(base_uv + float2(uv2.x, uv3.y) * ShadowMapTextureTexelSize_id214, uvW2.x * uvW3.y);
    kernel[15] = float3(base_uv + uv3 * ShadowMapTextureTexelSize_id214, uvW3.x * uvW3.y);
    return 2704.0;
}
void CalculatePCFKernelParameters_id203(float2 position, out float2 base_uv, out float2 st)
{
    float2 uv = position * ShadowMapTextureSize_id213;
    base_uv = floor(uv + 0.5);
    st = uv + 0.5 - base_uv;
    base_uv -= 0.5;
    base_uv *= ShadowMapTextureTexelSize_id214;
}
float GetAngularAttenuation_id193(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float GetDistanceAttenuation_id192(float lightVectorLength, float lightInvSquareRadius)
{
    float d2 = lightVectorLength * lightVectorLength;
    float attenuation = 1.0 / (max(d2, 0.01 * 0.01));
    attenuation *= SmoothDistanceAttenuation_id191(d2, lightInvSquareRadius);
    return attenuation;
}
float SampleAndFilter_id184(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    float2 uv = adjustedPixelPositionShadowSpace.xy * ShadowMapTextureSize_id199;
    ...
    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id176(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 16; ++i)
        {
            thickness += kernel[i].z * SampleThickness_id180(float3(kernel[i].xy, adjustedPixelPositionShadowSpace.z), adjustedPixelPositionWS, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
        }
    }
    return (thickness / normalizationFactor);
}
void CalculateAdjustedShadowSpacePixelPosition_id183(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    float4 bottomLeftTexelWS = Project_id170(float4(0.0, 0.0, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id170(float4(ShadowMapTextureTexelSize_id200.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, bottomLeftTexelWS.xyz);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 shadowMapCoordinate = Project_id170(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = shadowMapCoordinate.xyz;
}
void CalculateAdjustedShadowSpacePixelPositionPerspective_id182(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    const float4 shadowMapCoordinate = Project_id170(float4(pixelPositionWS, 1.0), worldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id170(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id200.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, pixelPositionWS);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 adjustedShadowMapCoordinate = Project_id170(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = adjustedShadowMapCoordinate.xyz;
}
float GetFilterRadiusInPixels_id181()
{
...
float GetDistanceAttenuation_id167(float lightVectorLength, float lightInvSquareRadius)
{
    float d2 = lightVectorLength * lightVectorLength;
    float attenuation = 1.0 / (max(d2, 0.01 * 0.01));
...
float SampleAndFilter_id136(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id128(base_uv, st, kernel);
...
float4 Compute_id437(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id240[id];
    return float4(p.Col, 1);
}
float FilterShadow_id199(float2 position, float positionDepth)
{
    float shadow = 0.0f;
    float2 base_uv;
    float2 st;
    CalculatePCFKernelParameters_id203(position, base_uv, st);

    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id206(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            shadow += kernel[i].z * SampleTextureAndCompare_id205(kernel[i].xy, positionDepth);
        }
        shadow /= normalizationFactor;
    }
    return shadow;
}
float ComputeAttenuation_id194(float3 PositionWS, float3 AngleOffsetAndInvSquareRadius, float3 DirectionWS, float3 position, inout float3 lightVectorNorm)
{
    ...
    float attenuation = GetDistanceAttenuation_id192(lightVectorLength, lightInvSquareRadius);
    attenuation *= GetAngularAttenuation_id193(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    return attenuation;
}
float SampleTextureAndCompare_id177(float2 position, float positionDepth)
{
    return ShadowMapTexture_id198.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id115, position, positionDepth);
}
void CalculatePCFKernelParameters_id175(float2 position, out float2 base_uv, out float2 st)
{
...
float FilterThickness_id171(float3 pixelPositionWS, float3 meshNormalWS, float2 depthRanges, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    float3 adjustedPixelPositionWS;
    float3 adjustedPixelPositionShadowSpace;
    if (isOrthographic)
    {
        CalculateAdjustedShadowSpacePixelPosition_id183(GetFilterRadiusInPixels_id181(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    else
    {
        CalculateAdjustedShadowSpacePixelPositionPerspective_id182(GetFilterRadiusInPixels_id181(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    return SampleAndFilter_id184(adjustedPixelPositionWS, adjustedPixelPositionShadowSpace, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
}
float ComputeAttenuation_id166(PointLightDataInternal light, float3 position, inout float3 lightVectorNorm)
{
    float3 lightVector = light.PositionWS - position;
    float lightVectorLength = length(lightVector);
    lightVectorNorm = lightVector / lightVectorLength;
    float lightInvSquareRadius = light.InvSquareRadius;
    return GetDistanceAttenuation_id167(lightVectorLength, lightInvSquareRadius);
}
...
float VisibilityhSchlickGGX_id283(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
    return nDotX / (nDotX * (1.0f - k) + k);
}
float3 FresnelSchlick_id267(float3 f0, float3 f90, float lOrVDotH)
{
...
float FilterShadow_id122(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id128(base_uv, st, kernel);
...
{
    streams.Input_2_id256 = Compute_id461();
}
void Compute_id452(inout PS_STREAMS streams)
{
    streams.Input_1_id247 = Compute_id449();
}
void Compute_id440(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id239 = Compute_id437(streams);
}
float4 EvaluateSphericalHarmonics_id221(float3 sphericalColors[TOrder_id229 * TOrder_id229], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float ComputeShadowFromCascade_id202(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    float4 shadowPosition = mul(float4(shadowPositionWS, 1.0), WorldToShadowCascadeUV_id218[cascadeIndex + lightIndex * TCascadeCountBase_id216]);
    shadowPosition.z -= DepthBiases_id222[lightIndex];
    shadowPosition.xyz /= shadowPosition.w;
    return FilterShadow_id199(shadowPosition.xy, shadowPosition.z);
}
float3 GetShadowPositionOffset_id201(float offsetScale, float nDotL, float3 normal)
{
    float normalOffsetScale = saturate(1.0f - nDotL);
    return 2.0f * ShadowMapTextureTexelSize_id214.x * offsetScale * normalOffsetScale * normal;
}
void ProcessLight_id195(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id194(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float FilterShadow_id174(float2 position, float positionDepth)
{
    float shadow = 0.0f;
    float2 base_uv;
    float2 st;
    CalculatePCFKernelParameters_id175(position, base_uv, st);

    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id176(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 16; ++i)
        {
            shadow += kernel[i].z * SampleTextureAndCompare_id177(kernel[i].xy, positionDepth);
        }
        shadow /= normalizationFactor;
    }
    return shadow;
}
float3 GetShadowPositionOffset_id173(float offsetScale, float nDotL, float3 normal)
{
    float normalOffsetScale = saturate(1.0f - nDotL);
    return 2.0f * ShadowMapTextureTexelSize_id200.x * offsetScale * normalOffsetScale * normal;
}
float ComputeThickness_id172(inout PS_STREAMS streams, float3 positionWS, int cascadeIndex)
{
    float tempThickness = 0.0;
    const bool ComputeThickness = true;

    {
        tempThickness = FilterThickness_id171(positionWS, streams.meshNormalWS_id17, float2(0.0f, 1.0f), WorldToShadow_id203[cascadeIndex], InverseWorldToShadow_id204[cascadeIndex], false);
    }
    return tempThickness;
}
void ProcessLight_id168(inout PS_STREAMS streams, PointLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id166(light, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float NormalDistributionGGX_id297(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    float d = max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001);
    return alphaR2 / (PI_id268 * d * d);
}
float VisibilitySmithSchlickGGX_id285(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id283(alphaR, nDotL) * VisibilityhSchlickGGX_id283(alphaR, nDotV) / (nDotL * nDotV);
}
float3 FresnelSchlick_id273(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id267(f0, 1.0f, lOrVDotH);
}
...
float Compute_id467(inout PS_STREAMS streams)
{
    return streams.Input_2_id256;
}
...
float4 Compute_id443(inout PS_STREAMS streams)
{
    return streams.ColorPerParticle_ShaderFXResult_0_id239;
}
...
float4 Compute_id423(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id233;
    return CubeMap_id234.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id418(float3 direction)
{
    return EvaluateSphericalHarmonics_id221(SphericalColors_id232, direction);
}
...
float3 Compute_id473(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id269.SampleLevel(LinearSampler_id113, float2(glossiness, nDotV), 0);
...
float3 ComputeSpecularTextureProjection_id190(float3 positionWS, float3 reflectionWS, int lightIndex)
{
    return 1.0f;
}
float3 ComputeTextureProjection_id189(float3 positionWS, int lightIndex)
{
    return 1.0f;
}
float3 ComputeShadow_id188(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    float3 shadowPosition = position.xyz;
    shadowPosition += GetShadowPositionOffset_id201(OffsetScales_id223[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
    float3 shadow = ComputeShadowFromCascade_id202(shadowPosition, 0, lightIndex);
    float tempThickness = 0.0;
...
void PrepareDirectLightCore_id187(inout PS_STREAMS streams, int lightIndex)
{
    SpotLightDataInternal data;
    data.PositionWS = Lights_id211[lightIndex].PositionWS;
    data.DirectionWS = Lights_id211[lightIndex].DirectionWS;
    data.AngleOffsetAndInvSquareRadius = Lights_id211[lightIndex].AngleOffsetAndInvSquareRadius;
    data.Color = Lights_id211[lightIndex].Color;
    ProcessLight_id195(streams, data);
}
...
float3 ComputeShadow_id162(inout PS_STREAMS streams, float3 positionWS, int lightIndex)
{
    float3 lightPosition = Lights_id197[lightIndex].PositionWS.xyz;
    ...
    streams.thicknessWS_id156 = ComputeThickness_id172(streams, positionWS, cascadeIndex);
    positionWS += GetShadowPositionOffset_id173(OffsetScales_id206[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
    float4 projectedPosition = mul(float4(positionWS, 1), WorldToShadow_id203[cascadeIndex]);
    projectedPosition /= projectedPosition.w;
    lightSpaceZ = abs(lightSpaceZ);
    lightSpaceZ -= DepthBiases_id205[lightIndex];
    float depth = DepthParameters_id207[lightIndex].x + (DepthParameters_id207[lightIndex].y / lightSpaceZ);
    if (depth < 0 || depth > 1)
        return 1;
    float shadow = FilterShadow_id174(projectedPosition.xy, depth);
    return (shadow);
}
void PrepareDirectLightCore_id161(inout PS_STREAMS streams, int lightIndex)
{
    ...
    data.InvSquareRadius = Lights_id197[lightIndex].InvSquareRadius;
...
float Compute_id565(inout PS_STREAMS streams)
{
    return NormalDistributionGGX_id297(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id535(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id285(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id505(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id273(f0, streams.LdotH_id77);
}
...
float Compute_id470(inout PS_STREAMS streams)
{
    Compute_id466(streams);
    return Compute_id467(streams);
}
...
void ResetStream_id300()
{
}
void AfterLightingAndShading_id622()
{
}
void AfterLightingAndShading_id603()
{
}
void PrepareEnvironmentLight_id436(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id433(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id225(streams);
    float ambientAccessibility = streams.matAmbientOcclusion_id57;
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id235);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id47 = Compute_id418(sampleDirection).rgb * Intensity_id236 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    sampleDirection = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id235);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id423(streams, sampleDirection).rgb * Intensity_id236 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id652(inout PS_STREAMS streams)
{
    ...
    return Compute_id473(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id596(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor * streams.envLightDiffuseColor_id47;
}
void PrepareEnvironmentLight_id428(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id216(streams);
    float3 lightColor = AmbientLight_id227 * streams.matAmbientOcclusion_id57;
    streams.envLightDiffuseColor_id47 = lightColor;
    streams.envLightSpecularColor_id48 = lightColor;
}
void PrepareDirectLight_id385(inout PS_STREAMS streams, int lightIndex)
{
    PrepareDirectLightCore_id187(streams, lightIndex);
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id155 = ComputeShadow_id188(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id44 *= ComputeTextureProjection_id189(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id45 *= ComputeSpecularTextureProjection_id190(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id387()
{
    return LightCount_id209;
}
int GetMaxLightCount_id388()
{
    return TMaxLightCount_id210;
}
void PrepareDirectLights_id383()
{
}
void PrepareDirectLight_id360(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id362()
{
    return LightCount_id195;
}
int GetMaxLightCount_id364()
{
    return TMaxLightCount_id196;
}
void PrepareDirectLights_id358()
{
}
void PrepareDirectLight_id347(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id351(inout PS_STREAMS streams)
{
    return streams.lightData_id186.y >> 16;
}
int GetMaxLightCount_id350(inout PS_STREAMS streams)
{
    return streams.lightData_id186.y >> 16;
}
void PrepareDirectLights_id345()
{
}
void PrepareDirectLight_id334(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id339(inout PS_STREAMS streams)
{
    return streams.lightData_id186.y & 0xFFFF;
}
int GetMaxLightCount_id338(inout PS_STREAMS streams)
{
    return streams.lightData_id186.y & 0xFFFF;
}
void PrepareDirectLights_id337(inout PS_STREAMS streams)
{
...
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id505(streams, specularColor);
    float geometricShadowing = Compute_id535(streams);
    float normalDistribution = Compute_id565(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id595(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id268 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id619()
{
}
void PrepareForLightingAndShading_id600()
{
}
void PrepareMaterialForLightingAndShading_id299(inout PS_STREAMS streams)
{
...
void ResetLightStream_id298(inout PS_STREAMS streams)
{
...
float4 Compute_id472(inout PS_STREAMS streams)
{
    float x = Compute_id470(streams);
    return float4(x, x, x, x);
}
float4 Compute_id460(inout PS_STREAMS streams)
{
    float x = Compute_id458(streams);
    return float4(x, x, x, x);
}
...
void Compute_id683(inout PS_STREAMS streams)
{
    UpdateNormalFromTangentSpace_id23(streams.matNormal_id51);
    if (!streams.IsFrontFace_id1)
        streams.normalWS_id19 = -streams.normalWS_id19;
    ResetLightStream_id298(streams);
    PrepareMaterialForLightingAndShading_id299(streams);

    {
        PrepareForLightingAndShading_id600();
    }

    {
        PrepareForLightingAndShading_id619();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id308();
        const int maxLightCount = GetMaxLightCount_id313();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id595(streams);
            }
    ...
    {
        PrepareDirectLights_id337(streams);
        const int maxLightCount = GetMaxLightCount_id338(streams);
        int count = GetLightCount_id339(streams);
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id334(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareDirectLights_id345();
        const int maxLightCount = GetMaxLightCount_id350(streams);
        int count = GetLightCount_id351(streams);
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id347(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareDirectLights_id358();
        const int maxLightCount = GetMaxLightCount_id364();
        int count = GetLightCount_id362();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id360(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareDirectLights_id383();
        const int maxLightCount = GetMaxLightCount_id388();
        int count = GetLightCount_id387();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id385(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareEnvironmentLight_id428(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id596(streams);
        }
    ...
    {
        PrepareEnvironmentLight_id433(streams);
    ...
    {
        PrepareEnvironmentLight_id436(streams);
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id268 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id603();
    }

    {
        AfterLightingAndShading_id622();
    }
}
void Compute_id667(inout PS_STREAMS streams)
{
    float metalness = Compute_id472(streams).r;
...
void Compute_id662(inout PS_STREAMS streams)
{
    float glossiness = Compute_id460(streams).r;
...
{
    float4 colorBase = Compute_id448(streams);
    streams.matDiffuse_id53 = colorBase;
    streams.matColorBase_id52 = colorBase;
}
void ResetStream_id302(inout PS_STREAMS streams)
{
...
void Compute_id112(inout PS_STREAMS streams)
{
    ...
    {
        Compute_id662(streams);
    }

    {
        Compute_id667(streams);
    }
