...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin PolarToCartesian_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Interpolation_id88 => PolarToCartesian_TextureFX.Interpolation
@C    OffsetX_id89 => PolarToCartesian_TextureFX.OffsetX
@C    OffsetY_id90 => PolarToCartesian_TextureFX.OffsetY
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    PolarToCartesian_TextureFX => 33a46f9d15deedbb1a0a4b2d02b743e3
...
//
#line 194 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_25715f723cc62e01981b48823d9c964a.hlsl"
...
@G    Pixel => 719c83193a9d6cee908681233ceecac3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x3f800000 
//   float OffsetX_id89;                // Offset:   84 Size:     4
//      = 0x00000000 
//   float OffsetY_id90;                // Offset:   88 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 164 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_25715f723cc62e01981b48823d9c964a.hlsl"
...
mad r0.xy, cb1[5].xxxx, r0.xyxx, v1.xyxx
add r0.xy, r0.xyxx, cb1[5].yzyy  // r0.y <- coords.y; r0.x <- coords.x
...
cbuffer Globals 
{
    ...
    float OffsetX_id89 = 0.0f;
    float OffsetY_id90 = 0.0f;
};
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    coords = lerp(uv, coords, Interpolation_id88) + float2(OffsetX_id89, OffsetY_id90);
