...
@C    InputValue_id190 => ShaderFX.InputValueFloat.i4
@C    InputValue_id213 => ShaderFX.InputValueFloat3.i8
@C    InputValue_id220 => ShaderFX.InputValueFloat3.i9
@C    InputValue_id248 => ShaderFX.InputValueFloat.i2
@C    InputValue_id256 => ShaderFX.InputValueFloat3.i2
@C    InputValue_id263 => ShaderFX.InputValueFloat3.i3
@C    InputValue_id270 => ShaderFX.InputValueFloat3.i4
@C    InputValue_id280 => ShaderFX.InputValueFloat.i1
@C    InputValue_id288 => ShaderFX.InputValueFloat3
@C    InputValue_id295 => ShaderFX.InputValueFloat3.i1
...
*****     Stages      *****
***************************
@G    Compute => aef7109a3c1342f4e102641a44019e5a
//
...
//   float InputValue_id248;            // Offset:   76 Size:     4
//   float3 InputValue_id256;           // Offset:   80 Size:    12
//   float3 InputValue_id263;           // Offset:   96 Size:    12
//   float3 InputValue_id270;           // Offset:  112 Size:    12
//   float InputValue_id280;            // Offset:  124 Size:     4
//   float3 InputValue_id288;           // Offset:  128 Size:    12
//   float3 InputValue_id295;           // Offset:  144 Size:    12
//   uint InputValue_id316;             // Offset:  156 Size:     4
//   float InputValue_id337;            // Offset:  160 Size:     4
//
// }
//
// cbuffer Globals
...
//
#line 1391 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_b0138d25b37d094118bc5757808e19bf.hlsl"
...
#line 660
  mad r11.xyz, cb1[7].wwww, cb1[8].xyzx, cb1[9].xyzx  // r11.x <- <Compute_id534 return value>.x; r11.y <- <Compute_id534 return value>.y; r11.z <- <Compute_id534 return value>.z
...
#line 656
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id422 return value>.x; r12.y <- <Compute_id422 return value>.y; r12.z <- <Compute_id422 return value>.z
...
#line 627
  mad r12.xyz, r12.xyzx, cb1[5].xyzx, cb1[6].xyzx  // r12.x <- <Compute_id471 return value>.x; r12.y <- <Compute_id471 return value>.y; r12.z <- <Compute_id471 return value>.z

#line 619
  add r12.xyz, r12.xyzx, cb1[7].xyzx  // r12.x <- <Compute_id479 return value>.x; r12.y <- <Compute_id479 return value>.y; r12.z <- <Compute_id479 return value>.z
...
#line 570
  mul r12.yz, r1.wwww, cb1[1].xxyx  // r12.y <- <Compute_id244 return value>.x; r12.z <- <Compute_id244 return value>.y
  mul r12.w, cb1[0].w, cb1[1].z  // r12.w <- <Compute_id244 return value>.z

#line 566
  add r12.xyz, r12.yzwy, cb1[0].xyzx  // r12.x <- <Compute_id250 return value>.x; r12.y <- <Compute_id250 return value>.y; r12.z <- <Compute_id250 return value>.z

#line 558
  mul r13.xyz, r12.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id258 return value>.x; r13.y <- <Compute_id258 return value>.y; r13.z <- <Compute_id258 return value>.z
...
#line 531
  mul r12.xyz, r6.zwwz, cb1[2].wwww  // r12.z <- <Compute_id357 return value>

#line 507
  mad r12.xyz, r12.xyzx, cb1[3].xyzx, cb1[4].xyzx  // r12.x <- <Compute_id387 return value>.x; r12.y <- <Compute_id387 return value>.y; r12.z <- <Compute_id387 return value>.z
...
#line 479
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id552 return value>.x; r14.y <- <SRgbToLinear_id552 return value>.y; r14.z <- <SRgbToLinear_id552 return value>.z
...
struct CS_STREAMS 
{
    ...
    float Input_13_id279;
    float3 SMVector3Join_ShaderFXResult_14_id282;
    float3 Input_15_id287;
    float3 Multiply_16_id290;
    float3 Input_17_id294;
    float3 Plus_18_id297;
    float4 TextureValue_20_id229;
    float SMCalcLuminance_ShaderFXResult_22_id236;
    float Input_23_id247;
    float3 SMVector3Join_ShaderFXResult_24_id250;
    float3 Input_25_id255;
    float3 Multiply_26_id258;
    float3 Input_27_id262;
    float3 Plus_28_id265;
    float3 Input_29_id269;
    float3 Plus_30_id272;
    ...
    float3 SMVector3Join_ShaderFXResult_39_id159;
    float3 Input_40_id164;
    float3 Multiply_41_id167;
    float3 Plus_42_id171;
    float3 Input_43_id175;
    float3 Multiply_44_id178;
    float r_45_id186;
    float Input_46_id189;
    float Multiply_47_id192;
    float g_48_id196;
    float Multiply_49_id199;
    float Multiply_50_id203;
    float3 SMVector3Join_ShaderFXResult_51_id207;
    float3 Input_52_id212;
    float3 Multiply_53_id215;
    float3 Input_54_id219;
    float3 Plus_55_id222;
    uint Input_3_id315;
...
{
    return streams.Input_54_id219;
}
float3 Compute_id382(inout CS_STREAMS streams)
{
    return streams.Multiply_53_id215;
}
float3 Compute_id376(inout CS_STREAMS streams)
{
    return streams.Input_52_id212;
}
float3 Compute_id374(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_51_id207;
}
...
{
    return streams.r_45_id186;
}
float4 Compute_id336(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float3 Compute_id255(inout CS_STREAMS streams)
{
    return streams.Input_43_id175;
}
float3 Compute_id253(inout CS_STREAMS streams)
{
    return streams.Plus_42_id171;
}
float3 Compute_id247(inout CS_STREAMS streams)
{
    return streams.Multiply_41_id167;
}
...
{
    return streams.Input_40_id164;
}
float3 Compute_id239(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_39_id159;
}
...
float4 Compute_id423(inout CS_STREAMS streams)
{
...
float4 Compute_id300(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
...
float4 SRgbToLinear_id552(float4 sRGBa)
{
...
{
    return Compute_id336(streams).r;
}
...
float3 Compute_id237()
{
    return InputValue_id165;
}
float3 Compute_id236(inout CS_STREAMS streams)
{
    return float3(Compute_id229(streams), Compute_id231(streams), Compute_id233(streams));
}
float Compute_id227()
{
...
float3 Compute_id456()
{
    return InputValue_id256;
}
float3 Compute_id455(inout CS_STREAMS streams)
{
    return float3(Compute_id448(streams), Compute_id450(streams), Compute_id452(streams));
}
float Compute_id446()
{
...
{
    float4 color = Compute_id423(streams);
    return Luminance_id57(color.rgb);
}
float4 Compute_id422(inout CS_STREAMS streams)
{
    return DynamicTexture_id230.SampleLevel(DynamicSampler_id131, Compute_id419(streams), Compute_id417());
}
...
{
    return float3(Compute_id511(streams), Compute_id513(streams), Compute_id515(streams));
}
float Compute_id509()
{
...
{
    float4 color = Compute_id300(streams);
...
{
    return DynamicTexture_id330.SampleLevel(DynamicSampler_id131, Compute_id115(streams), Compute_id113());
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return SRgbToLinear_id552(Compute_id109(streams));
}
float4 Compute_id108(inout CS_STREAMS streams)
{
    return DynamicBuffer_id323[Compute_id105(streams)];
}
...
{
    streams.Plus_55_id222 = Compute_id387(streams);
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Input_54_id219 = Compute_id380();
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.Multiply_53_id215 = Compute_id379(streams);
}
void Compute_id405(inout CS_STREAMS streams)
{
    streams.Input_52_id212 = Compute_id372();
}
void Compute_id403(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_51_id207 = Compute_id371(streams);
}
void Compute_id401(inout CS_STREAMS streams)
{
    streams.Multiply_50_id203 = Compute_id363(streams);
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.Multiply_49_id199 = Compute_id357(streams);
}
void Compute_id397(inout CS_STREAMS streams)
{
    streams.g_48_id196 = Compute_id351(streams);
}
void Compute_id395(inout CS_STREAMS streams)
{
    streams.Multiply_47_id192 = Compute_id347(streams);
}
void Compute_id393(inout CS_STREAMS streams)
{
    streams.Input_46_id189 = Compute_id340();
}
void Compute_id391(inout CS_STREAMS streams)
{
    streams.r_45_id186 = Compute_id339(streams);
}
...
{
    streams.Multiply_44_id178 = Compute_id258(streams);
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.Input_43_id175 = Compute_id251();
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Plus_42_id171 = Compute_id250(streams);
}
void Compute_id284(inout CS_STREAMS streams)
{
    streams.Multiply_41_id167 = Compute_id244(streams);
}
void Compute_id282(inout CS_STREAMS streams)
{
    streams.Input_40_id164 = Compute_id237();
}
void Compute_id280(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_39_id159 = Compute_id236(streams);
}
...
{
    streams.Plus_30_id272 = Compute_id479(streams);
}
void Compute_id501(inout CS_STREAMS streams)
{
    streams.Input_29_id269 = Compute_id472();
}
void Compute_id499(inout CS_STREAMS streams)
{
    streams.Plus_28_id265 = Compute_id471(streams);
}
void Compute_id497(inout CS_STREAMS streams)
{
    streams.Input_27_id262 = Compute_id464();
}
void Compute_id495(inout CS_STREAMS streams)
{
    streams.Multiply_26_id258 = Compute_id463(streams);
}
void Compute_id493(inout CS_STREAMS streams)
{
    streams.Input_25_id255 = Compute_id456();
}
void Compute_id491(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id250 = Compute_id455(streams);
}
void Compute_id489(inout CS_STREAMS streams)
{
    streams.Input_23_id247 = Compute_id446();
}
void Compute_id487(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id236 = Compute_id445(streams);
}
void Compute_id485(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id229 = Compute_id422(streams);
}
void Compute_id483()
{
}
...
{
    streams.Plus_18_id297 = Compute_id534(streams);
}
void Compute_id544(inout CS_STREAMS streams)
{
    streams.Input_17_id294 = Compute_id527();
}
void Compute_id542(inout CS_STREAMS streams)
{
    streams.Multiply_16_id290 = Compute_id526(streams);
}
void Compute_id540(inout CS_STREAMS streams)
{
    streams.Input_15_id287 = Compute_id519();
}
void Compute_id538(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id282 = Compute_id518(streams);
}
void Compute_id536(inout CS_STREAMS streams)
{
    streams.Input_13_id279 = Compute_id509();
}
void Compute_id326(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id118 = Compute_id322(streams);
}
...
{
    streams.Lerp_12_id339 = Compute_id128(streams);
}
void Compute_id149(inout CS_STREAMS streams)
{
    streams.Input_11_id336 = Compute_id119();
}
void Compute_id147(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id329 = Compute_id118(streams);
}
void Compute_id145()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id326 = Compute_id112(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id322 = Compute_id108(streams);
}
void Compute_id137(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id318 = Compute_id104(streams);
}
void Compute_id135(inout CS_STREAMS streams)
{
    streams.Input_3_id315 = Compute_id97();
}
...
{
    return streams.Multiply_44_id178;
}
