...
//
#line 1258 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_3bf92dde3b23b9a9dcea842b126d7fd4.hlsl"
...
//
#line 1358 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_3bf92dde3b23b9a9dcea842b126d7fd4.hlsl"
...
#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t2.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id75 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id75 return value>
...
#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id75 return value>

#line 563
  mad r5.w, r6.z, r8.w, r5.w

#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id75 return value>
...
#line 481
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id75 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id75 return value>
...
#line 481
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id75 return value>
...
float SampleAndFilter_id82(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id74(base_uv, st, kernel);
...
float FilterShadow_id68(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id74(base_uv, st, kernel);
