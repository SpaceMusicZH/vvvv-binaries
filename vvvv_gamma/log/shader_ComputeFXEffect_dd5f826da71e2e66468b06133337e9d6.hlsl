...
@P Dim: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat3<Input_31> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i7,PerUpdate>}], mixin AssignVarFloat<Input_32> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_33> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_32>}, {Y = GetVarFloat<Input_32>}, {Z = GetVarFloat<Input_32>}]}], mixin AssignVarFloat3<Input_34> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i8,PerUpdate>}], mixin AssignVarFloat3<Multiply_35> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_33>}, {Right = GetVarFloat3<Input_34>}]}], mixin AssignVarFloat3<Plus_36> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Input_31>}, {Right = GetVarFloat3<Multiply_35>}]}], mixin AssignVarFloat3<Input_37> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<SMQuantize_ShaderFXResult_38> [{Value = mixin SMQuantize_ShaderFX [{Stepsize = GetVarFloat3<Input_37>}, {Value = GetVarFloat3<Plus_36>}]}], mixin AssignVarFloat3<Input_39> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i10,PerUpdate>}], mixin AssignVarFloat3<Multiply_40> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMQuantize_ShaderFXResult_38>}, {Right = GetVarFloat3<Input_39>}]}], ComputeVoid, ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_42> [{Value = mixin SampleLevelTextureFloat4<ObjectTexture_fx41,PerUpdate,ObjectSampler_fx8,PerUpdate> [{LOD = ConstantFloat<0>}, {TexCd = GetSemanticFloat2<SemanticValue_43,TEXCOORD0>}]}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_44> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<TextureValue_42>}]}], mixin AssignVarFloat<Input_45> [{Value = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}], mixin AssignVarFloat<SMThreshold_ShaderFXResult_46> [{Value = mixin SMThreshold_ShaderFX [{Threshold = GetVarFloat<Input_45>}, {Value = GetVarFloat<SMCalcLuminance_ShaderFXResult_44>}]}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_47> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<SMThreshold_ShaderFXResult_46>}, {Y = GetVarFloat<SMThreshold_ShaderFXResult_46>}, {Z = GetVarFloat<SMThreshold_ShaderFXResult_46>}]}], mixin AssignVarFloat3<Multiply_48> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<Multiply_40>}, {Right = GetVarFloat3<SMVector3Join_ShaderFXResult_47>}]}]]}]}, {Value = GetVarFloat3<Multiply_48>}]
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_49> [{Value = InputFloat<ShaderFX.InputValueFloat.i5,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_50> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_49>}, {Y = GetVarFloat<Input_49>}, {Z = GetVarFloat<Input_49>}]}], mixin AssignVarFloat3<Input_51> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i11,PerUpdate>}], mixin AssignVarFloat3<Multiply_52> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_50>}, {Right = GetVarFloat3<Input_51>}]}], mixin AssignVarFloat3<Input_53> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i12,PerUpdate>}], mixin AssignVarFloat3<Plus_54> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_52>}, {Right = GetVarFloat3<Input_53>}]}], mixin AssignVarFloat3<Input_55> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i13,PerUpdate>}], mixin AssignVarFloat3<SMQuantize_ShaderFXResult_56> [{Value = mixin SMQuantize_ShaderFX [{Stepsize = GetVarFloat3<Input_55>}, {Value = GetVarFloat3<Plus_54>}]}]]}]}, {Value = GetVarFloat3<SMQuantize_ShaderFXResult_56>}]
...
@C    InputValue_id320 => ShaderFX.InputValueFloat
@C    InputValue_id330 => ShaderFX.InputValueUInt.i2
...
@R    DynamicTexture_id144 => ObjectTexture_fx41 [Stage: Compute, Slot: (3-3)]
@R    DynamicBuffer_id306 => ObjectBuffer_fx0 [Stage: Compute, Slot: (4-4)]
@R    DynamicTexture_id313 => ObjectTexture_fx7 [Stage: Compute, Slot: (5-5)]
...
*****     Stages      *****
***************************
@G    Compute => 26f26dcf23d4c33874e341fcba5988a0
//
...
//   float InputValue_id320;            // Offset:  228 Size:     4
//   uint InputValue_id330;             // Offset:  232 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicTexture_id313              texture  float4          2d             t5      1 
...
//
#line 1467 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_dd5f826da71e2e66468b06133337e9d6.hlsl"
...
#line 649
  mul r13.xyz, r0.wwww, r12.xyzx  // r13.x <- <Compute_id217 return value>.x; r13.y <- <Compute_id217 return value>.y; r13.z <- <Compute_id217 return value>.z
...
#line 617
  ...
  movc r12.xyz, r13.xyzx, r14.xyzx, r12.xyzx  // r12.x <- <Compute_id312 return value>.x; r12.y <- <Compute_id312 return value>.y; r12.z <- <Compute_id312 return value>.z
...
#line 274
  ...
  imad r0.w, r12.z, r0.w, r1.w  // r0.w <- <CalculateVoxelVolumeIndex_id49 return value>
...
#line 583
    mov r0.w, r13.x  // r0.w <- <SelectMidiValue_id50 return value>
    break 
...
#line 585
    mov r0.w, r13.y  // r0.w <- <SelectMidiValue_id50 return value>
    break 
...
#line 587
    mov r0.w, r13.z  // r0.w <- <SelectMidiValue_id50 return value>
    break 
...
#line 589
    mov r0.w, r13.w  // r0.w <- <SelectMidiValue_id50 return value>
    break 
...
#line 819
  ld_indexable(buffer)(float,float,float,float) r15.xyz, r0.wwww, t4.xyzw  // r15.x <- <Compute_id76 return value>.x; r15.y <- <Compute_id76 return value>.y; r15.z <- <Compute_id76 return value>.z
...
#line 551
  ...
  mul r17.xyz, r15.xyzx, r16.xyzx  // r17.x <- <SRgbToLinear_id456 return value>.x; r17.y <- <SRgbToLinear_id456 return value>.y; r17.z <- <SRgbToLinear_id456 return value>.z

#line 811
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t5.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id86 return value>.x; r6.z <- <Compute_id86 return value>.y; r6.w <- <Compute_id86 return value>.z
...
#line 490
    mov r14.x, r12.x  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 492
    mov r14.x, r12.y  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 494
    mov r14.x, r12.z  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 496
    mov r14.x, r12.w  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 498
    mov r14.x, r13.x  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 500
    mov r14.x, r13.y  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 502
    mov r14.x, r13.z  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 504
    mov r14.x, r13.w  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 506
    mov r14.x, r14.y  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 508
    mov r14.x, r14.z  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 510
    mov r14.x, r14.w  // r14.x <- <SelectMidiValue_id53 return value>
    break 
...
#line 514
    mov r14.x, l(0)  // r14.x <- <SelectMidiValue_id53 return value>
    break 

#line 515
  endswitch   // r14.x <- <SelectMidiValue_id53 return value>
...
const static float Value_id314 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float4 TextureValue_42_id143;
    float SMCalcLuminance_ShaderFXResult_44_id151;
    float Input_45_id162;
    float SMThreshold_ShaderFXResult_46_id165;
    float3 SMVector3Join_ShaderFXResult_47_id169;
    float3 Multiply_48_id174;
    float Input_49_id181;
    float3 SMVector3Join_ShaderFXResult_50_id184;
    float3 Input_51_id189;
    float3 Multiply_52_id192;
    float3 Input_53_id196;
    float3 Plus_54_id199;
    float3 Input_55_id203;
    float3 SMQuantize_ShaderFXResult_56_id206;
    uint Input_1_id284;
    ...
    float Input_11_id319;
    float4 Lerp_12_id322;
};
struct CS_INPUT 
{
...
Texture2D DynamicTexture_id313;
...
{
    return streams.Multiply_52_id192;
}
float3 Compute_id293(inout CS_STREAMS streams)
{
    return streams.Input_51_id189;
}
float3 Compute_id291(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_50_id184;
}
...
{
    return streams.SMVector3Join_ShaderFXResult_47_id169;
}
...
{
    return streams.SMThreshold_ShaderFXResult_46_id165;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_44_id151;
}
...
{
    return streams.TextureValue_42_id143;
}
float Compute_id167()
{
    return Value_id314;
...
{
    return DynamicTexture_id313.SampleLevel(DynamicSampler_id145, Compute_id83(streams), Compute_id81());
}
...
{
    streams.SMQuantize_ShaderFXResult_56_id206 = Compute_id312(streams);
}
void Compute_id326(inout CS_STREAMS streams)
{
    streams.Input_55_id203 = Compute_id305();
}
void Compute_id324(inout CS_STREAMS streams)
{
    streams.Plus_54_id199 = Compute_id304(streams);
}
void Compute_id322(inout CS_STREAMS streams)
{
    streams.Input_53_id196 = Compute_id297();
}
void Compute_id320(inout CS_STREAMS streams)
{
    streams.Multiply_52_id192 = Compute_id296(streams);
}
void Compute_id318(inout CS_STREAMS streams)
{
    streams.Input_51_id189 = Compute_id289();
}
void Compute_id316(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_50_id184 = Compute_id288(streams);
}
void Compute_id314(inout CS_STREAMS streams)
{
    streams.Input_49_id181 = Compute_id279();
}
void Compute_id253(inout CS_STREAMS streams)
{
    streams.Multiply_48_id174 = Compute_id217(streams);
}
void Compute_id251(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_47_id169 = Compute_id211(streams);
}
void Compute_id249(inout CS_STREAMS streams)
{
    streams.SMThreshold_ShaderFXResult_46_id165 = Compute_id203(streams);
}
void Compute_id247(inout CS_STREAMS streams)
{
    streams.Input_45_id162 = Compute_id196();
}
void Compute_id245(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_44_id151 = Compute_id195(streams);
}
void Compute_id243(inout CS_STREAMS streams)
{
    streams.TextureValue_42_id143 = Compute_id172(streams);
}
void Compute_id241()
{
}
...
{
    streams.Lerp_12_id322 = Compute_id96(streams);
}
void Compute_id117(inout CS_STREAMS streams)
{
    streams.Input_11_id319 = Compute_id87();
}
...
{
    return streams.SMQuantize_ShaderFXResult_56_id206;
}
...
{
    return streams.Multiply_48_id174;
}
