...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<1,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,7>, LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<3>, ShadowMapReceiverSpot<3,false>, ShadowMapFilterPcf<PerDraw.Lighting,5>
...
//
#line 1672 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_dc3e460ee323e64a6d4efb2a64ef0c20.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
//   } Lights_id197[3];                 // Offset:  464 Size:   188 [unused]
//   float2 ShadowMapTextureSize_id199; // Offset:  656 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  664 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id204[3];// Offset:  672 Size:   192 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id205[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id206[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id207[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id208[3];        // Offset: 1296 Size:    36 [unused]
//   float OffsetScales_id209[3];       // Offset: 1344 Size:    36 [unused]
...
//   float4x4 WorldToShadowCascadeUV_id166;// Offset:  464 Size:    64 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id167;// Offset:  528 Size:    64 [unused]
//   float4x4 ViewMatrices_id168;       // Offset:  592 Size:    64 [unused]
//   float2 DepthRanges_id169;          // Offset:  656 Size:     8 [unused]
//   float DepthBiases_id170;           // Offset:  672 Size:     4 [unused]
//   float OffsetScales_id171;          // Offset:  688 Size:     4 [unused]
//   float CascadeDepthSplits_id178;    // Offset:  704 Size:     4 [unused]
//   float ClusterDepthScale_id190;     // Offset:  708 Size:     4 [unused]
//   float ClusterDepthBias_id191;      // Offset:  712 Size:     4 [unused]
//   float2 ClusterStride_id192;        // Offset:  720 Size:     8 [unused]
//   float3 AmbientLight_id213;         // Offset:  736 Size:    12 [unused]
//   float3 SphericalColors_id218[9];   // Offset:  752 Size:   140 [unused]
//   float MipCount_id219;              // Offset:  892 Size:     4 [unused]
//   float4x4 SkyMatrix_id221;          // Offset:  896 Size:    64 [unused]
//   float Intensity_id222;             // Offset:  960 Size:     4 [unused]
//   float4 _padding_PerView_Lighting;  // Offset:  976 Size:    16 [unused]
//
// }
//
...
//
#line 1637 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_dc3e460ee323e64a6d4efb2a64ef0c20.hlsl"
...
@G    Pixel => 05bf62d6c84c4e3794c73177b95c7009
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id197[3];                 // Offset:  464 Size:   188
//   float2 ShadowMapTextureSize_id199; // Offset:  656 Size:     8
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  664 Size:     8
//   float4x4 WorldToShadowCascadeUV_id204[3];// Offset:  672 Size:   192
//   float4x4 InverseWorldToShadowCascadeUV_id205[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id206[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id207[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id208[3];        // Offset: 1296 Size:    36
//   float OffsetScales_id209[3];       // Offset: 1344 Size:    36
//   float4 _padding_PerDraw_Lighting;  // Offset: 1392 Size:    16 [unused]
//
// }
//
...
//   float4x4 WorldToShadowCascadeUV_id166;// Offset:  464 Size:    64
//   float4x4 InverseWorldToShadowCascadeUV_id167;// Offset:  528 Size:    64 [unused]
//   float4x4 ViewMatrices_id168;       // Offset:  592 Size:    64 [unused]
//   float2 DepthRanges_id169;          // Offset:  656 Size:     8 [unused]
//   float DepthBiases_id170;           // Offset:  672 Size:     4
//   float OffsetScales_id171;          // Offset:  688 Size:     4
//   float CascadeDepthSplits_id178;    // Offset:  704 Size:     4 [unused]
//   float ClusterDepthScale_id190;     // Offset:  708 Size:     4
//   float ClusterDepthBias_id191;      // Offset:  712 Size:     4
//   float2 ClusterStride_id192;        // Offset:  720 Size:     8
//   float3 AmbientLight_id213;         // Offset:  736 Size:    12
//   float3 SphericalColors_id218[9];   // Offset:  752 Size:   140
//   float MipCount_id219;              // Offset:  892 Size:     4
//   float4x4 SkyMatrix_id221;          // Offset:  896 Size:    64
//   float Intensity_id222;             // Offset:  960 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset:  976 Size:    16 [unused]
//
// }
//
...
//
#line 1621 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_dc3e460ee323e64a6d4efb2a64ef0c20.hlsl"
...
#line 831
  mul r3.w, cb2[28].z, cb2[43].x
  dp2 r2.w, r3.wwww, r2.wwww

#line 1020
  mad r7.xyz, r2.wwww, r1.xyzx, v0.xyzx  // r7.x <- shadowPosition.x; r7.y <- shadowPosition.y; r7.z <- shadowPosition.z

#line 823
  mov r7.w, l(1.000000)
  dp4 r8.x, r7.xyzw, cb2[29].xyzw  // r8.x <- shadowPosition.x
  dp4 r8.y, r7.xyzw, cb2[30].xyzw  // r8.y <- shadowPosition.y
  dp4 r2.w, r7.xyzw, cb2[31].xyzw  // r2.w <- shadowPosition.z
  dp4 r3.w, r7.xyzw, cb2[32].xyzw  // r3.w <- shadowPosition.w

#line 824
  add r8.z, r2.w, -cb2[42].x  // r8.z <- shadowPosition.z

#line 825
  div r7.xyz, r8.xyzx, r3.wwww  // r7.x <- shadowPosition.x; r7.y <- shadowPosition.y; r7.z <- shadowPosition.z
...
#line 427
  mad r8.xyzw, r6.zwwz, l(11.000000, 11.000000, 11.000000, 11.000000), l(-28.000000, -28.000000, 17.000000, 17.000000)  // r8.x <- uvW1.x; r8.y <- uvW1.y

#line 428
  mad r9.xyzw, r6.wzzw, l(5.000000, 5.000000, 5.000000, 5.000000), l(-6.000000, -6.000000, 1.000000, 1.000000)  // r9.x <- uvW0.y; r9.y <- uvW0.x

#line 430
  mad r10.xyzw, r6.zwzw, l(4.000000, 4.000000, 4.000000, 4.000000), l(-5.000000, -5.000000, -16.000000, -16.000000)
...
#line 431
  mad r10.xy, r6.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000), l(5.000000, 5.000000, 0.000000, 0.000000)
...
#line 432
  ...
  add r12.xy, r6.zwzz, l(3.000000, 3.000000, 0.000000, 0.000000)  // r12.x <- uv3.x; r12.y <- uv3.y
...
#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r13.xyxx, t3.xxxx, s1, r7.z  // r2.w <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.zwzz, t3.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id129 return value>

#line 722
  mul r3.w, r3.w, r8.x
  mad r2.w, r9.x, r2.w, r3.w  // r2.w <- shadow

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t3.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id129 return value>

#line 722
  mad r2.w, r6.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.xyxx, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r11.x, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r8.y, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.zwzz, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r18.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r12.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.zwzz, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r10.x, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r6.w, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.zwzz, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r12.w, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r18.xyxx, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r18.w, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r11.ywyy, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r8.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r19.xyxx, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r11.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r19.zwzz, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r10.z, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r10.ywyy, t3.xxxx, s1, r7.z

#line 722
  mad r2.w, r8.w, r3.w, r2.w

#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r7.xyxx, t3.xxxx, s1, r7.z
...
#line 1203
  mul r7.xyz, r2.wwww, cb2[27].xyzx
...
#line 692
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id241 return value>.x; r8.y <- <FresnelSchlick_id241 return value>.y; r8.z <- <FresnelSchlick_id241 return value>.z
...
#line 688
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id257 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id257 return value>

#line 810
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id259 return value>
...
#line 806
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id271 return value>
...
mul r0.xy, r0.xyxx, cb2[45].xyxx

#line 979
mad r0.z, r0.z, cb2[44].y, cb2[44].z
log r0.z, r0.z
...
#line 1171
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id312 return value>
...
#line 692
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id241 return value>.x; r13.y <- <FresnelSchlick_id241 return value>.y; r13.z <- <FresnelSchlick_id241 return value>.z
...
#line 688
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id257 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id257 return value>
...
#line 692
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id241 return value>.x; r16.y <- <FresnelSchlick_id241 return value>.y; r16.z <- <FresnelSchlick_id241 return value>.z
...
#line 688
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id257 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id257 return value>

#line 810
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id259 return value>
...
#line 806
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id271 return value>
...
mov r10.xyz, r4.xyzx  // r10.x <- streams.matDiffuseVisible_id69.x; r10.y <- streams.matDiffuseVisible_id69.y; r10.z <- streams.matDiffuseVisible_id69.z
mov r11.xyz, r5.xyzx  // r11.x <- streams.matSpecularVisible_id71.x; r11.y <- streams.matSpecularVisible_id71.y; r11.z <- streams.matSpecularVisible_id71.z
mov r12.x, r0.w  // r12.x <- streams.alphaRoughness_id70
...
#line 363
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id165 return value>
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r19.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id179 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r19.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id179 return value>
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r21.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id179 return value>
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id179 return value>
...
#line 692
  ...
  mul r4.w, r4.w, r4.w
  mul r1.w, r1.w, r4.w
  mad r16.xyz, r16.xyzx, r1.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id241 return value>.x; r16.y <- <FresnelSchlick_id241 return value>.y; r16.z <- <FresnelSchlick_id241 return value>.z
...
#line 688
  ...
  div r5.w, r3.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id257 return value>
  mad r1.w, r12.z, r4.w, r1.w
  div r1.w, r12.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id257 return value>

#line 810
  mul r1.w, r1.w, r5.w
  mul r3.w, r12.z, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id259 return value>
...
#line 806
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id271 return value>
...
#line 1096
mul r2.xyz, r0.yzwy, cb2[46].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id600 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id600 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id600 return value>.z

#line 1392
mad r2.xyz, r4.xyzx, cb2[46].xyzx, r2.xyzx  // r2.x <- environmentLightingContribution.x; r2.y <- environmentLightingContribution.y; r2.z <- environmentLightingContribution.z

#line 1085
dp3 r1.w, r1.xyzx, cb2[56].xyzx  // r1.w <- sampleDirection.x
dp3 r2.w, r1.xyzx, cb2[57].xyzx  // r2.w <- sampleDirection.y
dp3 r3.w, r1.xyzx, cb2[58].xyzx  // r3.w <- sampleDirection.z
...
#line 751
mad r5.yzw, cb2[48].xxyz, r2.wwww, cb2[47].xxyz  // r5.y <- color.x; r5.z <- color.y; r5.w <- color.z

#line 752
mad r5.yzw, cb2[49].xxyz, -r3.wwww, r5.yyzw

#line 753
mad r5.yzw, cb2[50].xxyz, r1.wwww, r5.yyzw

#line 756
mul r6.xyz, r2.wwww, cb2[51].xyzx
mad r5.yzw, r6.xxyz, r1.wwww, r5.yyzw

#line 757
mul r6.xyz, r2.wwww, cb2[52].xyzx
mad r5.yzw, r6.xxyz, -r3.wwww, r5.yyzw

#line 758
mad r2.w, r5.x, l(3.000000), l(-1.000000)
mad r5.xyz, cb2[53].xyzx, r2.wwww, r5.yzwy  // r5.x <- color.x; r5.y <- color.y; r5.z <- color.z

#line 759
mul r6.xyz, r1.wwww, cb2[54].xyzx
mad r5.xyz, r6.xyzx, -r3.wwww, r5.xyzx

#line 760
mad r1.w, r1.w, r1.w, -r4.w
mad r5.xyz, cb2[55].xyzx, r1.wwww, r5.xyzx

#line 1087
mul r5.xyz, r5.xyzx, cb2[60].xxxx  // r5.x <- streams.envLightDiffuseColor_id47.x; r5.y <- streams.envLightDiffuseColor_id47.y; r5.z <- streams.envLightDiffuseColor_id47.z
...
#line 1089
dp3 r3.x, r1.xyzx, cb2[56].xyzx  // r3.x <- sampleDirection.x
dp3 r3.y, r1.xyzx, cb2[57].xyzx  // r3.y <- sampleDirection.y
dp3 r1.x, r1.xyzx, cb2[58].xyzx  // r1.x <- sampleDirection.z

#line 1090
mov r3.z, -r1.x  // r3.z <- sampleDirection.z

#line 869
mul r0.x, r0.x, cb2[55].w  // r0.x <- mipLevel
...
#line 1091
mul r1.xyz, r1.xyzx, cb2[60].xxxx  // r1.x <- streams.envLightSpecularColor_id48.x; r1.y <- streams.envLightSpecularColor_id48.y; r1.z <- streams.envLightSpecularColor_id48.z
...
const static int TCascadeCountBase_id164 = 1;
const static int TLightCountBase_id165 = 1;
const static int TCascadeCount_id172 = 1;
...
const static int TMaxLightCount_id196 = 3;
const static int TCascadeCountBase_id202 = 1;
const static int TLightCountBase_id203 = 3;
const static bool TCascadeDebug_id211 = false;
const static int TFilterSize_id212 = 5;
...
float FilterShadow_id173(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id180(base_uv, st, kernel);
