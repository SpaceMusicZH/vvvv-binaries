...
@C    InputValue_id155 => ShaderFX.InputValueFloat
@C    InputValue_id164 => ShaderFX.InputValueFloat.i1
...
@R    Particles_id142 => ParticleBuffer.Particles [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id176 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id176 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
//
#line 295 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_62e31dd43ac6f22c9cddac7998a9e292.hlsl"
mov o0.xyzw, v0.xyzw
mov o1.x, v1.x
ret 
// Approximately 3 instruction slots used
@G    Geometry => 6f60c5a4721b920f9da0c8a7a553b7ba
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// PSIZE_ID144_SEM          0   xyz         1     NONE   float   xyz 
...
//
#line 262 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_62e31dd43ac6f22c9cddac7998a9e292.hlsl"
...
#line 224
    dp4 r3.x, r9.xyzw, cb1[16].xyzw  // r3.x <- streams.ShadingPosition_id0.x
    dp4 r3.y, r9.xyzw, cb1[17].xyzw  // r3.y <- streams.ShadingPosition_id0.y
    dp4 r3.z, r9.xyzw, cb1[18].xyzw  // r3.z <- streams.ShadingPosition_id0.z
    dp4 r4.w, r9.xyzw, cb1[19].xyzw  // r4.w <- streams.ShadingPosition_id0.w
...
#line 197
    ishl r2.x, l(1), r0.w  // r2.x <- b

#line 198
    and r6.xyz, r2.xxxx, l(0x0000a55a, 3891, 0x0000330f, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id65 return value>.x; r6.y <- <CubeVert_id65 return value>.y; r6.z <- <CubeVert_id65 return value>.z
...
#line 224
    dp4 r2.x, r6.xyzw, cb1[16].xyzw  // r2.x <- streams.ShadingPosition_id0.x
    dp4 r3.x, r6.xyzw, cb1[17].xyzw  // r3.x <- streams.ShadingPosition_id0.y
    dp4 r3.y, r6.xyzw, cb1[18].xyzw  // r3.y <- streams.ShadingPosition_id0.z
    dp4 r3.z, r6.xyzw, cb1[19].xyzw  // r3.z <- streams.ShadingPosition_id0.w
...
#line 198
    and r6.xyz, r2.xxxx, l(0x0000a500, 3840, 0x00003300, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id65 return value>.x; r6.y <- <CubeVert_id65 return value>.y; r6.z <- <CubeVert_id65 return value>.z
...
#line 198
    and r6.xyz, r2.xxxx, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id65 return value>.x; r6.y <- <CubeVert_id65 return value>.y; r6.z <- <CubeVert_id65 return value>.z
...
#line 198
    and r6.xyz, r2.xxxx, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id65 return value>.x; r6.y <- <CubeVert_id65 return value>.y; r6.z <- <CubeVert_id65 return value>.z
...
#line 224
    dp4 r2.x, r3.xyzw, cb1[16].xyzw  // r2.x <- streams.ShadingPosition_id0.x
    dp4 r2.y, r3.xyzw, cb1[17].xyzw  // r2.y <- streams.ShadingPosition_id0.y
    dp4 r2.z, r3.xyzw, cb1[18].xyzw  // r2.z <- streams.ShadingPosition_id0.z
    dp4 r4.w, r3.xyzw, cb1[19].xyzw  // r4.w <- streams.ShadingPosition_id0.w
...
struct GS_OUTPUT 
{
    ...
    float3 PSize_id144 : PSIZE_ID144_SEM;
...
cbuffer PerMaterial 
{
    ...
    float InputValue_id155;
    float InputValue_id164;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
Texture2D EnvironmentLightingDFG_LUT_id176;
...
void SpawnQuad_id71(inout GS_STREAMS streams, uint start, inout TriangleStream<GS_OUTPUT> triangleStream, float3 normal, Particle p, float3 AxisX, float3 AxisY, float3 AxisZ)
{
    ...
    for (uint i = start; i < start + 4; i++)
    {
        ...
        posWorld.xyz += qPos.x * AxisX * streams.PSize_id144.x;
        posWorld.xyz += qPos.y * AxisY * streams.PSize_id144.y;
        posWorld.xyz += qPos.z * AxisZ * streams.PSize_id144.z;
...

        {
            ...
            output.PSize_id144 = streams.PSize_id144;
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    uint id = streams.VertexID_id141;
    Particle p = Particles_id142[id];
    streams.PositionWS_id21 = float4(p.Position.xyz, 1);
    streams.PSize_id144 = p.Size3;
    if (dot(streams.PSize_id144, streams.PSize_id144) <= 0)
        return;
