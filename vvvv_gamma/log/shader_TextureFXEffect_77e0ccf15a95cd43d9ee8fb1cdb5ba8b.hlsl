...
*****     Sources     *****
***************************
@S    GlowMix_Internal_TextureFX => 6b7131cb96852574d1a455900944eba7
...
//
#line 211 "C:\SMxABB\Sources\SpaceMusic\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_77e0ccf15a95cd43d9ee8fb1cdb5ba8b.hlsl"
...
@G    Pixel => 29e3fd72794609e69adc509a61fa2f95
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id100;            // Offset:   20 Size:     4
//   float InputValue_id101;            // Offset:   24 Size:     4
//   float InputValue_id102;            // Offset:   28 Size:     4 [unused]
...
//
#line 190 "C:\SMxABB\Sources\SpaceMusic\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_77e0ccf15a95cd43d9ee8fb1cdb5ba8b.hlsl"
...
mad r1.w, cb0[1].y, r1.w, l(1.000000)
div r1.w, cb0[1].z, r1.w
...
float4 GlowPass_id34(inout PS_STREAMS streams, float highlightBoost)
{
    ...
    c *= Compute_id37() / lerp(1, av + .1, Compute_id38());
    c.a = s.a;
    c.a = 1;
    return c;
}
