...
*****     Stages      *****
***************************
@G    Vertex => 10adf6fcda181f8696d59de7d891786d
//
...
//
#line 155 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_ae648f0b8117c84ed5af5e06c6ef6388.hlsl"
...
#line 168
dp3 r0.x, v1.xyzx, cb0[8].xyzx  // r0.x <- streams.meshNormalWS_id16.x
dp3 r0.y, v1.xyzx, cb0[9].xyzx  // r0.y <- streams.meshNormalWS_id16.y
dp3 r0.z, v1.xyzx, cb0[10].xyzx  // r0.z <- streams.meshNormalWS_id16.z
...
float4 ComputeShadingPosition_id32(float4 world)
{
...
void PostTransformPosition_id33(inout VS_STREAMS streams)
{
    streams.ShadingPosition_id0 = ComputeShadingPosition_id32(streams.PositionWS_id21);
}
...
void BaseTransformVS_id8(inout VS_STREAMS streams)
{
    ...
    PostTransformPosition_id33(streams);
}
void VSMain_id0()
{
}
