...
*****     Stages      *****
***************************
@G    Compute => 7caa99eb718c43f2ab75c978ce5ed4ad
//
...
//
#line 90 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_eea73ab5d085f6efe888b3431d0e9289.hlsl"
...
#line 106
    ishl r0.z, r0.y, l(2)
    store_structured g0.x, r0.x, r0.z, l(0)
    iadd r0.y, r0.y, l(1)
  endloop 
  iadd r0.x, r0.x, l(1)
endloop 
...
#line 66
mul r0.w, r0.y, r0.z  // r0.w <- falloffRange

#line 67
add r0.z, -r0.z, l(1.000000)
mul r0.z, r0.z, r0.y  // r0.z <- falloffFrom

#line 68
div r2.x, l(-1.000000), r0.w  // r2.x <- falloffMul

#line 69
div r0.z, r0.z, r0.w
add r0.z, r0.z, l(1.000000)  // r0.z <- falloffAdd

#line 70
add r0.w, -r1.w, r0.x
mad_sat r0.w, r0.w, r2.x, r0.z  // r0.w <- weight0

#line 73
add r2.yzw, -r1.xxyz, r0.xxxx
mad_sat r2.yzw, r2.yyzw, r2.xxxx, r0.zzzz  // r2.y <- weight1; r2.z <- weight2; r2.w <- weight3

#line 74
add r0.x, r0.w, r2.y
add r0.x, r2.z, r0.x
add r0.x, r2.w, r0.x  // r0.x <- weightSum
...
div r0.x, r0.w, r0.x  // r0.x <- <XeGTAO_DepthMIPFilter_id18 return value>
...
#line 119
ld_structured r1.xy, l(1), l(0), g0.xyxx  // r1.x <- inTR; r1.y <- inBR

#line 118
ld_structured r0.w, l(0), l(4), g0.xxxx  // r0.w <- inBL

#line 63
max r1.zw, r0.xxxw, r1.xxxy
max r1.z, r1.w, r1.z  // r1.z <- maxDepth

#line 70
add r1.w, -r0.x, r1.z
mad_sat r1.w, r1.w, r2.x, r0.z  // r1.w <- weight0

#line 73
add r2.yz, -r1.xxyx, r1.zzzz
mad_sat r2.yz, r2.yyzy, r2.xxxx, r0.zzzz  // r2.y <- weight1; r2.z <- weight3

#line 72
add r1.z, -r0.w, r1.z
mad_sat r0.z, r1.z, r2.x, r0.z  // r0.z <- weight2

#line 74
add r1.z, r1.w, r2.y
add r1.z, r0.z, r1.z
add r1.z, r2.z, r1.z  // r1.z <- weightSum
...
div r0.x, r0.x, r1.z  // r0.x <- <XeGTAO_DepthMIPFilter_id18 return value>

#line 133
ushr r1.xyzw, vThreadID.xyxy, l(1, 1, 2, 2)

#line 121
store_uav_typed u2.xyzw, r1.xyyy, r0.xxxx

#line 124
sync_g_t

#line 129
ld_structured r0.z, l(2), l(0), g0.xxxx  // r0.z <- inTR

#line 130
ld_structured r0.w, l(0), l(8), g0.xxxx  // r0.w <- inBL

#line 131
ld_structured r1.x, l(2), l(8), g0.xxxx  // r1.x <- inBR

#line 63
max r1.y, r0.z, r0.x
max r2.x, r0.w, r1.x
max r1.y, r1.y, r2.x  // r1.y <- maxDepth

#line 66
ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r2.x, l(0), l(60), t0.xxxx
mul r2.y, r0.y, r2.x  // r2.y <- falloffRange

#line 67
add r2.x, -r2.x, l(1.000000)
mul r0.y, r0.y, r2.x  // r0.y <- falloffFrom

#line 68
div r2.x, l(-1.000000), r2.y  // r2.x <- falloffMul
...
#line 72
add r2.yzw, -r0.xxzw, r1.yyyy

#line 70
mad_sat r2.y, r2.y, r2.x, r0.y  // r2.y <- weight0

#line 71
mad_sat r2.z, r2.z, r2.x, r0.y  // r2.z <- weight1

#line 72
mad_sat r2.w, r2.w, r2.x, r0.y  // r2.w <- weight2

#line 73
add r1.y, -r1.x, r1.y
mad_sat r1.y, r1.y, r2.x, r0.y  // r1.y <- weight3

#line 74
add r3.x, r2.z, r2.y
add r3.x, r2.w, r3.x
add r3.x, r1.y, r3.x  // r3.x <- weightSum
...
#line 133
store_uav_typed u3.xyzw, r1.zwww, r0.xxxx

#line 136
sync_g_t

#line 141
ld_structured r0.z, l(4), l(0), g0.xxxx  // r0.z <- inTR

#line 142
ld_structured r0.w, l(0), l(16), g0.xxxx  // r0.w <- inBL

#line 143
ld_structured r1.x, l(4), l(16), g0.xxxx  // r1.x <- inBR

#line 63
max r1.y, r0.z, r0.x
max r1.z, r0.w, r1.x
max r1.y, r1.z, r1.y  // r1.y <- maxDepth

#line 71
add r1.zw, -r0.xxxz, r1.yyyy

#line 70
mad_sat r1.z, r1.z, r2.x, r0.y  // r1.z <- weight0

#line 71
mad_sat r1.w, r1.w, r2.x, r0.y  // r1.w <- weight1

#line 72
add r2.y, -r0.w, r1.y
mad_sat r2.y, r2.y, r2.x, r0.y  // r2.y <- weight2

#line 73
add r1.y, -r1.x, r1.y
mad_sat r0.y, r1.y, r2.x, r0.y  // r0.y <- weight3

#line 74
add r1.y, r1.w, r1.z
add r1.y, r2.y, r1.y
add r1.y, r0.y, r1.y  // r1.y <- weightSum
...
div r0.x, r0.x, r1.y  // r0.x <- <XeGTAO_DepthMIPFilter_id18 return value>
