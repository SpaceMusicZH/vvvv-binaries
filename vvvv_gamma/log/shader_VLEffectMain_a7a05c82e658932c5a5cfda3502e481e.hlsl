...
//
#line 1672 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7a05c82e658932c5a5cfda3502e481e.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
#line 1637 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7a05c82e658932c5a5cfda3502e481e.hlsl"
...
@G    Pixel => c57b42c08a6f79ad8e0636baf57a3f59
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1621 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7a05c82e658932c5a5cfda3502e481e.hlsl"
...
#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r11.xyxx, t3.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r11.zwzz, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id129 return value>
...
#line 607
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t3.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id129 return value>
...
#line 607
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r11.xyxx, t3.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id129 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.y, r11.zwzz, t3.xxxx, s1, r7.z  // r7.y <- <SampleTextureAndCompare_id129 return value>
...
#line 607
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t3.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id129 return value>
...
float SampleAndFilter_id136(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[4];
        normalizationFactor = Get3x3FilterKernel_id131(base_uv, st, kernel);
