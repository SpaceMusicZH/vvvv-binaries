...
//
//   } Lights_id185[3];                 // Offset:  464 Size:   188 [unused]
//   float2 ShadowMapTextureSize_id187; // Offset:  656 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id188;// Offset:  664 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id192[3];// Offset:  672 Size:   192 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id193[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id194[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id195[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id196[3];        // Offset: 1296 Size:    36 [unused]
//   float OffsetScales_id197[3];       // Offset: 1344 Size:    36 [unused]
...
//
#line 1485 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ef9a2ba1b9b48aac95f7b5a5d359ae5c.hlsl"
...
@G    Pixel => 6b2658e6edd693213319c2b7674d29ed
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id185[3];                 // Offset:  464 Size:   188
//   float2 ShadowMapTextureSize_id187; // Offset:  656 Size:     8
//   float2 ShadowMapTextureTexelSize_id188;// Offset:  664 Size:     8
//   float4x4 WorldToShadowCascadeUV_id192[3];// Offset:  672 Size:   192
//   float4x4 InverseWorldToShadowCascadeUV_id193[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id194[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id195[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id196[3];        // Offset: 1296 Size:    36
//   float OffsetScales_id197[3];       // Offset: 1344 Size:    36
//   float4 _padding_PerDraw_Lighting;  // Offset: 1392 Size:    16 [unused]
//
// }
//
...
//
#line 1557 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ef9a2ba1b9b48aac95f7b5a5d359ae5c.hlsl"
...
#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id73 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t2.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id73 return value>
...
#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t2.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id73 return value>

#line 685
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id73 return value>
...
#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t2.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id73 return value>
...
#line 572
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id73 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.zwzz, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id73 return value>
...
#line 572
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r17.xyxx, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id73 return value>
...
#line 655
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id185 return value>.x; r8.y <- <FresnelSchlick_id185 return value>.y; r8.z <- <FresnelSchlick_id185 return value>.z
...
#line 651
  ...
  div r5.w, r1.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id201 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id201 return value>

#line 773
  mul r2.x, r2.x, r5.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id203 return value>
...
#line 769
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id215 return value>
...
#line 1147
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id543 return value>.x; r7.y <- <ComputeDirectLightContribution_id543 return value>.y; r7.z <- <ComputeDirectLightContribution_id543 return value>.z
...
#line 943
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t3.xyzw  // r0.x <- streams.lightData_id174.x; r0.y <- streams.lightData_id174.y

#line 1134
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id256 return value>
...
#line 1158
  dp3_sat r5.w, r13.xyzx, r9.xywx  // r5.w <- streams.LdotH_id78
...
#line 655
  ...
  mul r5.w, r5.w, r10.w
  mad r13.xyz, r13.xyzx, r5.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id185 return value>.x; r13.y <- <FresnelSchlick_id185 return value>.y; r13.z <- <FresnelSchlick_id185 return value>.z
...
#line 651
  ...
  mad r12.w, r3.w, r10.w, r5.w
  div r12.w, r3.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id201 return value>
  mad r5.w, r6.w, r10.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id201 return value>

#line 773
  mul r5.w, r5.w, r12.w
  mul r3.w, r6.w, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id203 return value>
...
#line 769
  ...
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id215 return value>
...
#line 1112
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id268 return value>

#line 1303
mov r2.xyz, v0.xyzx  // r2.x <- streams.PositionWS_id23.x; r2.y <- streams.PositionWS_id23.y; r2.z <- streams.PositionWS_id23.z
mov r7.xyz, r5.xyzx  // r7.x <- streams.matDiffuseVisible_id70.x; r7.y <- streams.matDiffuseVisible_id70.y; r7.z <- streams.matDiffuseVisible_id70.z
mov r7.w, r6.y  // r7.w <- streams.NdotV_id73
mov r8.xyz, r4.xyzx  // r8.x <- streams.matSpecularVisible_id72.x; r8.y <- streams.matSpecularVisible_id72.y; r8.z <- streams.matSpecularVisible_id72.z
...
#line 902
  ishl r2.w, r1.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r2.wwww, t6.xyzw  // r13.x <- spotLight1.x; r13.y <- spotLight1.y; r13.z <- spotLight1.z
...
#line 655
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r8.xyzx  // r15.x <- <FresnelSchlick_id185 return value>.x; r15.y <- <FresnelSchlick_id185 return value>.y; r15.z <- <FresnelSchlick_id185 return value>.z

#line 650
  mul r3.w, r8.w, l(0.500000)  // r3.w <- k

#line 651
  mad r5.w, -r8.w, l(0.500000), l(1.000000)
  mad r6.w, r2.w, r5.w, r3.w
  div r6.w, r2.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id201 return value>
  mad r3.w, r7.w, r5.w, r3.w
  div r3.w, r7.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id201 return value>

#line 773
  mul r3.w, r3.w, r6.w
  mul r2.w, r7.w, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id203 return value>
...
#line 769
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id215 return value>
...
#line 866
  mad r2.xyz, r5.wwww, r10.xyzx, r7.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 730
  dp4 r15.x, r2.xyzw, cb0[r0.z + 42].xyzw  // r15.x <- shadowPosition.x
  dp4 r15.y, r2.xyzw, cb0[r0.z + 43].xyzw  // r15.y <- shadowPosition.y
  dp4 r5.w, r2.xyzw, cb0[r0.z + 44].xyzw  // r5.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[r0.z + 45].xyzw  // r2.x <- shadowPosition.w

#line 731
  add r15.z, r5.w, -cb0[r0.y + 81].x  // r15.z <- shadowPosition.z
...
#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.xyxx, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id123 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.zwzz, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id123 return value>

#line 608
  mul r7.w, r7.w, r19.x
  mad r2.x, r2.x, r5.w, r7.w  // r2.x <- shadow

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r21.xyxx, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id123 return value>

#line 608
  mad r2.x, r15.x, r5.w, r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r20.xyxx, t0.xxxx, s1, r2.z

#line 608
  mad r2.x, r19.y, r5.w, r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r20.zwzz, t0.xxxx, s1, r2.z

#line 608
  mad r2.x, r5.w, l(49.000000), r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r21.zwzz, t0.xxxx, s1, r2.z

#line 608
  mad r2.x, r17.z, r5.w, r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r16.xyxx, t0.xxxx, s1, r2.z

#line 608
  mad r2.x, r15.y, r5.w, r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r16.zwzz, t0.xxxx, s1, r2.z

#line 608
  mad r2.x, r17.w, r5.w, r2.x

#line 449
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id123 return value>
...
#line 655
  ...
  mul r5.w, r5.w, r5.w
  mul r1.w, r1.w, r5.w
  mad r15.xyz, r15.xyzx, r1.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id185 return value>.x; r15.y <- <FresnelSchlick_id185 return value>.y; r15.z <- <FresnelSchlick_id185 return value>.z
...
#line 651
  ...
  mad r6.z, r3.w, r5.w, r1.w
  div r6.z, r3.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id201 return value>
  mad r1.w, r8.w, r5.w, r1.w
  div r1.w, r8.w, r1.w  // r1.w <- <VisibilityhSchlickGGX_id201 return value>

#line 773
  mul r1.w, r1.w, r6.z
  mul r3.w, r8.w, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id203 return value>
...
#line 769
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id215 return value>
...
#line 848
mad r0.xyz, r4.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id365 return value>.x; r0.y <- <Compute_id365 return value>.y; r0.z <- <Compute_id365 return value>.z

#line 1059
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id544 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id544 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id544 return value>.z
...
#line 833
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.w  // r1.x <- <Compute_id315 return value>.x; r1.y <- <Compute_id315 return value>.y; r1.z <- <Compute_id315 return value>.z
...
const static int TFilterSize_id167 = 7;
const static int TMaxLightCount_id184 = 3;
const static int TCascadeCountBase_id190 = 1;
const static int TLightCountBase_id191 = 3;
...
float Get3x3FilterKernel_id125(float2 base_uv, float2 st, out float3 kernel[4])
{
    float2 uvW0 = (3 - 2 * st);
    float2 uvW1 = (1 + 2 * st);
    float2 uv0 = (2 - st) / uvW0 - 1;
...
float Get5x5FilterKernel_id124(float2 base_uv, float2 st, out float3 kernel[9])
{
    float2 uvW0 = (4 - 3 * st);
    float2 uvW1 = 7;
    float2 uvW2 = (1 + 3 * st);
...
float SampleTextureAndCompare_id123(float2 position, float positionDepth)
{
    return ShadowMapTexture_id186.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id125, position, positionDepth);
}
float Get7x7FilterKernel_id122(float2 base_uv, float2 st, out float3 kernel[16])
{
    float2 uvW0 = (5 * st - 6);
    float2 uvW1 = (11 * st - 28);
    float2 uvW2 = -(11 * st + 17);
...
void CalculatePCFKernelParameters_id121(float2 position, out float2 base_uv, out float2 st)
{
...
float4 Compute_id329()
{
    return InputValue_id214;
}
float FilterShadow_id117(float2 position, float positionDepth)
{
    float shadow = 0.0f;
    float2 base_uv;
    float2 st;
    CalculatePCFKernelParameters_id121(position, base_uv, st);

    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id124(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            shadow += kernel[i].z * SampleTextureAndCompare_id123(kernel[i].xy, positionDepth);
        }
...
float VisibilityhSchlickGGX_id201(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
    return nDotX / (nDotX * (1.0f - k) + k);
}
float3 FresnelSchlick_id185(float3 f0, float3 f90, float lOrVDotH)
{
...
{
    streams.Input_2_id230 = Compute_id353();
}
void Compute_id344(inout PS_STREAMS streams)
{
    streams.Input_1_id221 = Compute_id341();
}
void Compute_id332(inout PS_STREAMS streams)
{
    streams.Input_0_id213 = Compute_id329();
}
float4 EvaluateSphericalHarmonics_id139(float3 sphericalColors[TOrder_id203 * TOrder_id203], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float ComputeShadowFromCascade_id120(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id117(shadowPosition.xy, shadowPosition.z);
}
float3 GetShadowPositionOffset_id119(float offsetScale, float nDotL, float3 normal)
{
...
float NormalDistributionGGX_id215(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    float d = max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001);
    return alphaR2 / (PI_id242 * d * d);
}
float VisibilitySmithSchlickGGX_id203(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id201(alphaR, nDotL) * VisibilityhSchlickGGX_id201(alphaR, nDotV) / (nDotL * nDotV);
}
float3 FresnelSchlick_id191(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id185(f0, 1.0f, lOrVDotH);
}
...
float4 Compute_id315(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id310(float3 direction)
{
...
float3 Compute_id365(float3 specularColor, float alphaR, float nDotV)
{
...
float3 ComputeShadow_id106(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id119(OffsetScales_id197[lightIndex], streams.NdotL_id50, streams.normalWS_id20);
    float3 shadow = ComputeShadowFromCascade_id120(shadowPosition, 0, lightIndex);
...
{
    return NormalDistributionGGX_id215(streams.alphaRoughness_id71, streams.NdotH_id77);
}
float Compute_id427(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id203(streams.alphaRoughness_id71, streams.NdotL_id50, streams.NdotV_id73);
}
float3 Compute_id397(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id191(f0, streams.LdotH_id78);
}
...
void AfterLightingAndShading_id514()
{
}
void AfterLightingAndShading_id495()
{
}
...
void PrepareEnvironmentLight_id325(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id48 = Compute_id310(sampleDirection).rgb * Intensity_id210 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id49 = Compute_id315(streams, sampleDirection).rgb * Intensity_id210 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.y;
}
float3 ComputeEnvironmentLightContribution_id544(inout PS_STREAMS streams)
{
    ...
    return Compute_id365(specularColor, streams.alphaRoughness_id71, streams.NdotV_id73) * streams.envLightSpecularColor_id49;
}
...
int GetLightCount_id269(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y >> 16;
}
int GetMaxLightCount_id268(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y >> 16;
}
...
void PrepareDirectLight_id252(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id257(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y & 0xFFFF;
}
int GetMaxLightCount_id256(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y & 0xFFFF;
}
void PrepareDirectLights_id255(inout PS_STREAMS streams)
{
...
{
    float3 specularColor = streams.matSpecularVisible_id72;
    float3 fresnel = Compute_id397(streams, specularColor);
    float geometricShadowing = Compute_id427(streams);
    float normalDistribution = Compute_id457(streams);
...
void PrepareForLightingAndShading_id511()
{
}
void PrepareForLightingAndShading_id492()
{
}
...
void Compute_id575(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id492();
    }

    {
        PrepareForLightingAndShading_id511();
    }
    ...
    {
        PrepareDirectLights_id255(streams);
        const int maxLightCount = GetMaxLightCount_id256(streams);
        int count = GetLightCount_id257(streams);
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id252(streams, i);
            PrepareMaterialPerDirectLight_id32(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id268(streams);
        int count = GetLightCount_id269(streams);
    ...
    {
        PrepareEnvironmentLight_id325(streams);
    ...
    {
        AfterLightingAndShading_id495();
    }

    {
        AfterLightingAndShading_id514();
    }
}
void Compute_id559(inout PS_STREAMS streams)
{
    float metalness = Compute_id364(streams).r;
...
{
    float glossiness = Compute_id352(streams).r;
...
{
    float4 colorBase = Compute_id340(streams);
