...
@C    InputValue_id227 => ShaderFX.InputValueFloat3.i10
...
@R    DynamicTexture_id237 => ObjectTexture_fx19 [Stage: Compute, Slot: (4-4)]
@R    DynamicBuffer_id330 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id337 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => 23f7396e754302881879f87e7f61ec02
//
...
//   float3 InputValue_id220;           // Offset:   68 Size:    12
//   float3 InputValue_id227;           // Offset:   80 Size:    12
//   float InputValue_id255;            // Offset:   92 Size:     4
//   float3 InputValue_id263;           // Offset:   96 Size:    12
//   float3 InputValue_id270;           // Offset:  112 Size:    12
//   float3 InputValue_id277;           // Offset:  128 Size:    12
//   float InputValue_id287;            // Offset:  140 Size:     4
//   float3 InputValue_id295;           // Offset:  144 Size:    12
//   float3 InputValue_id302;           // Offset:  160 Size:    12
//   uint InputValue_id323;             // Offset:  172 Size:     4
...
// DynamicTexture_id237              texture  float4          2d             t4      1 
// DynamicBuffer_id330               texture  float4         buf             t5      1 
// DynamicTexture_id337              texture  float4          2d             t6      1 
...
//
#line 1392 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_e57af49ef1656917b9cad14547e50e07.hlsl"
...
#line 661
  mad r11.xyz, cb1[8].wwww, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id555 return value>.x; r11.y <- <Compute_id555 return value>.y; r11.z <- <Compute_id555 return value>.z
...
#line 657
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id443 return value>.x; r12.y <- <Compute_id443 return value>.y; r12.z <- <Compute_id443 return value>.z
...
#line 628
  mad r12.xyz, r12.xyzx, cb1[6].xyzx, cb1[7].xyzx  // r12.x <- <Compute_id492 return value>.x; r12.y <- <Compute_id492 return value>.y; r12.z <- <Compute_id492 return value>.z

#line 620
  add r12.xyz, r12.xyzx, cb1[8].xyzx  // r12.x <- <Compute_id500 return value>.x; r12.y <- <Compute_id500 return value>.y; r12.z <- <Compute_id500 return value>.z
...
#line 527
  mul r12.w, r0.w, cb1[4].x  // r12.w <- <Compute_id388 return value>

#line 515
  mov r12.yz, cb1[3].wwww

#line 507
  mad r12.xyz, r12.yzwy, cb1[4].yzwy, cb1[5].xyzx  // r12.x <- <Compute_id412 return value>.x; r12.y <- <Compute_id412 return value>.y; r12.z <- <Compute_id412 return value>.z
...
struct CS_STREAMS 
{
    ...
    float3 SMVector3Join_ShaderFXResult_50_id214;
    float3 Input_51_id219;
    float3 Multiply_52_id222;
    float3 Input_53_id226;
    float3 Plus_54_id229;
    uint Input_3_id322;
...
{
    return streams.Multiply_52_id222;
}
float3 Compute_id401(inout CS_STREAMS streams)
{
    return streams.Input_51_id219;
}
float3 Compute_id399(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_50_id214;
}
...
{
    return DynamicTexture_id237.SampleLevel(DynamicSampler_id128, Compute_id440(streams), Compute_id438());
}
...
{
    return DynamicTexture_id337.SampleLevel(DynamicSampler_id128, Compute_id119(streams), Compute_id117());
}
float4 Compute_id116(inout CS_STREAMS streams)
{
    return SRgbToLinear_id573(Compute_id113(streams));
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return DynamicBuffer_id330[Compute_id109(streams)];
}
...
{
    streams.Plus_54_id229 = Compute_id412(streams);
}
void Compute_id430(inout CS_STREAMS streams)
{
    streams.Input_53_id226 = Compute_id405();
}
void Compute_id428(inout CS_STREAMS streams)
{
    streams.Multiply_52_id222 = Compute_id404(streams);
}
void Compute_id426(inout CS_STREAMS streams)
{
    streams.Input_51_id219 = Compute_id397();
}
void Compute_id424(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_50_id214 = Compute_id396(streams);
}
...
{
    streams.Plus_30_id279 = Compute_id500(streams);
}
void Compute_id522(inout CS_STREAMS streams)
{
    streams.Input_29_id276 = Compute_id493();
}
void Compute_id520(inout CS_STREAMS streams)
{
    streams.Plus_28_id272 = Compute_id492(streams);
}
void Compute_id518(inout CS_STREAMS streams)
{
    streams.Input_27_id269 = Compute_id485();
}
void Compute_id516(inout CS_STREAMS streams)
{
    streams.Multiply_26_id265 = Compute_id484(streams);
}
void Compute_id514(inout CS_STREAMS streams)
{
    streams.Input_25_id262 = Compute_id477();
}
void Compute_id512(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id257 = Compute_id476(streams);
}
void Compute_id510(inout CS_STREAMS streams)
{
    streams.Input_23_id254 = Compute_id467();
}
void Compute_id508(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id243 = Compute_id466(streams);
}
void Compute_id506(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id236 = Compute_id443(streams);
}
void Compute_id504()
{
}
...
{
    streams.Plus_18_id304 = Compute_id555(streams);
}
void Compute_id565(inout CS_STREAMS streams)
{
    streams.Input_17_id301 = Compute_id548();
}
void Compute_id563(inout CS_STREAMS streams)
{
    streams.Multiply_16_id297 = Compute_id547(streams);
}
void Compute_id561(inout CS_STREAMS streams)
{
    streams.Input_15_id294 = Compute_id540();
}
void Compute_id559(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id289 = Compute_id539(streams);
}
void Compute_id557(inout CS_STREAMS streams)
{
    streams.Input_13_id286 = Compute_id530();
}
...
{
    streams.Lerp_12_id346 = Compute_id132(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_11_id343 = Compute_id123();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id336 = Compute_id122(streams);
}
void Compute_id149()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id333 = Compute_id116(streams);
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id329 = Compute_id112(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id325 = Compute_id108(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.Input_3_id322 = Compute_id101();
}
