...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurPass2_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@S    BlurPassBase => 0caed83c6b0e0532e00218c890bea95c
...
//
#line 199 "C:\SMxABB\Sources\SpaceMusic\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_92394eaac1b8ce3ec6ad4007aff7faca.hlsl"
...
//
#line 159 "C:\SMxABB\Sources\SpaceMusic\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_92394eaac1b8ce3ec6ad4007aff7faca.hlsl"
...
void ClacLodAndOffset_id29(float2 R, float strength, out float lod, out float2 off)
{
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    float lod;
    float2 off;
    ClacLodAndOffset_id29(ViewSize_id77, Compute_id33(), lod, off);
