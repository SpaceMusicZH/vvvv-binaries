...
//
#line 236 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_SSLRResolvePassEffect_fdcf807a10a764be0e1e2fa23b8feb7f.hlsl"
...
@G    Pixel => a21678a1421c7e1fa78ef8837726ddad
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   v1.x <- __input__.TexCoord_id62.x; v1.y <- __input__.TexCoord_id62.y
//
#line 184 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_SSLRResolvePassEffect_fdcf807a10a764be0e1e2fa23b8feb7f.hlsl"
...
#line 217
    mul r0.xyzw, r3.xyzw, l(0.142857, 0.142857, 0.142857, 0.142857)  // r0.x <- result.x; r0.y <- result.y; r0.z <- result.z; r0.w <- result.w
...
***************************
*************************/
const static int ResolveSamples_id87 = 7;
