...
//
#line 208 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_ac879095a6421db23fbaa8cff02f4efd.hlsl"
...
void Compute_id58(inout CS_STREAMS streams)
{
    ...
    float width = Compute_id59();
    float4 color = Compute_id60();
    ...
    if (MeshType_id48 == 0)
    {
        FlatMeshLine_id54(outputBuffer_id45, dtid, from, t, fromScale, color, to, t, toScale, color, Radius_id46, 2, NormalBend_id52, ViewAlign_id51 ? normalize(fromViewDir) : Compute_id62(), ViewAlign_id51 ? normalize(toViewDir) : Compute_id62());
    }
    else
    {
        TubeMeshLine_id56(outputBuffer_id45, dtid, from, t, fromScale, color, to, t, toScale, color, Radius_id46, 2, Resolution_id50, Compute_id61());
    }
}
[numthreads(1, 1, 1)]
