...
@C    InputValue_id157 => ShaderFX.InputValueFloat.i3
@C    InputValue_id169 => ShaderFX.InputValueFloat3.i6
@C    InputValue_id180 => ShaderFX.InputValueFloat3.i7
@C    InputValue_id194 => ShaderFX.InputValueFloat.i4
@C    InputValue_id217 => ShaderFX.InputValueFloat3.i8
@C    InputValue_id224 => ShaderFX.InputValueFloat3.i9
@C    InputValue_id252 => ShaderFX.InputValueFloat.i2
@C    InputValue_id260 => ShaderFX.InputValueFloat3.i2
@C    InputValue_id267 => ShaderFX.InputValueFloat3.i3
@C    InputValue_id274 => ShaderFX.InputValueFloat3.i4
@C    InputValue_id284 => ShaderFX.InputValueFloat.i1
@C    InputValue_id292 => ShaderFX.InputValueFloat3
@C    InputValue_id299 => ShaderFX.InputValueFloat3.i1
...
@R    DynamicTexture_id234 => ObjectTexture_fx19 [Stage: Compute, Slot: (4-4)]
@R    DynamicBuffer_id327 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id334 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => e61917dcfd3227136f884d3ff8bdf87a
//
...
//   float3 InputValue_id169;           // Offset:   16 Size:    12
//   float3 InputValue_id180;           // Offset:   32 Size:    12
//   float InputValue_id194;            // Offset:   44 Size:     4
//   float3 InputValue_id217;           // Offset:   48 Size:    12
//   float3 InputValue_id224;           // Offset:   64 Size:    12
//   float InputValue_id252;            // Offset:   76 Size:     4
//   float3 InputValue_id260;           // Offset:   80 Size:    12
//   float3 InputValue_id267;           // Offset:   96 Size:    12
//   float3 InputValue_id274;           // Offset:  112 Size:    12
//   float InputValue_id284;            // Offset:  124 Size:     4
...
// DynamicTexture_id234              texture  float4          2d             t4      1 
// DynamicBuffer_id327               texture  float4         buf             t5      1 
// DynamicTexture_id334              texture  float4          2d             t6      1 
...
//
#line 1412 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_0cb8d5aa783ff8f10146c90037e83904.hlsl"
...
#line 673
  mad r11.xyz, cb1[7].wwww, cb1[8].xyzx, cb1[9].xyzx  // r11.x <- <Compute_id542 return value>.x; r11.y <- <Compute_id542 return value>.y; r11.z <- <Compute_id542 return value>.z
...
#line 669
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id430 return value>.x; r12.y <- <Compute_id430 return value>.y; r12.z <- <Compute_id430 return value>.z
...
#line 640
  mad r12.xyz, r12.xyzx, cb1[5].xyzx, cb1[6].xyzx  // r12.x <- <Compute_id479 return value>.x; r12.y <- <Compute_id479 return value>.y; r12.z <- <Compute_id479 return value>.z

#line 632
  add r12.xyz, r12.xyzx, cb1[7].xyzx  // r12.x <- <Compute_id487 return value>.x; r12.y <- <Compute_id487 return value>.y; r12.z <- <Compute_id487 return value>.z
...
#line 603
  mul r12.yz, r0.wwww, r1.wwww  // r12.z <- <Compute_id220 return value>

#line 591
  mul r12.w, r0.w, cb1[0].w  // r12.w <- <Compute_id234 return value>

#line 575
  mad r12.xyz, r12.yzwy, cb1[1].xyzx, cb1[0].xyzx  // r12.x <- <Compute_id256 return value>.x; r12.y <- <Compute_id256 return value>.y; r12.z <- <Compute_id256 return value>.z

#line 567
  mul r13.xyz, r12.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id264 return value>.x; r13.y <- <Compute_id264 return value>.y; r13.z <- <Compute_id264 return value>.z
...
#line 540
  mul r12.xyz, r6.zwwz, cb1[2].wwww  // r12.z <- <Compute_id365 return value>

#line 516
  mad r12.xyz, r12.xyzx, cb1[3].xyzx, cb1[4].xyzx  // r12.x <- <Compute_id395 return value>.x; r12.y <- <Compute_id395 return value>.y; r12.z <- <Compute_id395 return value>.z
...
#line 488
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id560 return value>.x; r14.y <- <SRgbToLinear_id560 return value>.y; r14.z <- <SRgbToLinear_id560 return value>.z
...
struct CS_STREAMS 
{
    ...
    float Input_13_id283;
    float3 SMVector3Join_ShaderFXResult_14_id286;
    float3 Input_15_id291;
    float3 Multiply_16_id294;
    float3 Input_17_id298;
    float3 Plus_18_id301;
    float4 TextureValue_20_id233;
    float SMCalcLuminance_ShaderFXResult_22_id240;
    float Input_23_id251;
    float3 SMVector3Join_ShaderFXResult_24_id254;
    float3 Input_25_id259;
    float3 Multiply_26_id262;
    float3 Input_27_id266;
    float3 Plus_28_id269;
    float3 Input_29_id273;
    float3 Plus_30_id276;
    ...
    float Input_38_id156;
    float Multiply_39_id159;
    float3 SMVector3Join_ShaderFXResult_40_id163;
    float3 Input_41_id168;
    float3 Multiply_42_id171;
    float3 Plus_43_id175;
    float3 Input_44_id179;
    float3 Multiply_45_id182;
    float r_46_id190;
    float Input_47_id193;
    float Multiply_48_id196;
    float g_49_id200;
    float Multiply_50_id203;
    float Multiply_51_id207;
    float3 SMVector3Join_ShaderFXResult_52_id211;
    float3 Input_53_id216;
    float3 Multiply_54_id219;
    float3 Input_55_id223;
    float3 Plus_56_id226;
    uint Input_3_id319;
...
cbuffer PerUpdate 
{
    ...
    float3 InputValue_id217;
    float3 InputValue_id224;
    float InputValue_id252;
    float3 InputValue_id260;
    float3 InputValue_id267;
    float3 InputValue_id274;
    float InputValue_id284;
...
{
    return streams.Input_55_id223;
}
float3 Compute_id390(inout CS_STREAMS streams)
{
    return streams.Multiply_54_id219;
}
float3 Compute_id384(inout CS_STREAMS streams)
{
    return streams.Input_53_id216;
}
float3 Compute_id382(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_52_id211;
}
...
{
    return streams.Multiply_48_id196;
}
...
{
    return streams.r_46_id190;
}
float4 Compute_id344(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float3 Compute_id261(inout CS_STREAMS streams)
{
    return streams.Input_44_id179;
}
...
{
    return streams.Multiply_42_id171;
}
...
{
    return streams.Input_41_id168;
}
float3 Compute_id245(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_40_id163;
}
float Compute_id239(inout CS_STREAMS streams)
{
    return streams.Multiply_39_id159;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_22_id240;
}
...
{
    return streams.TextureValue_20_id233;
}
float Compute_id425()
{
    return Value_id335;
...
{
    return streams.Input_17_id298;
}
float3 Compute_id537(inout CS_STREAMS streams)
{
    return streams.Multiply_16_id294;
}
float3 Compute_id531(inout CS_STREAMS streams)
{
    return streams.Input_15_id291;
}
float3 Compute_id529(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_14_id286;
}
float Compute_id523(inout CS_STREAMS streams)
{
    return streams.Input_13_id283;
}
float Compute_id521(inout CS_STREAMS streams)
{
    return streams.Input_13_id283;
}
...
float4 SRgbToLinear_id560(float4 sRGBa)
{
...
{
    return Compute_id356(streams).g;
}
...
{
    return Compute_id344(streams).r;
}
...
{
    return InputValue_id267;
}
float3 Compute_id471(inout CS_STREAMS streams)
{
    return Compute_id466(streams) * Compute_id468(streams);
}
float3 Compute_id464()
{
    return InputValue_id260;
}
float3 Compute_id463(inout CS_STREAMS streams)
{
    return float3(Compute_id456(streams), Compute_id458(streams), Compute_id460(streams));
}
float Compute_id454()
{
...
{
    return DynamicTexture_id234.SampleLevel(DynamicSampler_id131, Compute_id427(streams), Compute_id425());
}
...
{
    return Compute_id529(streams) * Compute_id531(streams);
}
...
{
    return float3(Compute_id519(streams), Compute_id521(streams), Compute_id523(streams));
}
float Compute_id517()
{
...
{
    return DynamicTexture_id334.SampleLevel(DynamicSampler_id131, Compute_id115(streams), Compute_id113());
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return SRgbToLinear_id560(Compute_id109(streams));
}
float4 Compute_id108(inout CS_STREAMS streams)
{
    return DynamicBuffer_id327[Compute_id105(streams)];
}
...
{
    streams.Plus_56_id226 = Compute_id395(streams);
}
void Compute_id417(inout CS_STREAMS streams)
{
    streams.Input_55_id223 = Compute_id388();
}
void Compute_id415(inout CS_STREAMS streams)
{
    streams.Multiply_54_id219 = Compute_id387(streams);
}
void Compute_id413(inout CS_STREAMS streams)
{
    streams.Input_53_id216 = Compute_id380();
}
void Compute_id411(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_52_id211 = Compute_id379(streams);
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Multiply_51_id207 = Compute_id371(streams);
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.Multiply_50_id203 = Compute_id365(streams);
}
void Compute_id405(inout CS_STREAMS streams)
{
    streams.g_49_id200 = Compute_id359(streams);
}
void Compute_id403(inout CS_STREAMS streams)
{
    streams.Multiply_48_id196 = Compute_id355(streams);
}
void Compute_id401(inout CS_STREAMS streams)
{
    streams.Input_47_id193 = Compute_id348();
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.r_46_id190 = Compute_id347(streams);
}
...
{
    streams.Multiply_45_id182 = Compute_id264(streams);
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.Input_44_id179 = Compute_id257();
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.Plus_43_id175 = Compute_id256(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.Multiply_42_id171 = Compute_id250(streams);
}
void Compute_id290(inout CS_STREAMS streams)
{
    streams.Input_41_id168 = Compute_id243();
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_40_id163 = Compute_id242(streams);
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Multiply_39_id159 = Compute_id234(streams);
}
void Compute_id284(inout CS_STREAMS streams)
{
    streams.Input_38_id156 = Compute_id227();
}
...
{
    streams.Plus_30_id276 = Compute_id487(streams);
}
void Compute_id509(inout CS_STREAMS streams)
{
    streams.Input_29_id273 = Compute_id480();
}
void Compute_id507(inout CS_STREAMS streams)
{
    streams.Plus_28_id269 = Compute_id479(streams);
}
void Compute_id505(inout CS_STREAMS streams)
{
    streams.Input_27_id266 = Compute_id472();
}
void Compute_id503(inout CS_STREAMS streams)
{
    streams.Multiply_26_id262 = Compute_id471(streams);
}
void Compute_id501(inout CS_STREAMS streams)
{
    streams.Input_25_id259 = Compute_id464();
}
void Compute_id499(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id254 = Compute_id463(streams);
}
void Compute_id497(inout CS_STREAMS streams)
{
    streams.Input_23_id251 = Compute_id454();
}
void Compute_id495(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id240 = Compute_id453(streams);
}
void Compute_id493(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id233 = Compute_id430(streams);
}
void Compute_id491()
{
}
...
{
    streams.Plus_18_id301 = Compute_id542(streams);
}
void Compute_id552(inout CS_STREAMS streams)
{
    streams.Input_17_id298 = Compute_id535();
}
void Compute_id550(inout CS_STREAMS streams)
{
    streams.Multiply_16_id294 = Compute_id534(streams);
}
void Compute_id548(inout CS_STREAMS streams)
{
    streams.Input_15_id291 = Compute_id527();
}
void Compute_id546(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id286 = Compute_id526(streams);
}
void Compute_id544(inout CS_STREAMS streams)
{
    streams.Input_13_id283 = Compute_id517();
}
void Compute_id334(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id118 = Compute_id330(streams);
}
...
{
    streams.Lerp_12_id343 = Compute_id128(streams);
}
void Compute_id149(inout CS_STREAMS streams)
{
    streams.Input_11_id340 = Compute_id119();
}
void Compute_id147(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id333 = Compute_id118(streams);
}
void Compute_id145()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id330 = Compute_id112(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id326 = Compute_id108(streams);
}
void Compute_id137(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id322 = Compute_id104(streams);
}
void Compute_id135(inout CS_STREAMS streams)
{
    streams.Input_3_id319 = Compute_id97();
}
...
{
    return streams.Multiply_45_id182;
}
