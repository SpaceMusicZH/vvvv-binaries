...
//
#line 1672 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_2858e4482bcb9c37fe0d0db9b2969c89.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
//   } Lights_id197[2];                 // Offset:  464 Size:   124 [unused]
//   float2 ShadowMapTextureSize_id199; // Offset:  592 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  600 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id204[2];// Offset:  608 Size:   128 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id205[2];// Offset:  736 Size:   128 [unused]
//   float4x4 ViewMatrices_id206[2];    // Offset:  864 Size:   128 [unused]
//   float2 DepthRanges_id207[2];       // Offset:  992 Size:    24 [unused]
//   float DepthBiases_id208[2];        // Offset: 1024 Size:    20 [unused]
//   float OffsetScales_id209[2];       // Offset: 1056 Size:    20 [unused]
...
//
#line 1637 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_2858e4482bcb9c37fe0d0db9b2969c89.hlsl"
...
@G    Pixel => 5ebf0edee1d9556897187ef285335284
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id197[2];                 // Offset:  464 Size:   124
//   float2 ShadowMapTextureSize_id199; // Offset:  592 Size:     8
//   float2 ShadowMapTextureTexelSize_id200;// Offset:  600 Size:     8
//   float4x4 WorldToShadowCascadeUV_id204[2];// Offset:  608 Size:   128
//   float4x4 InverseWorldToShadowCascadeUV_id205[2];// Offset:  736 Size:   128 [unused]
//   float4x4 ViewMatrices_id206[2];    // Offset:  864 Size:   128 [unused]
//   float2 DepthRanges_id207[2];       // Offset:  992 Size:    24 [unused]
//   float DepthBiases_id208[2];        // Offset: 1024 Size:    20
//   float OffsetScales_id209[2];       // Offset: 1056 Size:    20
//   float4 _padding_PerDraw_Lighting;  // Offset: 1088 Size:    16 [unused]
//
// }
//
...
//
#line 1621 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_2858e4482bcb9c37fe0d0db9b2969c89.hlsl"
...
#line 767
  dp4 r16.x, r2.xyzw, cb0[r0.z + 38].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r2.xyzw, cb0[r0.z + 39].xyzw  // r16.y <- shadowPosition.y
  dp4 r4.w, r2.xyzw, cb0[r0.z + 40].xyzw  // r4.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[r0.z + 41].xyzw  // r2.x <- shadowPosition.w

#line 768
  add r16.z, r4.w, -cb0[r0.y + 64].x  // r16.z <- shadowPosition.z
...
#line 472
  mad r19.xyzw, r17.xwzw, cb0[37].zwzw, r6.zwzw
...
#line 475
  mad r20.xyzw, r17.xyzy, cb0[37].zwzw, r6.zwzw

#line 476
  mad r21.xyzw, r18.xzxw, cb0[37].zwzw, r6.zwzw
...
#line 478
  mad r17.xyzw, r17.xyzy, cb0[37].zwzw, r6.zwzw
  mul r18.zw, r16.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 479
  mad r6.zw, r18.xxxy, cb0[37].zzzw, r6.zzzw
...
const static int TMaxLightCount_id196 = 2;
const static int TCascadeCountBase_id202 = 1;
const static int TLightCountBase_id203 = 2;
