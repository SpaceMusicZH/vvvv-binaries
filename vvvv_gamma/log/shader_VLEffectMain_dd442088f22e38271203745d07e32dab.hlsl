...
@C    Lights_id188 => LightSpotGroup.Lights.directLightGroups[3]
...
@C    WorldToShadowCascadeUV_id195 => ShadowMapReceiverBase.WorldToShadowCascadeUV.directLightGroups[3]
@C    InverseWorldToShadowCascadeUV_id196 => ShadowMapReceiverBase.InverseWorldToShadowCascadeUV.directLightGroups[3]
@C    ViewMatrices_id197 => ShadowMapReceiverBase.ViewMatrices.directLightGroups[3]
@C    DepthRanges_id198 => ShadowMapReceiverBase.DepthRanges.directLightGroups[3]
@C    DepthBiases_id199 => ShadowMapReceiverBase.DepthBiases.directLightGroups[3]
@C    OffsetScales_id200 => ShadowMapReceiverBase.OffsetScales.directLightGroups[3]
@C    _padding_PerDraw_Lighting => _padding_PerDraw_Lighting
cbuffer PerMaterial [Size: 16]
@C    MeshIndex_id143 => SMGridMeshSelector_ShaderFX.MeshIndex
@C    InputValue_id225 => ShaderFX.InputValueFloat
@C    InputValue_id234 => ShaderFX.InputValueFloat.i1
...
@C    SphericalColors_id209 => SphericalHarmonicsEnvironmentColor.SphericalColors.lightDiffuseColor.environmentLights[1]
@C    MipCount_id210 => RoughnessCubeMapEnvironmentColor.MipCount.lightSpecularColor.environmentLights[1]
@C    SkyMatrix_id212 => LightSkyboxShader.SkyMatrix.environmentLights[1]
@C    Intensity_id213 => LightSkyboxShader.Intensity.environmentLights[1]
...
@R    ParticlesBuffer_id144 => SMGridMeshSelector_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id217 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id217 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
...
@R    SpotLights_id185 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    CubeMap_id211 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
@R    CubeMap_id211 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
...
@R    ParticlesBuffer_id217 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (1-1)]
@R    EnvironmentLightingDFG_LUT_id246 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (2-2)]
@R    ShadowMapTexture_id151 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (3-3)]
@R    LightClusters_id179 => LightClustered.LightClusters [Stage: Pixel, Slot: (4-4)]
@R    LightIndices_id180 => LightClustered.LightIndices [Stage: Pixel, Slot: (5-5)]
@R    PointLights_id184 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (6-6)]
@R    SpotLights_id185 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (7-7)]
@R    CubeMap_id211 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (8-8)]
...
//
//   } Lights_id188[3];                 // Offset:  464 Size:   188 [unused]
//   float2 ShadowMapTextureSize_id190; // Offset:  656 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id191;// Offset:  664 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id195[3];// Offset:  672 Size:   192 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id196[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id197[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id198[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id199[3];        // Offset: 1296 Size:    36 [unused]
//   float OffsetScales_id200[3];       // Offset: 1344 Size:    36 [unused]
...
//   float InputValue_id225;            // Offset:    4 Size:     4 [unused]
//   float InputValue_id234;            // Offset:    8 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id204;         // Offset: 1408 Size:    12 [unused]
//   float3 SphericalColors_id209[9];   // Offset: 1424 Size:   140 [unused]
//   float MipCount_id210;              // Offset: 1564 Size:     4 [unused]
//   float4x4 SkyMatrix_id212;          // Offset: 1568 Size:    64 [unused]
//   float Intensity_id213;             // Offset: 1632 Size:     4 [unused]
...
//
#line 1495 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_dd442088f22e38271203745d07e32dab.hlsl"
...
@G    Pixel => f5d85cc9a5f470b42f0160f2583d8278
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id188[3];                 // Offset:  464 Size:   188
//   float2 ShadowMapTextureSize_id190; // Offset:  656 Size:     8
//   float2 ShadowMapTextureTexelSize_id191;// Offset:  664 Size:     8
//   float4x4 WorldToShadowCascadeUV_id195[3];// Offset:  672 Size:   192
//   float4x4 InverseWorldToShadowCascadeUV_id196[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id197[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id198[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id199[3];        // Offset: 1296 Size:    36
//   float OffsetScales_id200[3];       // Offset: 1344 Size:    36
//   float4 _padding_PerDraw_Lighting;  // Offset: 1392 Size:    16 [unused]
//
// }
//
...
//   float InputValue_id225;            // Offset:    4 Size:     4
//   float InputValue_id234;            // Offset:    8 Size:     4
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id204;         // Offset: 1408 Size:    12
//   float3 SphericalColors_id209[9];   // Offset: 1424 Size:   140
//   float MipCount_id210;              // Offset: 1564 Size:     4
//   float4x4 SkyMatrix_id212;          // Offset: 1568 Size:    64
//   float Intensity_id213;             // Offset: 1632 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
// Resource bind info for ParticlesBuffer_id217
// {
//
//   struct SMGridParticle
//   {
...
// ParticlesBuffer_id217             texture  struct         r/o             t1      1 
// EnvironmentLightingDFG_LUT_id246    texture  float4          2d             t2      1 
// ShadowMapTexture_id151            texture  float4          2d             t3      1 
// LightClusters_id179               texture   uint2          3d             t4      1 
// LightIndices_id180                texture    uint         buf             t5      1 
// PointLights_id184                 texture  float4         buf             t6      1 
// SpotLights_id185                  texture  float4         buf             t7      1 
// CubeMap_id211                     texture  float4        cube             t8      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
// PerMaterial                       cbuffer      NA          NA            cb1      1 
// PerView                           cbuffer      NA          NA            cb2      1 
//
...
//
#line 1595 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_dd442088f22e38271203745d07e32dab.hlsl"
...
#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t3.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id76 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id76 return value>
...
#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id76 return value>

#line 705
  mad r5.w, r6.z, r8.w, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t3.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id76 return value>

#line 705
  mad r5.w, r12.x, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r15.xyxx, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r9.y, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r15.zwzz, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r19.z, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r16.zwzz, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r13.z, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.zwzz, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r11.x, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.xyxx, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r6.w, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.zwzz, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r13.w, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r19.xyxx, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r19.w, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r12.ywyy, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r9.z, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r20.xyxx, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r12.z, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r20.zwzz, t3.xxxx, s1, r8.z

#line 705
  mad r5.w, r11.z, r6.z, r5.w

#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r11.ywyy, t3.xxxx, s1, r8.z
...
#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t3.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id76 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id76 return value>
...
#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id76 return value>

#line 705
      mad r3.w, r6.z, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t3.xxxx, s1, r7.z

#line 705
      mad r3.w, r12.x, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t3.xxxx, s1, r7.z

#line 705
      mad r3.w, r9.y, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.zwzz, t3.xxxx, s1, r7.z
...
#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r20.xyxx, t3.xxxx, s1, r7.z

#line 705
      mad r3.w, r12.z, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r20.zwzz, t3.xxxx, s1, r7.z

#line 705
      mad r3.w, r11.z, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r11.ywyy, t3.xxxx, s1, r7.z

#line 705
      mad r3.w, r9.w, r4.w, r3.w

#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r7.xyxx, t3.xxxx, s1, r7.z
...
#line 1167
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id546 return value>.x; r7.y <- <ComputeDirectLightContribution_id546 return value>.y; r7.z <- <ComputeDirectLightContribution_id546 return value>.z
...
#line 963
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t4.xyzw  // r0.x <- streams.lightData_id177.x; r0.y <- streams.lightData_id177.y

#line 1154
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id259 return value>
...
#line 675
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id188 return value>.x; r13.y <- <FresnelSchlick_id188 return value>.y; r13.z <- <FresnelSchlick_id188 return value>.z
...
#line 671
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id204 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id204 return value>
...
#line 922
  ishl r2.w, r1.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r2.wwww, t7.xyzw  // r14.x <- spotLight1.x; r14.y <- spotLight1.y; r14.z <- spotLight1.z
...
#line 675
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id188 return value>.x; r16.y <- <FresnelSchlick_id188 return value>.y; r16.z <- <FresnelSchlick_id188 return value>.z
...
#line 671
  ...
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id204 return value>
...
mov r9.xyz, r3.xyzx  // r9.z <- streams.viewWS_id70.z; r9.x <- streams.viewWS_id70.x; r9.y <- streams.viewWS_id70.y
mov r10.xyz, r4.xyzx  // r10.x <- streams.matDiffuseVisible_id71.x; r10.y <- streams.matDiffuseVisible_id71.y; r10.z <- streams.matDiffuseVisible_id71.z
mov r11.xyz, r5.xyzx  // r11.x <- streams.matSpecularVisible_id73.x; r11.y <- streams.matSpecularVisible_id73.y; r11.z <- streams.matSpecularVisible_id73.z
mov r12.x, r0.w  // r12.x <- streams.alphaRoughness_id72
mov r12.z, r6.y  // r12.z <- streams.NdotV_id74
...
#line 636
  add r15.xyz, -r7.xyzx, cb0[r0.z + 29].xyzx  // r15.x <- lightVector.x; r15.y <- lightVector.y; r15.z <- lightVector.z
...
#line 346
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id112 return value>

#line 516
  mul r1.w, r1.w, r3.w  // r1.w <- attenuation

#line 507
  dp3 r3.w, -cb0[r0.z + 30].xyzx, r15.xyzx  // r3.w <- cd
...
#line 750
  dp4 r16.x, r2.xyzw, cb0[r0.z + 42].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r2.xyzw, cb0[r0.z + 43].xyzw  // r16.y <- shadowPosition.y
  dp4 r4.w, r2.xyzw, cb0[r0.z + 44].xyzw  // r4.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[r0.z + 45].xyzw  // r2.x <- shadowPosition.w

#line 751
  add r16.z, r4.w, -cb0[r0.y + 81].x  // r16.z <- shadowPosition.z
...
#line 448
  mad r12.yw, -r2.yyyx, l(0.000000, 3.000000, 0.000000, 3.000000), l(0.000000, 4.000000, 0.000000, 4.000000)  // r12.y <- uvW0.y; r12.w <- uvW0.x

#line 450
  mad r16.xy, r2.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r16.x <- uvW2.x; r16.y <- uvW2.y

#line 451
  mad r16.zw, -r2.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r16.zw, r16.zzzw, r12.wwwy
  add r17.xw, r16.zzzw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r17.x <- uv0.x; r17.w <- uv0.y

#line 452
  add r16.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  mul r17.yz, r16.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r17.y <- uv1.y; r17.z <- uv1.x
...
#line 454
  mul r2.x, r12.y, r12.w

#line 455
  mad r19.xyzw, r17.xwzw, cb0[41].zwzw, r6.zwzw

#line 459
  mov r18.zw, r17.wwwy

#line 457
  mul r16.zw, r12.yyyw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 458
  mad r20.xyzw, r17.xyzy, cb0[41].zwzw, r6.zwzw

#line 459
  mad r21.xyzw, r18.xzxw, cb0[41].zwzw, r6.zwzw

#line 460
  mov r17.y, r18.y
  mul r12.yw, r12.yyyw, r16.xxxy

#line 461
  mad r17.xyzw, r17.xyzy, cb0[41].zwzw, r6.zwzw
  mul r18.zw, r16.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 462
  mad r6.zw, r18.xxxy, cb0[41].zzzw, r6.zzzw
  mul r2.y, r16.y, r16.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r19.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id126 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r19.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id126 return value>
...
#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r21.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id126 return value>

#line 628
  mad r2.x, r12.y, r4.w, r2.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r20.xyxx, t0.xxxx, s1, r2.z

#line 628
  mad r2.x, r16.w, r4.w, r2.x
...
#line 628
  mad r2.x, r18.z, r4.w, r2.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t0.xxxx, s1, r2.z

#line 628
  mad r2.x, r12.w, r4.w, r2.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.zwzz, t0.xxxx, s1, r2.z

#line 628
  mad r2.x, r18.w, r4.w, r2.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id126 return value>
...
#line 1098
  mul r16.xyz, r1.wwww, cb0[r0.z + 32].xyzx
  mul r2.xyz, r2.xxxx, r16.xyzx
  mul r2.xyz, r3.wwww, r2.xyzx  // r2.x <- streams.lightColorNdotL_id46.x; r2.y <- streams.lightColorNdotL_id46.y; r2.z <- streams.lightColorNdotL_id46.z

#line 1176
  add r16.xyz, r9.xyzx, r15.xyzx
  dp3 r0.z, r16.xyzx, r16.xyzx
  rsq r0.z, r0.z
  mul r16.xyz, r0.zzzz, r16.xyzx  // r16.x <- streams.H_id77.x; r16.y <- streams.H_id77.y; r16.z <- streams.H_id77.z

#line 1177
  dp3_sat r0.z, r8.xyzx, r16.xyzx  // r0.z <- streams.NdotH_id78

#line 1178
  dp3_sat r1.w, r15.xyzx, r16.xyzx  // r1.w <- streams.LdotH_id79
...
#line 675
  ...
  mul r4.w, r4.w, r4.w
  mul r1.w, r1.w, r4.w
  mad r16.xyz, r16.xyzx, r1.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id188 return value>.x; r16.y <- <FresnelSchlick_id188 return value>.y; r16.z <- <FresnelSchlick_id188 return value>.z
...
#line 671
  ...
  mad r1.w, r12.z, r4.w, r1.w
  div r1.w, r12.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id204 return value>

#line 793
  mul r1.w, r1.w, r5.w
  mul r3.w, r12.z, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id206 return value>
...
#line 789
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id218 return value>
...
#line 868
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id368 return value>.x; r0.z <- <Compute_id368 return value>.y; r0.w <- <Compute_id368 return value>.z

#line 1079
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id547 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id547 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id547 return value>.z
...
#line 853
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t8.xyzw, s0, r0.x  // r1.x <- <Compute_id318 return value>.x; r1.y <- <Compute_id318 return value>.y; r1.z <- <Compute_id318 return value>.z
...
const static int TMaxLightCount_id187 = 3;
const static int TCascadeCountBase_id193 = 1;
const static int TLightCountBase_id194 = 3;
const static bool TCascadeDebug_id202 = false;
const static int TFilterSize_id203 = 5;
const static int TOrder_id206 = 3;
const static int TOrder_id208 = 3;
const static bool TInvert_id231 = true;
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id216;
    float Input_1_id224;
    float Input_2_id233;
...
cbuffer PerDraw 
{
    ...
    SpotLightData Lights_id188[TMaxLightCount_id187];
    float2 ShadowMapTextureSize_id190;
    float2 ShadowMapTextureTexelSize_id191;
    float4x4 WorldToShadowCascadeUV_id195[TCascadeCountBase_id193 * TLightCountBase_id194];
    float4x4 InverseWorldToShadowCascadeUV_id196[TCascadeCountBase_id193 * TLightCountBase_id194];
    float4x4 ViewMatrices_id197[TCascadeCountBase_id193 * TLightCountBase_id194];
    float2 DepthRanges_id198[TCascadeCountBase_id193 * TLightCountBase_id194];
    float DepthBiases_id199[TLightCountBase_id194];
    float OffsetScales_id200[TLightCountBase_id194];
...
cbuffer PerView 
{
    ...
    float3 SphericalColors_id209[TOrder_id208 * TOrder_id208];
    float MipCount_id210;
    float4x4 SkyMatrix_id212;
    float Intensity_id213;
...
StructuredBuffer<SMGridParticle> ParticlesBuffer_id217;
...
float4 Compute_id332(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id217[id];
    return float4(p.Col, 1);
}
float FilterShadow_id120(float2 position, float positionDepth)
{
    float shadow = 0.0f;
    float2 base_uv;
    float2 st;
...
{
    streams.Input_2_id233 = Compute_id356();
}
void Compute_id347(inout PS_STREAMS streams)
{
    streams.Input_1_id224 = Compute_id344();
}
void Compute_id335(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id216 = Compute_id332(streams);
}
float4 EvaluateSphericalHarmonics_id142(float3 sphericalColors[TOrder_id206 * TOrder_id206], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float ComputeShadowFromCascade_id123(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    float4 shadowPosition = mul(float4(shadowPositionWS, 1.0), WorldToShadowCascadeUV_id195[cascadeIndex + lightIndex * TCascadeCountBase_id193]);
    shadowPosition.z -= DepthBiases_id199[lightIndex];
    shadowPosition.xyz /= shadowPosition.w;
    return FilterShadow_id120(shadowPosition.xy, shadowPosition.z);
}
...
{
    return streams.ColorPerParticle_ShaderFXResult_0_id216;
}
...
float4 Compute_id318(inout PS_STREAMS streams, float3 direction)
{
    ...
    float mipLevel = sqrt(alpha) * MipCount_id210;
    return CubeMap_id211.SampleLevel(LinearSampler_id115, direction, mipLevel);
}
float4 Compute_id313(float3 direction)
{
    return EvaluateSphericalHarmonics_id142(SphericalColors_id209, direction);
}
...
float3 Compute_id368(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id246.SampleLevel(LinearSampler_id115, float2(glossiness, nDotV), 0);
...
float3 ComputeShadow_id109(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id122(OffsetScales_id200[lightIndex], streams.NdotL_id51, streams.normalWS_id19);
    float3 shadow = ComputeShadowFromCascade_id123(shadowPosition, 0, lightIndex);
...
void PrepareDirectLightCore_id108(inout PS_STREAMS streams, int lightIndex)
{
    ...
    data.DirectionWS = Lights_id188[lightIndex].DirectionWS;
    data.AngleOffsetAndInvSquareRadius = Lights_id188[lightIndex].AngleOffsetAndInvSquareRadius;
...
void PrepareEnvironmentLight_id328(inout PS_STREAMS streams)
{
    ...
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id212);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id49 = Compute_id313(sampleDirection).rgb * Intensity_id213 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.x;
    sampleDirection = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id212);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id50 = Compute_id318(streams, sampleDirection).rgb * Intensity_id213 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
...
void PrepareEnvironmentLight_id323(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id204 * streams.matAmbientOcclusion_id59;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id245 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void Compute_id578(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id245 + environmentLightingContribution;
