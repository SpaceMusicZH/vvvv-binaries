...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.w, r20.xyxx, t2.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id84 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r16.z, r20.zwzz, t2.xxxx, s1, r13.z  // r16.z <- <SampleTextureAndCompare_id84 return value>
...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r15.x, r22.xyxx, t2.xxxx, s1, r13.z  // r15.x <- <SampleTextureAndCompare_id84 return value>

#line 569
  mad r13.x, r13.x, r15.x, r13.w  // r13.x <- shadow

#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.w, r23.xyxx, t2.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id84 return value>
...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.y, r24.zwzz, t2.xxxx, s1, r13.z  // r13.y <- <SampleTextureAndCompare_id84 return value>
...
#line 487
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r20.xyxx, t2.xxxx, s1, r6.z  // r5.w <- <SampleTextureAndCompare_id84 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r20.zwzz, t2.xxxx, s1, r6.z  // r9.w <- <SampleTextureAndCompare_id84 return value>
...
#line 487
      sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r22.xyxx, t2.xxxx, s1, r6.z  // r9.w <- <SampleTextureAndCompare_id84 return value>

#line 569
      mad r5.w, r6.x, r9.w, r5.w

#line 487
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r23.xyxx, t2.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id84 return value>
...
#line 539
  ...
  mul r9.y, r9.y, r9.y
  mul r9.x, r9.y, r9.x
  mad r9.xyw, r14.xyxz, r9.xxxx, r11.xyxz  // r9.x <- <FresnelSchlick_id168 return value>.x; r9.y <- <FresnelSchlick_id168 return value>.y; r9.w <- <FresnelSchlick_id168 return value>.z
...
#line 535
  ...
  div r13.w, r5.z, r13.w  // r13.w <- <VisibilityhSchlickGGX_id184 return value>
  mad r10.w, r1.w, r12.w, r10.w
  div r10.w, r1.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id184 return value>

#line 637
  mul r10.w, r10.w, r13.w
  mul r5.z, r1.w, r5.z
  div r5.z, r10.w, r5.z  // r5.z <- <VisibilitySmithSchlickGGX_id186 return value>
...
#line 633
  ...
  div r5.w, r10.w, r5.w  // r5.w <- <NormalDistributionGGX_id198 return value>
...
#line 947
and r0.w, r0.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id239 return value>
...
#line 539
  ...
  mul r8.y, r8.y, r8.y
  mul r8.x, r8.y, r8.x
  mad r8.xyw, r15.xyxz, r8.xxxx, r10.xyxz  // r8.x <- <FresnelSchlick_id168 return value>.x; r8.y <- <FresnelSchlick_id168 return value>.y; r8.w <- <FresnelSchlick_id168 return value>.z
...
#line 535
  ...
  div r9.w, r5.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id184 return value>

#line 637
  mul r9.w, r9.w, r12.w
  mul r3.w, r5.w, r3.w
  div r3.w, r9.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id186 return value>
...
#line 633
  ...
  div r2.w, r9.w, r2.w  // r2.w <- <NormalDistributionGGX_id198 return value>
...
mov r0.yw, r5.yyyz  // r0.y <- streams.NdotV_id74; r0.w <- streams.lightIndex_id180
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r2.w, r1.w, r0.x
  breakc_nz r2.w
...
#line 539
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r15.xyz, r15.xyzx, r5.wwww, r7.xyzx  // r15.x <- <FresnelSchlick_id168 return value>.x; r15.y <- <FresnelSchlick_id168 return value>.y; r15.z <- <FresnelSchlick_id168 return value>.z
...
#line 535
  ...
  div r5.w, r0.y, r5.w  // r5.w <- <VisibilityhSchlickGGX_id184 return value>

#line 637
  mul r5.w, r5.w, r8.w
  mul r3.w, r0.y, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id186 return value>
...
#line 633
  mul r2.w, r2.w, r2.w
  mul r2.w, r2.w, l(3.141593)
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id198 return value>
...
#line 712
mad r0.xyz, r4.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id322 return value>.x; r0.y <- <Compute_id322 return value>.y; r0.z <- <Compute_id322 return value>.z

#line 894
mul r5.xyz, r0.xyzx, cb2[88].xyzx  // r5.x <- <ComputeEnvironmentLightContribution_id501 return value>.x; r5.y <- <ComputeEnvironmentLightContribution_id501 return value>.y; r5.z <- <ComputeEnvironmentLightContribution_id501 return value>.z
...
#line 697
sample_l_indexable(texturecube)(float,float,float,float) r2.xyz, r7.xyzx, t7.xyzw, s0, r0.w  // r2.x <- <Compute_id272 return value>.x; r2.y <- <Compute_id272 return value>.y; r2.z <- <Compute_id272 return value>.z
