...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Sharpen_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Amount_id88 => Sharpen_TextureFX.Amount
@C    Radius_id89 => Sharpen_TextureFX.Radius
@C    Saturation_id90 => Sharpen_TextureFX.Saturation
@C    Gamma_id91 => Sharpen_TextureFX.Gamma
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Sharpen_TextureFX => b735ba5f7d8f969da303df5f855b496e
...
//
#line 183 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_cad0c13d3951018dfcd906af00a10dac.hlsl"
...
@G    Pixel => ef94454cd08122f7dec99dd7017bab8a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x00000000 
//   float Gamma_id91;                  // Offset:   92 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 151 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_cad0c13d3951018dfcd906af00a10dac.hlsl"
max r0.x, cb1[1].y, cb1[1].x
log r0.y, r0.x

#line 153
div r0.x, cb2[5].y, r0.x

#line 151
add r0.y, r0.y, l(0.500000)  // r0.y <- maxl

#line 153
mov_sat r0.z, cb2[5].y
mul r0.w, r0.z, r0.y
mad r0.z, r0.y, r0.z, l(1.000000)
mul r0.y, r0.y, cb2[5].y
exp r0.y, r0.y
mul r0.x, r0.y, r0.x
exp r0.x, r0.x
sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t0.xyzw, s0, r0.z
sample_l_indexable(texture2d)(float,float,float,float) r0.yzw, v1.xyxx, t0.wxyz, s0, r0.w
add r0.yzw, -r1.xxyz, r0.yyzw
mul r0.yzw, r0.yyzw, cb2[5].xxxx
mul r0.yzw, r0.yyzw, l(0.000000, 128.000000, 128.000000, 128.000000)
div r0.xyz, r0.yzwy, r0.xxxx  // r0.x <- sh.x; r0.y <- sh.y; r0.z <- sh.z
...
mad r0.xyz, cb2[5].zzzz, r0.xyzx, r0.wwww  // r0.x <- sh.x; r0.y <- sh.y; r0.z <- sh.z
...
cbuffer Globals 
{
    ...
    float Amount_id88 = 0.1f;
    float Radius_id89 = 0.0f;
    float Saturation_id90 = 0.0f;
    float Gamma_id91 = 0.0f;
};
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float4 sh = 0;
    sh.rgb += (Texture0_id14.SampleLevel(Sampler0_id52, uv, 0 + maxl * saturate(Radius_id89)) - Texture0_id14.SampleLevel(Sampler0_id52, uv, 1 + maxl * saturate(Radius_id89))) * 128 * Amount_id88 / pow(2, Radius_id89 / max(R.x, R.y) * pow(2, maxl * Radius_id89));
    sh.rgb = lerp(dot(sh.rgb, 1.0) / 3.0, sh.rgb, Saturation_id90);
    sh.rgb = sign(sh.rgb) * pow(abs(sh.rgb) * 5, pow(2, Gamma_id91 * 2)) / 5;
    sh /= 1 + col;
    col.rgb *= pow(2, sh);
    return col;
}
