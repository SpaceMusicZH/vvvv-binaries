...
//
#line 1578 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_4d400ea878e5b4e60b15690022dbf453.hlsl"
...
@G    Pixel => a221cb3d7e272d7a47ac8dcd82ced39a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1640 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_4d400ea878e5b4e60b15690022dbf453.hlsl"
...
#line 662
  add r17.xyz, -r9.xyzx, cb0[r0.w + 28].xyzx  // r17.x <- lightVector.x; r17.y <- lightVector.y; r17.z <- lightVector.z
...
#line 396
  mul r1.w, r1.w, cb0[r0.w + 28].w  // r1.w <- factor
...
#line 931
  add r6.xyz, r9.xyzx, -cb0[r0.w + 28].xyzx  // r6.x <- lightDelta.x; r6.y <- lightDelta.y; r6.z <- lightDelta.z
...
#line 962
  add r3.w, |r5.w|, -cb0[r0.y + 129].x  // r3.w <- lightSpaceZ

#line 963
  div r3.w, cb0[r0.y + 133].y, r3.w
  add r3.w, r3.w, cb0[r0.y + 133].x  // r3.w <- depth
...
#line 959
    ishl r4.w, r4.w, l(2)
    dp4 r6.x, r8.xyzw, cb0[r4.w + 33].xyzw  // r6.x <- projectedPosition.x
    dp4 r6.y, r8.xyzw, cb0[r4.w + 34].xyzw  // r6.y <- projectedPosition.y
    dp4 r4.w, r8.xyzw, cb0[r4.w + 36].xyzw  // r4.w <- projectedPosition.w

#line 960
    div r5.zw, r6.xxxy, r4.wwww  // r5.z <- projectedPosition.x; r5.w <- projectedPosition.y

#line 641
    mad r5.zw, r5.zzzw, cb0[32].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
    round_ni r6.xy, r5.zwzz  // r6.x <- base_uv.x; r6.y <- base_uv.y
...
#line 341
    mad r20.xyzw, r18.xwzw, cb0[32].zwzw, r6.xyxy
...
#line 344
    mad r21.xyzw, r18.xyzy, cb0[32].zwzw, r6.xyxy

#line 345
    mad r22.xyzw, r19.xzxw, cb0[32].zwzw, r6.xyxy
...
#line 347
    mad r18.xyzw, r18.xyzy, cb0[32].zwzw, r6.xyxy
    mul r15.yw, r8.xxxy, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 348
    mad r6.xy, r19.xyxx, cb0[32].zwzz, r6.xyxx
    mul r6.z, r8.y, r8.x

#line 636
    sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r20.xyxx, t0.xxxx, s1, r3.w  // r8.x <- <SampleTextureAndCompare_id114 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r20.zwzz, t0.xxxx, s1, r3.w  // r8.y <- <SampleTextureAndCompare_id114 return value>
...
#line 636
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r22.xyxx, t0.xxxx, s1, r3.w  // r5.z <- <SampleTextureAndCompare_id114 return value>
...
#line 636
    sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r6.xyxx, t0.xxxx, s1, r3.w  // r3.w <- <SampleTextureAndCompare_id114 return value>
...
#line 1171
  mul r8.xyz, r1.wwww, cb0[r0.w + 29].xyzx
  mul r6.xyz, r6.xyzx, r8.xyzx
  mul r6.xyz, r2.wwww, r6.xyzx  // r6.x <- streams.lightColorNdotL_id43.x; r6.y <- streams.lightColorNdotL_id43.y; r6.z <- streams.lightColorNdotL_id43.z
...
#line 1251
  dp3_sat r1.w, r17.xyzx, r8.xyzx  // r1.w <- streams.LdotH_id76
...
#line 696
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r17.xyz, r17.xyzx, r1.wwww, r14.xyzx  // r17.x <- <FresnelSchlick_id176 return value>.x; r17.y <- <FresnelSchlick_id176 return value>.y; r17.z <- <FresnelSchlick_id176 return value>.z
...
#line 692
  ...
  div r4.w, r2.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id192 return value>
  mad r1.w, r15.z, r3.w, r1.w
  div r1.w, r15.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id192 return value>

#line 838
  mul r1.w, r1.w, r4.w
  mul r2.w, r15.z, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id194 return value>
