...
@G    Pixel => c11fe3367cc62b17c32c88e389bcfc18
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 750
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id87 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t4.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id87 return value>
...
#line 750
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t4.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id87 return value>

#line 899
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 750
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id87 return value>
...
#line 750
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t4.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id87 return value>
...
#line 750
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t4.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id87 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.zwzz, t4.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id87 return value>
...
#line 750
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t4.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id87 return value>
...
#line 869
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r9.xyz, r9.xyzx, r3.wwww, r5.xyzx  // r9.x <- <FresnelSchlick_id225 return value>.x; r9.y <- <FresnelSchlick_id225 return value>.y; r9.z <- <FresnelSchlick_id225 return value>.z
...
#line 865
  ...
  div r6.z, r1.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id241 return value>
  mad r3.w, r6.y, r4.w, r3.w
  div r3.w, r6.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id241 return value>

#line 1031
  mul r3.w, r3.w, r6.z
  mul r1.w, r6.y, r1.w
  div r1.w, r3.w, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id243 return value>
...
#line 1027
  ...
  div r2.w, r3.w, r2.w  // r2.w <- <NormalDistributionGGX_id255 return value>
...
#line 1484
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id609 return value>.x; r7.y <- <ComputeDirectLightContribution_id609 return value>.y; r7.z <- <ComputeDirectLightContribution_id609 return value>.z
...
ftoi r8.xy, r0.xyxx
mov r8.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r8.xyzw, t5.xyzw  // r0.x <- streams.lightData_id179.x; r0.y <- streams.lightData_id179.y

#line 1471
and r1.w, r0.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id296 return value>
...
#line 869
  ...
  mul r7.w, r7.w, r11.w
  mad r14.xyz, r14.xyzx, r7.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id225 return value>.x; r14.y <- <FresnelSchlick_id225 return value>.y; r14.z <- <FresnelSchlick_id225 return value>.z
...
#line 865
  ...
  div r13.w, r4.w, r13.w  // r13.w <- <VisibilityhSchlickGGX_id241 return value>
  mad r7.w, r6.w, r11.w, r7.w
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id241 return value>

#line 1031
  mul r7.w, r7.w, r13.w
  mul r4.w, r6.w, r4.w
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id243 return value>
...
#line 1027
  ...
  div r3.w, r7.w, r3.w  // r3.w <- <NormalDistributionGGX_id255 return value>
...
#line 869
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r16.xyz, r16.xyzx, r7.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id225 return value>.x; r16.y <- <FresnelSchlick_id225 return value>.y; r16.z <- <FresnelSchlick_id225 return value>.z
...
#line 865
  ...
  div r9.w, r6.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id241 return value>
  mad r7.w, r1.w, r8.w, r7.w
  div r7.w, r1.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id241 return value>

#line 1031
  mul r7.w, r7.w, r9.w
  mul r6.w, r1.w, r6.w
  div r6.w, r7.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id243 return value>
...
#line 1027
  ...
  div r4.w, r7.w, r4.w  // r4.w <- <NormalDistributionGGX_id255 return value>
...
#line 809
    sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r15.xyxx, t0.xxxx, s1, r1.w  // r2.w <- <SampleTextureAndCompare_id135 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t0.xxxx, s1, r1.w  // r3.w <- <SampleTextureAndCompare_id135 return value>
...
#line 809
    sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t0.xxxx, s1, r1.w  // r3.w <- <SampleTextureAndCompare_id135 return value>
...
#line 809
    sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t0.xxxx, s1, r1.w  // r1.w <- <SampleTextureAndCompare_id135 return value>
...
#line 1189
  else   // Prior locations: r10.x <- streams.matDiffuseVisible_id73.x; r10.y <- streams.matDiffuseVisible_id73.y; r10.z <- streams.matDiffuseVisible_id73.z; r11.x <- streams.matSpecularVisible_id75.x; r11.y <- streams.matSpecularVisible_id75.y; r11.z <- streams.matSpecularVisible_id75.z; r8.z <- lightDelta.z; r6.z <- faceIndex; r1.w <- depth
...
#line 1493
  ...
  rsq r0.x, r0.x
  mul r9.xyz, r0.xxxx, r9.xyzx  // r9.x <- streams.H_id79.x; r9.y <- streams.H_id79.y; r9.z <- streams.H_id79.z

#line 1494
  dp3_sat r0.x, r1.xyzx, r9.xyzx  // r0.x <- streams.NdotH_id80

#line 1495
  dp3_sat r1.w, r7.xyzx, r9.xyzx  // r1.w <- streams.LdotH_id81
...
#line 869
  ...
  mul r2.w, r2.w, r2.w
  mul r1.w, r1.w, r2.w
  mad r9.xyz, r9.xyzx, r1.wwww, r5.xyzx  // r9.x <- <FresnelSchlick_id225 return value>.x; r9.y <- <FresnelSchlick_id225 return value>.y; r9.z <- <FresnelSchlick_id225 return value>.z
...
#line 865
  ...
  div r1.w, r6.y, r1.w  // r1.w <- <VisibilityhSchlickGGX_id241 return value>

#line 1031
  mul r1.w, r1.w, r3.w
  mul r0.y, r6.y, r0.y
  div r0.y, r1.w, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id243 return value>
...
#line 1027
  ...
  div r0.x, r1.w, r0.x  // r0.x <- <NormalDistributionGGX_id255 return value>
...
#line 371
  mul r0.x, r0.x, r0.x  // r0.x <- <SmoothDistanceAttenuation_id149 return value>
...
#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.xyxx, t1.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id163 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r13.zwzz, t1.xxxx, s1, r8.z  // r4.w <- <SampleTextureAndCompare_id163 return value>
...
#line 572
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t1.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id163 return value>
...
#line 869
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r7.xyz, r7.xyzx, r0.zzzz, r5.xyzx  // r7.x <- <FresnelSchlick_id225 return value>.x; r7.y <- <FresnelSchlick_id225 return value>.y; r7.z <- <FresnelSchlick_id225 return value>.z
...
#line 865
  ...
  div r2.w, r0.y, r2.w  // r2.w <- <VisibilityhSchlickGGX_id241 return value>
  mad r0.z, r6.y, r1.w, r0.z
  div r0.z, r6.y, r0.z  // r0.z <- <VisibilityhSchlickGGX_id241 return value>

#line 1031
  mul r0.z, r0.z, r2.w
  mul r0.y, r6.y, r0.y
  div r0.y, r0.z, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id243 return value>
...
#line 1027
  mul r0.x, r0.x, r0.x
  mul r0.x, r0.x, l(3.141593)
  div r0.x, r0.z, r0.x  // r0.x <- <NormalDistributionGGX_id255 return value>
...
#line 1106
mad r0.xyz, r5.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id431 return value>.x; r0.y <- <Compute_id431 return value>.y; r0.z <- <Compute_id431 return value>.z

#line 1374
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id610 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id610 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id610 return value>.z
...
#line 1091
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r7.xyzx, t9.xyzw, s0, r0.w  // r3.x <- <Compute_id381 return value>.x; r3.y <- <Compute_id381 return value>.y; r3.z <- <Compute_id381 return value>.z
