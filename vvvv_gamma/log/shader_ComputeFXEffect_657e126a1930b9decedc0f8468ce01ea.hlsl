...
@P Dim: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<SMVideoBufferSelector_ShaderFXResult_1> [{Value = SMVideoBufferSelector_ShaderFX}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_2> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<SMVideoBufferSelector_ShaderFXResult_1>}]}], ComputeVoid, ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_28> [{Value = mixin SampleLevelTextureFloat4<ObjectTexture_fx27,PerUpdate,ObjectSampler_fx8,PerUpdate> [{LOD = ConstantFloat<0>}, {TexCd = GetSemanticFloat2<SemanticValue_29,TEXCOORD2>}]}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_30> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<TextureValue_28>}]}], mixin AssignVarFloat<Multiply_31> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_30>}]}], mixin AssignVarFloat<Multiply_32> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_30>}]}], mixin AssignVarFloat<Multiply_33> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_30>}]}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_34> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Multiply_31>}, {Y = GetVarFloat<Multiply_32>}, {Z = GetVarFloat<Multiply_33>}]}], mixin AssignVarFloat3<Input_35> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i5,PerUpdate>}], mixin AssignVarFloat3<Multiply_36> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_34>}, {Right = GetVarFloat3<Input_35>}]}], mixin AssignVarFloat3<Input_37> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i6,PerUpdate>}], mixin AssignVarFloat3<Plus_38> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_36>}, {Right = GetVarFloat3<Input_37>}]}], mixin AssignVarFloat3<Input_39> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i7,PerUpdate>}], mixin AssignVarFloat3<Plus_40> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Plus_38>}, {Right = GetVarFloat3<Input_39>}]}], mixin AssignVarFloat3<Input_41> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i8,PerUpdate>}], mixin AssignVarFloat3<Multiply_42> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<Plus_40>}, {Right = GetVarFloat3<Input_41>}]}]]}]}, {Value = GetVarFloat3<Multiply_42>}]
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_43> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_44> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_43>}, {Y = GetVarFloat<Input_43>}, {Z = GetVarFloat<Input_43>}]}], mixin AssignVarFloat3<Input_45> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<Multiply_46> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_44>}, {Right = GetVarFloat3<Input_45>}]}], mixin AssignVarFloat3<Input_47> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i10,PerUpdate>}], mixin AssignVarFloat3<Plus_48> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_46>}, {Right = GetVarFloat3<Input_47>}]}]]}]}, {Value = GetVarFloat3<Plus_48>}]
...
@R    DynamicTexture_id127 => ObjectTexture_fx27 [Stage: Compute, Slot: (3-3)]
@R    DynamicBuffer_id294 => ObjectBuffer_fx0 [Stage: Compute, Slot: (4-4)]
@R    DynamicTexture_id301 => ObjectTexture_fx7 [Stage: Compute, Slot: (5-5)]
...
*****     Stages      *****
***************************
@G    Compute => c659bd32a2856ae68f5341a92ce1a011
//
...
// DynamicBuffer_id294               texture  float4         buf             t4      1 
// DynamicTexture_id301              texture  float4          2d             t5      1 
...
//
#line 1249 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_657e126a1930b9decedc0f8468ce01ea.hlsl"
...
#line 594
  mad r11.xyz, cb1[8].wwww, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id464 return value>.x; r11.y <- <Compute_id464 return value>.y; r11.z <- <Compute_id464 return value>.z
...
#line 570
  mad r12.xyz, cb1[5].wwww, cb1[6].xyzx, cb1[7].xyzx  // r12.x <- <Compute_id409 return value>.x; r12.y <- <Compute_id409 return value>.y; r12.z <- <Compute_id409 return value>.z

#line 562
  add r12.xyz, r12.xyzx, cb1[8].xyzx  // r12.x <- <Compute_id417 return value>.x; r12.y <- <Compute_id417 return value>.y; r12.z <- <Compute_id417 return value>.z
...
#line 546
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.xzxx, t3.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id182 return value>.x; r12.y <- <Compute_id182 return value>.y; r12.z <- <Compute_id182 return value>.z

#line 324
  dp3 r1.w, r12.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r1.w <- <Luminance_id50 return value>

#line 537
  mul r1.w, r0.w, r1.w  // r1.w <- <Compute_id211 return value>

#line 509
  mad r12.xyz, r1.wwww, cb1[0].xyzx, cb1[1].xyzx  // r12.x <- <Compute_id247 return value>.x; r12.y <- <Compute_id247 return value>.y; r12.z <- <Compute_id247 return value>.z

#line 501
  add r12.xyz, r12.xyzx, cb1[2].xyzx  // r12.x <- <Compute_id255 return value>.x; r12.y <- <Compute_id255 return value>.y; r12.z <- <Compute_id255 return value>.z

#line 493
  mul r13.xyz, r12.xyzx, cb1[3].xyzx  // r13.x <- <Compute_id263 return value>.x; r13.y <- <Compute_id263 return value>.y; r13.z <- <Compute_id263 return value>.z
...
#line 469
  mad r12.xyz, cb1[3].wwww, cb1[4].xyzx, cb1[5].xyzx  // r12.x <- <Compute_id366 return value>.x; r12.y <- <Compute_id366 return value>.y; r12.z <- <Compute_id366 return value>.z
...
#line 652
  ...
  mul r1.w, r0.w, r1.w
  round_ne r1.w, r1.w
  ftou r1.w, r1.w  // r1.w <- <Compute_id97 return value>

#line 646
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r1.wwww, t4.xyzw  // r12.x <- <Compute_id101 return value>.x; r12.y <- <Compute_id101 return value>.y; r12.z <- <Compute_id101 return value>.z
...
#line 441
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id482 return value>.x; r14.y <- <SRgbToLinear_id482 return value>.y; r14.z <- <SRgbToLinear_id482 return value>.z

#line 638
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t5.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id111 return value>.x; r6.z <- <Compute_id111 return value>.y; r6.w <- <Compute_id111 return value>.z

#line 630
  mad r6.yzw, -r12.xxyz, r13.xxyz, r6.yyzw
  mad r6.yzw, cb1[11].xxxx, r6.yyzw, r14.xxyz  // r6.y <- <Compute_id121 return value>.x; r6.z <- <Compute_id121 return value>.y; r6.w <- <Compute_id121 return value>.z
...
struct CS_STREAMS 
{
    ...
    float Input_13_id250;
    float3 SMVector3Join_ShaderFXResult_14_id253;
    float3 Input_15_id258;
    float3 Multiply_16_id261;
    float3 Input_17_id265;
    float3 Plus_18_id268;
    float Input_19_id218;
    float3 SMVector3Join_ShaderFXResult_20_id221;
    float3 Input_21_id226;
    float3 Multiply_22_id229;
    float3 Input_23_id233;
    float3 Plus_24_id236;
    float3 Input_25_id240;
    float3 Plus_26_id243;
    float4 SMVideoBufferSelector_ShaderFXResult_1_id107;
    float SMCalcLuminance_ShaderFXResult_2_id115;
    float4 TextureValue_28_id126;
    float SMCalcLuminance_ShaderFXResult_30_id134;
    float Multiply_31_id145;
    float Multiply_32_id149;
    float Multiply_33_id153;
    float3 SMVector3Join_ShaderFXResult_34_id157;
    float3 Input_35_id162;
    float3 Multiply_36_id165;
    float3 Input_37_id169;
    float3 Plus_38_id172;
    float3 Input_39_id176;
    float3 Plus_40_id179;
    float3 Input_41_id183;
    float3 Multiply_42_id186;
    float Input_43_id193;
...
float4 Compute_id183(inout CS_STREAMS streams)
{
    return streams.TextureValue_28_id126;
}
float Compute_id177()
{
    return Value_id302;
}
float2 Compute_id179(inout CS_STREAMS streams)
{
...
float4 Compute_id309(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id107;
}
...
float2 Compute_id108(inout CS_STREAMS streams)
{
    return streams.TexCoord_id59;
}
float4 SRgbToLinear_id482(float4 sRGBa)
{
...
float Compute_id94(inout CS_STREAMS streams)
{
    return streams.SMCalcLuminance_ShaderFXResult_2_id115;
}
...
{
    return Compute_id353(streams) * Compute_id355(streams);
}
float3 Compute_id351()
{
    return InputValue_id202;
}
float3 Compute_id350(inout CS_STREAMS streams)
{
    return float3(Compute_id343(streams), Compute_id345(streams), Compute_id347(streams));
}
float Compute_id341()
{
...
{
    return float3(Compute_id224(streams), Compute_id226(streams), Compute_id228(streams));
}
...
{
    float4 color = Compute_id183(streams);
    return Luminance_id50(color.rgb);
}
float4 Compute_id182(inout CS_STREAMS streams)
{
    return DynamicTexture_id127.SampleLevel(DynamicSampler_id128, Compute_id179(streams), Compute_id177());
}
float Compute_id176(inout CS_STREAMS streams)
{
    float4 color = Compute_id154(streams);
...
float3 Compute_id394()
{
    return InputValue_id227;
}
float3 Compute_id393(inout CS_STREAMS streams)
{
    return float3(Compute_id386(streams), Compute_id388(streams), Compute_id390(streams));
}
float Compute_id384()
{
...
{
    float4 color = Compute_id309(streams);
...
{
    return lerp(Compute_id114(streams), Compute_id116(streams), Compute_id118(streams));
}
float Compute_id112()
{
...
{
    return DynamicTexture_id301.SampleLevel(DynamicSampler_id128, Compute_id108(streams), Compute_id106());
}
float4 Compute_id105(inout CS_STREAMS streams)
{
    return SRgbToLinear_id482(Compute_id102(streams));
}
float4 Compute_id101(inout CS_STREAMS streams)
{
    return DynamicBuffer_id294[Compute_id98(streams)];
}
uint Compute_id97(inout CS_STREAMS streams)
{
    float v = Compute_id94(streams);
    uint c = Compute_id92(streams);
    return round(v * c);
}
uint Compute_id90()
{
...
{
    float4 color = Compute_id67(streams);
...
{
    streams.Plus_48_id211 = Compute_id366(streams);
}
void Compute_id376(inout CS_STREAMS streams)
{
    streams.Input_47_id208 = Compute_id359();
}
void Compute_id374(inout CS_STREAMS streams)
{
    streams.Multiply_46_id204 = Compute_id358(streams);
}
void Compute_id372(inout CS_STREAMS streams)
{
    streams.Input_45_id201 = Compute_id351();
}
void Compute_id370(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_44_id196 = Compute_id350(streams);
}
void Compute_id368(inout CS_STREAMS streams)
{
    streams.Input_43_id193 = Compute_id341();
}
void Compute_id299(inout CS_STREAMS streams)
{
    streams.Multiply_42_id186 = Compute_id263(streams);
}
void Compute_id297(inout CS_STREAMS streams)
{
    streams.Input_41_id183 = Compute_id256();
}
void Compute_id295(inout CS_STREAMS streams)
{
    streams.Plus_40_id179 = Compute_id255(streams);
}
void Compute_id293(inout CS_STREAMS streams)
{
    streams.Input_39_id176 = Compute_id248();
}
void Compute_id291(inout CS_STREAMS streams)
{
    streams.Plus_38_id172 = Compute_id247(streams);
}
void Compute_id289(inout CS_STREAMS streams)
{
    streams.Input_37_id169 = Compute_id240();
}
void Compute_id287(inout CS_STREAMS streams)
{
    streams.Multiply_36_id165 = Compute_id239(streams);
}
void Compute_id285(inout CS_STREAMS streams)
{
    streams.Input_35_id162 = Compute_id232();
}
void Compute_id283(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_34_id157 = Compute_id231(streams);
}
void Compute_id281(inout CS_STREAMS streams)
{
    streams.Multiply_33_id153 = Compute_id223(streams);
}
void Compute_id279(inout CS_STREAMS streams)
{
    streams.Multiply_32_id149 = Compute_id217(streams);
}
void Compute_id277(inout CS_STREAMS streams)
{
    streams.Multiply_31_id145 = Compute_id211(streams);
}
void Compute_id275(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_30_id134 = Compute_id205(streams);
}
void Compute_id273(inout CS_STREAMS streams)
{
    streams.TextureValue_28_id126 = Compute_id182(streams);
}
void Compute_id271()
{
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id176(streams);
}
...
{
    streams.Plus_26_id243 = Compute_id417(streams);
}
void Compute_id431(inout CS_STREAMS streams)
{
    streams.Input_25_id240 = Compute_id410();
}
void Compute_id429(inout CS_STREAMS streams)
{
    streams.Plus_24_id236 = Compute_id409(streams);
}
void Compute_id427(inout CS_STREAMS streams)
{
    streams.Input_23_id233 = Compute_id402();
}
void Compute_id425(inout CS_STREAMS streams)
{
    streams.Multiply_22_id229 = Compute_id401(streams);
}
void Compute_id423(inout CS_STREAMS streams)
{
    streams.Input_21_id226 = Compute_id394();
}
void Compute_id421(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_20_id221 = Compute_id393(streams);
}
void Compute_id419(inout CS_STREAMS streams)
{
    streams.Input_19_id218 = Compute_id384();
}
void Compute_id476(inout CS_STREAMS streams)
{
    streams.Plus_18_id268 = Compute_id464(streams);
}
void Compute_id474(inout CS_STREAMS streams)
{
    streams.Input_17_id265 = Compute_id457();
}
void Compute_id472(inout CS_STREAMS streams)
{
    streams.Multiply_16_id261 = Compute_id456(streams);
}
void Compute_id470(inout CS_STREAMS streams)
{
    streams.Input_15_id258 = Compute_id449();
}
void Compute_id468(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id253 = Compute_id448(streams);
}
void Compute_id466(inout CS_STREAMS streams)
{
    streams.Input_13_id250 = Compute_id439();
}
void Compute_id335(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id331(streams);
}
...
{
    streams.Lerp_12_id310 = Compute_id121(streams);
}
void Compute_id142(inout CS_STREAMS streams)
{
    streams.Input_11_id307 = Compute_id112();
}
void Compute_id140(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id300 = Compute_id111(streams);
}
void Compute_id138()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id297 = Compute_id105(streams);
}
void Compute_id132(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id293 = Compute_id101(streams);
}
void Compute_id130(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id289 = Compute_id97(streams);
}
void Compute_id128(inout CS_STREAMS streams)
{
    streams.Input_3_id286 = Compute_id90();
}
void Compute_id126(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id89(streams);
}
void Compute_id124(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id107 = Compute_id51(streams);
}
void Compute_id122()
{
}
...
{
    return streams.Multiply_42_id186;
}
