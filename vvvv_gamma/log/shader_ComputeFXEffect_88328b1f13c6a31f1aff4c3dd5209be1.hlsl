...
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_46> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_47> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_46>}, {Y = GetVarFloat<Input_46>}, {Z = GetVarFloat<Input_46>}]}], mixin AssignVarFloat3<Input_48> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<Multiply_49> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_47>}, {Right = GetVarFloat3<Input_48>}]}], mixin AssignVarFloat3<Input_50> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i10,PerUpdate>}], mixin AssignVarFloat3<Plus_51> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_49>}, {Right = GetVarFloat3<Input_50>}]}]]}]}, {Value = GetVarFloat3<Plus_51>}]
...
@C    InputValue_id325 => ShaderFX.InputValueFloat
...
*****     Stages      *****
***************************
@G    Compute => 1d23e05caa9cd24dc522b416315428c7
//
...
//   float InputValue_id325;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
//
#line 1320 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_88328b1f13c6a31f1aff4c3dd5209be1.hlsl"
...
#line 665
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t3.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id115 return value>.x; r6.z <- <Compute_id115 return value>.y; r6.w <- <Compute_id115 return value>.z
...
const static float Value_id319 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float4 TextureValue_31_id126;
    float SMCalcLuminance_ShaderFXResult_33_id134;
    float Multiply_34_id145;
    float Multiply_35_id149;
    float Multiply_36_id153;
    float3 SMVector3Join_ShaderFXResult_37_id157;
    float3 Input_38_id162;
    float3 Multiply_39_id165;
    float3 Input_40_id169;
    float3 Plus_41_id172;
    float3 Input_42_id176;
    float3 Plus_43_id179;
    float3 Input_44_id183;
    float3 Multiply_45_id186;
    float Input_46_id193;
    float3 SMVector3Join_ShaderFXResult_47_id196;
    float3 Input_48_id201;
    float3 Multiply_49_id204;
    float3 Input_50_id208;
    float3 Plus_51_id211;
    uint Input_3_id304;
    ...
    float Input_11_id324;
    float4 Lerp_12_id327;
};
struct CS_INPUT 
{
...
{
    return streams.TextureValue_31_id126;
}
float Compute_id181()
{
    return Value_id319;
...
{
    return DynamicTexture_id127.SampleLevel(DynamicSampler_id128, Compute_id112(streams), Compute_id110());
}
...
{
    streams.Plus_51_id211 = Compute_id370(streams);
}
void Compute_id380(inout CS_STREAMS streams)
{
    streams.Input_50_id208 = Compute_id363();
}
void Compute_id378(inout CS_STREAMS streams)
{
    streams.Multiply_49_id204 = Compute_id362(streams);
}
void Compute_id376(inout CS_STREAMS streams)
{
    streams.Input_48_id201 = Compute_id355();
}
void Compute_id374(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_47_id196 = Compute_id354(streams);
}
void Compute_id372(inout CS_STREAMS streams)
{
    streams.Input_46_id193 = Compute_id345();
}
void Compute_id303(inout CS_STREAMS streams)
{
    streams.Multiply_45_id186 = Compute_id267(streams);
}
void Compute_id301(inout CS_STREAMS streams)
{
    streams.Input_44_id183 = Compute_id260();
}
void Compute_id299(inout CS_STREAMS streams)
{
    streams.Plus_43_id179 = Compute_id259(streams);
}
void Compute_id297(inout CS_STREAMS streams)
{
    streams.Input_42_id176 = Compute_id252();
}
void Compute_id295(inout CS_STREAMS streams)
{
    streams.Plus_41_id172 = Compute_id251(streams);
}
void Compute_id293(inout CS_STREAMS streams)
{
    streams.Input_40_id169 = Compute_id244();
}
void Compute_id291(inout CS_STREAMS streams)
{
    streams.Multiply_39_id165 = Compute_id243(streams);
}
void Compute_id289(inout CS_STREAMS streams)
{
    streams.Input_38_id162 = Compute_id236();
}
void Compute_id287(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_37_id157 = Compute_id235(streams);
}
void Compute_id285(inout CS_STREAMS streams)
{
    streams.Multiply_36_id153 = Compute_id227(streams);
}
void Compute_id283(inout CS_STREAMS streams)
{
    streams.Multiply_35_id149 = Compute_id221(streams);
}
void Compute_id281(inout CS_STREAMS streams)
{
    streams.Multiply_34_id145 = Compute_id215(streams);
}
void Compute_id279(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_33_id134 = Compute_id209(streams);
}
void Compute_id277(inout CS_STREAMS streams)
{
    streams.TextureValue_31_id126 = Compute_id186(streams);
}
void Compute_id275()
{
}
...
{
    streams.Lerp_12_id327 = Compute_id125(streams);
}
void Compute_id146(inout CS_STREAMS streams)
{
    streams.Input_11_id324 = Compute_id116();
}
...
{
    return streams.Multiply_45_id186;
}
