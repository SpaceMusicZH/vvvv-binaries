...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurPass1_Internal_TextureFX [{Control = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_1> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_1>}]}, {Strength = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_0>}]}]
...
*****     Sources     *****
***************************
@S    BlurPass1_Internal_TextureFX => 85db32af68cc419cf1805a618880a23f
...
//
#line 242 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_e8a366ab25289937e02a41fbe2c45967.hlsl"
...
@G    Pixel => e7360595491582f8edf7c55f47e6a4d6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 204 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_e8a366ab25289937e02a41fbe2c45967.hlsl"
div r0.xyzw, l(0.500000, 0.500000, 0.500000, 0.500000), cb1[1].xyxy

#line 203
max r1.x, cb1[1].y, cb1[1].x
log r1.x, r1.x
mul r1.y, r1.x, cb0[1].x  // r1.y <- lod

#line 205
mad r1.x, cb0[1].x, r1.x, l(-2.000000)  // r1.x <- lod
...
{
    streams.Input_0_id95 = Compute_id44();
}
float4 Compute_id35()
{
...
{
    streams.Default_1_id89 = Compute_id35();
}
...
void ClacLodAndOffset_id32(inout PS_STREAMS streams, float2 R, float strenght, out float lod, out float2 off)
{
    lod = Compute_id34(streams) * log2(max(R.x, R.y));
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    float lod;
    float2 off;
    ClacLodAndOffset_id32(streams, ViewSize_id77, Compute_id34(streams), lod, off);
...
float4 Shading_id28(inout PS_STREAMS streams)
{
    ...
    return lerp(col, Filter_id31(streams, col), Compute_id33(streams));
}
