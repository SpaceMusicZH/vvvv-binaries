...
@G    Pixel => 2feaa3a4aa820a26a4c91463587344d6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 615
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.z, r12.xyxx, t2.xxxx, s1, r8.z  // r9.z <- <SampleTextureAndCompare_id67 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r12.zwzz, t2.xxxx, s1, r8.z  // r9.w <- <SampleTextureAndCompare_id67 return value>
...
#line 615
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id67 return value>
...
#line 615
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.xyxx, t2.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id67 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r12.zwzz, t2.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id67 return value>
...
#line 615
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t2.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id67 return value>
...
#line 699
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id177 return value>.x; r8.y <- <FresnelSchlick_id177 return value>.y; r8.z <- <FresnelSchlick_id177 return value>.z
...
#line 695
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id193 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id193 return value>

#line 841
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id195 return value>
...
#line 837
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id207 return value>
...
#line 1230
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id248 return value>
...
#line 699
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id177 return value>.x; r13.y <- <FresnelSchlick_id177 return value>.y; r13.z <- <FresnelSchlick_id177 return value>.z
...
#line 695
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id193 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id193 return value>
...
#line 695
  ...
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id193 return value>
...
mov r14.xyz, r4.xyzx  // r14.x <- streams.matSpecularVisible_id71.x; r14.y <- streams.matSpecularVisible_id71.y; r14.z <- streams.matSpecularVisible_id71.z
mov r15.x, r0.w  // r15.x <- streams.alphaRoughness_id70
mov r15.z, r6.y  // r15.z <- streams.NdotV_id72
...
#line 665
  add r17.xyz, -r9.xyzx, cb0[r0.z + 29].xyzx  // r17.x <- lightVector.x; r17.y <- lightVector.y; r17.z <- lightVector.z
...
#line 667
  div r17.xyz, r17.xyzx, r3.wwww  // r17.x <- lightVectorNorm.x; r17.y <- lightVectorNorm.y; r17.z <- lightVectorNorm.z
...
#line 399
  mul r1.w, r1.w, cb0[r0.z + 29].w  // r1.w <- factor
...
#line 934
  add r2.xyz, r9.xyzx, -cb0[r0.z + 29].xyzx  // r2.x <- lightDelta.x; r2.y <- lightDelta.y; r2.z <- lightDelta.z
...
#line 936
  div r18.xyz, r2.xyzx, r4.wwww  // r18.x <- direction.x; r18.y <- direction.y; r18.z <- direction.z

#line 938
  max r4.w, |r18.z|, |r18.y|
  max r4.w, r4.w, |r18.x|  // r4.w <- longestAxis

#line 947
  eq r6.zw, r4.wwww, |r18.xxxy|

#line 956
  mov r7.yw, r2.zzzx
  movc r2.xy, r6.wwww, r2.wyww, r7.xyxx  // r2.x <- faceIndex; r2.y <- lightSpaceZ
  movc r2.xy, r6.zzzz, r7.zwzz, r2.xyxx

#line 965
  add r2.z, |r2.y|, -cb0[r0.y + 130].x  // r2.z <- lightSpaceZ

#line 966
  div r2.z, cb0[r0.y + 134].y, r2.z
  add r2.z, r2.z, cb0[r0.y + 134].x  // r2.z <- depth

#line 967
  lt r4.w, r2.z, l(0.000000)
  lt r5.w, l(1.000000), r2.z
  or r4.w, r4.w, r5.w
...
#line 795
    mul r4.w, r0.x, cb0[r0.y + 132].x
    mul r2.y, r2.y, r4.w

#line 961
    mad r8.xyz, r2.yyyy, r10.xyzx, r9.xyzx  // r8.x <- positionWS.x; r8.y <- positionWS.y; r8.z <- positionWS.z

#line 962
    ishl r2.x, r2.x, l(2)
    dp4 r18.x, r8.xyzw, cb0[r2.x + 34].xyzw  // r18.x <- projectedPosition.x
    dp4 r18.y, r8.xyzw, cb0[r2.x + 35].xyzw  // r18.y <- projectedPosition.y
    dp4 r2.x, r8.xyzw, cb0[r2.x + 37].xyzw  // r2.x <- projectedPosition.w

#line 963
    div r2.xy, r18.xyxx, r2.xxxx  // r2.x <- projectedPosition.x; r2.y <- projectedPosition.y
...
#line 647
    mul r6.zw, r6.zzzw, cb0[33].zzzw

#line 337
    mad r7.yw, -r2.yyyx, l(0.000000, 3.000000, 0.000000, 3.000000), l(0.000000, 4.000000, 0.000000, 4.000000)  // r7.y <- uvW0.y; r7.w <- uvW0.x

#line 339
    mad r8.xy, r2.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r8.x <- uvW2.x; r8.y <- uvW2.y

#line 340
    mad r15.yw, -r2.xxxy, l(0.000000, 2.000000, 0.000000, 2.000000), l(0.000000, 3.000000, 0.000000, 3.000000)
    div r15.yw, r15.yyyw, r7.wwwy
    add r18.xw, r15.yyyw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r18.x <- uv0.x; r18.w <- uv0.y

#line 341
    add r15.yw, r2.xxxy, l(0.000000, 3.000000, 0.000000, 3.000000)
    mul r18.yz, r15.wwyw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r18.y <- uv1.y; r18.z <- uv1.x

#line 342
    div r2.xy, r2.xyxx, r8.xyxx
    add r19.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r19.x <- uv2.x; r19.y <- uv2.y

#line 343
    mul r2.x, r7.y, r7.w

#line 344
    mad r20.xyzw, r18.xwzw, cb0[33].zwzw, r6.zwzw

#line 348
    mov r19.zw, r18.wwwy

#line 346
    mul r15.yw, r7.yyyw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 347
    mad r21.xyzw, r18.xyzy, cb0[33].zwzw, r6.zwzw

#line 348
    mad r22.xyzw, r19.xzxw, cb0[33].zwzw, r6.zwzw
...
#line 350
    mad r18.xyzw, r18.xyzy, cb0[33].zwzw, r6.zwzw
    mul r19.zw, r8.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 351
    mad r6.zw, r19.xxxy, cb0[33].zzzw, r6.zzzw
    mul r2.y, r8.y, r8.x

#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r20.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id115 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r20.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id115 return value>
...
#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r22.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id115 return value>

#line 786
    mad r2.x, r7.y, r4.w, r2.x

#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r21.xyxx, t0.xxxx, s1, r2.z

#line 786
    mad r2.x, r15.w, r4.w, r2.x
...
#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r22.zwzz, t0.xxxx, s1, r2.z

#line 786
    mad r2.x, r19.z, r4.w, r2.x

#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.xyxx, t0.xxxx, s1, r2.z

#line 786
    mad r2.x, r7.w, r4.w, r2.x

#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.zwzz, t0.xxxx, s1, r2.z

#line 786
    mad r2.x, r19.w, r4.w, r2.x

#line 639
    sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id115 return value>
...
#line 970
  else   // Prior locations: r18.x <- direction.x; r18.y <- direction.y; r18.z <- direction.z; r2.x <- faceIndex; r2.z <- depth
    mov r2.xyz, l(1.000000,1.000000,1.000000,0)
  endif 

#line 1174
  mul r8.xyz, r1.wwww, cb0[r0.z + 30].xyzx
...
#line 1252
  ...
  rsq r0.z, r0.z
  mul r8.xyz, r0.zzzz, r8.xyzx  // r8.x <- streams.H_id75.x; r8.y <- streams.H_id75.y; r8.z <- streams.H_id75.z

#line 1253
  dp3_sat r0.z, r10.xyzx, r8.xyzx  // r0.z <- streams.NdotH_id76

#line 1254
  dp3_sat r1.w, r17.xyzx, r8.xyzx  // r1.w <- streams.LdotH_id77

#line 1248
  mul r8.xyz, r2.xyzx, r12.xyzx
...
#line 695
  mad r4.w, -r15.x, l(0.500000), l(1.000000)
  mad r5.w, r3.w, r4.w, r1.w
  div r5.w, r3.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id193 return value>
  mad r1.w, r15.z, r4.w, r1.w
  div r1.w, r15.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id193 return value>

#line 841
  mul r1.w, r1.w, r5.w
  mul r3.w, r15.z, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id195 return value>

#line 835
  mul r3.w, r15.x, r15.x  // r3.w <- alphaR2

#line 836
  mul r0.z, r0.z, r0.z
  mad r4.w, r15.x, r15.x, l(-1.000000)
...
#line 837
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id207 return value>
...
#line 1437
  mad r16.xyz, r2.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r8.xyzx  // r16.x <- directLightingContribution.x; r16.y <- directLightingContribution.y; r16.z <- directLightingContribution.z
...
#line 901
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.x  // r1.x <- <Compute_id307 return value>.x; r1.y <- <Compute_id307 return value>.y; r1.z <- <Compute_id307 return value>.z
