...
@P   - AmbientOcclusionWithOrthoBlur.VerticalBlur: True
@P AmbientOcclusionWithOrthoBlur.IsOrtho: False
@P AmbientOcclusionWithOrthoBlur.Count: 5
@P AmbientOcclusionWithOrthoBlur.BlurScale: 0.14
@P AmbientOcclusionWithOrthoBlur.EdgeSharpness: 0
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 189 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_AmbientOcclusionWithOrthoBlurEffect_2114645b9e7b9902ecda65707d7d9145.hlsl"
...
@G    Pixel => d7a665d6c7867f34a42a33eaa22b26ec
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 149 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_AmbientOcclusionWithOrthoBlurEffect_2114645b9e7b9902ecda65707d7d9145.hlsl"
...
#line 158
lt r0.w, r0.w, l(300.000000)
if_nz r0.w

#line 164
  add r0.w, cb1[6].x, l(0.300000)  // r0.w <- weight

#line 165
  mad r1.xyzw, cb1[0].xyxy, l(-0.000000, -0.140000, 0.000000, 0.140000), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t0.xyzw, s0  // r1.x <- value

#line 168
  mad r2.xyz, r1.xxxx, r0.wwww, r0.xyzx  // r2.x <- sum.x; r2.y <- sum.y; r2.z <- sum.z

#line 165
  sample_indexable(texture2d)(float,float,float,float) r1.x, r1.zwzz, t0.xyzw, s0

#line 168
  mad r1.xyz, r1.xxxx, r0.wwww, r2.xyzx  // r1.x <- sum.x; r1.y <- sum.y; r1.z <- sum.z

#line 169
  mad r0.w, r0.w, l(2.000000), cb1[5].x  // r0.w <- totalWeight

#line 164
  add r1.w, cb1[7].x, l(0.300000)  // r1.w <- weight

#line 165
  mad r2.xyzw, cb1[0].xyxy, l(-0.000000, -0.280000, 0.000000, 0.280000), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t0.xyzw, s0  // r2.x <- value

#line 168
  mad r1.xyz, r2.xxxx, r1.wwww, r1.xyzx
...
#line 164
  add r1.w, cb1[8].x, l(0.300000)

#line 165
  mad r2.xyzw, cb1[0].xyxy, l(-0.000000, -0.420000, 0.000000, 0.420000), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t0.xyzw, s0  // r2.x <- value
...
#line 164
  add r1.w, cb1[9].x, l(0.300000)

#line 165
  mad r2.xyzw, cb1[0].xyxy, l(-0.000000, -0.560000, 0.000000, 0.560000), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t0.xyzw, s0  // r2.x <- value
...
const static bool IsVertical_id80 = true;
const static float BlurScale_id81 = 0.14;
const static float EdgeSharpness_id82 = 0;
