...
*****     Stages      *****
***************************
@G    Vertex => 04e3c0de6c6143c6019e4876bf4adc52
//
...
//
#line 170 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_5fd7e74e8b13fa556080c4afee1d3716.hlsl"
...
#line 162
  ...
  dp4 r5.w, r4.xyzw, cb0[3].xyzw  // r6.x <- <GetInstanceWorld_id40 return value>._m00; r6.y <- <GetInstanceWorld_id40 return value>._m10; r6.z <- <GetInstanceWorld_id40 return value>._m20; r6.w <- <GetInstanceWorld_id40 return value>._m30; r7.x <- <GetInstanceWorld_id40 return value>._m01; r7.y <- <GetInstanceWorld_id40 return value>._m11; r7.z <- <GetInstanceWorld_id40 return value>._m21; r7.w <- <GetInstanceWorld_id40 return value>._m31; r8.x <- <GetInstanceWorld_id40 return value>._m02; r8.y <- <GetInstanceWorld_id40 return value>._m12; r8.z <- <GetInstanceWorld_id40 return value>._m22; r8.w <- <GetInstanceWorld_id40 return value>._m32

#line 172
endif   // r5.x <- <GetInstanceWorld_id40 return value>._m03; r5.y <- <GetInstanceWorld_id40 return value>._m13; r5.z <- <GetInstanceWorld_id40 return value>._m23; r5.w <- <GetInstanceWorld_id40 return value>._m33
...
#line 166
dp4 o1.x, r1.xyzw, cb2[16].xyzw
dp4 o1.y, r1.xyzw, cb2[17].xyzw
dp4 o1.z, r1.xyzw, cb2[18].xyzw
dp4 o1.w, r1.xyzw, cb2[19].xyzw

#line 193
if_nz r0.x

#line 177
  ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, v1.x, l(0), t1.xyzw
  ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, v1.x, l(16), t1.xyzw
  ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, v1.x, l(32), t1.xyzw
  mul r0.yzw, r2.yyyy, cb0[5].xxyz
  mad r0.yzw, cb0[4].xxyz, r2.xxxx, r0.yyzw
  mad r0.yzw, cb0[6].xxyz, r2.zzzz, r0.yyzw
  mad r0.yzw, cb0[7].xxyz, r2.wwww, r0.yyzw  // r0.y <- <GetInstanceWorldInverse_id14 return value>._m00; r0.z <- <GetInstanceWorldInverse_id14 return value>._m10; r0.w <- <GetInstanceWorldInverse_id14 return value>._m20
  mul r2.xyz, r3.yyyy, cb0[5].xyzx
  mad r2.xyz, cb0[4].xyzx, r3.xxxx, r2.xyzx
  mad r2.xyz, cb0[6].xyzx, r3.zzzz, r2.xyzx
  mad r2.xyz, cb0[7].xyzx, r3.wwww, r2.xyzx  // r2.x <- <GetInstanceWorldInverse_id14 return value>._m01; r2.y <- <GetInstanceWorldInverse_id14 return value>._m11; r2.z <- <GetInstanceWorldInverse_id14 return value>._m21
  mul r3.xyz, r4.yyyy, cb0[5].xyzx
  mad r3.xyz, cb0[4].xyzx, r4.xxxx, r3.xyzx
  mad r3.xyz, cb0[6].xyzx, r4.zzzz, r3.xyzx
  mad r3.xyz, cb0[7].xyzx, r4.wwww, r3.xyzx  // r3.x <- <GetInstanceWorldInverse_id14 return value>._m02; r3.y <- <GetInstanceWorldInverse_id14 return value>._m12; r3.z <- <GetInstanceWorldInverse_id14 return value>._m22

#line 194
  mov r4.x, r0.y  // r4.x <- <GetInstanceWorldInverse_id41 return value>._m00
  mov r4.y, r2.x  // r4.y <- <GetInstanceWorldInverse_id41 return value>._m01
  mov r4.z, r3.x  // r4.z <- <GetInstanceWorldInverse_id41 return value>._m02
  mov r5.x, r0.z  // r5.x <- <GetInstanceWorldInverse_id41 return value>._m10
  mov r5.y, r2.y  // r5.y <- <GetInstanceWorldInverse_id41 return value>._m11
  mov r5.z, r3.y  // r5.z <- <GetInstanceWorldInverse_id41 return value>._m12
  mov r3.x, r0.w  // r3.x <- <GetInstanceWorldInverse_id41 return value>._m20
  mov r3.y, r2.z
endif   // r3.x <- <GetInstanceWorldInverse_id41 return value>._m20; r3.y <- <GetInstanceWorldInverse_id41 return value>._m21; r3.z <- <GetInstanceWorldInverse_id41 return value>._m22
...
#line 208
dp3 r0.x, r4.xyzx, v2.xyzx  // r0.x <- streams.meshNormalWS_id16.x
dp3 r0.y, r5.xyzx, v2.xyzx  // r0.y <- streams.meshNormalWS_id16.y
dp3 r0.z, r3.xyzx, v2.xyzx  // r0.z <- streams.meshNormalWS_id16.z
...
float4x4 GetInstanceWorld_id40(uint instanceId)
{
...
{
    streams.PositionWS_id21 = mul(streams.Position_id20, GetInstanceWorld_id40(streams.InstanceID_id13));
}
float4x4 GetInstanceWorldInverse_id41(uint instanceId)
{
    uint m = ParticlesBuffer_id143[instanceId].Mesh;
    if (m == MeshIndex_id142)
...
{
    streams.meshNormalWS_id16 = mul((float3x3)GetInstanceWorldInverse_id41(streams.InstanceID_id13), streams.meshNormal_id15);
