...
@G    Pixel => 35d241c03f906893f4ca9eb001672373
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r12.xyxx, t0.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id62 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.y, r12.zwzz, t0.xxxx, s0, r7.w  // r9.y <- <SampleTextureAndCompare_id62 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r14.xyxx, t0.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id62 return value>

#line 511
  mad r7.y, r8.z, r9.x, r7.y

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.z, r13.xyxx, t0.xxxx, s0, r7.w  // r8.z <- <SampleTextureAndCompare_id62 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r8.xyxx, t0.xxxx, s0, r7.w  // r7.w <- <SampleTextureAndCompare_id62 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r12.xyxx, t0.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id62 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r12.zwzz, t0.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id62 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t0.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id62 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r7.xzxx, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id62 return value>
