...
@S    SMBoxImpostor_ShaderFX => bf5916c3e15ac11f544bb490e2a6385c
...
//
#line 1694 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_abfd68f035e6f89cda55f895488b656d.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => bf468b7befcc171290d7de40b138d455
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1659 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_abfd68f035e6f89cda55f895488b656d.hlsl"
...
mul r4.x, r0.z, -r3.x  // r4.x <- <rot3x3_id67 return value>._m01
mul r6.xyzw, r0.xyyz, r3.yzxy  // r6.z <- <rot3x3_id67 return value>._m20
mad r7.x, r6.x, r0.z, -r6.y  // r7.x <- <rot3x3_id67 return value>._m02
mad r5.y, -r0.w, r3.z, r6.w  // r5.y <- <rot3x3_id67 return value>._m10
mul r0.w, r3.z, r6.x
mad r7.y, -r0.y, r0.z, -r0.w  // r7.y <- <rot3x3_id67 return value>._m12
...
#line 1574
    and r8.xyz, r2.wwww, l(90, 51, 15, 0)
...
#line 1599
    ...
    mad r3.xyz, r9.xyzx, r1.zzzz, r8.xywx  // r3.x <- posWorld.x; r3.y <- posWorld.y; r3.z <- posWorld.z

#line 1600
    dp4 r8.x, r3.xyzw, cb0[0].xyzw  // r8.x <- posWorld.x
    dp4 r8.y, r3.xyzw, cb0[1].xyzw  // r8.y <- posWorld.y
    dp4 r8.z, r3.xyzw, cb0[2].xyzw  // r8.z <- posWorld.z
    dp4 r8.w, r3.xyzw, cb0[3].xyzw  // r8.w <- posWorld.w

#line 1604
    dp4 r2.w, r8.xyzw, cb2[16].xyzw  // r2.w <- streams.ShadingPosition_id0.x
    dp4 r3.x, r8.xyzw, cb2[17].xyzw  // r3.x <- streams.ShadingPosition_id0.y
    dp4 r3.y, r8.xyzw, cb2[18].xyzw  // r3.y <- streams.ShadingPosition_id0.z
    dp4 r3.z, r8.xyzw, cb2[19].xyzw  // r3.z <- streams.ShadingPosition_id0.w
...
#line 1574
    and r8.xyz, r2.wwww, l(0x0000a55a, 3891, 0x0000330f, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id91 return value>.x; r8.y <- <CubeVert_id91 return value>.y; r8.z <- <CubeVert_id91 return value>.z

#line 1597
    mul r9.xyz, r5.xywx, r8.xxxx
    mad r9.xyz, r9.xyzx, r1.xxxx, r2.xyzx  // r9.x <- posWorld.x; r9.y <- posWorld.y; r9.z <- posWorld.z
...
#line 1574
    and r8.xyz, r2.wwww, l(0x0000a500, 3840, 0x00003300, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id91 return value>.x; r8.y <- <CubeVert_id91 return value>.y; r8.z <- <CubeVert_id91 return value>.z
...
#line 1604
    ...
    dp4 r3.x, r8.xyzw, cb2[18].xyzw  // r3.x <- streams.ShadingPosition_id0.z
    dp4 r3.y, r8.xyzw, cb2[19].xyzw  // r3.y <- streams.ShadingPosition_id0.w
...
#line 1574
    and r5.xyz, r1.wwww, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r5.xyz, r5.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r5.x <- <CubeVert_id91 return value>.x; r5.y <- <CubeVert_id91 return value>.y; r5.z <- <CubeVert_id91 return value>.z

#line 1597
    mul r8.xyz, r6.xyzx, r5.xxxx
    mad r8.xyz, r8.xyzx, r1.xxxx, r2.xyzx  // r8.x <- posWorld.x; r8.y <- posWorld.y; r8.z <- posWorld.z

#line 1598
    mul r5.xyw, r4.xyxz, r5.yyyy
    mad r5.xyw, r5.xyxw, r1.yyyy, r8.xyxz  // r5.x <- posWorld.x; r5.y <- posWorld.y; r5.w <- posWorld.z

#line 1599
    mul r8.xyz, r7.xyzx, r5.zzzz
    mad r3.xyz, r8.xyzx, r1.zzzz, r5.xywx  // r3.x <- posWorld.x; r3.y <- posWorld.y; r3.z <- posWorld.z

#line 1600
    dp4 r5.x, r3.xyzw, cb0[0].xyzw  // r5.x <- posWorld.x
    dp4 r5.y, r3.xyzw, cb0[1].xyzw  // r5.y <- posWorld.y
    dp4 r5.z, r3.xyzw, cb0[2].xyzw  // r5.z <- posWorld.z
    dp4 r5.w, r3.xyzw, cb0[3].xyzw  // r5.w <- posWorld.w

#line 1604
    dp4 r1.w, r5.xyzw, cb2[16].xyzw  // r1.w <- streams.ShadingPosition_id0.x
    dp4 r2.w, r5.xyzw, cb2[17].xyzw  // r2.w <- streams.ShadingPosition_id0.y
    dp4 r3.x, r5.xyzw, cb2[18].xyzw  // r3.x <- streams.ShadingPosition_id0.z
    dp4 r3.y, r5.xyzw, cb2[19].xyzw  // r3.y <- streams.ShadingPosition_id0.w
...
#line 1597
    mul r5.xyz, r6.xyzx, r3.xxxx
    mad r5.xyz, r5.xyzx, r1.xxxx, r2.xyzx  // r5.x <- posWorld.x; r5.y <- posWorld.y; r5.z <- posWorld.z

#line 1598
    mul r3.xyw, r4.xyxz, r3.yyyy
    mad r3.xyw, r3.xyxw, r1.yyyy, r5.xyxz  // r3.x <- posWorld.x; r3.y <- posWorld.y; r3.w <- posWorld.z

#line 1599
    mul r5.xyz, r7.xyzx, r3.zzzz
    mad r0.xyz, r5.xyzx, r1.zzzz, r3.xywx  // r0.x <- posWorld.x; r0.y <- posWorld.y; r0.z <- posWorld.z
...
//
#line 1641 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_abfd68f035e6f89cda55f895488b656d.hlsl"
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    if (dot(streams.PSize_id153, streams.PSize_id153) <= 0)
        return;
    float3x3 or = transpose(rot3x3_id67(p.Rot));
