...
@G    Pixel => e6cfc84651952ad78711e2575587f048
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
void sphereImpostorSimple_id46(float2 mapping, float3 spherePos, float sphereRadius, out float3 pos, out float3 normal)
{
...
float4 Shading_id47(inout PS_STREAMS streams)
{
    ...
    sphereImpostorSimple_id46(mapping, streams.PositionWS_id16.xyz, size, worldPos, worldNormal);
