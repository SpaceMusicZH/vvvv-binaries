...
@C    InputValue_id231 => ShaderFX.InputValueFloat3.i9
@C    InputValue_id238 => ShaderFX.InputValueFloat3.i10
@C    InputValue_id266 => ShaderFX.InputValueFloat.i2
@C    InputValue_id274 => ShaderFX.InputValueFloat3.i2
@C    InputValue_id281 => ShaderFX.InputValueFloat3.i3
@C    InputValue_id288 => ShaderFX.InputValueFloat3.i4
@C    InputValue_id298 => ShaderFX.InputValueFloat.i1
@C    InputValue_id306 => ShaderFX.InputValueFloat3
@C    InputValue_id313 => ShaderFX.InputValueFloat3.i1
...
@R    DynamicTexture_id248 => ObjectTexture_fx19 [Stage: Compute, Slot: (4-4)]
...
*****     Stages      *****
***************************
@G    Compute => d05ac7ea8b5e4d5f65510199da8e6a9f
//
...
//   float3 InputValue_id231;           // Offset:   64 Size:    12
//   float3 InputValue_id238;           // Offset:   80 Size:    12
//   float InputValue_id266;            // Offset:   92 Size:     4
//   float3 InputValue_id274;           // Offset:   96 Size:    12
//   float3 InputValue_id281;           // Offset:  112 Size:    12
//   float3 InputValue_id288;           // Offset:  128 Size:    12
//   float InputValue_id298;            // Offset:  140 Size:     4
//   float3 InputValue_id306;           // Offset:  144 Size:    12
//   float3 InputValue_id313;           // Offset:  160 Size:    12
//   uint InputValue_id334;             // Offset:  172 Size:     4
//   float InputValue_id355;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicTexture_id248              texture  float4          2d             t4      1 
...
//
#line 1454 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_59ea5bdd170e14a08ba8e22937d8324e.hlsl"
...
#line 699
  mad r11.xyz, cb1[8].wwww, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id579 return value>.x; r11.y <- <Compute_id579 return value>.y; r11.z <- <Compute_id579 return value>.z
...
#line 695
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id467 return value>.x; r12.y <- <Compute_id467 return value>.y; r12.z <- <Compute_id467 return value>.z
...
#line 666
  mad r12.xyz, r12.xyzx, cb1[6].xyzx, cb1[7].xyzx  // r12.x <- <Compute_id516 return value>.x; r12.y <- <Compute_id516 return value>.y; r12.z <- <Compute_id516 return value>.z

#line 658
  add r12.xyz, r12.xyzx, cb1[8].xyzx  // r12.x <- <Compute_id524 return value>.x; r12.y <- <Compute_id524 return value>.y; r12.z <- <Compute_id524 return value>.z
...
#line 642
  sample_l_indexable(texture2d)(float,float,float,float) r13.xyz, r6.xzxx, t3.xyzw, s0, l(0.000000)  // r13.x <- <Compute_id193 return value>.x; r13.y <- <Compute_id193 return value>.y; r13.z <- <Compute_id193 return value>.z

#line 372
  dp3 r1.w, r13.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r1.w <- <Luminance_id51 return value>

#line 633
  mul r1.w, r0.w, r1.w  // r1.w <- <Compute_id222 return value>

#line 605
  mad r13.xyz, r1.wwww, cb1[0].xyzx, cb1[1].xyzx  // r13.x <- <Compute_id258 return value>.x; r13.y <- <Compute_id258 return value>.y; r13.z <- <Compute_id258 return value>.z

#line 597
  add r13.xyz, r13.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id266 return value>.x; r13.y <- <Compute_id266 return value>.y; r13.z <- <Compute_id266 return value>.z

#line 589
  mul r14.xyz, r13.xyzx, cb1[3].xyzx  // r14.x <- <Compute_id274 return value>.x; r14.y <- <Compute_id274 return value>.y; r14.z <- <Compute_id274 return value>.z

#line 1432
  ld_structured_indexable(structured_buffer, stride=12)(mixed,mixed,mixed,mixed) r15.xyz, l(2), l(0), t0.xyzx
  mov r9.w, r10.x
  mad r9.xyz, -r13.xyzx, cb1[3].xyzx, r9.yzwy
  mad r9.xyz, r15.xyzx, r9.xyzx, r14.xyzx  // r9.x <- m.Dim.x; r9.y <- m.Dim.y; r9.z <- m.Dim.z

#line 562
  mul r12.yz, r12.xxyx, cb1[3].wwww  // r12.z <- <Compute_id377 return value>

#line 553
  mul r12.w, r0.w, cb1[3].w  // r12.w <- <Compute_id406 return value>

#line 533
  mad r12.xyz, r12.yzwy, cb1[4].xyzx, cb1[5].xyzx  // r12.x <- <Compute_id430 return value>.x; r12.y <- <Compute_id430 return value>.y; r12.z <- <Compute_id430 return value>.z
...
#line 505
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id597 return value>.x; r14.y <- <SRgbToLinear_id597 return value>.y; r14.z <- <SRgbToLinear_id597 return value>.z
...
struct CS_STREAMS 
{
    ...
    float Input_13_id297;
    float3 SMVector3Join_ShaderFXResult_14_id300;
    float3 Input_15_id305;
    float3 Multiply_16_id308;
    float3 Input_17_id312;
    float3 Plus_18_id315;
    float4 TextureValue_20_id247;
    float SMCalcLuminance_ShaderFXResult_22_id254;
    float Input_23_id265;
    float3 SMVector3Join_ShaderFXResult_24_id268;
    float3 Input_25_id273;
    float3 Multiply_26_id276;
    float3 Input_27_id280;
    float3 Plus_28_id283;
    float3 Input_29_id287;
    float3 Plus_30_id290;
    ...
    float Multiply_52_id221;
    float3 SMVector3Join_ShaderFXResult_53_id225;
    float3 Input_54_id230;
    float3 Multiply_55_id233;
    float3 Input_56_id237;
    float3 Plus_57_id240;
    uint Input_3_id333;
...
{
    return streams.Input_56_id237;
}
float3 Compute_id425(inout CS_STREAMS streams)
{
    return streams.Multiply_55_id233;
}
...
{
    return streams.SMVector3Join_ShaderFXResult_53_id225;
}
float Compute_id411(inout CS_STREAMS streams)
{
    return streams.Multiply_52_id221;
}
...
float4 Compute_id378(inout CS_STREAMS streams)
{
...
float4 Compute_id468(inout CS_STREAMS streams)
{
...
float2 Compute_id464(inout CS_STREAMS streams)
{
    return streams.TexCoord1_id60;
}
float3 Compute_id576(inout CS_STREAMS streams)
{
    return streams.Input_17_id312;
}
float3 Compute_id574(inout CS_STREAMS streams)
{
    return streams.Multiply_16_id308;
}
float3 Compute_id568(inout CS_STREAMS streams)
{
    return streams.Input_15_id305;
}
float3 Compute_id566(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_14_id300;
}
float Compute_id560(inout CS_STREAMS streams)
{
    return streams.Input_13_id297;
}
float Compute_id558(inout CS_STREAMS streams)
{
    return streams.Input_13_id297;
}
float Compute_id556(inout CS_STREAMS streams)
{
    return streams.Input_13_id297;
}
...
float4 SRgbToLinear_id597(float4 sRGBa)
{
...
{
    float4 color = Compute_id378(streams);
...
{
    return Compute_id519(streams) + Compute_id521(streams);
}
float3 Compute_id517()
{
    return InputValue_id288;
}
float3 Compute_id516(inout CS_STREAMS streams)
{
    return Compute_id511(streams) + Compute_id513(streams);
}
float3 Compute_id509()
{
...
{
    return float3(Compute_id493(streams), Compute_id495(streams), Compute_id497(streams));
}
float Compute_id491()
{
...
{
    float4 color = Compute_id468(streams);
    return Luminance_id61(color.rgb);
}
float4 Compute_id467(inout CS_STREAMS streams)
{
    return DynamicTexture_id248.SampleLevel(DynamicSampler_id128, Compute_id464(streams), Compute_id462());
}
float3 Compute_id579(inout CS_STREAMS streams)
{
    return Compute_id574(streams) + Compute_id576(streams);
}
float3 Compute_id572()
{
    return InputValue_id313;
}
float3 Compute_id571(inout CS_STREAMS streams)
{
    return Compute_id566(streams) * Compute_id568(streams);
}
float3 Compute_id564()
{
    return InputValue_id306;
}
float3 Compute_id563(inout CS_STREAMS streams)
{
    return float3(Compute_id556(streams), Compute_id558(streams), Compute_id560(streams));
}
float Compute_id554()
{
...
{
    return DynamicTexture_id348.SampleLevel(DynamicSampler_id128, Compute_id119(streams), Compute_id117());
}
float4 Compute_id116(inout CS_STREAMS streams)
{
    return SRgbToLinear_id597(Compute_id113(streams));
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return DynamicBuffer_id341[Compute_id109(streams)];
}
...
{
    streams.Plus_57_id240 = Compute_id430(streams);
}
void Compute_id454(inout CS_STREAMS streams)
{
    streams.Input_56_id237 = Compute_id423();
}
void Compute_id452(inout CS_STREAMS streams)
{
    streams.Multiply_55_id233 = Compute_id422(streams);
}
void Compute_id450(inout CS_STREAMS streams)
{
    streams.Input_54_id230 = Compute_id415();
}
void Compute_id448(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_53_id225 = Compute_id414(streams);
}
void Compute_id446(inout CS_STREAMS streams)
{
    streams.Multiply_52_id221 = Compute_id406(streams);
}
void Compute_id444(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id400(streams);
}
void Compute_id442(inout CS_STREAMS streams)
{
    streams.Multiply_51_id207 = Compute_id377(streams);
}
void Compute_id440(inout CS_STREAMS streams)
{
    streams.g_50_id204 = Compute_id371(streams);
}
...
{
    streams.Plus_30_id290 = Compute_id524(streams);
}
void Compute_id546(inout CS_STREAMS streams)
{
    streams.Input_29_id287 = Compute_id517();
}
void Compute_id544(inout CS_STREAMS streams)
{
    streams.Plus_28_id283 = Compute_id516(streams);
}
void Compute_id542(inout CS_STREAMS streams)
{
    streams.Input_27_id280 = Compute_id509();
}
void Compute_id540(inout CS_STREAMS streams)
{
    streams.Multiply_26_id276 = Compute_id508(streams);
}
void Compute_id538(inout CS_STREAMS streams)
{
    streams.Input_25_id273 = Compute_id501();
}
void Compute_id536(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id268 = Compute_id500(streams);
}
void Compute_id534(inout CS_STREAMS streams)
{
    streams.Input_23_id265 = Compute_id491();
}
void Compute_id532(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id254 = Compute_id490(streams);
}
void Compute_id530(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id247 = Compute_id467(streams);
}
void Compute_id528()
{
}
...
{
    streams.Plus_18_id315 = Compute_id579(streams);
}
void Compute_id589(inout CS_STREAMS streams)
{
    streams.Input_17_id312 = Compute_id572();
}
void Compute_id587(inout CS_STREAMS streams)
{
    streams.Multiply_16_id308 = Compute_id571(streams);
}
void Compute_id585(inout CS_STREAMS streams)
{
    streams.Input_15_id305 = Compute_id564();
}
void Compute_id583(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id300 = Compute_id563(streams);
}
void Compute_id581(inout CS_STREAMS streams)
{
    streams.Input_13_id297 = Compute_id554();
}
...
{
    streams.Lerp_12_id357 = Compute_id132(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_11_id354 = Compute_id123();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id347 = Compute_id122(streams);
}
void Compute_id149()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id344 = Compute_id116(streams);
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id340 = Compute_id112(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id336 = Compute_id108(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.Input_3_id333 = Compute_id101();
}
...
{
    return streams.Plus_18_id315;
}
void Compute_id593(inout CS_STREAMS streams)
{
