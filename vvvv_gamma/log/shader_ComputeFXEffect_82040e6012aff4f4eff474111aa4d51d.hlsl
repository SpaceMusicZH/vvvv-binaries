...
@C    InputValue_id332 => ShaderFX.InputValueUInt
@C    InputValue_id353 => ShaderFX.InputValueFloat
...
@R    DynamicTexture_id249 => ObjectTexture_fx23 [Stage: Compute, Slot: (5-5)]
@R    DynamicBuffer_id339 => ObjectBuffer_fx0 [Stage: Compute, Slot: (6-6)]
@R    DynamicTexture_id346 => ObjectTexture_fx7 [Stage: Compute, Slot: (7-7)]
...
*****     Stages      *****
***************************
@G    Compute => 626675941704d95bfe97d408bea4a5ed
//
...
//   uint InputValue_id332;             // Offset:  156 Size:     4
//   float InputValue_id353;            // Offset:  160 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicBuffer_id339               texture  float4         buf             t6      1 
// DynamicTexture_id346              texture  float4          2d             t7      1 
...
//
#line 1449 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_82040e6012aff4f4eff474111aa4d51d.hlsl"
...
#line 689
  mad r11.xyz, cb1[7].wwww, cb1[8].xyzx, cb1[9].xyzx  // r11.x <- <Compute_id574 return value>.x; r11.y <- <Compute_id574 return value>.y; r11.z <- <Compute_id574 return value>.z
...
#line 676
  sample_l_indexable(texture2d)(float,float,float,float) r13.xyz, r6.xyxx, t5.xyzw, s0, l(0.000000)  // r13.x <- <Compute_id459 return value>.x; r13.y <- <Compute_id459 return value>.y; r13.z <- <Compute_id459 return value>.z

#line 414
  dp3 r12.y, r13.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r12.y <- <Luminance_id61 return value>

#line 651
  mad r12.xyz, r12.xxyx, cb1[5].xyzx, cb1[6].xyzx  // r12.x <- <Compute_id506 return value>.x; r12.y <- <Compute_id506 return value>.y; r12.z <- <Compute_id506 return value>.z

#line 643
  add r12.xyz, r12.xyzx, cb1[7].xyzx  // r12.x <- <Compute_id514 return value>.x; r12.y <- <Compute_id514 return value>.y; r12.z <- <Compute_id514 return value>.z
...
#line 590
  mad r12.xyz, r1.wwww, cb1[1].xyzx, cb1[0].xyzx  // r12.x <- <Compute_id258 return value>.x; r12.y <- <Compute_id258 return value>.y; r12.z <- <Compute_id258 return value>.z

#line 582
  mul r13.xyz, r12.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id266 return value>.x; r13.y <- <Compute_id266 return value>.y; r13.z <- <Compute_id266 return value>.z
...
#line 503
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id592 return value>.x; r14.y <- <SRgbToLinear_id592 return value>.y; r14.z <- <SRgbToLinear_id592 return value>.z
...
const static float Value_id347 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Input_13_id295;
    float3 SMVector3Join_ShaderFXResult_14_id298;
    float3 Input_15_id303;
    float3 Multiply_16_id306;
    float3 Input_17_id310;
    float3 Plus_18_id313;
    float4 TextureValue_20_id230;
    float SMCalcLuminance_ShaderFXResult_22_id237;
    float4 TextureValue_24_id248;
    float SMCalcLuminance_ShaderFXResult_26_id255;
    float3 SMVector3Join_ShaderFXResult_27_id266;
    float3 Input_28_id271;
    float3 Multiply_29_id274;
    float3 Input_30_id278;
    float3 Plus_31_id281;
    float3 Input_32_id285;
    float3 Plus_33_id288;
    ...
    float r_48_id187;
    float Input_49_id190;
    float Multiply_50_id193;
    float g_51_id197;
    ...
    uint Input_3_id331;
    uint SMValueToIndex_ShaderFXResult_4_id334;
    float4 BufferItem_5_id338;
    float4 SRgbToLinear_ShaderFXResult_6_id342;
    float4 TextureValue_9_id345;
    float Input_11_id352;
    float4 Lerp_12_id355;
};
struct CS_INPUT 
{
...
cbuffer PerUpdate 
{
    ...
    uint InputValue_id332;
    float InputValue_id353;
};
cbuffer Globals 
{
...
Buffer<float4> DynamicBuffer_id339;
Texture2D DynamicTexture_id346;
...
{
    return streams.TextureValue_24_id248;
}
float Compute_id454()
{
    return Value_id347;
}
float2 Compute_id456(inout CS_STREAMS streams)
{
...
{
    return streams.Input_11_id352;
}
float4 Compute_id127(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id345;
}
float4 Compute_id125(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id342;
}
float Compute_id117()
{
    return Value_id347;
...
float4 SRgbToLinear_id592(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id338;
}
uint Compute_id109(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id334;
}
uint Compute_id103(inout CS_STREAMS streams)
{
    return streams.Input_3_id331;
}
...
{
    float4 color = Compute_id460(streams);
    return Luminance_id61(color.rgb);
}
float4 Compute_id459(inout CS_STREAMS streams)
{
    return DynamicTexture_id249.SampleLevel(DynamicSampler_id131, Compute_id456(streams), Compute_id454());
}
...
{
    return DynamicTexture_id231.SampleLevel(DynamicSampler_id131, Compute_id427(streams), Compute_id425());
}
...
float Compute_id123()
{
    return InputValue_id353;
}
float4 Compute_id122(inout CS_STREAMS streams)
{
    return DynamicTexture_id346.SampleLevel(DynamicSampler_id131, Compute_id119(streams), Compute_id117());
}
float4 Compute_id116(inout CS_STREAMS streams)
{
    return SRgbToLinear_id592(Compute_id113(streams));
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return DynamicBuffer_id339[Compute_id109(streams)];
}
...
{
    streams.Plus_58_id223 = Compute_id395(streams);
}
void Compute_id417(inout CS_STREAMS streams)
{
    streams.Input_57_id220 = Compute_id388();
}
void Compute_id415(inout CS_STREAMS streams)
{
    streams.Multiply_56_id216 = Compute_id387(streams);
}
void Compute_id413(inout CS_STREAMS streams)
{
    streams.Input_55_id213 = Compute_id380();
}
void Compute_id411(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_54_id208 = Compute_id379(streams);
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Multiply_53_id204 = Compute_id371(streams);
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.Multiply_52_id200 = Compute_id365(streams);
}
void Compute_id405(inout CS_STREAMS streams)
{
    streams.g_51_id197 = Compute_id359(streams);
}
void Compute_id403(inout CS_STREAMS streams)
{
    streams.Multiply_50_id193 = Compute_id355(streams);
}
void Compute_id401(inout CS_STREAMS streams)
{
    streams.Input_49_id190 = Compute_id348();
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.r_48_id187 = Compute_id347(streams);
}
...
{
    streams.Multiply_47_id179 = Compute_id266(streams);
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.Input_46_id176 = Compute_id259();
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.Plus_45_id172 = Compute_id258(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.Multiply_44_id168 = Compute_id252(streams);
}
void Compute_id290(inout CS_STREAMS streams)
{
    streams.Input_43_id165 = Compute_id245();
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_42_id160 = Compute_id244(streams);
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Multiply_41_id156 = Compute_id236(streams);
}
...
{
    streams.Plus_33_id288 = Compute_id514(streams);
}
void Compute_id541(inout CS_STREAMS streams)
{
    streams.Input_32_id285 = Compute_id507();
}
void Compute_id539(inout CS_STREAMS streams)
{
    streams.Plus_31_id281 = Compute_id506(streams);
}
void Compute_id537(inout CS_STREAMS streams)
{
    streams.Input_30_id278 = Compute_id499();
}
void Compute_id535(inout CS_STREAMS streams)
{
    streams.Multiply_29_id274 = Compute_id498(streams);
}
void Compute_id533(inout CS_STREAMS streams)
{
    streams.Input_28_id271 = Compute_id491();
}
void Compute_id531(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_27_id266 = Compute_id490(streams);
}
void Compute_id529(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_26_id255 = Compute_id482(streams);
}
void Compute_id527(inout CS_STREAMS streams)
{
    streams.TextureValue_24_id248 = Compute_id459(streams);
}
void Compute_id525()
{
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_22_id237 = Compute_id453(streams);
}
void Compute_id520(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id230 = Compute_id430(streams);
}
void Compute_id518()
{
}
...
{
    streams.Plus_18_id313 = Compute_id574(streams);
}
void Compute_id584(inout CS_STREAMS streams)
{
    streams.Input_17_id310 = Compute_id567();
}
void Compute_id582(inout CS_STREAMS streams)
{
    streams.Multiply_16_id306 = Compute_id566(streams);
}
void Compute_id580(inout CS_STREAMS streams)
{
    streams.Input_15_id303 = Compute_id559();
}
void Compute_id578(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id298 = Compute_id558(streams);
}
void Compute_id576(inout CS_STREAMS streams)
{
    streams.Input_13_id295 = Compute_id549();
}
...
{
    streams.Lerp_12_id355 = Compute_id132(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_11_id352 = Compute_id123();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id345 = Compute_id122(streams);
}
void Compute_id149()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id342 = Compute_id116(streams);
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id338 = Compute_id112(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id334 = Compute_id108(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.Input_3_id331 = Compute_id101();
}
...
float3 Compute_id589(inout CS_STREAMS streams)
{
    return streams.Plus_18_id313;
}
