...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,7>, LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<2>, ShadowMapReceiverSpot<2,false>, ShadowMapFilterPcf<PerDraw.Lighting,3>
...
//
#line 1672 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb81d357f2e4762e32e1976be182e878.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
#line 1637 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb81d357f2e4762e32e1976be182e878.hlsl"
...
@G    Pixel => c52b77c2f1df477bbec932f05347d6f8
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1621 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb81d357f2e4762e32e1976be182e878.hlsl"
...
#line 458
  mad r18.xyzw, r17.zwxw, cb0[37].zwzw, r6.zwzw

#line 459
  mul r12.yw, r12.yyyw, r16.xxxy

#line 460
  mad r17.xyzw, r17.zyxy, cb0[37].zwzw, r6.zwzw
  mul r2.y, r16.y, r16.x

#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id179 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id179 return value>
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id179 return value>

#line 645
  mad r2.x, r12.w, r4.w, r2.x

#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r17.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id179 return value>
...
mov o0.w, l(1.000000)
ret 
// Approximately 584 instruction slots used
***************************
*************************/
