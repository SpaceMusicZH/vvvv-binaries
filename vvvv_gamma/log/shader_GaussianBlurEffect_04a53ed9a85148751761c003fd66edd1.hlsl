...
@P GaussianBlur.Count: 12
***************************
****  ConstantBuffers  ****
***************************
cbuffer PerDraw [Size: 64]
@C    MatrixTransform_id73 => SpriteBase.MatrixTransform
cbuffer Globals [Size: 272]
...
//
#line 156 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_GaussianBlurEffect_04a53ed9a85148751761c003fd66edd1.hlsl"
...
@G    Pixel => 2dcc11fc9ba6195674c149f116225a79
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 OffsetsWeights_id76[12];    // Offset:   80 Size:   184
//
// }
//
//
...
//
#line 132 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_GaussianBlurEffect_04a53ed9a85148751761c003fd66edd1.hlsl"
...
#line 137
mad r1.zw, -r1.xxxy, cb0[10].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, cb0[10].yyyy, r0.xyzx
...
#line 137
mad r1.zw, -r1.xxxy, cb0[11].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
...
#line 137
mad r1.zw, -r1.xxxy, cb0[12].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, cb0[12].yyyy, r0.xyzx
...
#line 137
mad r1.zw, -r1.xxxy, cb0[13].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, cb0[13].yyyy, r0.xyzx
...
#line 137
mad r1.zw, -r1.xxxy, cb0[14].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, cb0[14].yyyy, r0.xyzx
...
#line 137
mad r1.zw, -r1.xxxy, cb0[15].xxxx, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, cb0[15].yyyy, r0.xyzx
...
#line 137
mad r1.zw, -r1.xxxy, cb0[16].xxxx, v1.xxxy

#line 138
mad r1.xy, r1.xyxx, cb0[16].xxxx, v1.xyxx
...
mad r0.xyz, r1.xyzx, cb0[16].yyyy, r0.xyzx

#line 138
mad o0.xyz, r2.xyzx, cb0[16].yyyy, r0.xyzx
...
***************************
*************************/
const static int BlurCount_id74 = 12;
const static bool IsVertical_id75 = false;
struct PS_STREAMS 
{
