...
//
#line 1302 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_c0750be8683195965aca7d6cc23b2e9f.hlsl"
...
@G    Pixel => a1251fe7ad5d4685301f5a195c02f792
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1364 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_c0750be8683195965aca7d6cc23b2e9f.hlsl"
...
#line 598
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r12.xyxx, t1.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id59 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.y, r12.zwzz, t1.xxxx, s0, r7.w  // r9.y <- <SampleTextureAndCompare_id59 return value>
...
#line 598
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r14.xyxx, t1.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id59 return value>

#line 691
  mad r7.y, r8.z, r9.x, r7.y

#line 598
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.z, r13.xyxx, t1.xxxx, s0, r7.w  // r8.z <- <SampleTextureAndCompare_id59 return value>
...
#line 598
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r8.xyxx, t1.xxxx, s0, r7.w  // r7.w <- <SampleTextureAndCompare_id59 return value>
...
#line 598
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r12.xyxx, t1.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id59 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r12.zwzz, t1.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id59 return value>
...
#line 598
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t1.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id59 return value>
...
#line 598
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r7.xzxx, t1.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id59 return value>
...
#line 1040
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id171 return value>
...
#line 1018
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id183 return value>

#line 1175
mov r2.xyz, r1.xyzx
mov r2.w, v0.x
mov r3.yz, v0.yyzy
mov r0.yzw, cb1[0].xxyz  // r0.y <- streams.matDiffuseVisible_id68.x; r0.z <- streams.matDiffuseVisible_id68.y; r0.w <- streams.matDiffuseVisible_id68.z
...
#line 855
  ishl r5.w, r4.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r6.xyz, r5.wwww, t5.xyzw  // r6.x <- spotLight1.x; r6.y <- spotLight1.y; r6.z <- spotLight1.z
...
#line 390
  mul r3.x, r3.x, r3.x  // r3.x <- <SmoothDistanceAttenuation_id84 return value>
...
mov r7.yz, v0.yyzy  // r7.y <- streams.PositionWS_id21.y; r7.z <- streams.PositionWS_id21.z
mov r0.yzw, cb1[0].xxyz
...
#line 524
  mul r4.w, r4.w, r7.w  // r4.w <- attenuation
...
#line 791
  add r2.xyz, r7.xyzx, -cb0[28].xyzx  // r2.x <- lightDelta.x; r2.y <- lightDelta.y; r2.z <- lightDelta.z
...
#line 822
  add r2.z, |r2.y|, -cb0[79].x  // r2.z <- lightSpaceZ

#line 823
  div r2.z, cb0[81].y, r2.z
  add r2.z, r2.z, cb0[81].x  // r2.z <- depth
...
#line 818
    mad r5.xyz, r2.yyyy, r6.xyzx, r7.xyzx  // r5.x <- positionWS.x; r5.y <- positionWS.y; r5.z <- positionWS.z

#line 819
    ishl r2.x, r2.x, l(2)
    dp4 r9.x, r5.xyzw, cb0[r2.x + 31].xyzw  // r9.x <- projectedPosition.x
    dp4 r9.y, r5.xyzw, cb0[r2.x + 32].xyzw  // r9.y <- projectedPosition.y
    dp4 r2.x, r5.xyzw, cb0[r2.x + 34].xyzw  // r2.x <- projectedPosition.w

#line 820
    div r2.xy, r9.xyxx, r2.xxxx  // r2.x <- projectedPosition.x; r2.y <- projectedPosition.y

#line 615
    mad r2.xy, r2.xyxx, cb0[30].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
#line 327
    mad r12.xyzw, r10.xwzw, cb0[30].zwzw, r3.ywyw
...
#line 330
    mad r13.xyzw, r10.xyzy, cb0[30].zwzw, r3.ywyw

#line 331
    mad r14.xyzw, r11.xzxw, cb0[30].zwzw, r3.ywyw
...
#line 333
    mad r10.xyzw, r10.xyzy, cb0[30].zwzw, r3.ywyw
    mul r11.zw, r9.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 334
    mad r3.yw, r11.xxxy, cb0[30].zzzw, r3.yyyw
    mul r2.y, r9.y, r9.x

#line 610
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r12.xyxx, t0.xxxx, s0, r2.z  // r5.z <- <SampleTextureAndCompare_id107 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r12.zwzz, t0.xxxx, s0, r2.z  // r7.x <- <SampleTextureAndCompare_id107 return value>

#line 711
    mul r7.x, r7.x, r9.z
    mad r2.x, r2.x, r5.z, r7.x  // r2.x <- shadow

#line 610
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r14.xyxx, t0.xxxx, s0, r2.z  // r5.z <- <SampleTextureAndCompare_id107 return value>

#line 711
    mad r2.x, r5.x, r5.z, r2.x

#line 610
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t0.xxxx, s0, r2.z  // r5.x <- <SampleTextureAndCompare_id107 return value>
...
#line 610
    sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r3.ywyy, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id107 return value>
...
#line 827
  else   // Prior locations: r9.z <- direction.z; r2.x <- faceIndex; r2.z <- depth
    mov r2.xyz, l(1.000000,1.000000,1.000000,0)
  endif 

#line 984
  mul r5.xyz, r4.wwww, cb0[29].xyzx
  mul r2.xyz, r2.xyzx, r5.xyzx
...
#line 970
mul r0.xyz, cb1[0].xyzx, cb2[88].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id222 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id222 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id222 return value>.z
...
float4 Project_id100(float4 vec, float4x4 mat)
{
    float4 vecProjected = mul(vec, mat);
    vecProjected.xyz /= vecProjected.w;
    return vecProjected;
}
float4 Project_id51(float4 vec, float4x4 mat)
{
    float4 vecProjected = mul(vec, mat);
    vecProjected.xyz /= vecProjected.w;
    return vecProjected;
}
float Get3x3FilterKernel_id109(float2 base_uv, float2 st, out float3 kernel[4])
{
    float2 uvW0 = (3 - 2 * st);
    float2 uvW1 = (1 + 2 * st);
...
float Get5x5FilterKernel_id108(float2 base_uv, float2 st, out float3 kernel[9])
{
    float2 uvW0 = (4 - 3 * st);
    float2 uvW1 = 7;
    float2 uvW2 = (1 + 3 * st);
...
float SampleThickness_id110(float3 shadowSpaceCoordinate, float3 pixelPositionWS, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    ...
    {
        float4 shadowmapPositionWorldSpace = Project_id100(float4(shadowSpaceCoordinate.xy, shadowMapDepth, 1.0), inverseWorldToShadowCascadeUV);
        thickness = distance(shadowmapPositionWorldSpace.xyz, pixelPositionWS.xyz);
    }
    return (thickness);
}
float Get7x7FilterKernel_id106(float2 base_uv, float2 st, out float3 kernel[16])
{
    float2 uvW0 = (5 * st - 6);
...
float Get3x3FilterKernel_id61(float2 base_uv, float2 st, out float3 kernel[4])
{
    float2 uvW0 = (3 - 2 * st);
    float2 uvW1 = (1 + 2 * st);
    float2 uv0 = (2 - st) / uvW0 - 1;
...
float Get5x5FilterKernel_id60(float2 base_uv, float2 st, out float3 kernel[9])
{
    float2 uvW0 = (4 - 3 * st);
    float2 uvW1 = 7;
    float2 uvW2 = (1 + 3 * st);
...
float SampleThickness_id62(float3 shadowSpaceCoordinate, float3 pixelPositionWS, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    ...
    {
        float4 shadowmapPositionWorldSpace = Project_id51(float4(shadowSpaceCoordinate.xy, shadowMapDepth, 1.0), inverseWorldToShadowCascadeUV);
        thickness = distance(shadowmapPositionWorldSpace.xyz, pixelPositionWS.xyz);
    }
    return (thickness);
}
float Get7x7FilterKernel_id58(float2 base_uv, float2 st, out float3 kernel[16])
{
    float2 uvW0 = (5 * st - 6);
    float2 uvW1 = (11 * st - 28);
    float2 uvW2 = -(11 * st + 17);
...
float SampleAndFilter_id114(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[9];
        normalizationFactor = Get5x5FilterKernel_id108(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            thickness += kernel[i].z * SampleThickness_id110(float3(kernel[i].xy, adjustedPixelPositionShadowSpace.z), adjustedPixelPositionWS, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
        }
    }
    return (thickness / normalizationFactor);
}
void CalculateAdjustedShadowSpacePixelPosition_id113(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    float4 bottomLeftTexelWS = Project_id100(float4(0.0, 0.0, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id100(float4(ShadowMapTextureTexelSize_id185.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, bottomLeftTexelWS.xyz);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 shadowMapCoordinate = Project_id100(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = shadowMapCoordinate.xyz;
}
void CalculateAdjustedShadowSpacePixelPositionPerspective_id112(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    const float4 shadowMapCoordinate = Project_id100(float4(pixelPositionWS, 1.0), worldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id100(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id185.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, pixelPositionWS);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 adjustedShadowMapCoordinate = Project_id100(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = adjustedShadowMapCoordinate.xyz;
}
float GetFilterRadiusInPixels_id111()
{
...
float GetAngularAttenuation_id86(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float GetDistanceAttenuation_id75(float lightVectorLength, float lightInvSquareRadius)
{
    float d2 = lightVectorLength * lightVectorLength;
    float attenuation = 1.0 / (max(d2, 0.01 * 0.01));
...
float SampleAndFilter_id66(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[9];
        normalizationFactor = Get5x5FilterKernel_id60(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            thickness += kernel[i].z * SampleThickness_id62(float3(kernel[i].xy, adjustedPixelPositionShadowSpace.z), adjustedPixelPositionWS, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
        }
    }
    return (thickness / normalizationFactor);
}
...
{
    float4 bottomLeftTexelWS = Project_id51(float4(0.0, 0.0, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id51(float4(ShadowMapTextureTexelSize_id89.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, bottomLeftTexelWS.xyz);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 shadowMapCoordinate = Project_id51(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = shadowMapCoordinate.xyz;
}
...
{
    const float4 shadowMapCoordinate = Project_id51(float4(pixelPositionWS, 1.0), worldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id51(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id89.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, pixelPositionWS);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 adjustedShadowMapCoordinate = Project_id51(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
    adjustedPixelPositionShadowSpace = adjustedShadowMapCoordinate.xyz;
}
float GetFilterRadiusInPixels_id63()
{
...
float SampleTextureAndCompare_id59(float2 position, float positionDepth)
{
    return ShadowMapTexture_id87.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id122, position, positionDepth);
}
void CalculatePCFKernelParameters_id57(float2 position, out float2 base_uv, out float2 st)
{
...
void CalculatePCFKernelParameters_id105(float2 position, out float2 base_uv, out float2 st)
{
...
float FilterThickness_id101(float3 pixelPositionWS, float3 meshNormalWS, float2 depthRanges, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    float3 adjustedPixelPositionWS;
    float3 adjustedPixelPositionShadowSpace;
    if (isOrthographic)
    {
        CalculateAdjustedShadowSpacePixelPosition_id113(GetFilterRadiusInPixels_id111(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    else
    {
        CalculateAdjustedShadowSpacePixelPositionPerspective_id112(GetFilterRadiusInPixels_id111(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    return SampleAndFilter_id114(adjustedPixelPositionWS, adjustedPixelPositionShadowSpace, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
}
float ComputeAttenuation_id96(PointLightDataInternal light, float3 position, inout float3 lightVectorNorm)
{
    float3 lightVector = light.PositionWS - position;
    float lightVectorLength = length(lightVector);
    lightVectorNorm = lightVector / lightVectorLength;
    float lightInvSquareRadius = light.InvSquareRadius;
    return GetDistanceAttenuation_id97(lightVectorLength, lightInvSquareRadius);
}
float ComputeAttenuation_id87(float3 PositionWS, float3 AngleOffsetAndInvSquareRadius, float3 DirectionWS, float3 position, inout float3 lightVectorNorm)
{
    ...
    float attenuation = GetDistanceAttenuation_id85(lightVectorLength, lightInvSquareRadius);
    attenuation *= GetAngularAttenuation_id86(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    return attenuation;
}
float ComputeAttenuation_id74(PointLightDataInternal light, float3 position, inout float3 lightVectorNorm)
{
    float3 lightVector = light.PositionWS - position;
    float lightVectorLength = length(lightVector);
    lightVectorNorm = lightVector / lightVectorLength;
    float lightInvSquareRadius = light.InvSquareRadius;
    return GetDistanceAttenuation_id75(lightVectorLength, lightInvSquareRadius);
}
float FilterThickness_id53(float3 pixelPositionWS, float3 meshNormalWS, float2 depthRanges, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    float3 adjustedPixelPositionWS;
    float3 adjustedPixelPositionShadowSpace;
    if (isOrthographic)
    {
        CalculateAdjustedShadowSpacePixelPosition_id65(GetFilterRadiusInPixels_id63(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    else
    {
        CalculateAdjustedShadowSpacePixelPositionPerspective_id64(GetFilterRadiusInPixels_id63(), pixelPositionWS, meshNormalWS, worldToShadowCascadeUV, inverseWorldToShadowCascadeUV, adjustedPixelPositionWS, adjustedPixelPositionShadowSpace);
    }
    return SampleAndFilter_id66(adjustedPixelPositionWS, adjustedPixelPositionShadowSpace, depthRanges, inverseWorldToShadowCascadeUV, isOrthographic);
}
float FilterShadow_id52(float2 position, float positionDepth)
{
    float shadow = 0.0f;
    float2 base_uv;
    float2 st;
    CalculatePCFKernelParameters_id57(position, base_uv, st);

    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id60(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            shadow += kernel[i].z * SampleTextureAndCompare_id59(kernel[i].xy, positionDepth);
        }
...
float FilterShadow_id104(float2 position, float positionDepth)
{
    ...
    float2 base_uv;
    float2 st;
    CalculatePCFKernelParameters_id105(position, base_uv, st);

    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id108(base_uv, st, kernel);

        [unroll]
        for (int i = 0; i < 9; ++i)
        {
            shadow += kernel[i].z * SampleTextureAndCompare_id107(kernel[i].xy, positionDepth);
        }
        shadow /= normalizationFactor;
    }
    return shadow;
...
float ComputeThickness_id102(inout PS_STREAMS streams, float3 positionWS, int cascadeIndex)
{
    float tempThickness = 0.0;
    const bool ComputeThickness = true;

    {
        tempThickness = FilterThickness_id101(positionWS, streams.meshNormalWS_id16, float2(0.0f, 1.0f), WorldToShadow_id188[cascadeIndex], InverseWorldToShadow_id189[cascadeIndex], false);
    }
...
void ProcessLight_id98(inout PS_STREAMS streams, PointLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id96(light, streams.PositionWS_id21.xyz, lightVectorNorm);
...
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id87(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id21.xyz, lightVectorNorm);
    streams.lightColor_id42 = light.Color;
    streams.lightAttenuation_id45 = attenuation;
    streams.lightDirectionWS_id41 = lightVectorNorm;
}
...
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id74(light, streams.PositionWS_id21.xyz, lightVectorNorm);
    streams.lightPositionWS_id40 = light.PositionWS;
    streams.lightColor_id42 = light.Color;
    streams.lightAttenuation_id45 = attenuation;
    streams.lightDirectionWS_id41 = lightVectorNorm;
}
float ComputeThicknessFromCascade_id56(float3 pixelPositionWS, float3 meshNormalWS, int cascadeIndex, int lightIndex, bool isOrthographic)
{
    const int arrayIndex = cascadeIndex + lightIndex * TCascadeCountBase_id149;
    return FilterThickness_id53(pixelPositionWS, meshNormalWS, DepthRanges_id154[arrayIndex], WorldToShadowCascadeUV_id151[arrayIndex], InverseWorldToShadowCascadeUV_id152[arrayIndex], isOrthographic);
}
float ComputeShadowFromCascade_id55(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id52(shadowPosition.xy, shadowPosition.z);
}
float3 GetShadowPositionOffset_id54(float offsetScale, float nDotL, float3 normal)
{
    float normalOffsetScale = saturate(1.0f - nDotL);
...
float3 ComputeShadow_id92(inout PS_STREAMS streams, float3 positionWS, int lightIndex)
{
    ...
    streams.thicknessWS_id83 = ComputeThickness_id102(streams, positionWS, cascadeIndex);
    positionWS += GetShadowPositionOffset_id103(OffsetScales_id191[lightIndex], streams.NdotL_id48, streams.normalWS_id18);
    ...
    if (depth < 0 || depth > 1)
        return 1;
    float shadow = FilterShadow_id104(projectedPosition.xy, depth);
    return (shadow);
}
void PrepareDirectLightCore_id91(inout PS_STREAMS streams, int lightIndex)
{
    ...
    ProcessLight_id98(streams, data);
}
...
float3 ComputeShadow_id46(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id54(OffsetScales_id156[lightIndex], streams.NdotL_id48, streams.normalWS_id18);
    if (cascadeIndex < TCascadeCount_id157)
    {
        shadow = ComputeShadowFromCascade_id55(shadowPosition, cascadeIndex, lightIndex);
        ...
        if (splitDist < 0.2)
        {
            ...
            {
                float nextShadow = ComputeShadowFromCascade_id55(shadowPosition, cascadeIndex + 1, lightIndex);
...
void PrepareDirectLightCore_id45(inout PS_STREAMS streams, int lightIndex)
{
    streams.lightColor_id42 = Lights_id86[lightIndex].Color;
    streams.lightDirectionWS_id41 = -Lights_id86[lightIndex].DirectionWS;
}
void ResetStream_id133()
{
}
void AfterLightingAndShading_id229()
{
}
void PrepareEnvironmentLight_id218(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id46 = 0;
    streams.envLightSpecularColor_id47 = 0;
}
float3 ComputeEnvironmentLightContribution_id222(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id167(inout PS_STREAMS streams, int lightIndex)
{
    PrepareDirectLightCore_id69(streams, lightIndex);
    streams.NdotL_id48 = max(dot(streams.normalWS_id18, streams.lightDirectionWS_id41), 0.0001f);
    streams.shadowColor_id82 = ComputeShadow_id70(streams, streams.PositionWS_id21.xyz, lightIndex);
    streams.lightColorNdotL_id43 = streams.lightColor_id42 * streams.lightAttenuation_id45 * streams.shadowColor_id82 * streams.NdotL_id48 * streams.lightDirectAmbientOcclusion_id49;
    streams.lightSpecularColorNdotL_id44 = streams.lightColorNdotL_id43;
    streams.lightColorNdotL_id43 *= ComputeTextureProjection_id71(streams.PositionWS_id21.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id67, streams.normalWS_id18);
    streams.lightSpecularColorNdotL_id44 *= ComputeSpecularTextureProjection_id72(streams.PositionWS_id21.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id172(inout PS_STREAMS streams)
{
    return streams.lightData_id171.y & 0xFFFF;
}
int GetMaxLightCount_id171(inout PS_STREAMS streams)
{
    return streams.lightData_id171.y & 0xFFFF;
}
void PrepareDirectLights_id170(inout PS_STREAMS streams)
{
    PrepareLightData_id76(streams);
}
float3 ComputeDirectLightContribution_id221(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id68;
    return diffuseColor / PI_id198 * streams.lightColorNdotL_id43 * streams.matDiffuseSpecularAlphaBlend_id64.x;
}
...
void PrepareDirectLight_id143(inout PS_STREAMS streams, int lightIndex)
{
    PrepareDirectLightCore_id45(streams, lightIndex);
    streams.NdotL_id48 = max(dot(streams.normalWS_id18, streams.lightDirectionWS_id41), 0.0001f);
    streams.shadowColor_id82 = ComputeShadow_id46(streams, streams.PositionWS_id21.xyz, lightIndex);
    streams.lightColorNdotL_id43 = streams.lightColor_id42 * streams.lightAttenuation_id45 * streams.shadowColor_id82 * streams.NdotL_id48 * streams.lightDirectAmbientOcclusion_id49;
    streams.lightSpecularColorNdotL_id44 = streams.lightColorNdotL_id43;
    streams.lightColorNdotL_id43 *= ComputeTextureProjection_id47(streams.PositionWS_id21.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id67, streams.normalWS_id18);
    streams.lightSpecularColorNdotL_id44 *= ComputeSpecularTextureProjection_id48(streams.PositionWS_id21.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id145()
{
    return LightCount_id84;
}
int GetMaxLightCount_id146()
{
    return TMaxLightCount_id85;
}
void PrepareDirectLights_id141()
{
}
void PrepareForLightingAndShading_id226()
{
}
void PrepareMaterialForLightingAndShading_id132(inout PS_STREAMS streams)
{
...
void ResetLightStream_id131(inout PS_STREAMS streams)
{
...
void Compute_id263(inout PS_STREAMS streams)
{
    UpdateNormalFromTangentSpace_id23(streams.matNormal_id50);
    if (!streams.IsFrontFace_id1)
        streams.normalWS_id18 = -streams.normalWS_id18;
    ResetLightStream_id131(streams);
    PrepareMaterialForLightingAndShading_id132(streams);

    {
        PrepareForLightingAndShading_id226();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id141();
        const int maxLightCount = GetMaxLightCount_id146();
        int count = GetLightCount_id145();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id143(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);

            {
                directLightingContribution += ComputeDirectLightContribution_id221(streams);
            }
        }
    }

    {
        PrepareDirectLights_id170(streams);
        const int maxLightCount = GetMaxLightCount_id171(streams);
        int count = GetLightCount_id172(streams);
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id167(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id222(streams);
        }
    }

    {
        PrepareEnvironmentLight_id218(streams);
