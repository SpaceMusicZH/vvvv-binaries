...
*****     Stages      *****
***************************
@G    Compute => c704c34ea540d455dca90d341e042a82
//
...
//
#line 1497 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_d9a7fe9ec7329b43bcd320dec3b10bbe.hlsl"
...
struct CS_STREAMS 
{
    ...
    float4 TextureValue_27_id129;
    float SMCalcLuminance_ShaderFXResult_29_id137;
    float3 SMVector3Join_ShaderFXResult_30_id284;
    float3 Input_31_id289;
    float3 Multiply_32_id292;
    float3 Input_33_id296;
    float3 Plus_34_id299;
    float3 Input_35_id303;
    float3 Plus_36_id306;
    float3 Input_37_id107;
    ...
    float Multiply_50_id208;
    float3 SMVector3Join_ShaderFXResult_51_id212;
    float3 Input_52_id217;
    float3 Multiply_53_id220;
    float3 Input_54_id224;
    float3 Plus_55_id227;
    uint Input_3_id349;
...
{
    return streams.Multiply_53_id220;
}
float3 Compute_id407(inout CS_STREAMS streams)
{
    return streams.Input_52_id217;
}
float3 Compute_id405(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_51_id212;
}
float Compute_id399(inout CS_STREAMS streams)
{
    return streams.Multiply_50_id208;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_29_id137;
}
...
{
    return streams.TextureValue_27_id129;
}
float Compute_id198()
{
    return Value_id364;
...
{
    return DynamicTexture_id130.SampleLevel(DynamicSampler_id131, Compute_id127(streams), Compute_id125());
}
...
{
    streams.Plus_55_id227 = Compute_id418(streams);
}
void Compute_id438(inout CS_STREAMS streams)
{
    streams.Input_54_id224 = Compute_id411();
}
void Compute_id436(inout CS_STREAMS streams)
{
    streams.Multiply_53_id220 = Compute_id410(streams);
}
void Compute_id434(inout CS_STREAMS streams)
{
    streams.Input_52_id217 = Compute_id403();
}
void Compute_id432(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_51_id212 = Compute_id402(streams);
}
void Compute_id430(inout CS_STREAMS streams)
{
    streams.Multiply_50_id208 = Compute_id394(streams);
}
void Compute_id428(inout CS_STREAMS streams)
{
    streams.Multiply_49_id204 = Compute_id388(streams);
}
void Compute_id426(inout CS_STREAMS streams)
{
    streams.Multiply_48_id200 = Compute_id382(streams);
}
void Compute_id424(inout CS_STREAMS streams)
{
    streams.Input_47_id197 = Compute_id375();
}
...
{
    streams.Multiply_46_id179 = Compute_id274(streams);
}
...
{
    streams.Multiply_43_id168 = Compute_id260(streams);
}
void Compute_id298(inout CS_STREAMS streams)
{
    streams.Input_42_id165 = Compute_id253();
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_41_id160 = Compute_id252(streams);
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.Multiply_40_id156 = Compute_id244(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.Multiply_39_id152 = Compute_id238(streams);
}
void Compute_id290(inout CS_STREAMS streams)
{
    streams.Multiply_38_id148 = Compute_id232(streams);
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_29_id137 = Compute_id226(streams);
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.TextureValue_27_id129 = Compute_id203(streams);
}
void Compute_id284()
{
}
...
{
    streams.Input_37_id107 = Compute_id169();
}
void Compute_id600(inout CS_STREAMS streams)
{
    streams.Plus_36_id306 = Compute_id564(streams);
}
void Compute_id598(inout CS_STREAMS streams)
{
    streams.Input_35_id303 = Compute_id557();
}
void Compute_id596(inout CS_STREAMS streams)
{
    streams.Plus_34_id299 = Compute_id556(streams);
}
void Compute_id594(inout CS_STREAMS streams)
{
    streams.Input_33_id296 = Compute_id549();
}
void Compute_id592(inout CS_STREAMS streams)
{
    streams.Multiply_32_id292 = Compute_id548(streams);
}
void Compute_id590(inout CS_STREAMS streams)
{
    streams.Input_31_id289 = Compute_id541();
}
void Compute_id588(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_30_id284 = Compute_id540(streams);
}
void Compute_id586(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_29_id137 = Compute_id532(streams);
}
void Compute_id584(inout CS_STREAMS streams)
{
    streams.TextureValue_27_id129 = Compute_id509(streams);
}
void Compute_id582()
{
}
...
{
    streams.Lerp_12_id372 = Compute_id140(streams);
}
void Compute_id161(inout CS_STREAMS streams)
{
    streams.Input_11_id369 = Compute_id131();
}
