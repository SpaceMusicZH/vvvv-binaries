...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin SMVideoBufferSelector_ShaderFX
***************************
*****     Sources     *****
***************************
...
cbuffer Globals 
{
    ...
    float2 SamplerOffset_id86;
    float2 SamplerScale_id87 = float2(1, 1);
    uint PlacementLevelCount_id88 = 1048576;
};
...
StructuredBuffer<float4> VoxelVolume_id83;
void Compute_id1()
{
}
[numthreads(1, 1, 1)]
