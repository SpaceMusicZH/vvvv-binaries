...
@S    SMBoxImpostor_ShaderFX => d13152beb19565469730b47d9e8f217e
...
//
#line 1696 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_1839746e522b35e49e40a00a6c00b4ed.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => c051f64d707e770278606d64dcaeb375
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1660 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_1839746e522b35e49e40a00a6c00b4ed.hlsl"
...
#line 1670
dp3 r3.x, r0.xyzx, cb0[4].xyzx  // r3.x <- viewDir.x
dp3 r3.y, r0.xyzx, cb0[5].xyzx  // r3.y <- viewDir.y
dp3 r3.z, r0.xyzx, cb0[6].xyzx  // r3.z <- viewDir.z
...
#line 1591
  dp3 r0.x, r7.yzwy, cb0[0].xyzx  // r0.x <- normal.x
  dp3 r0.y, r7.yzwy, cb0[1].xyzx  // r0.y <- normal.y
  dp3 r0.z, r7.yzwy, cb0[2].xyzx  // r0.z <- normal.z
...
#line 1591
  dp3 r0.x, r4.xyzx, cb0[0].xyzx  // r0.x <- normal.x
  dp3 r0.y, r4.xyzx, cb0[1].xyzx  // r0.y <- normal.y
  dp3 r0.z, r4.xyzx, cb0[2].xyzx  // r0.z <- normal.z
...
#line 1591
  dp3 r0.x, r5.xyzx, cb0[0].xyzx  // r0.x <- normal.x
  dp3 r0.y, r5.xyzx, cb0[1].xyzx  // r0.y <- normal.y
  dp3 r0.z, r5.xyzx, cb0[2].xyzx  // r0.z <- normal.z
...
//
#line 1642 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_1839746e522b35e49e40a00a6c00b4ed.hlsl"
...
{
    normal = mul(float4(normal, 0), World_id34).xyz;
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    viewDir = mul(float4(viewDir, 0), WorldInverse_id35);
