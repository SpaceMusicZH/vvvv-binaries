...
//
#line 202 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_eecd95c37e8a01c724afe5a564ebb1a6.hlsl"
...
#line 109
      ...
      mul r2.w, r5.x, r5.x
      mad r9.w, r2.w, r1.w, r7.x  // r9.w <- <rot3D_id53 return value>._m22
...
void Compute_id58(inout CS_STREAMS streams)
{
    ...
    uint n = sbSize3_id4(PositionBuffer_id43);
    if (dtid >= n)
        return;
    ...
    if (MeshType_id46 == 0)
    {
        FlatMeshLineStrip_id55(outputBuffer_id44, dtid - lineId, lineId, segmentId, p, t, scale, Compute_id60(), segmentCount, NormalBend_id49, ViewAlign_id48 ? normalize(viewDir) : Compute_id62());
    }
    else
    {
        TubeMeshLineStrip_id57(outputBuffer_id44, dtid - lineId, lineId, segmentId, p, t, scale, Compute_id60(), segmentCount, Resolution_id50, Compute_id61());
    }
}
[numthreads(1, 1, 1)]
