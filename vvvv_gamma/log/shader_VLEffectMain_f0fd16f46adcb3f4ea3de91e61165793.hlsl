...
//   float4x4 WorldToShadowCascadeUV_id153;// Offset:  464 Size:    64 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id154;// Offset:  528 Size:    64 [unused]
//   float4x4 ViewMatrices_id155;       // Offset:  592 Size:    64 [unused]
//   float2 DepthRanges_id156;          // Offset:  656 Size:     8 [unused]
//   float DepthBiases_id157;           // Offset:  672 Size:     4 [unused]
//   float OffsetScales_id158;          // Offset:  688 Size:     4 [unused]
//   float CascadeDepthSplits_id165;    // Offset:  704 Size:     4 [unused]
//   float ClusterDepthScale_id177;     // Offset:  708 Size:     4 [unused]
//   float ClusterDepthBias_id178;      // Offset:  712 Size:     4 [unused]
//   float2 ClusterStride_id179;        // Offset:  720 Size:     8 [unused]
//   float3 AmbientLight_id200;         // Offset:  736 Size:    12 [unused]
//   float3 SphericalColors_id205[9];   // Offset:  752 Size:   140 [unused]
//   float MipCount_id206;              // Offset:  892 Size:     4 [unused]
//   float4x4 SkyMatrix_id208;          // Offset:  896 Size:    64 [unused]
//   float Intensity_id209;             // Offset:  960 Size:     4 [unused]
...
//
#line 1481 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f0fd16f46adcb3f4ea3de91e61165793.hlsl"
...
@G    Pixel => dfed7918a1b603f236cea76ab3bcacf3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4x4 WorldToShadowCascadeUV_id153;// Offset:  464 Size:    64
//   float4x4 InverseWorldToShadowCascadeUV_id154;// Offset:  528 Size:    64 [unused]
//   float4x4 ViewMatrices_id155;       // Offset:  592 Size:    64 [unused]
//   float2 DepthRanges_id156;          // Offset:  656 Size:     8 [unused]
//   float DepthBiases_id157;           // Offset:  672 Size:     4
//   float OffsetScales_id158;          // Offset:  688 Size:     4
//   float CascadeDepthSplits_id165;    // Offset:  704 Size:     4 [unused]
//   float ClusterDepthScale_id177;     // Offset:  708 Size:     4
//   float ClusterDepthBias_id178;      // Offset:  712 Size:     4
//   float2 ClusterStride_id179;        // Offset:  720 Size:     8
//   float3 AmbientLight_id200;         // Offset:  736 Size:    12
//   float3 SphericalColors_id205[9];   // Offset:  752 Size:   140
//   float MipCount_id206;              // Offset:  892 Size:     4
//   float4x4 SkyMatrix_id208;          // Offset:  896 Size:    64
//   float Intensity_id209;             // Offset:  960 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset:  976 Size:    16 [unused]
//
// }
//
...
//
#line 1548 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f0fd16f46adcb3f4ea3de91e61165793.hlsl"
...
#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r13.xyxx, t2.xxxx, s1, r7.z  // r2.w <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.zwzz, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
...
#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id68 return value>

#line 681
  mad r2.w, r6.z, r3.w, r2.w

#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.xyxx, t2.xxxx, s1, r7.z

#line 681
  mad r2.w, r11.x, r3.w, r2.w

#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t2.xxxx, s1, r7.z

#line 681
  mad r2.w, r8.y, r3.w, r2.w

#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.zwzz, t2.xxxx, s1, r7.z
...
#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r19.zwzz, t2.xxxx, s1, r7.z

#line 681
  mad r2.w, r10.z, r3.w, r2.w

#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r10.ywyy, t2.xxxx, s1, r7.z
...
#line 651
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id180 return value>.x; r8.y <- <FresnelSchlick_id180 return value>.y; r8.z <- <FresnelSchlick_id180 return value>.z
...
#line 647
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id196 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id196 return value>

#line 769
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id198 return value>
...
#line 765
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id210 return value>
...
#line 1130
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id251 return value>
...
#line 651
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id180 return value>.x; r13.y <- <FresnelSchlick_id180 return value>.y; r13.z <- <FresnelSchlick_id180 return value>.z
...
#line 647
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id196 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id196 return value>
...
#line 651
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id180 return value>.x; r16.y <- <FresnelSchlick_id180 return value>.y; r16.z <- <FresnelSchlick_id180 return value>.z
...
#line 647
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id196 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id196 return value>

#line 769
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id198 return value>
...
#line 765
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id210 return value>
...
#line 324
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id104 return value>
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r19.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id118 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r19.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id118 return value>
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r21.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id118 return value>
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id118 return value>
...
#line 651
  ...
  mul r4.w, r4.w, r4.w
  mul r1.w, r1.w, r4.w
  mad r16.xyz, r16.xyzx, r1.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id180 return value>.x; r16.y <- <FresnelSchlick_id180 return value>.y; r16.z <- <FresnelSchlick_id180 return value>.z
...
#line 647
  ...
  div r5.w, r3.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id196 return value>
  mad r1.w, r12.z, r4.w, r1.w
  div r1.w, r12.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id196 return value>

#line 769
  mul r1.w, r1.w, r5.w
  mul r3.w, r12.z, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id198 return value>
...
#line 765
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id210 return value>
...
#line 1055
mul r2.xyz, r0.yzwy, cb2[46].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id539 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id539 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id539 return value>.z

#line 1351
mad r2.xyz, r5.xyzx, cb2[46].xyzx, r2.xyzx  // r2.x <- environmentLightingContribution.x; r2.y <- environmentLightingContribution.y; r2.z <- environmentLightingContribution.z
...
#line 710
mad r6.xyz, cb2[48].xyzx, r2.wwww, cb2[47].xyzx  // r6.x <- color.x; r6.y <- color.y; r6.z <- color.z

#line 711
mad r6.xyz, cb2[49].xyzx, -r3.wwww, r6.xyzx

#line 712
mad r6.xyz, cb2[50].xyzx, r1.wwww, r6.xyzx

#line 715
mul r7.xyz, r2.wwww, cb2[51].xyzx
mad r6.xyz, r7.xyzx, r1.wwww, r6.xyzx

#line 716
mul r7.xyz, r2.wwww, cb2[52].xyzx
mad r6.xyz, r7.xyzx, -r3.wwww, r6.xyzx

#line 717
mad r2.w, r4.y, l(3.000000), l(-1.000000)
mad r4.yzw, cb2[53].xxyz, r2.wwww, r6.xxyz  // r4.y <- color.x; r4.z <- color.y; r4.w <- color.z
...
mad r4.xyz, cb2[55].xyzx, r1.wwww, r4.yzwy  // r4.x <- color.x; r4.y <- color.y; r4.z <- color.z

#line 1046
mul r4.xyz, r4.xyzx, cb2[60].xxxx  // r4.x <- streams.envLightDiffuseColor_id47.x; r4.y <- streams.envLightDiffuseColor_id47.y; r4.z <- streams.envLightDiffuseColor_id47.z
...
const static int TCascadeCountBase_id151 = 1;
const static int TLightCountBase_id152 = 1;
const static int TCascadeCount_id159 = 1;
...
const static int TFilterSize_id199 = 5;
...
float FilterShadow_id112(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id119(base_uv, st, kernel);
