...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_Dot_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    BackgroundColor_id88 => Hatch_Dot_TextureFX.BackgroundColor
@C    HatchColor_id89 => Hatch_Dot_TextureFX.HatchColor
@C    Threshold_id90 => Hatch_Dot_TextureFX.Threshold
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Hatch_Dot_TextureFX => eeecd4adafbb4f0c6ea2e317241fdb9d
...
//
#line 177 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_b437901d85671fdcca3b502a39cad243.hlsl"
...
@G    Pixel => 2347ace5fe4fb0ed30c9514c4b6be03d
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 149 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_b437901d85671fdcca3b502a39cad243.hlsl"
mad r0.xy, v1.xyxx, cb1[1].xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)  // r0.x <- x.x; r0.y <- x.y

#line 152
mad r0.x, r0.x, l(5.000000), r0.y
mul r0.y, r0.x, l(8.000000)
ge r0.y, r0.y, -r0.y
movc r0.yz, r0.yyyy, l(0,8.000000,0.125000,0), l(0,-8.000000,-0.125000,0)
mul r0.x, r0.z, r0.x
frc r0.x, r0.x
mul r0.x, r0.x, r0.y
...
#line 151
sqrt r0.y, r1.z  // r0.y <- col.z

#line 152
mul r0.y, r0.y, cb2[7].x
lt r0.x, r0.x, r0.y
...
mad r0.xyzw, r0.xyzw, r2.xyzw, cb2[6].xyzw  // r0.x <- <Filter_id29 return value>.x; r0.y <- <Filter_id29 return value>.y; r0.z <- <Filter_id29 return value>.z; r0.w <- <Filter_id29 return value>.w
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    return lerp(HatchColor_id89, BackgroundColor_id88, any(((x.x * 5.0 + x.y) % 8.0 < col.b * Threshold_id90)) * float4(1, 1, 1, col.a));
}
