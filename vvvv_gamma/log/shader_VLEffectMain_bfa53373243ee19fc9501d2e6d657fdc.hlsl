...
//
#line 1785 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bfa53373243ee19fc9501d2e6d657fdc.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
mov o3.xyz, v2.xyzx
...
//
#line 1743 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bfa53373243ee19fc9501d2e6d657fdc.hlsl"
...
@G    Pixel => e6748d690b560ed522d5153df815bd19
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1640 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bfa53373243ee19fc9501d2e6d657fdc.hlsl"
...
#line 737
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r9.xyz, r9.xyzx, r1.wwww, r6.xyzx  // r9.x <- <FresnelSchlick_id223 return value>.x; r9.y <- <FresnelSchlick_id223 return value>.y; r9.z <- <FresnelSchlick_id223 return value>.z
...
#line 733
  ...
  div r4.w, r2.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id239 return value>
...
#line 863
  mul r1.w, r1.w, r4.w
  mul r2.w, r7.y, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 859
  ...
  div r0.w, r2.w, r0.w  // r0.w <- <NormalDistributionGGX_id253 return value>
...
#line 1281
  mul r8.xyz, r8.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r8.x <- <ComputeDirectLightContribution_id593 return value>.x; r8.y <- <ComputeDirectLightContribution_id593 return value>.y; r8.z <- <ComputeDirectLightContribution_id593 return value>.z
...
ftoi r8.xy, r2.xyxx
mov r8.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r2.xy, r8.xyzw, t4.xyzw  // r2.x <- streams.lightData_id186.x; r2.y <- streams.lightData_id186.y

#line 1268
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id294 return value>
...
#line 1039
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r7.zzzz, t5.yzwx  // r2.w <- realLightIndex
...
#line 1042
  ishl r3.w, r2.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyzw, r3.wwww, t6.xyzw  // r14.x <- pointLight1.x; r14.y <- pointLight1.y; r14.z <- pointLight1.z; r14.w <- pointLight1.w

#line 1043
  bfi r2.w, l(31), l(1), r2.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r15.xyz, r2.wwww, t6.xyzw  // r15.x <- pointLight2.x; r15.y <- pointLight2.y; r15.z <- pointLight2.z
...
#line 737
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r14.xyz, r14.xyzx, r4.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id223 return value>.x; r14.y <- <FresnelSchlick_id223 return value>.y; r14.z <- <FresnelSchlick_id223 return value>.z
...
#line 733
  ...
  div r6.w, r3.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r4.w, r7.w, r5.w, r4.w
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id239 return value>
...
#line 1246
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id306 return value>
...
#line 1011
  ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r1.wwww, t5.yzwx  // r3.w <- realLightIndex
...
#line 1014
  ishl r4.w, r3.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r4.wwww, t7.xyzw  // r14.x <- spotLight1.x; r14.y <- spotLight1.y; r14.z <- spotLight1.z
...
#line 737
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r16.xyz, r16.xyzx, r5.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z
...
#line 733
  ...
  div r7.w, r4.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r5.w, r3.z, r6.w, r5.w
  div r5.w, r3.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id239 return value>
...
#line 381
  mul r3.x, r3.x, r3.x  // r3.x <- <SmoothDistanceAttenuation_id136 return value>
...
#line 737
  ...
  mul r4.w, r4.w, r4.w
  mul r3.x, r3.x, r4.w
  mad r16.xyz, r16.xyzx, r3.xxxx, r11.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z
...
#line 733
  ...
  div r3.x, r3.z, r3.x  // r3.x <- <VisibilityhSchlickGGX_id239 return value>

#line 863
  mul r3.x, r3.x, r5.w
  mul r3.w, r3.z, r3.w
  div r3.x, r3.x, r3.w  // r3.x <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 1485
mov r2.xyw, r1.xyxz
mov r8.y, r2.z  // r8.y <- streams.alphaRoughness_id70
mov r8.z, r7.y  // r8.z <- streams.NdotV_id72
mov r9.xyz, r0.xyzx  // r9.x <- streams.normalWS_id19.x; r9.y <- streams.normalWS_id19.y; r9.z <- streams.normalWS_id19.z
mov r10.xyz, r4.xyzx  // r10.z <- streams.viewWS_id68.z; r10.x <- streams.viewWS_id68.x; r10.y <- streams.viewWS_id68.y
mov r11.xyz, r5.xyzx  // r11.x <- streams.matDiffuseVisible_id69.x; r11.y <- streams.matDiffuseVisible_id69.y; r11.z <- streams.matDiffuseVisible_id69.z
mov r12.xyz, r6.xyzx  // r12.x <- streams.matSpecularVisible_id71.x; r12.y <- streams.matSpecularVisible_id71.y; r12.z <- streams.matSpecularVisible_id71.z
...
#line 685
  add r15.xyz, -r2.xywx, cb0[r4.w + 61].xyzx  // r15.x <- lightVector.x; r15.y <- lightVector.y; r15.z <- lightVector.z
...
#line 373
  mul r5.w, r5.w, cb0[r4.w + 63].z  // r5.w <- factor
...
#line 375
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id147 return value>

#line 551
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation

#line 542
  dp3 r6.w, -cb0[r4.w + 62].xyzx, r15.xyzx  // r6.w <- cd

#line 543
  mad_sat r6.w, r6.w, cb0[r4.w + 63].x, cb0[r4.w + 63].y  // r6.w <- attenuation
...
#line 820
  mul r7.w, r0.w, cb0[r1.w + 98].x
  mul r7.z, r7.z, r7.w

#line 956
  mad r3.xyz, r7.zzzz, r9.xyzx, r2.xywx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 812
  dp4 r16.x, r3.xyzw, cb0[r4.w + 70].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r3.xyzw, cb0[r4.w + 71].xyzw  // r16.y <- shadowPosition.y
  dp4 r7.z, r3.xyzw, cb0[r4.w + 72].xyzw  // r7.z <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb0[r4.w + 73].xyzw  // r3.x <- shadowPosition.w

#line 813
  add r16.z, r7.z, -cb0[r1.w + 96].x  // r16.z <- shadowPosition.z

#line 814
  div r3.xyz, r16.xyzx, r3.xxxx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 535
  mad r3.xy, r3.xyxx, cb0[69].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r7.zw, r3.xxxy  // r7.z <- base_uv.x; r7.w <- base_uv.y

#line 536
  add r3.xy, r3.xyxx, -r7.zwzz  // r3.x <- st.x; r3.y <- st.y

#line 537
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)

#line 538
  mul r7.zw, r7.zzzw, cb0[69].zzzw

#line 471
  mad r8.xw, -r3.yyyx, l(2.000000, 0.000000, 0.000000, 2.000000), l(3.000000, 0.000000, 0.000000, 3.000000)  // r8.x <- uvW0.y; r8.w <- uvW0.x

#line 472
  mad r16.xy, r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r16.x <- uvW1.x; r16.y <- uvW1.y

#line 473
  add r16.zw, -r3.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000)
  div r16.zw, r16.zzzw, r8.wwwx
  add r17.zw, r16.zzzw, l(0.000000, 0.000000, -1.000000, -1.000000)  // r17.z <- uv0.x; r17.w <- uv0.y

#line 474
  div r3.xy, r3.xyxx, r16.xyxx
  add r17.xy, r3.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)  // r17.x <- uv1.x; r17.y <- uv1.y

#line 475
  mul r3.x, r8.x, r8.w

#line 476
  mad r18.xyzw, r17.zwxw, cb0[69].zwzw, r7.zwzw

#line 477
  mul r8.xw, r8.xxxw, r16.xxxy

#line 478
  mad r17.xyzw, r17.zyxy, cb0[69].zwzw, r7.zwzw
  mul r3.y, r16.y, r16.x

#line 502
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r18.xyxx, t0.xxxx, s1, r3.z  // r7.z <- <SampleTextureAndCompare_id161 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.zwzz, t0.xxxx, s1, r3.z  // r7.w <- <SampleTextureAndCompare_id161 return value>

#line 677
  mul r7.w, r7.w, r8.x
  mad r3.x, r3.x, r7.z, r7.w  // r3.x <- shadow

#line 502
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r17.xyxx, t0.xxxx, s1, r3.z  // r7.z <- <SampleTextureAndCompare_id161 return value>

#line 677
  mad r3.x, r8.w, r7.z, r3.x

#line 502
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r17.zwzz, t0.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id161 return value>

#line 677
  mad r3.x, r3.y, r3.z, r3.x

#line 679
  mul r3.x, r3.x, l(0.062500)

#line 1190
  mul r16.xyz, r5.wwww, cb0[r4.w + 64].xyzx
  mul r3.xyz, r3.xxxx, r16.xyzx
...
#line 1291
  dp3_sat r4.w, r9.xyzx, r16.xyzx  // r4.w <- streams.NdotH_id76

#line 1292
  dp3_sat r5.w, r15.xyzx, r16.xyzx  // r5.w <- streams.LdotH_id77

#line 1286
  mul r15.xyz, r3.xyzx, r11.xyzx
...
#line 737
  ...
  mul r7.z, r7.z, r7.z
  mul r5.w, r5.w, r7.z
  mad r16.xyz, r16.xyzx, r5.wwww, r12.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z

#line 732
  mul r5.w, r8.y, l(0.500000)  // r5.w <- k

#line 733
  mad r7.z, -r8.y, l(0.500000), l(1.000000)
  mad r7.w, r6.w, r7.z, r5.w
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r5.w, r8.z, r7.z, r5.w
  div r5.w, r8.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id239 return value>

#line 863
  mul r5.w, r5.w, r7.w
  mul r6.w, r8.z, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 1499
  mad r14.xyz, r3.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r15.xyzx  // r14.x <- directLightingContribution.x; r14.y <- directLightingContribution.y; r14.z <- directLightingContribution.z
...
#line 938
mad r1.xyz, r6.xyzx, r1.xxxx, r1.yyyy  // r1.x <- <Compute_id415 return value>.x; r1.y <- <Compute_id415 return value>.y; r1.z <- <Compute_id415 return value>.z

#line 1171
mul r2.xyz, r1.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id594 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id594 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id594 return value>.z
...
#line 923
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r4.xyzx, t8.xyzw, s0, r0.x  // r0.x <- <Compute_id365 return value>.x; r0.y <- <Compute_id365 return value>.y; r0.z <- <Compute_id365 return value>.z
...
mov o0.w, l(1.000000)
ret 
// Approximately 614 instruction slots used
***************************
*************************/
...
float FilterShadow_id155(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id163(base_uv, st, kernel);
...
{
    streams.Input_2_id245 = Compute_id403();
}
void Compute_id394(inout PS_STREAMS streams)
{
    streams.Input_1_id236 = Compute_id391();
}
void Compute_id382(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id228 = Compute_id379(streams);
}
float4 EvaluateSphericalHarmonics_id177(float3 sphericalColors[TOrder_id218 * TOrder_id218], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id151(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id150(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float4 Compute_id365(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id360(float3 direction)
{
    return EvaluateSphericalHarmonics_id177(SphericalColors_id221, direction);
}
...
float3 Compute_id415(float3 specularColor, float alphaR, float nDotV)
{
...
float3 ComputeShadow_id144(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id157(OffsetScales_id212[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
...
void AfterLightingAndShading_id564()
{
}
void AfterLightingAndShading_id545()
{
}
...
void PrepareEnvironmentLight_id375(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id360(sampleDirection).rgb * Intensity_id225 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id365(streams, sampleDirection).rgb * Intensity_id225 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id594(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id415(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id538(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id327(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id155 = ComputeShadow_id144(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id44 *= ComputeTextureProjection_id145(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id45 *= ComputeSpecularTextureProjection_id146(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id329()
{
    return LightCount_id198;
}
int GetMaxLightCount_id330()
{
    return TMaxLightCount_id199;
}
void PrepareDirectLights_id325()
{
}
...
float3 ComputeDirectLightContribution_id593(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id447(streams, specularColor);
    float geometricShadowing = Compute_id477(streams);
    float normalDistribution = Compute_id507(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id537(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareForLightingAndShading_id561()
{
}
void PrepareForLightingAndShading_id542()
{
}
...
void Compute_id625(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id542();
    }

    {
        PrepareForLightingAndShading_id561();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id537(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id593(streams);
            }
        }
    }
    ...
    {
        PrepareDirectLights_id325();
        const int maxLightCount = GetMaxLightCount_id330();
        int count = GetLightCount_id329();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id327(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id538(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id594(streams);
        }
    }
    ...
    {
        AfterLightingAndShading_id545();
    }

    {
        AfterLightingAndShading_id564();
    }
}
void Compute_id609(inout PS_STREAMS streams)
{
    float metalness = Compute_id414(streams).r;
...
{
    float glossiness = Compute_id402(streams).r;
...
{
    float4 colorBase = Compute_id390(streams);
