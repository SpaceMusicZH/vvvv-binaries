...
@G    Pixel => 0e274804a21a499501e80a2149cd60a3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r8.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id60 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.y, r8.zwzz, t0.xxxx, s0, r3.w  // r5.y <- <SampleTextureAndCompare_id60 return value>
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r10.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id60 return value>

#line 504
  mad r3.y, r4.z, r5.x, r3.y

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r9.xyxx, t0.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id60 return value>
...
#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t0.xxxx, s0, r3.w  // r3.w <- <SampleTextureAndCompare_id60 return value>
...
#line 445
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r8.xyxx, t0.xxxx, s0, r2.z  // r3.w <- <SampleTextureAndCompare_id60 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r8.zwzz, t0.xxxx, s0, r2.z  // r4.w <- <SampleTextureAndCompare_id60 return value>
...
#line 445
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r10.xyxx, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id60 return value>
...
#line 739
  ...
  mul r2.xyz, r2.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id170 return value>.x; r2.y <- <ComputeDirectLightContribution_id170 return value>.y; r2.z <- <ComputeDirectLightContribution_id170 return value>.z
