...
@P   - DepthAwareDirectionalBlur.Count: 5
@P DepthAwareDirectionalBlur.TotalTap: 9
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 198 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_DepthAwareDirectionalBlurEffect_16b50e4e7893d5d946f9de5b641ad25d.hlsl"
...
@G    Pixel => aae700354aa70a3ac7ea33d4f0ee0e9c
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float TapWeights_id62[5];          // Offset:   96 Size:    68
//   float CoCReference_id63;           // Offset:  164 Size:     4 [unused]
//
// }
//
//
...
//
#line 134 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_DepthAwareDirectionalBlurEffect_16b50e4e7893d5d946f9de5b641ad25d.hlsl"
mul r0.x, cb0[5].z, l(0.250000)
mul r0.xyzw, r0.xxxx, cb0[0].xyxy  // r0.z <- tapOffset.x; r0.w <- tapOffset.y

#line 145
mul r1.xyzw, r0.xyzw, cb0[5].xyxy
mad r2.xyzw, -r1.xyzw, l(3.000000, 3.000000, 4.000000, 4.000000), v1.xyxy  // r2.z <- tapUV.x; r2.w <- tapUV.y
...
#line 163
mul r3.xyzw, r3.xyzw, cb0[9].xxxx

#line 148
mul r2.xyz, r2.wwww, r2.xyzx

#line 163
mad r2.xyzw, r2.xyzw, cb0[10].xxxx, r3.xyzw  // r2.x <- resultColor.x; r2.y <- resultColor.y; r2.z <- resultColor.z; r2.w <- resultColor.w

#line 145
mad r0.xy, -r1.zwzz, l(2.000000, 2.000000, 0.000000, 0.000000), v1.xyxx  // r0.x <- tapUV.x; r0.y <- tapUV.y
...
#line 163
mad r2.xyzw, r3.xyzw, cb0[8].xxxx, r2.xyzw

#line 145
mad r0.xy, -cb0[5].xyxx, r0.zwzz, v1.xyxx

#line 150
mad r0.zw, cb0[5].xxxy, r0.zzzw, v1.xxxy  // r0.z <- tapUV.x; r0.w <- tapUV.y
...
#line 163
mad r0.xyzw, r0.xyzw, cb0[7].xxxx, r2.xyzw  // r0.x <- resultColor.x; r0.y <- resultColor.y; r0.z <- resultColor.z; r0.w <- resultColor.w
...
#line 163
mad r0.xyzw, r2.xyzw, cb0[6].xxxx, r0.xyzw

#line 153
mul r3.xyz, r3.wwww, r3.xyzx

#line 163
mad r0.xyzw, r3.xyzw, cb0[7].xxxx, r0.xyzw

#line 150
mad r2.xy, r1.zwzz, l(2.000000, 2.000000, 0.000000, 0.000000), v1.xyxx  // r2.x <- tapUV.x; r2.y <- tapUV.y
mad r1.xyzw, r1.xyzw, l(3.000000, 3.000000, 4.000000, 4.000000), v1.xyxy  // r1.z <- tapUV.x; r1.w <- tapUV.y
...
#line 163
mad r0.xyzw, r2.xyzw, cb0[8].xxxx, r0.xyzw
...
#line 163
mad r0.xyzw, r2.xyzw, cb0[9].xxxx, r0.xyzw

#line 153
mul r1.xyz, r1.wwww, r1.xyzx

#line 163
mad r0.xyzw, r1.xyzw, cb0[10].xxxx, r0.xyzw

#line 164
add r1.x, cb0[9].x, cb0[10].x  // r1.x <- totalWeight
...
***************************
*************************/
const static int TWeightCount_id58 = 5;
const static int TTotalNumber_id59 = 9;
struct PS_STREAMS 
{
