...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,5>, LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<2>, ShadowMapReceiverSpot<2,false>, ShadowMapFilterPcf<PerDraw.Lighting,3>
...
//
#line 1673 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_02096d27c719e9da2bba3a5009d07e0b.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
mov o3.xyz, v2.xyzx
...
//
#line 1631 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_02096d27c719e9da2bba3a5009d07e0b.hlsl"
...
@G    Pixel => 5773262f338c962923f9e0be1015bf1a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1528 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_02096d27c719e9da2bba3a5009d07e0b.hlsl"
...
#line 701
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r9.xyz, r9.xyzx, r1.wwww, r6.xyzx  // r9.x <- <FresnelSchlick_id212 return value>.x; r9.y <- <FresnelSchlick_id212 return value>.y; r9.z <- <FresnelSchlick_id212 return value>.z
...
#line 697
  ...
  div r4.w, r2.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id228 return value>
...
#line 819
  mul r1.w, r1.w, r4.w
  mul r2.w, r7.y, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id230 return value>
...
#line 815
  ...
  div r0.w, r2.w, r0.w  // r0.w <- <NormalDistributionGGX_id242 return value>
...
#line 1180
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id283 return value>
...
#line 701
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r14.xyz, r14.xyzx, r4.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id212 return value>.x; r14.y <- <FresnelSchlick_id212 return value>.y; r14.z <- <FresnelSchlick_id212 return value>.z
...
#line 697
  ...
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id228 return value>
...
#line 1158
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id295 return value>
...
#line 701
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r16.xyz, r16.xyzx, r5.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id212 return value>.x; r16.y <- <FresnelSchlick_id212 return value>.y; r16.z <- <FresnelSchlick_id212 return value>.z
...
#line 697
  ...
  div r7.w, r4.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id228 return value>
  mad r5.w, r3.z, r6.w, r5.w
  div r5.w, r3.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id228 return value>
...
#line 776
  ...
  dp4 r7.z, r3.xyzw, cb0[r4.w + 40].xyzw  // r7.z <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb0[r4.w + 41].xyzw  // r3.x <- shadowPosition.w

#line 777
  add r16.z, r7.z, -cb0[r1.w + 64].x  // r16.z <- shadowPosition.z
...
#line 467
  mad r18.xyzw, r17.zwxw, cb0[37].zwzw, r7.zwzw

#line 468
  mul r8.xw, r8.xxxw, r16.xxxy

#line 469
  mad r17.xyzw, r17.zyxy, cb0[37].zwzw, r7.zwzw
  mul r3.y, r16.y, r16.x

#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r18.xyxx, t0.xxxx, s1, r3.z  // r7.z <- <SampleTextureAndCompare_id150 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.zwzz, t0.xxxx, s1, r3.z  // r7.w <- <SampleTextureAndCompare_id150 return value>
...
#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r17.xyxx, t0.xxxx, s1, r3.z  // r7.z <- <SampleTextureAndCompare_id150 return value>

#line 654
  mad r3.x, r8.w, r7.z, r3.x

#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r17.zwzz, t0.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id150 return value>
...
#line 701
  ...
  mul r7.z, r7.z, r7.z
  mul r5.w, r5.w, r7.z
  mad r16.xyz, r16.xyzx, r5.wwww, r13.xyzx  // r16.x <- <FresnelSchlick_id212 return value>.x; r16.y <- <FresnelSchlick_id212 return value>.y; r16.z <- <FresnelSchlick_id212 return value>.z
...
#line 697
  ...
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id228 return value>
  mad r5.w, r8.z, r7.z, r5.w
  div r5.w, r8.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id228 return value>

#line 819
  mul r5.w, r5.w, r7.w
  mul r6.w, r8.z, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id230 return value>
...
#line 815
  ...
  div r4.w, r6.w, r4.w  // r4.w <- <NormalDistributionGGX_id242 return value>
...
mov o0.w, l(1.000000)
ret 
// Approximately 541 instruction slots used
***************************
*************************/
