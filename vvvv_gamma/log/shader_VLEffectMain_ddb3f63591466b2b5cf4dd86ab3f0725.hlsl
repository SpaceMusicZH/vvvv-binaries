...
@C    InputValue_id210 => ShaderFX.InputValueFloat
@C    InputValue_id219 => ShaderFX.InputValueFloat.i1
...
@C    AmbientLight_id189 => LightSimpleAmbient.AmbientLight.environmentLights[0]
@C    SphericalColors_id194 => SphericalHarmonicsEnvironmentColor.SphericalColors.lightDiffuseColor.environmentLights[1]
@C    MipCount_id195 => RoughnessCubeMapEnvironmentColor.MipCount.lightSpecularColor.environmentLights[1]
@C    SkyMatrix_id197 => LightSkyboxShader.SkyMatrix.environmentLights[1]
@C    Intensity_id198 => LightSkyboxShader.Intensity.environmentLights[1]
...
@R    ParticlesBuffer_id144 => SMGridMeshSelector_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id202 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id202 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id231 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id231 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    SpotLights_id185 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    CubeMap_id196 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
@R    CubeMap_id196 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
...
@R    ParticlesBuffer_id202 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id231 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
@R    CubeMap_id196 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (7-7)]
...
//
//   } Lights_id188[8];                 // Offset:  464 Size:   508 [unused]
...
//   float InputValue_id210;            // Offset:    4 Size:     4 [unused]
//   float InputValue_id219;            // Offset:    8 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id189;         // Offset: 1408 Size:    12 [unused]
//   float3 SphericalColors_id194[9];   // Offset: 1424 Size:   140 [unused]
//   float MipCount_id195;              // Offset: 1564 Size:     4 [unused]
//   float4x4 SkyMatrix_id197;          // Offset: 1568 Size:    64 [unused]
//   float Intensity_id198;             // Offset: 1632 Size:     4 [unused]
...
//
#line 1372 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ddb3f63591466b2b5cf4dd86ab3f0725.hlsl"
...
@G    Pixel => 5a2f53ba9776be50131ff35932052d39
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id188[8];                 // Offset:  464 Size:   508
//   float4 _padding_PerDraw_Lighting;  // Offset:  976 Size:    16 [unused]
//
// }
//
...
//   float InputValue_id210;            // Offset:    4 Size:     4
//   float InputValue_id219;            // Offset:    8 Size:     4
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id189;         // Offset: 1408 Size:    12
//   float3 SphericalColors_id194[9];   // Offset: 1424 Size:   140
//   float MipCount_id195;              // Offset: 1564 Size:     4
//   float4x4 SkyMatrix_id197;          // Offset: 1568 Size:    64
//   float Intensity_id198;             // Offset: 1632 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
// Resource bind info for ParticlesBuffer_id202
// {
//
//   struct SMGridParticle
//   {
...
// ParticlesBuffer_id202             texture  struct         r/o             t0      1 
// EnvironmentLightingDFG_LUT_id231    texture  float4          2d             t1      1 
...
// CubeMap_id196                     texture  float4        cube             t7      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
// PerMaterial                       cbuffer      NA          NA            cb1      1 
// PerView                           cbuffer      NA          NA            cb2      1 
//
...
//
#line 1472 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ddb3f63591466b2b5cf4dd86ab3f0725.hlsl"
...
#line 506
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r11.xyxx, t2.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id75 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r11.zwzz, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id75 return value>
...
#line 506
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id75 return value>
...
#line 506
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r11.xyxx, t2.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id75 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.y, r11.zwzz, t2.xxxx, s1, r7.z  // r7.y <- <SampleTextureAndCompare_id75 return value>
...
#line 506
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t2.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id75 return value>
...
#line 571
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id170 return value>.x; r8.y <- <FresnelSchlick_id170 return value>.y; r8.z <- <FresnelSchlick_id170 return value>.z
...
#line 567
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id186 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id186 return value>

#line 677
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id188 return value>
...
#line 673
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id200 return value>
...
#line 1044
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id514 return value>.x; r7.y <- <ComputeDirectLightContribution_id514 return value>.y; r7.z <- <ComputeDirectLightContribution_id514 return value>.z
...
#line 571
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id170 return value>.x; r13.y <- <FresnelSchlick_id170 return value>.y; r13.z <- <FresnelSchlick_id170 return value>.z
...
#line 567
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id186 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id186 return value>
...
#line 571
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id170 return value>.x; r16.y <- <FresnelSchlick_id170 return value>.y; r16.z <- <FresnelSchlick_id170 return value>.z
...
#line 567
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id186 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id186 return value>

#line 677
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id188 return value>
...
#line 673
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id200 return value>
...
mov r9.xyz, r5.xyzx  // r9.x <- streams.matSpecularVisible_id73.x; r9.y <- streams.matSpecularVisible_id73.y; r9.z <- streams.matSpecularVisible_id73.z
...
#line 333
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id111 return value>
...
#line 571
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id170 return value>.x; r15.y <- <FresnelSchlick_id170 return value>.y; r15.z <- <FresnelSchlick_id170 return value>.z
...
#line 567
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id186 return value>
  mad r3.w, r10.z, r5.w, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id186 return value>

#line 677
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id188 return value>
...
#line 752
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id336 return value>.x; r0.z <- <Compute_id336 return value>.y; r0.w <- <Compute_id336 return value>.z

#line 956
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id515 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id515 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id515 return value>.z
...
#line 737
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.x  // r1.x <- <Compute_id286 return value>.x; r1.y <- <Compute_id286 return value>.y; r1.z <- <Compute_id286 return value>.z
...
const static int TMaxLightCount_id187 = 8;
const static int TOrder_id191 = 3;
const static int TOrder_id193 = 3;
const static bool TInvert_id216 = true;
const static bool TIsEnergyConservative_id228 = false;
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id201;
    float Input_1_id209;
    float Input_2_id218;
...
cbuffer PerView 
{
    ...
    float3 AmbientLight_id189;
    float3 SphericalColors_id194[TOrder_id193 * TOrder_id193];
    float MipCount_id195;
    float4x4 SkyMatrix_id197;
    float Intensity_id198;
...
StructuredBuffer<SMGridParticle> ParticlesBuffer_id202;
Texture2D EnvironmentLightingDFG_LUT_id231;
...
float SampleAndFilter_id82(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[4];
        normalizationFactor = Get3x3FilterKernel_id77(base_uv, st, kernel);
...
float4 Compute_id300(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id202[id];
...
float FilterShadow_id68(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id77(base_uv, st, kernel);
...
{
    streams.Input_2_id218 = Compute_id324();
}
void Compute_id315(inout PS_STREAMS streams)
{
    streams.Input_1_id209 = Compute_id312();
}
void Compute_id303(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id201 = Compute_id300(streams);
}
float4 EvaluateSphericalHarmonics_id124(float3 sphericalColors[TOrder_id191 * TOrder_id191], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id115(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id114(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
{
    return streams.ColorPerParticle_ShaderFXResult_0_id201;
}
...
float4 Compute_id286(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id72;
    float mipLevel = sqrt(alpha) * MipCount_id195;
    return CubeMap_id196.SampleLevel(LinearSampler_id115, direction, mipLevel);
}
float4 Compute_id281(float3 direction)
{
    return EvaluateSphericalHarmonics_id124(SphericalColors_id194, direction);
}
...
float3 Compute_id336(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id231.SampleLevel(LinearSampler_id115, float2(glossiness, nDotV), 0);
...
void PrepareDirectLightCore_id107(inout PS_STREAMS streams, int lightIndex)
{
...
{
    return NormalDistributionGGX_id200(streams.alphaRoughness_id72, streams.NdotH_id78);
}
float Compute_id398(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id188(streams.alphaRoughness_id72, streams.NdotL_id51, streams.NdotV_id74);
}
float3 Compute_id368(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id176(f0, streams.LdotH_id79);
}
...
void AfterLightingAndShading_id485()
{
}
void AfterLightingAndShading_id466()
{
}
...
void PrepareEnvironmentLight_id296(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id128(streams);
    float ambientAccessibility = streams.matAmbientOcclusion_id59;
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id197);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id49 = Compute_id281(sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.x;
    sampleDirection = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id197);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id50 = Compute_id286(streams, sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
float3 ComputeEnvironmentLightContribution_id515(inout PS_STREAMS streams)
{
    ...
    return Compute_id336(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
void PrepareEnvironmentLight_id291(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id189 * streams.matAmbientOcclusion_id59;
...
void PrepareDirectLight_id262(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id146 = ComputeShadow_id108(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id109(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id110(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id264()
{
    return LightCount_id186;
}
int GetMaxLightCount_id265()
{
...
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id368(streams, specularColor);
    float geometricShadowing = Compute_id398(streams);
    float normalDistribution = Compute_id428(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id230 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id482()
{
}
void PrepareForLightingAndShading_id463()
{
}
...
void Compute_id546(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id463();
    }

    {
        PrepareForLightingAndShading_id482();
    }
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id265();
        int count = GetLightCount_id264();
    ...
    {
        PrepareEnvironmentLight_id296(streams);
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id230 + environmentLightingContribution;
    streams.shadingColorAlpha_id76 = streams.matDiffuse_id55.a;

    {
        AfterLightingAndShading_id466();
    }

    {
        AfterLightingAndShading_id485();
    }
}
void Compute_id530(inout PS_STREAMS streams)
{
    float metalness = Compute_id335(streams).r;
...
{
    float glossiness = Compute_id323(streams).r;
...
{
    float4 colorBase = Compute_id311(streams);
