...
@S    SMBoxImpostor_ShaderFX => 357490b1becf53908939239c06eef615
...
//
#line 289 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_a7868a823f6dc64b1db8afa9421769b4.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 8a03947aa38ef0c6e43fadd3390141bf
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 255 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_a7868a823f6dc64b1db8afa9421769b4.hlsl"
...
#line 238
mul r4.xyz, r3.zzyz, r3.yxxy  // r4.y <- <rot3x3_id69 return value>._m11; r4.z <- <rot3x3_id69 return value>._m22
mul r0.w, r0.y, r0.x
mad r5.x, r0.w, r0.z, r4.x  // r5.x <- <rot3x3_id69 return value>._m00
mul r5.y, r0.z, -r3.x  // r5.y <- <rot3x3_id69 return value>._m01
mul r6.xyzw, r0.xyzy, r3.yzyx  // r6.w <- <rot3x3_id69 return value>._m20
...
#line 238
mad r5.z, r6.x, r0.z, -r7.x  // r5.z <- <rot3x3_id69 return value>._m02
mad r8.x, -r0.w, r3.z, r6.z  // r8.x <- <rot3x3_id69 return value>._m10
mul r0.w, r3.z, r6.x
mad r8.y, -r0.y, r0.z, -r0.w  // r8.y <- <rot3x3_id69 return value>._m12

#line 264
add r0.yzw, -r2.xxyz, cb2[21].xxyz  // r0.y <- viewDir.x; r0.z <- viewDir.y; r0.w <- viewDir.z

#line 265
dp3 r3.x, r0.yzwy, cb0[4].xyzx  // r3.x <- viewDir.x
dp3 r3.y, r0.yzwy, cb0[5].xyzx  // r3.y <- viewDir.y
dp3 r3.z, r0.yzwy, cb0[6].xyzx  // r3.z <- viewDir.z
...
#line 190
    ishl r0.w, l(1), r0.y  // r0.w <- b

#line 191
    and r6.xyz, r0.wwww, l(90, 51, 15, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id93 return value>.x; r6.y <- <CubeVert_id93 return value>.y; r6.z <- <CubeVert_id93 return value>.z
...
#line 217
    dp4 r0.w, r10.xyzw, cb2[16].xyzw  // r0.w <- streams.ShadingPosition_id0.x
    dp4 r1.w, r10.xyzw, cb2[17].xyzw  // r1.w <- streams.ShadingPosition_id0.y
    dp4 r2.w, r10.xyzw, cb2[18].xyzw  // r2.w <- streams.ShadingPosition_id0.z
    dp4 r3.w, r10.xyzw, cb2[19].xyzw  // r3.w <- streams.ShadingPosition_id0.w

#line 229
    mov o0.xyzw, r10.xyzw
    mov o1.xyz, r1.xyzx
    mov o2.xy, icb[r0.z + 0].xyxx
    mov o2.z, r3.w
    mov o3.x, r6.w
    mov o3.y, r0.x
    mov o3.z, r4.z
...
#line 191
    and r6.xyz, r3.wwww, l(0x0000a55a, 3891, 0x0000330f, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id93 return value>.x; r6.y <- <CubeVert_id93 return value>.y; r6.z <- <CubeVert_id93 return value>.z
...
#line 217
    ...
    dp4 r3.w, r6.xyzw, cb2[19].xyzw  // r3.w <- streams.ShadingPosition_id0.w
...
#line 191
    and r6.xyz, r3.wwww, l(0x0000a500, 3840, 0x00003300, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id93 return value>.x; r6.y <- <CubeVert_id93 return value>.y; r6.z <- <CubeVert_id93 return value>.z
...
#line 191
    and r6.xyz, r3.wwww, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id93 return value>.x; r6.y <- <CubeVert_id93 return value>.y; r6.z <- <CubeVert_id93 return value>.z
...
#line 191
    and r6.xyz, r3.wwww, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id93 return value>.x; r6.y <- <CubeVert_id93 return value>.y; r6.z <- <CubeVert_id93 return value>.z
...
#line 191
    ...
    movc r3.xyz, r3.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r3.x <- <CubeVert_id93 return value>.x; r3.y <- <CubeVert_id93 return value>.y; r3.z <- <CubeVert_id93 return value>.z
...
void PostTransformPosition_id91(inout VS_STREAMS streams)
{
...
void TransformPosition_id90()
{
}
void PreTransformPosition_id89()
{
}
float3 CubeVert_id93(in uint vertexID)
{
    uint b = 1 << vertexID;
...
{
    PreTransformPosition_id89();
    TransformPosition_id90();
    PostTransformPosition_id91(streams);
}
void VSMain_id0()
{
}
void SpawnQuad_id94(inout GS_STREAMS streams, uint start, inout TriangleStream<GS_OUTPUT> triangleStream, float3 normal, SMGridParticle p, float3 AxisX, float3 AxisY, float3 AxisZ)
{
...
float3x3 rot3x3_id69(float3 rotation)
{
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    if (dot(streams.PSize_id150, streams.PSize_id150) <= 0)
        return;
    float3x3 or = rot3x3_id69(p.Rot);
    float3 AxisX = or[0];
    float3 AxisY = or[1];
    float3 AxisZ = or[2];
    float3 viewDir = Eye_id30.xyz - p.Pos;
    viewDir = mul(float4(viewDir, 0), WorldInverse_id32);
    if (dot(viewDir, AxisZ) > 0)
        SpawnQuad_id94(streams, 0, triangleStream, AxisZ, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisZ) > 0)
        SpawnQuad_id94(streams, 4, triangleStream, -AxisZ, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, AxisY) > 0)
        SpawnQuad_id94(streams, 8, triangleStream, AxisY, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisY) > 0)
        SpawnQuad_id94(streams, 12, triangleStream, -AxisY, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, AxisX) > 0)
        SpawnQuad_id94(streams, 16, triangleStream, AxisX, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisX) > 0)
        SpawnQuad_id94(streams, 20, triangleStream, -AxisX, p, AxisX, AxisY, AxisZ);
}
