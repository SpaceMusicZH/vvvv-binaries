...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin HSCB_TextureFX [{Control = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_0>}]}]
...
@C    Hue_id88 => HSCB_TextureFX.Hue
@C    HueCycles_id89 => HSCB_TextureFX.HueCycles
@C    Saturation_id90 => HSCB_TextureFX.Saturation
@C    SaturationBalance_id91 => HSCB_TextureFX.SaturationBalance
@C    Contrast_id92 => HSCB_TextureFX.Contrast
@C    Brightness_id93 => HSCB_TextureFX.Brightness
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    HSCB_TextureFX => e75b41615f251bd451a1d6d410bad5c0
...
//
#line 235 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_10e4ba160db745a89d0d740e56031a3d.hlsl"
...
@G    Pixel => 4d6ae787d1fcc32daa63dd355d182503
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float Hue_id88;                    // Offset:   80 Size:     4
//      = 0x00000000 
//   float HueCycles_id89;              // Offset:   84 Size:     4
//      = 0x3f800000 
//   float Saturation_id90;             // Offset:   88 Size:     4
//      = 0x3f800000 
//   float SaturationBalance_id91;      // Offset:   92 Size:     4
//      = 0x00000000 
//   float Contrast_id92;               // Offset:   96 Size:     4
//      = 0x00000000 
//   float Brightness_id93;             // Offset:  100 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 164 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_10e4ba160db745a89d0d740e56031a3d.hlsl"
...
#line 206
mul r0.w, r1.x, cb1[5].y  // r0.w <- HSL.x
...
mul r0.y, r0.y, r1.x
exp r0.y, r0.y
mul_sat r0.y, r0.y, cb1[5].z  // r0.y <- h.y
...
cbuffer Globals 
{
    ...
    float Hue_id88 = .0f;
    float HueCycles_id89 = 1.0f;
    float Saturation_id90 = 1.0f;
    float SaturationBalance_id91 = .0f;
    float Contrast_id92 = .0f;
    float Brightness_id93 = .0f;
};
...
{
    streams.Default_0_id94 = Compute_id31();
}
...
float4 Filter_id29(float4 tex0col)
{
    float4 c = tex0col;
    float3 h = RGBtoHSL_id13(c.rgb);
    h.y = pow(h.y, pow(2, SaturationBalance_id91)) * Saturation_id90;
    h.y = saturate(h.y);
    float3 k0 = HSLtoRGB_id10(float3((frac(h.x + Hue_id88) - 0) * HueCycles_id89, h.y, h.z));
    float3 k1 = HSLtoRGB_id10(float3((frac(h.x + Hue_id88) - 1) * HueCycles_id89, h.y, h.z));
    c.rgb = lerp(k0, k1, pow(smoothstep(0, 1, h.x), 2));
    c.rgb = normalize(c.rgb) * sqrt(3) * pow(length(c.rgb) / sqrt(3), pow(2, Contrast_id92));
    c.rgb *= pow(2, Brightness_id93);
    return c;
}
...
float4 Shading_id28(inout PS_STREAMS streams)
{
    ...
    return lerp(col, Filter_id29(col), Compute_id30(streams));
}
