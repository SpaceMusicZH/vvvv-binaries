...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin FuseGeometryMeshSurfacePSExtension_ShaderFX [{ShadingColor0 = ComputeColor}, {Surface = FuseGeometryMeshSurface}]
...
@S    FuseGeometryMeshSurfacePSExtension_ShaderFX => 01482d5f0691c1b0631697d8e9b87ec2
...
*****     Stages      *****
***************************
@G    Vertex => df352aae0307e32a95ac07b391cd5545
//
...
//   o2.x <- <VSMain return value>.TexCoord_id86.x; o2.y <- <VSMain return value>.TexCoord_id86.y; 
...
//
#line 267 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_8b4ac901236ea2b6f7df77962be2f3d9.hlsl"
mov o0.xyz, l(0,0,0,0)
mov o1.xyzw, v0.xyzw
mov o2.xy, v1.xyxx
ret 
// Approximately 4 instruction slots used
@G    Pixel => 108c8ef7781158e5df0776df4b813706
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// POSITION_WS              0   xyzw        1     NONE   float   xyz 
...
//   v2.x <- __input__.TexCoord_id86.x; v2.y <- __input__.TexCoord_id86.y; 
//   o0.x <- <PSMain return value>.ColorTarget_id2.x; o0.y <- <PSMain return value>.ColorTarget_id2.y; o0.z <- <PSMain return value>.ColorTarget_id2.z; o0.w <- <PSMain return value>.ColorTarget_id2.w; 
//   oDepth <- <PSMain return value>.Depth_id10
//
#line 171 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_8b4ac901236ea2b6f7df77962be2f3d9.hlsl"
mov r0.xyz, v1.xyzx
mov r0.w, l(1.000000)
...
void assignMeshSurfaceStreams_id18(inout PS_STREAMS streams, MeshSurface surface)
{
    streams.msP_id96 = surface.p;
    streams.msN_id97 = surface.n;
    streams.msUV_id98 = surface.uv;
}
MeshSurface makeSurface_id21(float3 p, float3 n, float2 uv)
{
    MeshSurface surface;
    surface.p = p;
    surface.n = n;
...
float4 Shading_id19(inout PS_STREAMS streams)
{
    ...
    MeshSurface surface = makeSurface_id21(p, n, uv);
    ...
    return StrideShadingWorldNormal_id17(streams, streams.msP_id96, normal);
}
void PSMain_id1()
{
}
