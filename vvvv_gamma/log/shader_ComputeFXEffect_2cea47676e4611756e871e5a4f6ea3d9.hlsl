...
@C    InputValue_id130 => ShaderFX.InputValueFloat.i4
...
@C    InputValue_id189 => ShaderFX.InputValueFloat.i6
...
@C    InputValue_id269 => ShaderFX.InputValueFloat.i3
...
@C    InputValue_id323 => ShaderFX.InputValueFloat.i2
@C    InputValue_id335 => ShaderFX.InputValueFloat3
@C    InputValue_id342 => ShaderFX.InputValueFloat3.i1
@C    InputValue_id356 => ShaderFX.InputValueUInt
...
@R    DynamicTexture_id218 => ObjectTexture_fx24 [Stage: Compute, Slot: (4-4)]
@R    DynamicBuffer_id363 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id370 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => b5dc0c4037f66e29e4675b48f06b9bcd
//
...
//   float InputValue_id323;            // Offset:  128 Size:     4
//   float3 InputValue_id335;           // Offset:  132 Size:    12
//   float3 InputValue_id342;           // Offset:  144 Size:    12
//   uint InputValue_id356;             // Offset:  156 Size:     4
//   float InputValue_id377;            // Offset:  160 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicBuffer_id363               texture  float4         buf             t5      1 
// DynamicTexture_id370              texture  float4          2d             t6      1 
...
//
#line 1620 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_2cea47676e4611756e871e5a4f6ea3d9.hlsl"
...
#line 842
  mul r1.w, r0.w, cb1[7].w  // r1.w <- <Compute_id588 return value>

#line 822
  mul r12.xz, r1.wwww, cb1[8].yywy  // r12.x <- <Compute_id612 return value>.x; r12.z <- <Compute_id612 return value>.z
  mul r12.y, cb1[8].z, cb1[8].x  // r12.y <- <Compute_id612 return value>.y

#line 814
  add r11.yzw, r12.xxyz, cb1[9].xxyz  // r11.y <- <Compute_id620 return value>.x; r11.z <- <Compute_id620 return value>.y; r11.w <- <Compute_id620 return value>.z

#line 1596
  ld_structured_indexable(structured_buffer, stride=12)(mixed,mixed,mixed,mixed) r12.xyz, l(0), l(0), t0.xyzx
  add r13.xyz, r8.yzwy, -r11.yzwy
  mad r12.xyz, r12.xyzx, r13.xyzx, r11.yzwy  // r12.x <- m.Trans.x; r12.y <- m.Trans.y; r12.z <- m.Trans.z

#line 799
  sample_l_indexable(texture2d)(float,float,float,float) r11.yzw, r6.xyxx, t4.wxyz, s0, l(0.000000)  // r11.y <- <Compute_id399 return value>.x; r11.z <- <Compute_id399 return value>.y; r11.w <- <Compute_id399 return value>.z

#line 511
  dp3 r1.w, r11.yzwy, l(0.299000, 0.587000, 0.114000, 0.000000)  // r1.w <- <Luminance_id64 return value>

#line 790
  mul r11.x, r1.w, r11.x  // r11.x <- <Compute_id428 return value>

#line 781
  mul r11.y, r0.w, r1.w  // r11.y <- <Compute_id457 return value>
...
#line 279
  ...
  imad r1.w, r13.z, r1.w, r2.w  // r1.w <- <CalculateVoxelVolumeIndex_id70 return value>

#line 283
  ld_structured_indexable(structured_buffer, stride=48)(mixed,mixed,mixed,mixed) r13.xyzw, r1.w, l(0), t3.xyzw  // r13.x <- <GetVoxel_id37 return value>.Empty; r13.y <- <GetVoxel_id37 return value>.StartTime; r13.z <- <GetVoxel_id37 return value>.Note; r13.w <- <GetVoxel_id37 return value>.Velocity
...
#line 447
    mov r15.x, r13.x  // r15.x <- <SelectMidiValue_id71 return value>
    break 
...
#line 449
    mov r15.x, r13.y  // r15.x <- <SelectMidiValue_id71 return value>
    break 
...
#line 451
    mov r15.x, r13.z  // r15.x <- <SelectMidiValue_id71 return value>
    break 
...
#line 453
    mov r15.x, r13.w  // r15.x <- <SelectMidiValue_id71 return value>
    break 
...
#line 764
  mul r11.z, r15.x, cb1[5].x  // r11.z <- <Compute_id476 return value>

#line 744
  mad r11.xyz, r11.xyzx, cb1[5].yzwy, cb1[6].xyzx  // r11.x <- <Compute_id500 return value>.x; r11.y <- <Compute_id500 return value>.y; r11.z <- <Compute_id500 return value>.z

#line 736
  add r11.xyz, r11.xyzx, cb1[7].xyzx  // r11.x <- <Compute_id508 return value>.x; r11.y <- <Compute_id508 return value>.y; r11.z <- <Compute_id508 return value>.z
...
#line 1597
  ...
  mad r8.xyz, r13.xyzx, r8.xyzx, r11.xyzx  // r8.x <- m.Rot.x; r8.y <- m.Rot.y; r8.z <- m.Rot.z

#line 712
  mul r1.w, r0.w, cb1[0].w  // r1.w <- <Compute_id190 return value>

#line 688
  mad r11.xyz, r1.wwww, cb1[1].xyzx, cb1[0].xyzx  // r11.x <- <Compute_id224 return value>.x; r11.y <- <Compute_id224 return value>.y; r11.z <- <Compute_id224 return value>.z

#line 680
  mul r13.xyz, r11.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id232 return value>.x; r13.y <- <Compute_id232 return value>.y; r13.z <- <Compute_id232 return value>.z
...
#line 660
  mul r11.y, r0.w, cb1[2].w  // r11.y <- <Compute_id334 return value>

#line 644
  mov r11.zw, cb1[3].xxxx

#line 636
  mad r11.xyz, r11.yzwy, cb1[3].yzwy, cb1[4].xyzx  // r11.x <- <Compute_id360 return value>.x; r11.y <- <Compute_id360 return value>.y; r11.z <- <Compute_id360 return value>.z
...
#line 1599
  ...
  mad r10.yzw, r13.xxyz, r10.xxyz, r11.xxyz  // r10.y <- m.Piv.x; r10.z <- m.Piv.y

#line 1601
  mov r12.w, r8.x
  store_structured u0.xyzw, vThreadID.x, l(0), r12.xyzw
  mov r11.xy, r8.yzyy
  mov r11.zw, r9.xxxy
...
#line 896
  ...
  mul r0.w, r0.w, r11.y
  round_ne r0.w, r0.w
  ftou r0.w, r0.w  // r0.w <- <Compute_id101 return value>

#line 890
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r0.wwww, t5.xyzw  // r13.x <- <Compute_id105 return value>.x; r13.y <- <Compute_id105 return value>.y; r13.z <- <Compute_id105 return value>.z
...
#line 612
  ...
  mul r15.xyz, r13.xyzx, r14.xyzx  // r15.x <- <SRgbToLinear_id648 return value>.x; r15.y <- <SRgbToLinear_id648 return value>.y; r15.z <- <SRgbToLinear_id648 return value>.z
...
#line 874
  ...
  mad r6.yzw, cb1[10].xxxx, r6.yyzw, r15.xxyz  // r6.y <- <Compute_id125 return value>.x; r6.z <- <Compute_id125 return value>.y; r6.w <- <Compute_id125 return value>.z
...
#line 1486
  mul r5.zw, r12.yyyx, r10.xxxx

#line 1485
  mad r0.w, r13.x, r12.x, -r5.z

#line 1486
  mad r1.w, r13.x, r12.y, r5.w  // r1.w <- p.y
...
#line 583
  dp3 r0.w, r11.xzwx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r0.w <- <Luminance_id85 return value>
...
struct CS_STREAMS 
{
    ...
    float Input_16_id322;
    float Multiply_17_id325;
    float3 SMVector3Join_ShaderFXResult_18_id329;
    float3 Input_19_id334;
    float3 Multiply_20_id337;
    float3 Input_21_id341;
    float3 Plus_22_id344;
    float r_23_id214;
    float4 TextureValue_25_id217;
    float SMCalcLuminance_ShaderFXResult_27_id225;
    ...
    float g_2_id352;
    uint Input_3_id355;
    uint SMValueToIndex_ShaderFXResult_4_id358;
    float4 BufferItem_5_id362;
    float4 SRgbToLinear_ShaderFXResult_6_id366;
    float4 TextureValue_9_id369;
...
cbuffer PerUpdate 
{
    ...
    float InputValue_id323;
    float3 InputValue_id335;
    float3 InputValue_id342;
    uint InputValue_id356;
...
Buffer<float4> DynamicBuffer_id363;
Texture2D DynamicTexture_id370;
...
float Compute_id199(inout CS_STREAMS streams)
{
...
uint Compute_id465(inout CS_STREAMS streams)
{
...
{
    return streams.SMCalcLuminance_ShaderFXResult_27_id225;
}
...
float4 Compute_id429(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float Compute_id425(inout CS_STREAMS streams)
{
    return streams.SMCalcLuminance_ShaderFXResult_27_id225;
}
float Compute_id423(inout CS_STREAMS streams)
{
    return streams.r_23_id214;
}
float Luminance_id64(float3 color)
{
    return dot(color, float3(0.299f, 0.587f, 0.114f));
}
float4 Compute_id400(inout CS_STREAMS streams)
{
    return streams.TextureValue_25_id217;
}
float Compute_id394()
{
    return Value_id371;
}
float2 Compute_id396(inout CS_STREAMS streams)
{
    return streams.TexCoord_id59;
}
float4 Compute_id390(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float3 Compute_id617(inout CS_STREAMS streams)
{
    return streams.Input_21_id341;
}
float3 Compute_id615(inout CS_STREAMS streams)
{
    return streams.Multiply_20_id337;
}
float3 Compute_id609(inout CS_STREAMS streams)
{
    return streams.Input_19_id334;
}
float3 Compute_id607(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_18_id329;
}
float Compute_id601(inout CS_STREAMS streams)
{
    return streams.Multiply_17_id325;
}
float Compute_id599(inout CS_STREAMS streams)
{
    return streams.Input_16_id322;
}
float Compute_id597(inout CS_STREAMS streams)
{
    return streams.Multiply_15_id318;
}
float Compute_id593(inout CS_STREAMS streams)
{
...
float4 Compute_id558(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float Luminance_id85(float3 color)
{
    return dot(color, float3(0.299f, 0.587f, 0.114f));
}
float4 Compute_id268(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
...
{
    return streams.TextureValue_9_id369;
}
float4 Compute_id118(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id366;
}
float Compute_id110()
{
    return Value_id371;
...
float4 SRgbToLinear_id648(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id362;
}
uint Compute_id102(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id358;
}
uint Compute_id96(inout CS_STREAMS streams)
{
    return streams.Input_3_id355;
}
float Compute_id98(inout CS_STREAMS streams)
{
    return streams.g_2_id352;
}
...
{
    return Compute_id355(streams) + Compute_id357(streams);
}
float3 Compute_id353()
{
...
float3 Compute_id345()
{
    return InputValue_id197;
}
float3 Compute_id344(inout CS_STREAMS streams)
{
    return float3(Compute_id337(streams), Compute_id339(streams), Compute_id341(streams));
}
float Compute_id335()
{
...
float3 Compute_id211()
{
    return InputValue_id150;
}
float3 Compute_id210(inout CS_STREAMS streams)
{
    return float3(Compute_id203(streams), Compute_id205(streams), Compute_id207(streams));
}
float Compute_id202(inout CS_STREAMS streams)
{
    return Compute_id197(streams) * Compute_id199(streams);
}
float Compute_id196(inout CS_STREAMS streams)
{
    return Compute_id191(streams) * Compute_id193(streams);
}
...
float Compute_id182(inout CS_STREAMS streams)
{
    float4 color = Compute_id160(streams);
...
float3 Compute_id154()
{
    return InputValue_id108;
}
float3 Compute_id508(inout CS_STREAMS streams)
{
    return Compute_id503(streams) + Compute_id505(streams);
}
float3 Compute_id501()
{
...
{
    return float3(Compute_id477(streams), Compute_id479(streams), Compute_id481(streams));
}
...
float Compute_id468(inout CS_STREAMS streams)
{
    ...
    return SelectMidiValue_id71(m, Compute_id465(streams));
}
uint Compute_id458()
{
...
{
    return Compute_id452(streams) * Compute_id454(streams);
}
float Compute_id451(inout CS_STREAMS streams)
{
    float4 color = Compute_id429(streams);
...
float Compute_id422(inout CS_STREAMS streams)
{
    float4 color = Compute_id400(streams);
    return Luminance_id64(color.rgb);
}
float4 Compute_id399(inout CS_STREAMS streams)
{
    return DynamicTexture_id218.SampleLevel(DynamicSampler_id219, Compute_id396(streams), Compute_id394());
}
float Compute_id393(inout CS_STREAMS streams)
{
    return Compute_id390(streams).r;
}
...
{
    return Compute_id615(streams) + Compute_id617(streams);
}
float3 Compute_id613()
{
    return InputValue_id342;
}
float3 Compute_id612(inout CS_STREAMS streams)
{
    return Compute_id607(streams) * Compute_id609(streams);
}
float3 Compute_id605()
{
    return InputValue_id335;
}
float3 Compute_id604(inout CS_STREAMS streams)
{
    return float3(Compute_id597(streams), Compute_id599(streams), Compute_id601(streams));
}
float Compute_id596(inout CS_STREAMS streams)
{
    return Compute_id591(streams) * Compute_id593(streams);
}
float Compute_id589()
{
    return InputValue_id323;
}
float Compute_id588(inout CS_STREAMS streams)
{
...
{
    float4 color = Compute_id558(streams);
...
{
    float4 color = Compute_id268(streams);
    return Luminance_id85(color.rgb);
}
...
{
    return DynamicTexture_id370.SampleLevel(DynamicSampler_id219, Compute_id112(streams), Compute_id110());
}
float4 Compute_id109(inout CS_STREAMS streams)
{
    return SRgbToLinear_id648(Compute_id106(streams));
}
float4 Compute_id105(inout CS_STREAMS streams)
{
    return DynamicBuffer_id363[Compute_id102(streams)];
}
...
{
    streams.Plus_59_id206 = Compute_id360(streams);
}
void Compute_id378(inout CS_STREAMS streams)
{
    streams.Input_58_id203 = Compute_id353();
}
void Compute_id376(inout CS_STREAMS streams)
{
    streams.Multiply_57_id199 = Compute_id352(streams);
}
void Compute_id374(inout CS_STREAMS streams)
{
    streams.Input_56_id196 = Compute_id345();
}
void Compute_id372(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_55_id191 = Compute_id344(streams);
}
void Compute_id370(inout CS_STREAMS streams)
{
    streams.Input_54_id188 = Compute_id335();
}
void Compute_id368(inout CS_STREAMS streams)
{
    streams.Multiply_53_id184 = Compute_id334(streams);
}
void Compute_id366(inout CS_STREAMS streams)
{
    streams.Input_52_id181 = Compute_id327();
}
void Compute_id364(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id326(streams);
}
...
{
    streams.Multiply_51_id163 = Compute_id232(streams);
}
void Compute_id256(inout CS_STREAMS streams)
{
    streams.Input_50_id160 = Compute_id225();
}
void Compute_id254(inout CS_STREAMS streams)
{
    streams.Plus_49_id156 = Compute_id224(streams);
}
void Compute_id252(inout CS_STREAMS streams)
{
    streams.Multiply_48_id152 = Compute_id218(streams);
}
void Compute_id250(inout CS_STREAMS streams)
{
    streams.Input_47_id149 = Compute_id211();
}
void Compute_id248(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_46_id144 = Compute_id210(streams);
}
void Compute_id246(inout CS_STREAMS streams)
{
    streams.Multiply_45_id140 = Compute_id202(streams);
}
void Compute_id244(inout CS_STREAMS streams)
{
    streams.Multiply_44_id136 = Compute_id196(streams);
}
void Compute_id242(inout CS_STREAMS streams)
{
    streams.Multiply_43_id132 = Compute_id190(streams);
}
void Compute_id240(inout CS_STREAMS streams)
{
    streams.Input_42_id129 = Compute_id183();
}
void Compute_id238(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id182(streams);
}
...
{
    streams.Input_41_id107 = Compute_id154();
}
void Compute_id548(inout CS_STREAMS streams)
{
    streams.Plus_40_id297 = Compute_id508(streams);
}
void Compute_id546(inout CS_STREAMS streams)
{
    streams.Input_39_id294 = Compute_id501();
}
void Compute_id544(inout CS_STREAMS streams)
{
    streams.Plus_38_id290 = Compute_id500(streams);
}
void Compute_id542(inout CS_STREAMS streams)
{
    streams.Input_37_id287 = Compute_id493();
}
void Compute_id540(inout CS_STREAMS streams)
{
    streams.Multiply_36_id283 = Compute_id492(streams);
}
void Compute_id538(inout CS_STREAMS streams)
{
    streams.Input_35_id280 = Compute_id485();
}
void Compute_id536(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_34_id275 = Compute_id484(streams);
}
void Compute_id534(inout CS_STREAMS streams)
{
    streams.Multiply_33_id271 = Compute_id476(streams);
}
void Compute_id532(inout CS_STREAMS streams)
{
    streams.Input_32_id268 = Compute_id469();
}
void Compute_id530(inout CS_STREAMS streams)
{
    streams.SMMidiSelectValue_ShaderFXResult_31_id257 = Compute_id468(streams);
}
void Compute_id528(inout CS_STREAMS streams)
{
    streams.Input_30_id254 = Compute_id458();
}
void Compute_id526(inout CS_STREAMS streams)
{
    streams.Multiply_29_id250 = Compute_id457(streams);
}
void Compute_id524(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id451(streams);
}
void Compute_id522(inout CS_STREAMS streams)
{
    streams.Multiply_28_id236 = Compute_id428(streams);
}
void Compute_id520(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_27_id225 = Compute_id422(streams);
}
void Compute_id518(inout CS_STREAMS streams)
{
    streams.TextureValue_25_id217 = Compute_id399(streams);
}
void Compute_id516()
{
}
...
{
    streams.r_23_id214 = Compute_id393(streams);
}
void Compute_id510(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id110 = Compute_id59(streams);
}
void Compute_id642(inout CS_STREAMS streams)
{
    streams.Plus_22_id344 = Compute_id620(streams);
}
void Compute_id640(inout CS_STREAMS streams)
{
    streams.Input_21_id341 = Compute_id613();
}
void Compute_id638(inout CS_STREAMS streams)
{
    streams.Multiply_20_id337 = Compute_id612(streams);
}
void Compute_id636(inout CS_STREAMS streams)
{
    streams.Input_19_id334 = Compute_id605();
}
void Compute_id634(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_18_id329 = Compute_id604(streams);
}
void Compute_id632(inout CS_STREAMS streams)
{
    streams.Multiply_17_id325 = Compute_id596(streams);
}
void Compute_id630(inout CS_STREAMS streams)
{
    streams.Input_16_id322 = Compute_id589();
}
void Compute_id628(inout CS_STREAMS streams)
{
    streams.Multiply_15_id318 = Compute_id588(streams);
}
void Compute_id626(inout CS_STREAMS streams)
{
    streams.Input_14_id315 = Compute_id581();
}
void Compute_id624(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id580(streams);
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id290(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id110 = Compute_id80(streams);
}
void Compute_id148(inout CS_STREAMS streams)
{
    streams.Lerp_12_id379 = Compute_id125(streams);
}
void Compute_id146(inout CS_STREAMS streams)
{
    streams.Input_11_id376 = Compute_id116();
}
void Compute_id144(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id369 = Compute_id115(streams);
}
void Compute_id142()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id366 = Compute_id109(streams);
}
void Compute_id136(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id362 = Compute_id105(streams);
}
void Compute_id134(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id358 = Compute_id101(streams);
}
void Compute_id132(inout CS_STREAMS streams)
{
    streams.Input_3_id355 = Compute_id94();
}
void Compute_id130(inout CS_STREAMS streams)
{
    streams.g_2_id352 = Compute_id93(streams);
}
void Compute_id128(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id110 = Compute_id78(streams);
}
void Compute_id126()
{
}
...
float3 Compute_id645(inout CS_STREAMS streams)
{
    return streams.Plus_22_id344;
}
void Compute_id644(inout CS_STREAMS streams)
{
    ...
    {
        Compute_id638(streams);
    }

    {
        Compute_id640(streams);
    }
...
float Compute_id297(inout CS_STREAMS streams)
{
    return streams.SMCalcLuminance_ShaderFXResult_13_id118;
}
