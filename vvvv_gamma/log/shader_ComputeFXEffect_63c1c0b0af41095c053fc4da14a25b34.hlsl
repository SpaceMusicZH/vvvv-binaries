...
@P Dim: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<SMVideoBufferSelector_ShaderFXResult_1> [{Value = SMVideoBufferSelector_ShaderFX}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_2> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<SMVideoBufferSelector_ShaderFXResult_1>}]}], ComputeVoid, ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_29> [{Value = mixin SampleLevelTextureFloat4<ObjectTexture_fx7,PerUpdate,ObjectSampler_fx8,PerUpdate> [{LOD = ConstantFloat<0>}, {TexCd = GetSemanticFloat2<SemanticValue_30,TEXCOORD2>}]}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_31> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<TextureValue_29>}]}], mixin AssignVarFloat<Multiply_32> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_31>}]}], mixin AssignVarFloat<Multiply_33> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_31>}]}], mixin AssignVarFloat<Multiply_34> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_2>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_31>}]}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_35> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Multiply_32>}, {Y = GetVarFloat<Multiply_33>}, {Z = GetVarFloat<Multiply_34>}]}], mixin AssignVarFloat3<Input_36> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i5,PerUpdate>}], mixin AssignVarFloat3<Multiply_37> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_35>}, {Right = GetVarFloat3<Input_36>}]}], mixin AssignVarFloat3<Input_38> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i6,PerUpdate>}], mixin AssignVarFloat3<Plus_39> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_37>}, {Right = GetVarFloat3<Input_38>}]}], mixin AssignVarFloat3<Input_40> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i7,PerUpdate>}], mixin AssignVarFloat3<Plus_41> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Plus_39>}, {Right = GetVarFloat3<Input_40>}]}], mixin AssignVarFloat3<Input_42> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i8,PerUpdate>}], mixin AssignVarFloat3<Multiply_43> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<Plus_41>}, {Right = GetVarFloat3<Input_42>}]}]]}]}, {Value = GetVarFloat3<Multiply_43>}]
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_44> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_45> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_44>}, {Y = GetVarFloat<Input_44>}, {Z = GetVarFloat<Input_44>}]}], mixin AssignVarFloat3<Input_46> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<Multiply_47> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_45>}, {Right = GetVarFloat3<Input_46>}]}], mixin AssignVarFloat3<Input_48> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i10,PerUpdate>}], mixin AssignVarFloat3<Plus_49> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_47>}, {Right = GetVarFloat3<Input_48>}]}]]}]}, {Value = GetVarFloat3<Plus_49>}]
...
@C    InputValue_id307 => ShaderFX.InputValueFloat
@C    InputValue_id318 => ShaderFX.InputValueUInt.i1
...
@C    VoxelCounts_id322 => SMMidiBufferSelector_ShaderFX.VoxelCounts
@C    PlacementCounts_id323 => SMMidiBufferSelector_ShaderFX.PlacementCounts
@C    Channel_id324 => SMMidiBufferSelector_ShaderFX.Channel
@C    Blink_id325 => SMMidiBufferSelector_ShaderFX.Blink
@C    SamplerOffset_id326 => SMMidiBufferSelector_ShaderFX.SamplerOffset
@C    SamplerScale_id327 => SMMidiBufferSelector_ShaderFX.SamplerScale
***************************
******  Resources    ******
***************************
...
@R    VoxelVolume_id321 => SMMidiBufferSelector_ShaderFX.VoxelVolume [Stage: Compute, Slot: (3-3)]
@R    DynamicTexture_id127 => ObjectTexture_fx7 [Stage: Compute, Slot: (4-4)]
...
*****     Stages      *****
***************************
@G    Compute => 53376bdcfbde3f4a898ce4979d96209e
//
...
//   float InputValue_id307;            // Offset:  176 Size:     4
//   uint InputValue_id318;             // Offset:  180 Size:     4
//
// }
//
// cbuffer Globals
...
//      = 0x00100000 
//   int3 VoxelCounts_id322;            // Offset:  132 Size:    12
//   int3 PlacementCounts_id323;        // Offset:  144 Size:    12 [unused]
//   int Channel_id324;                 // Offset:  156 Size:     4 [unused]
//   float Blink_id325;                 // Offset:  160 Size:     4 [unused]
//   float2 SamplerOffset_id326;        // Offset:  164 Size:     8 [unused]
//   float2 SamplerScale_id327;         // Offset:  176 Size:     8 [unused]
//      = 0x3f800000 0x3f800000 
//
// }
//
...
// }
//
// Resource bind info for VoxelVolume_id321
// {
//
...
// VoxelVolume_id321                 texture  struct         r/o             t3      1 
...
//
#line 1329 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_63c1c0b0af41095c053fc4da14a25b34.hlsl"
...
#line 718
  sample_l_indexable(texture2d)(float,float,float,float) r15.xyz, r6.xyxx, t4.xyzw, s0, l(0.000000)  // r15.x <- <Compute_id110 return value>.x; r15.y <- <Compute_id110 return value>.y; r15.z <- <Compute_id110 return value>.z
...
const static float Value_id301 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Multiply_32_id145;
    float Multiply_33_id149;
    float Multiply_34_id153;
    float3 SMVector3Join_ShaderFXResult_35_id157;
    float3 Input_36_id162;
    float3 Multiply_37_id165;
    float3 Input_38_id169;
    float3 Plus_39_id172;
    float3 Input_40_id176;
    float3 Plus_41_id179;
    float3 Input_42_id183;
    float3 Multiply_43_id186;
    float Input_44_id193;
    float3 SMVector3Join_ShaderFXResult_45_id196;
    float3 Input_46_id201;
    float3 Multiply_47_id204;
    float3 Input_48_id208;
    float3 Plus_49_id211;
    uint Input_3_id286;
    ...
    float Input_11_id306;
    float4 Lerp_12_id309;
    uint Input_13_id317;
    float SMMidiSelectValue_ShaderFXResult_14_id320;
};
struct CS_INPUT 
{
...
cbuffer PerUpdate 
{
    ...
    float InputValue_id307;
    uint InputValue_id318;
};
cbuffer Globals 
{
    ...
    int3 VoxelCounts_id322;
    int3 PlacementCounts_id323;
    int Channel_id324;
    float Blink_id325;
    float2 SamplerOffset_id326;
    float2 SamplerScale_id327 = float2(1, 1);
};
...
StructuredBuffer<SMMidiNoteData> VoxelVolume_id321;
...
{
    return dot(coordinate, uint3(1, VoxelCounts_id322.x, VoxelCounts_id322.x * VoxelCounts_id322.y));
}
SMMidiNoteData GetVoxel_id36(uint3 coordinate)
{
    return VoxelVolume_id321[CalculateVoxelVolumeIndex_id60(coordinate)];
}
float3 Compute_id346(inout CS_STREAMS streams)
{
    return streams.Input_48_id208;
}
float3 Compute_id344(inout CS_STREAMS streams)
{
    return streams.Multiply_47_id204;
}
float3 Compute_id338(inout CS_STREAMS streams)
{
    return streams.Input_46_id201;
}
float3 Compute_id336(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_45_id196;
}
float Compute_id330(inout CS_STREAMS streams)
{
    return streams.Input_44_id193;
}
...
{
    return DynamicTexture_id127.SampleLevel(DynamicSampler_id128, Compute_id107(streams), Compute_id105());
}
...
{
    streams.Plus_49_id211 = Compute_id349(streams);
}
void Compute_id359(inout CS_STREAMS streams)
{
    streams.Input_48_id208 = Compute_id342();
}
void Compute_id357(inout CS_STREAMS streams)
{
    streams.Multiply_47_id204 = Compute_id341(streams);
}
void Compute_id355(inout CS_STREAMS streams)
{
    streams.Input_46_id201 = Compute_id334();
}
void Compute_id353(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_45_id196 = Compute_id333(streams);
}
void Compute_id351(inout CS_STREAMS streams)
{
    streams.Input_44_id193 = Compute_id324();
}
void Compute_id298(inout CS_STREAMS streams)
{
    streams.Multiply_43_id186 = Compute_id262(streams);
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.Input_42_id183 = Compute_id255();
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.Plus_41_id179 = Compute_id254(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.Input_40_id176 = Compute_id247();
}
void Compute_id290(inout CS_STREAMS streams)
{
    streams.Plus_39_id172 = Compute_id246(streams);
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.Input_38_id169 = Compute_id239();
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Multiply_37_id165 = Compute_id238(streams);
}
void Compute_id284(inout CS_STREAMS streams)
{
    streams.Input_36_id162 = Compute_id231();
}
void Compute_id282(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_35_id157 = Compute_id230(streams);
}
void Compute_id280(inout CS_STREAMS streams)
{
    streams.Multiply_34_id153 = Compute_id222(streams);
}
void Compute_id278(inout CS_STREAMS streams)
{
    streams.Multiply_33_id149 = Compute_id216(streams);
}
void Compute_id276(inout CS_STREAMS streams)
{
    streams.Multiply_32_id145 = Compute_id210(streams);
}
void Compute_id274(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_31_id134 = Compute_id204(streams);
}
void Compute_id272(inout CS_STREAMS streams)
{
    streams.TextureValue_29_id126 = Compute_id181(streams);
}
void Compute_id270()
{
}
...
{
    streams.SMMidiSelectValue_ShaderFXResult_14_id320 = Compute_id314(streams);
}
void Compute_id316(inout CS_STREAMS streams)
{
    streams.Input_13_id317 = Compute_id304();
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.Lerp_12_id309 = Compute_id120(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.Input_11_id306 = Compute_id111();
}
...
{
    return streams.Multiply_43_id186;
}
...
{
    return streams.SMMidiSelectValue_ShaderFXResult_14_id320;
}
