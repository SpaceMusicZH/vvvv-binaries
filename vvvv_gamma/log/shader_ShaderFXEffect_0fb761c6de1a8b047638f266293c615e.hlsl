...
//
#line 316 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_0fb761c6de1a8b047638f266293c615e.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 1e9d752ace104345a5d7182018d6e051
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 283 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_0fb761c6de1a8b047638f266293c615e.hlsl"
...
add r0.xyz, -r0.xyzx, cb2[21].xyzx  // r0.x <- viewDir.x; r0.y <- viewDir.y; r0.z <- viewDir.z
...
//
#line 274 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_0fb761c6de1a8b047638f266293c615e.hlsl"
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    float3 AxisY = or[1];
    float3 AxisZ = or[2];
    float3 viewDir = Eye_id29.xyz - mul(float4(p.Pos, 1), World_id30).xyz;
