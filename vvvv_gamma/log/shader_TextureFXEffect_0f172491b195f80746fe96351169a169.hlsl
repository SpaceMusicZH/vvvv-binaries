...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_Line_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    BackgroundColor_id88 => Hatch_Line_TextureFX.BackgroundColor
@C    HatchColor_id89 => Hatch_Line_TextureFX.HatchColor
@C    Threshhold_id90 => Hatch_Line_TextureFX.Threshhold
@C    Thickness_id91 => Hatch_Line_TextureFX.Thickness
@C    Rotation_id92 => Hatch_Line_TextureFX.Rotation
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Hatch_Line_TextureFX => beb239523523fe8145e8bbd30627e86e
...
//
#line 184 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_0f172491b195f80746fe96351169a169.hlsl"
...
@G    Pixel => 1ef8649b91ae8bc332bca215d491c434
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float Threshhold_id90;             // Offset:  112 Size:     4
//      = 0x40a00000 
//   float Thickness_id91;              // Offset:  116 Size:     4
//      = 0x40800000 
//   float Rotation_id92;               // Offset:  120 Size:     4
//      = 0x3eb851ec 
//
// }
//
...
//
#line 156 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_0f172491b195f80746fe96351169a169.hlsl"
mad r0.xy, v1.xyxx, cb1[1].xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)  // r0.x <- x.x; r0.y <- x.y

#line 159
mad r0.xy, -cb1[1].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), r0.xyxx

#line 145
mul r0.z, cb2[7].z, l(6.283185)  // r0.z <- a

#line 146
sincos r1.x, r2.x, r0.z
mul r0.x, r0.x, r1.x
mad r0.x, r2.x, r0.y, -r0.x  // r0.x <- <r2d_id29 return value>.y

#line 159
add r0.x, r0.x, cb1[1].y
mul r0.y, r0.x, cb2[7].y
ge r0.y, r0.y, -r0.y
movc r0.y, r0.y, cb2[7].y, -cb2[7].y
...
#line 158
sqrt r0.yzw, r1.xxyz  // r0.y <- col.x; r0.z <- col.y; r0.w <- col.z

#line 159
mul r0.yzw, r0.yyzw, cb2[7].xxxx
lt r0.xyz, r0.xxxx, r0.yzwy
or r0.x, r0.y, r0.x
or r0.x, r0.z, r0.x
and r0.x, r0.x, l(0x3f800000)
add r2.xyzw, -cb2[5].xyzw, cb2[6].xyzw
mad r0.xyzw, r0.xxxx, r2.xyzw, cb2[5].xyzw
mov r2.x, l(1.000000)
mov r2.w, r1.w

#line 168
mad r0.xyzw, r0.xyzw, r2.xxxw, -r1.xyzw
...
cbuffer Globals 
{
    ...
    float4 HatchColor_id89 = float4(1.0f, 1.0f, 1.0f, 1.0f);
    float Threshhold_id90 = 5.0f;
    float Thickness_id91 = 4.0f;
    float Rotation_id92 = 0.36f;
};
...
float4 Filter_id30(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    return lerp(BackgroundColor_id88, HatchColor_id89, any(((r2d_id29(x - R * .5, Rotation_id92) + R).y) % Thickness_id91 < col.rgb * Threshhold_id90)) * float4(1, 1, 1, col.a);
}
