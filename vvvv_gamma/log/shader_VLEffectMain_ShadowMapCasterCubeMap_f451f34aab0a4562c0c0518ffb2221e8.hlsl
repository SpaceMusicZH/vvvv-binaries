...
//
#line 290 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_f451f34aab0a4562c0c0518ffb2221e8.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 04431bf7894014595bc63886a25dff0c
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 256 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCasterCubeMap_f451f34aab0a4562c0c0518ffb2221e8.hlsl"
...
mad r4.x, -r0.w, r3.z, r6.z  // r4.x <- <rot3x3_id69 return value>._m10
mul r0.x, r3.z, r6.x
mad r4.z, -r0.y, r0.z, -r0.x  // r4.z <- <rot3x3_id69 return value>._m12
...
#line 191
    ...
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id93 return value>.x; r8.y <- <CubeVert_id93 return value>.y; r8.z <- <CubeVert_id93 return value>.z
...
#line 218
    ...
    dp4 r3.w, r8.xyzw, cb2[17].xyzw  // r3.w <- streams.ShadingPosition_id0.y
    dp4 r5.w, r8.xyzw, cb2[18].xyzw  // r5.w <- streams.ShadingPosition_id0.z
    dp4 r6.x, r8.xyzw, cb2[19].xyzw  // r6.x <- streams.ShadingPosition_id0.w
...
#line 218
    dp4 r2.w, r8.xyzw, cb2[16].xyzw  // r2.w <- streams.ShadingPosition_id0.x
    dp4 r3.w, r8.xyzw, cb2[17].xyzw  // r3.w <- streams.ShadingPosition_id0.y
    dp4 r4.w, r8.xyzw, cb2[18].xyzw  // r4.w <- streams.ShadingPosition_id0.z
...
#line 191
    and r8.xyz, r2.wwww, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id93 return value>.x; r8.y <- <CubeVert_id93 return value>.y; r8.z <- <CubeVert_id93 return value>.z
...
#line 191
    and r8.xyz, r2.wwww, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id93 return value>.x; r8.y <- <CubeVert_id93 return value>.y; r8.z <- <CubeVert_id93 return value>.z
...
{
    normal = mul(float4(normal, 0), World_id31).xyz;
