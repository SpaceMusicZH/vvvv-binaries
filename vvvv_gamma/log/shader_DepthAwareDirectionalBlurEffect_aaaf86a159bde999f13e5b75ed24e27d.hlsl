...
@P   - DepthAwareDirectionalBlur.Count: 4
@P DepthAwareDirectionalBlur.TotalTap: 7
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 198 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_DepthAwareDirectionalBlurEffect_aaaf86a159bde999f13e5b75ed24e27d.hlsl"
...
@G    Pixel => 821cd42b83f2187e5f6e0ef5025a28ce
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float TapWeights_id62[4];          // Offset:   96 Size:    52
//   float CoCReference_id63;           // Offset:  148 Size:     4 [unused]
//
// }
//
//
...
//
#line 134 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_DepthAwareDirectionalBlurEffect_aaaf86a159bde999f13e5b75ed24e27d.hlsl"
mul r0.x, cb0[5].z, l(0.333333)
mul r0.xy, r0.xxxx, cb0[0].xyxx  // r0.x <- tapOffset.x; r0.y <- tapOffset.y

#line 145
mul r0.zw, r0.xxxy, cb0[5].xxxy
mad r1.xy, -r0.zwzz, l(2.000000, 2.000000, 0.000000, 0.000000), v1.xyxx  // r1.x <- tapUV.x; r1.y <- tapUV.y
...
#line 163
mul r1.xyzw, r1.xyzw, cb0[8].xxxx

#line 145
mad r2.xy, -r0.zwzz, l(3.000000, 3.000000, 0.000000, 0.000000), v1.xyxx  // r2.x <- tapUV.x; r2.y <- tapUV.y
...
#line 163
mad r1.xyzw, r2.xyzw, cb0[9].xxxx, r1.xyzw  // r1.x <- resultColor.x; r1.y <- resultColor.y; r1.z <- resultColor.z; r1.w <- resultColor.w

#line 145
mad r2.xy, -cb0[5].xyxx, r0.xyxx, v1.xyxx  // r2.x <- tapUV.x; r2.y <- tapUV.y
...
#line 163
mad r1.xyzw, r2.xyzw, cb0[7].xxxx, r1.xyzw
...
#line 163
mad r1.xyzw, r3.xyzw, cb0[7].xxxx, r1.xyzw

#line 150
mad r0.xy, r0.zwzz, l(2.000000, 2.000000, 0.000000, 0.000000), v1.xyxx
mad r0.zw, r0.zzzw, l(0.000000, 0.000000, 3.000000, 3.000000), v1.xxxy  // r0.z <- tapUV.x; r0.w <- tapUV.y
...
#line 164
add r1.x, cb0[8].x, cb0[9].x  // r1.x <- totalWeight
...
***************************
*************************/
const static int TWeightCount_id58 = 4;
const static int TTotalNumber_id59 = 7;
struct PS_STREAMS 
{
