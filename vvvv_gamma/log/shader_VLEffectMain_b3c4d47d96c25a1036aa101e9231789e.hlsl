...
@G    Pixel => 4797b1286336039ad590714c9e25b976
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 732
  ...
  dp4 r4.w, r6.xyzw, cb0[36].xyzw  // r4.w <- shadowPosition.z
  dp4 r5.z, r6.xyzw, cb0[37].xyzw  // r5.z <- shadowPosition.w

#line 733
  add r15.z, r4.w, -cb0[47].x  // r15.z <- shadowPosition.z
...
#line 451
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r18.xyxx, t0.xxxx, s1, r6.z  // r9.w <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r18.zwzz, t0.xxxx, s1, r6.z  // r10.w <- <SampleTextureAndCompare_id129 return value>
...
#line 451
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r20.xyxx, t0.xxxx, s1, r6.z  // r5.z <- <SampleTextureAndCompare_id129 return value>

#line 610
  mad r4.w, r15.x, r5.z, r4.w
...
#line 1160
  dp3_sat r4.w, r14.xyzx, r15.xyzx  // r4.w <- streams.LdotH_id79
...
#line 657
  ...
  mul r5.z, r5.z, r5.z
  mul r4.w, r4.w, r5.z
  mad r15.xyz, r15.xyzx, r4.wwww, r8.xyzx  // r15.x <- <FresnelSchlick_id191 return value>.x; r15.y <- <FresnelSchlick_id191 return value>.y; r15.z <- <FresnelSchlick_id191 return value>.z
...
#line 653
  ...
  div r4.w, r0.y, r4.w  // r4.w <- <VisibilityhSchlickGGX_id207 return value>

#line 775
  mul r4.w, r4.w, r5.w
  mul r2.w, r0.y, r2.w
  div r2.w, r4.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id209 return value>
