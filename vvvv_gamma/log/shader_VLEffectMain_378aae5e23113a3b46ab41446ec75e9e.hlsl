...
@G    Pixel => a5c0cacfcb9fba5a36fb319855a9ba04
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 537
  ishl r5.w, r4.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r6.yzw, r5.wwww, t4.wxyz  // r6.y <- spotLight1.x; r6.z <- spotLight1.y; r6.w <- spotLight1.z
...
mov r5.yz, v0.yyzy  // r5.y <- streams.PositionWS_id22.y; r5.z <- streams.PositionWS_id22.z
...
#line 416
  mov r5.x, r3.w
  add r7.xyz, -r5.xyzx, cb0[29].xyzx  // r7.x <- lightVector.x; r7.y <- lightVector.y; r7.z <- lightVector.z
...
#line 361
  dp3 r5.w, -cb0[30].xyzx, r7.xyzx  // r5.w <- cd

#line 362
  mad_sat r5.w, r5.w, cb0[31].x, cb0[31].y  // r5.w <- attenuation
...
#line 501
  mad r2.xyz, r6.wwww, r3.xyzx, r5.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 450
  dp4 r7.x, r2.xyzw, cb0[34].xyzw  // r7.x <- shadowPosition.x
  dp4 r7.y, r2.xyzw, cb0[35].xyzw  // r7.y <- shadowPosition.y
  dp4 r5.x, r2.xyzw, cb0[36].xyzw  // r5.x <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[37].xyzw  // r2.x <- shadowPosition.w

#line 451
  add r7.z, r5.x, -cb0[47].x  // r7.z <- shadowPosition.z
...
#line 309
  mad r11.xyzw, r9.xwzw, cb0[33].zwzw, r7.xyxy
...
#line 312
  mad r12.xyzw, r9.xyzy, cb0[33].zwzw, r7.xyxy

#line 313
  mad r13.xyzw, r10.xzxw, cb0[33].zwzw, r7.xyxy
...
#line 315
  mad r9.xyzw, r9.xyzy, cb0[33].zwzw, r7.xyxy
  mul r10.zw, r8.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 316
  mad r7.xy, r10.xyxx, cb0[33].zwzz, r7.xyxx
  mul r2.y, r8.y, r8.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r11.xyxx, t0.xxxx, s0, r2.z  // r5.x <- <SampleTextureAndCompare_id86 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r11.zwzz, t0.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id86 return value>

#line 408
  mul r6.w, r6.w, r8.z
  mad r2.x, r2.x, r5.x, r6.w  // r2.x <- shadow

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t0.xxxx, s0, r2.z  // r5.x <- <SampleTextureAndCompare_id86 return value>

#line 408
  mad r2.x, r7.z, r5.x, r2.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r12.xyxx, t0.xxxx, s0, r2.z

#line 408
  mad r2.x, r8.w, r5.x, r2.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r12.zwzz, t0.xxxx, s0, r2.z
...
#line 408
  mad r2.x, r10.z, r5.x, r2.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r9.xyxx, t0.xxxx, s0, r2.z

#line 408
  mad r2.x, r7.w, r5.x, r2.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r9.zwzz, t0.xxxx, s0, r2.z

#line 408
  mad r2.x, r10.w, r5.x, r2.x

#line 321
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r7.xyxx, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id86 return value>
...
#line 609
  mul r7.xyz, r4.wwww, cb0[32].xyzx
