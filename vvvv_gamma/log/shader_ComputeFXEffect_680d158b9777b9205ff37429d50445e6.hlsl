...
@P Dim: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat3<Input_32> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i5,PerUpdate>}], mixin AssignVarFloat4<SMVideoBufferSelector_ShaderFXResult_1> [{Value = SMVideoBufferSelector_ShaderFX}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_13> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<SMVideoBufferSelector_ShaderFXResult_1>}]}], ComputeVoid, ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_34> [{Value = mixin SampleLevelTextureFloat4<ObjectTexture_fx33,PerUpdate,ObjectSampler_fx8,PerUpdate> [{LOD = ConstantFloat<0>}, {TexCd = GetSemanticFloat2<SemanticValue_35,TEXCOORD2>}]}], mixin AssignVarFloat<SMCalcLuminance_ShaderFXResult_36> [{Value = mixin SMCalcLuminance_ShaderFX [{Color = GetVarFloat4<TextureValue_34>}]}], mixin AssignVarFloat<Multiply_37> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_13>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_36>}]}], mixin AssignVarFloat<Multiply_38> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_13>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_36>}]}], mixin AssignVarFloat<Multiply_39> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<SMCalcLuminance_ShaderFXResult_13>}, {Right = GetVarFloat<SMCalcLuminance_ShaderFXResult_36>}]}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_40> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Multiply_37>}, {Y = GetVarFloat<Multiply_38>}, {Z = GetVarFloat<Multiply_39>}]}], mixin AssignVarFloat3<Input_41> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i6,PerUpdate>}], mixin AssignVarFloat3<Multiply_42> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_40>}, {Right = GetVarFloat3<Input_41>}]}], mixin AssignVarFloat3<Plus_43> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Input_32>}, {Right = GetVarFloat3<Multiply_42>}]}], mixin AssignVarFloat3<Input_44> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i7,PerUpdate>}], mixin AssignVarFloat3<Multiply_45> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<Plus_43>}, {Right = GetVarFloat3<Input_44>}]}]]}]}, {Value = GetVarFloat3<Multiply_45>}]
...
@C    InputValue_id309 => ShaderFX.InputValueUInt
@C    InputValue_id330 => ShaderFX.InputValueFloat
...
@R    DynamicTexture_id130 => ObjectTexture_fx33 [Stage: Compute, Slot: (3-3)]
@R    DynamicTexture_id231 => ObjectTexture_fx20 [Stage: Compute, Slot: (4-4)]
@R    DynamicBuffer_id316 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id323 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => 0b8a224c1ee1355300f4a3dca9af7cfd
//
...
//   uint InputValue_id309;             // Offset:  156 Size:     4
//   float InputValue_id330;            // Offset:  160 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicBuffer_id316               texture  float4         buf             t5      1 
// DynamicTexture_id323              texture  float4          2d             t6      1 
...
//
#line 1393 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_680d158b9777b9205ff37429d50445e6.hlsl"
...
#line 663
  mad r11.xyz, cb1[7].wwww, cb1[8].xyzx, cb1[9].xyzx  // r11.x <- <Compute_id515 return value>.x; r11.y <- <Compute_id515 return value>.y; r11.z <- <Compute_id515 return value>.z
...
#line 659
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id403 return value>.x; r12.y <- <Compute_id403 return value>.y; r12.z <- <Compute_id403 return value>.z
...
#line 630
  mad r12.xyz, r12.xyzx, cb1[5].xyzx, cb1[6].xyzx  // r12.x <- <Compute_id452 return value>.x; r12.y <- <Compute_id452 return value>.y; r12.z <- <Compute_id452 return value>.z

#line 622
  add r12.xyz, r12.xyzx, cb1[7].xyzx  // r12.x <- <Compute_id460 return value>.x; r12.y <- <Compute_id460 return value>.y; r12.z <- <Compute_id460 return value>.z
...
#line 602
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.xzxx, t3.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id168 return value>.x; r12.y <- <Compute_id168 return value>.y; r12.z <- <Compute_id168 return value>.z

#line 353
  dp3 r1.w, r12.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r1.w <- <Luminance_id51 return value>

#line 593
  mul r0.w, r0.w, r1.w  // r0.w <- <Compute_id197 return value>

#line 569
  mad r12.xyz, r0.wwww, cb1[1].xyzx, cb1[0].xyzx  // r12.x <- <Compute_id231 return value>.x; r12.y <- <Compute_id231 return value>.y; r12.z <- <Compute_id231 return value>.z

#line 561
  mul r13.xyz, r12.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id239 return value>.x; r13.y <- <Compute_id239 return value>.y; r13.z <- <Compute_id239 return value>.z
...
#line 534
  mul r13.xyz, r12.xyyx, cb1[2].wwww  // r13.z <- <Compute_id338 return value>

#line 510
  mad r13.xyz, r13.xyzx, cb1[3].xyzx, cb1[4].xyzx  // r13.x <- <Compute_id368 return value>.x; r13.y <- <Compute_id368 return value>.y; r13.z <- <Compute_id368 return value>.z
...
#line 721
  ...
  mul r0.w, r0.w, r12.y
  round_ne r0.w, r0.w
  ftou r0.w, r0.w  // r0.w <- <Compute_id81 return value>

#line 715
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r0.wwww, t5.xyzw  // r13.x <- <Compute_id85 return value>.x; r13.y <- <Compute_id85 return value>.y; r13.z <- <Compute_id85 return value>.z
...
#line 486
  ...
  mul r15.xyz, r13.xyzx, r14.xyzx  // r15.x <- <SRgbToLinear_id533 return value>.x; r15.y <- <SRgbToLinear_id533 return value>.y; r15.z <- <SRgbToLinear_id533 return value>.z
...
#line 699
  ...
  mad r6.yzw, cb1[10].xxxx, r6.yyzw, r15.xxyz  // r6.y <- <Compute_id105 return value>.x; r6.z <- <Compute_id105 return value>.y; r6.w <- <Compute_id105 return value>.z
...
#line 457
  dp3 r0.w, r12.xzwx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r0.w <- <Luminance_id65 return value>
...
const static float Value_id324 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Input_14_id280;
    float3 SMVector3Join_ShaderFXResult_15_id283;
    float3 Input_16_id288;
    float3 Multiply_17_id291;
    float3 Input_18_id295;
    float3 Plus_19_id298;
    float4 TextureValue_21_id230;
    float SMCalcLuminance_ShaderFXResult_23_id237;
    float Input_24_id248;
    float3 SMVector3Join_ShaderFXResult_25_id251;
    float3 Input_26_id256;
    float3 Multiply_27_id259;
    float3 Input_28_id263;
    float3 Plus_29_id266;
    float3 Input_30_id270;
    float3 Plus_31_id273;
    float3 Input_32_id107;
    float4 SMVideoBufferSelector_ShaderFXResult_1_id110;
    float SMCalcLuminance_ShaderFXResult_13_id118;
    float4 TextureValue_34_id129;
    float SMCalcLuminance_ShaderFXResult_36_id137;
    float Multiply_37_id148;
    float Multiply_38_id152;
    float Multiply_39_id156;
    float3 SMVector3Join_ShaderFXResult_40_id160;
    float3 Input_41_id165;
    float3 Multiply_42_id168;
    float3 Plus_43_id172;
    float3 Input_44_id176;
    float3 Multiply_45_id179;
    float r_46_id187;
    float Input_47_id190;
    float Multiply_48_id193;
    float g_2_id197;
    ...
    uint Input_3_id308;
    uint SMValueToIndex_ShaderFXResult_4_id311;
    float4 BufferItem_5_id315;
    float4 SRgbToLinear_ShaderFXResult_6_id319;
    float4 TextureValue_9_id322;
    float Input_11_id329;
    float4 Lerp_12_id332;
};
struct CS_INPUT 
{
...
cbuffer PerUpdate 
{
    ...
    uint InputValue_id309;
    float InputValue_id330;
};
cbuffer Globals 
{
...
Buffer<float4> DynamicBuffer_id316;
Texture2D DynamicTexture_id323;
...
{
    return streams.Multiply_48_id193;
}
float Compute_id341(inout CS_STREAMS streams)
{
    return streams.Input_47_id190;
}
...
float Compute_id323(inout CS_STREAMS streams)
{
    return streams.r_46_id187;
}
float4 Compute_id317(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
...
float4 Compute_id169(inout CS_STREAMS streams)
{
    return streams.TextureValue_34_id129;
}
float Compute_id163()
{
    return Value_id324;
}
float2 Compute_id165(inout CS_STREAMS streams)
{
...
{
    return streams.Input_30_id270;
}
float3 Compute_id455(inout CS_STREAMS streams)
{
    return streams.Plus_29_id266;
}
float3 Compute_id449(inout CS_STREAMS streams)
{
    return streams.Input_28_id263;
}
float3 Compute_id447(inout CS_STREAMS streams)
{
    return streams.Multiply_27_id259;
}
float3 Compute_id441(inout CS_STREAMS streams)
{
    return streams.Input_26_id256;
}
float3 Compute_id439(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_25_id251;
}
float Compute_id433(inout CS_STREAMS streams)
{
    return streams.Input_24_id248;
}
float Compute_id431(inout CS_STREAMS streams)
{
    return streams.Input_24_id248;
}
...
{
    return streams.Input_18_id295;
}
float3 Compute_id510(inout CS_STREAMS streams)
{
    return streams.Multiply_17_id291;
}
float3 Compute_id504(inout CS_STREAMS streams)
{
    return streams.Input_16_id288;
}
float3 Compute_id502(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_15_id283;
}
float Compute_id496(inout CS_STREAMS streams)
{
    return streams.Input_14_id280;
}
float Compute_id494(inout CS_STREAMS streams)
{
    return streams.Input_14_id280;
}
float Compute_id492(inout CS_STREAMS streams)
{
    return streams.Input_14_id280;
}
...
float4 Compute_id281(inout CS_STREAMS streams)
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id110;
}
float Compute_id102(inout CS_STREAMS streams)
{
    return streams.Input_11_id329;
}
float4 Compute_id100(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id322;
}
float4 Compute_id98(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id319;
}
float Compute_id90()
{
    return Value_id324;
...
float4 SRgbToLinear_id533(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id315;
}
uint Compute_id82(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id311;
}
uint Compute_id76(inout CS_STREAMS streams)
{
    return streams.Input_3_id308;
}
...
{
    return float3(Compute_id345(streams), Compute_id347(streams), Compute_id349(streams));
}
...
{
    return Compute_id329(streams).g;
}
...
{
    return Compute_id317(streams).r;
}
...
{
    return Compute_id192(streams) * Compute_id194(streams);
}
float Compute_id191(inout CS_STREAMS streams)
{
    float4 color = Compute_id169(streams);
    return Luminance_id51(color.rgb);
}
float4 Compute_id168(inout CS_STREAMS streams)
{
    return DynamicTexture_id130.SampleLevel(DynamicSampler_id131, Compute_id165(streams), Compute_id163());
}
float Compute_id162(inout CS_STREAMS streams)
{
    float4 color = Compute_id140(streams);
...
{
    return Compute_id455(streams) + Compute_id457(streams);
}
float3 Compute_id453()
{
    return InputValue_id271;
}
float3 Compute_id452(inout CS_STREAMS streams)
{
    return Compute_id447(streams) + Compute_id449(streams);
}
float3 Compute_id445()
{
    return InputValue_id264;
}
float3 Compute_id444(inout CS_STREAMS streams)
{
    return Compute_id439(streams) * Compute_id441(streams);
}
float3 Compute_id437()
{
    return InputValue_id257;
}
float3 Compute_id436(inout CS_STREAMS streams)
{
    return float3(Compute_id429(streams), Compute_id431(streams), Compute_id433(streams));
}
float Compute_id427()
{
...
{
    return DynamicTexture_id231.SampleLevel(DynamicSampler_id131, Compute_id400(streams), Compute_id398());
}
...
{
    return Compute_id502(streams) * Compute_id504(streams);
}
...
{
    return float3(Compute_id492(streams), Compute_id494(streams), Compute_id496(streams));
}
float Compute_id490()
{
    return InputValue_id281;
}
float Compute_id303(inout CS_STREAMS streams)
{
    float4 color = Compute_id281(streams);
...
{
    return DynamicTexture_id323.SampleLevel(DynamicSampler_id131, Compute_id92(streams), Compute_id90());
}
float4 Compute_id89(inout CS_STREAMS streams)
{
    return SRgbToLinear_id533(Compute_id86(streams));
}
float4 Compute_id85(inout CS_STREAMS streams)
{
    return DynamicBuffer_id316[Compute_id82(streams)];
}
...
{
    streams.Plus_55_id223 = Compute_id368(streams);
}
void Compute_id390(inout CS_STREAMS streams)
{
    streams.Input_54_id220 = Compute_id361();
}
void Compute_id388(inout CS_STREAMS streams)
{
    streams.Multiply_53_id216 = Compute_id360(streams);
}
void Compute_id386(inout CS_STREAMS streams)
{
    streams.Input_52_id213 = Compute_id353();
}
void Compute_id384(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_51_id208 = Compute_id352(streams);
}
void Compute_id382(inout CS_STREAMS streams)
{
    streams.Multiply_50_id204 = Compute_id344(streams);
}
void Compute_id380(inout CS_STREAMS streams)
{
    streams.Multiply_49_id200 = Compute_id338(streams);
}
void Compute_id378(inout CS_STREAMS streams)
{
    streams.g_2_id197 = Compute_id332(streams);
}
void Compute_id376(inout CS_STREAMS streams)
{
    streams.Multiply_48_id193 = Compute_id328(streams);
}
void Compute_id374(inout CS_STREAMS streams)
{
    streams.Input_47_id190 = Compute_id321();
}
void Compute_id372(inout CS_STREAMS streams)
{
    streams.r_46_id187 = Compute_id320(streams);
}
...
{
    streams.Multiply_45_id179 = Compute_id239(streams);
}
...
{
    streams.Multiply_42_id168 = Compute_id225(streams);
}
void Compute_id263(inout CS_STREAMS streams)
{
    streams.Input_41_id165 = Compute_id218();
}
void Compute_id261(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_40_id160 = Compute_id217(streams);
}
void Compute_id259(inout CS_STREAMS streams)
{
    streams.Multiply_39_id156 = Compute_id209(streams);
}
void Compute_id257(inout CS_STREAMS streams)
{
    streams.Multiply_38_id152 = Compute_id203(streams);
}
void Compute_id255(inout CS_STREAMS streams)
{
    streams.Multiply_37_id148 = Compute_id197(streams);
}
void Compute_id253(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_36_id137 = Compute_id191(streams);
}
void Compute_id251(inout CS_STREAMS streams)
{
    streams.TextureValue_34_id129 = Compute_id168(streams);
}
void Compute_id249()
{
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id162(streams);
}
...
{
    streams.Input_32_id107 = Compute_id134();
}
void Compute_id484(inout CS_STREAMS streams)
{
    streams.Plus_31_id273 = Compute_id460(streams);
}
void Compute_id482(inout CS_STREAMS streams)
{
    streams.Input_30_id270 = Compute_id453();
}
void Compute_id480(inout CS_STREAMS streams)
{
    streams.Plus_29_id266 = Compute_id452(streams);
}
void Compute_id478(inout CS_STREAMS streams)
{
    streams.Input_28_id263 = Compute_id445();
}
void Compute_id476(inout CS_STREAMS streams)
{
    streams.Multiply_27_id259 = Compute_id444(streams);
}
void Compute_id474(inout CS_STREAMS streams)
{
    streams.Input_26_id256 = Compute_id437();
}
void Compute_id472(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_25_id251 = Compute_id436(streams);
}
void Compute_id470(inout CS_STREAMS streams)
{
    streams.Input_24_id248 = Compute_id427();
}
void Compute_id468(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_23_id237 = Compute_id426(streams);
}
void Compute_id466(inout CS_STREAMS streams)
{
    streams.TextureValue_21_id230 = Compute_id403(streams);
}
void Compute_id464()
{
}
...
{
    streams.Plus_19_id298 = Compute_id515(streams);
}
void Compute_id525(inout CS_STREAMS streams)
{
    streams.Input_18_id295 = Compute_id508();
}
void Compute_id523(inout CS_STREAMS streams)
{
    streams.Multiply_17_id291 = Compute_id507(streams);
}
void Compute_id521(inout CS_STREAMS streams)
{
    streams.Input_16_id288 = Compute_id500();
}
void Compute_id519(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_15_id283 = Compute_id499(streams);
}
void Compute_id517(inout CS_STREAMS streams)
{
    streams.Input_14_id280 = Compute_id490();
}
void Compute_id307(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id118 = Compute_id303(streams);
}
...
{
    streams.Lerp_12_id332 = Compute_id105(streams);
}
void Compute_id126(inout CS_STREAMS streams)
{
    streams.Input_11_id329 = Compute_id96();
}
void Compute_id124(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id322 = Compute_id95(streams);
}
void Compute_id122()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id319 = Compute_id89(streams);
}
void Compute_id116(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id315 = Compute_id85(streams);
}
void Compute_id114(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id311 = Compute_id81(streams);
}
void Compute_id112(inout CS_STREAMS streams)
{
    streams.Input_3_id308 = Compute_id74();
}
void Compute_id110(inout CS_STREAMS streams)
{
    streams.g_2_id197 = Compute_id73(streams);
}
...
{
    return streams.Multiply_45_id179;
}
