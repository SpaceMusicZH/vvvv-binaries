...
@C    constantColor_id200 => Material.DiffuseValue
...
//
#line 1245 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7ea12e808ea17fd03e8fc0020c729fc.hlsl"
...
@G    Pixel => 29f716ef00f1e189ddf4223376df18c2
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 constantColor_id200;        // Offset:    0 Size:    16
//
// }
//
// cbuffer PerView
...
//
#line 1312 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7ea12e808ea17fd03e8fc0020c729fc.hlsl"
...
#line 964
  ...
  mul r2.xyz, r2.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id252 return value>.x; r2.y <- <ComputeDirectLightContribution_id252 return value>.y; r2.z <- <ComputeDirectLightContribution_id252 return value>.z
...
#line 955
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id178 return value>
...
#line 933
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id190 return value>
...
#line 307
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id108 return value>
...
#line 863
mul r0.xyz, r0.xyzx, cb1[0].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id253 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id253 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id253 return value>.z
...
float4 EvaluateSphericalHarmonics_id121(float3 sphericalColors[TOrder_id190 * TOrder_id190], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float4 Compute_id236(inout PS_STREAMS streams, float3 direction)
{
...
{
    return EvaluateSphericalHarmonics_id121(SphericalColors_id193, direction);
}
...
void ResetStream_id140()
{
}
void AfterLightingAndShading_id260()
{
}
...
void PrepareEnvironmentLight_id246(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id231(sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id236(streams, sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id253(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id187(inout PS_STREAMS streams, int lightIndex)
{
...
void PrepareDirectLights_id185()
{
}
...
int GetLightCount_id179(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y & 0xFFFF;
}
int GetMaxLightCount_id178(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y & 0xFFFF;
}
void PrepareDirectLights_id177(inout PS_STREAMS streams)
{
    PrepareLightData_id79(streams);
}
float3 ComputeDirectLightContribution_id252(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareDirectLight_id150(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id152()
{
    return LightCount_id86;
}
int GetMaxLightCount_id153()
{
    return TMaxLightCount_id87;
}
void PrepareDirectLights_id148()
{
}
void PrepareForLightingAndShading_id257()
{
}
...
void ResetStream_id141(inout PS_STREAMS streams)
{
    ResetStream_id140();
...
void Compute_id294(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id257();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id148();
        const int maxLightCount = GetMaxLightCount_id153();
        int count = GetLightCount_id152();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id150(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);

            {
                directLightingContribution += ComputeDirectLightContribution_id252(streams);
            }
        }
    }

    {
        PrepareDirectLights_id177(streams);
        const int maxLightCount = GetMaxLightCount_id178(streams);
        int count = GetLightCount_id179(streams);
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id187(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id253(streams);
        }
    }
...
void ResetStream_id142(inout PS_STREAMS streams)
{
    ResetStream_id141(streams);
