...
//
#line 1695 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_60fbc66a7a66024dcb24f59440a388c5.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
mov o3.xyz, v2.xyzx
...
//
//   } Lights_id199[2];                 // Offset:  464 Size:   124 [unused]
//   float2 ShadowMapTextureSize_id201; // Offset:  592 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id202;// Offset:  600 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id206[2];// Offset:  608 Size:   128 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id207[2];// Offset:  736 Size:   128 [unused]
//   float4x4 ViewMatrices_id208[2];    // Offset:  864 Size:   128 [unused]
//   float2 DepthRanges_id209[2];       // Offset:  992 Size:    24 [unused]
//   float DepthBiases_id210[2];        // Offset: 1024 Size:    20 [unused]
//   float OffsetScales_id211[2];       // Offset: 1056 Size:    20 [unused]
...
//
#line 1653 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_60fbc66a7a66024dcb24f59440a388c5.hlsl"
...
@G    Pixel => 21503a95e11a8c732633849f1e7e8016
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id199[2];                 // Offset:  464 Size:   124
//   float2 ShadowMapTextureSize_id201; // Offset:  592 Size:     8
//   float2 ShadowMapTextureTexelSize_id202;// Offset:  600 Size:     8
//   float4x4 WorldToShadowCascadeUV_id206[2];// Offset:  608 Size:   128
//   float4x4 InverseWorldToShadowCascadeUV_id207[2];// Offset:  736 Size:   128 [unused]
//   float4x4 ViewMatrices_id208[2];    // Offset:  864 Size:   128 [unused]
//   float2 DepthRanges_id209[2];       // Offset:  992 Size:    24 [unused]
//   float DepthBiases_id210[2];        // Offset: 1024 Size:    20
//   float OffsetScales_id211[2];       // Offset: 1056 Size:    20
//   float4 _padding_PerDraw_Lighting;  // Offset: 1088 Size:    16 [unused]
//
// }
//
...
//
#line 1538 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_60fbc66a7a66024dcb24f59440a388c5.hlsl"
...
#line 643
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, v5.x, l(48), t1.xyzx  // r4.x <- p.Col.x; r4.y <- p.Col.y; r4.z <- p.Col.z
...
max r6.y, r2.z, l(0.000100)  // r6.y <- streams.NdotV_id74
...
#line 846
dp2 r2.z, cb2[82].xxxx, cb2[28].zzzz
...
mov r8.w, r1.x  // r8.w <- streams.PositionWS_id24.x
mov r9.xy, r1.yzyy  // r9.x <- streams.PositionWS_id24.y; r9.y <- streams.PositionWS_id24.z
...
mov r2.w, r1.w  // r2.w <- streams.DepthVS_id25
mov r3.w, r6.y  // r3.w <- streams.NdotV_id74
mov r4.w, l(0)  // r4.w <- i
loop 
  ige r6.z, r4.w, l(1)
  breakc_nz r6.z
...
#line 1027
  lt r10.w, cb2[r6.w + 83].x, r2.w

#line 1030
  and r10.w, r10.w, l(1)  // r10.w <- cascadeIndex

#line 1027
  bfi r14.xy, l(30, 30, 0, 0), l(2, 2, 0, 0), r4.wwww, l(1, 2, 0, 0)
  lt r11.w, cb2[r14.x + 83].x, r2.w

#line 1030
  movc r10.w, r11.w, l(2), r10.w

#line 1027
  lt r11.w, cb2[r14.y + 83].x, r2.w

#line 1030
  movc r10.w, r11.w, l(3), r10.w

#line 845
  add r13.w, -r6.z, l(1.000000)
  max r13.w, r13.w, l(0.000000)  // r13.w <- normalOffsetScale

#line 846
  mul r13.w, r2.z, r13.w

#line 1035
  mov r14.x, r8.w
  mov r14.yz, r9.xxyx
  mad r7.xyz, r13.wwww, r8.xyzx, r14.xyzx  // r7.x <- shadowPosition.x; r7.y <- shadowPosition.y; r7.z <- shadowPosition.z

#line 838
  bfi r13.w, l(30), l(2), r4.w, r10.w
  ishl r14.x, r10.w, l(2)
  bfi r14.x, l(30), l(4), r4.w, r14.x
  dp4 r15.x, r7.xyzw, cb2[r14.x + 29].xyzw  // r15.x <- shadowPosition.x
  dp4 r15.y, r7.xyzw, cb2[r14.x + 30].xyzw  // r15.y <- shadowPosition.y
  dp4 r14.y, r7.xyzw, cb2[r14.x + 31].xyzw  // r14.y <- shadowPosition.z
  dp4 r14.x, r7.xyzw, cb2[r14.x + 32].xyzw  // r14.x <- shadowPosition.w

#line 839
  add r15.z, r14.y, -cb2[81].x  // r15.z <- shadowPosition.z

#line 840
  div r14.xyz, r15.xyzx, r14.xxxx  // r14.x <- shadowPosition.x; r14.y <- shadowPosition.y; r14.z <- shadowPosition.z

#line 627
  mad r14.xy, r14.xyxx, cb2[28].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r15.xy, r14.xyxx  // r15.x <- base_uv.x; r15.y <- base_uv.y

#line 628
  add r14.xy, r14.xyxx, -r15.xyxx  // r14.x <- st.x; r14.y <- st.y

#line 629
  add r15.xy, r15.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)

#line 630
  mul r15.xy, r15.xyxx, cb2[28].zwzz

#line 442
  mad r16.xyzw, r14.xyyx, l(11.000000, 11.000000, 11.000000, 11.000000), l(-28.000000, -28.000000, 17.000000, 17.000000)  // r16.x <- uvW1.x; r16.y <- uvW1.y

#line 443
  mad r17.xyzw, r14.yxxy, l(5.000000, 5.000000, 5.000000, 5.000000), l(-6.000000, -6.000000, 1.000000, 1.000000)  // r17.x <- uvW0.y; r17.y <- uvW0.x

#line 445
  mad r18.xyzw, r14.xyxy, l(4.000000, 4.000000, 4.000000, 4.000000), l(-5.000000, -5.000000, -16.000000, -16.000000)

#line 444
  div r15.zw, r18.xxxy, r17.yyyx
  add r19.xw, r15.zzzw, l(-3.000000, 0.000000, 0.000000, -3.000000)  // r19.x <- uv0.x; r19.w <- uv0.y

#line 445
  div r15.zw, r18.zzzw, r16.xxxy
  add r19.yz, r15.wwzw, l(0.000000, -1.000000, -1.000000, 0.000000)  // r19.y <- uv1.y; r19.z <- uv1.x

#line 446
  mad r15.zw, r14.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000), l(0.000000, 0.000000, 5.000000, 5.000000)
  div r15.zw, r15.zzzw, r16.wwwz
  add r18.xw, r15.wwwz, l(1.000000, 0.000000, 0.000000, 1.000000)  // r18.x <- uv2.y; r18.w <- uv2.x

#line 447
  div r14.xy, r14.xyxx, r17.zwzz
  add r20.xy, r14.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)  // r20.x <- uv3.x; r20.y <- uv3.y

#line 449
  mad r21.xyzw, r19.xwzw, cb2[28].zwzw, r15.xyxy
...
#line 453
  mad r22.xyzw, r19.xyzy, cb2[28].zwzw, r15.xyxy

#line 454
  mad r23.xyzw, r18.wywz, cb2[28].zwzw, r15.xyxy

#line 455
  mad r24.xyzw, r20.xzxw, cb2[28].zwzw, r15.xyxy

#line 456
  mov r19.y, r18.x
  mul r14.xy, -r16.wzww, r17.xyxx

#line 457
  mad r25.xyzw, r19.xyzy, cb2[28].zwzw, r15.xyxy
  mul r15.zw, r16.yyyx, -r16.wwwz

#line 458
  mad r20.zw, r18.wwwx, cb2[28].zzzw, r15.xxxy
  mul r26.xy, r16.yzyy, r16.xwxx

#line 459
  mov r19.w, r20.x
  mad r19.yw, r19.wwwy, cb2[28].zzzw, r15.xxxy
...
#line 460
  mov r18.y, r20.y
  mul r19.xz, r17.xxyx, -r17.zzwz

#line 461
  mad r27.xyzw, r18.xyzy, cb2[28].zwzw, r15.xyxy
  mul r18.xz, r16.yyxy, -r17.zzwz

#line 462
  mad r18.yw, r18.wwwy, cb2[28].zzzw, r15.xxxy
  mul r16.xyzw, r16.xyzw, r17.xyzw

#line 463
  mad r15.xy, r20.xyxx, cb2[28].zwzz, r15.xyxx
  mul r17.xy, r17.xwxx, r17.yzyy

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r21.xyxx, t3.xxxx, s1, r14.z  // r14.w <- <SampleTextureAndCompare_id111 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r17.z, r21.zwzz, t3.xxxx, s1, r14.z  // r17.z <- <SampleTextureAndCompare_id111 return value>

#line 737
  mul r16.x, r16.x, r17.z
  mad r14.w, r17.x, r14.w, r16.x  // r14.w <- shadow

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r16.x, r23.xyxx, t3.xxxx, s1, r14.z  // r16.x <- <SampleTextureAndCompare_id111 return value>

#line 737
  mad r14.x, r14.x, r16.x, r14.w  // r14.x <- shadow

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r24.xyxx, t3.xxxx, s1, r14.z  // r14.w <- <SampleTextureAndCompare_id111 return value>

#line 737
  mad r14.x, r19.x, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r22.xyxx, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r16.y, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r22.zwzz, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r26.x, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r23.zwzz, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r15.z, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r24.zwzz, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r18.x, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.w, r25.xyxx, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r14.y, r14.w, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r25.zwzz, t3.xxxx, s1, r14.z  // r14.y <- <SampleTextureAndCompare_id111 return value>

#line 737
  mad r14.x, r15.w, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r20.zwzz, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r26.y, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r19.ywyy, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r16.z, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r27.xyxx, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r19.z, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r27.zwzz, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r18.z, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r18.ywyy, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r16.w, r14.y, r14.x

#line 622
  sample_c_lz_indexable(texture2d)(float,float,float,float) r14.y, r15.xyxx, t3.xxxx, s1, r14.z

#line 737
  mad r14.x, r17.y, r14.y, r14.x

#line 739
  mul r14.yzw, r14.xxxx, l(0.000000, 0.000370, 0.000370, 0.000370)  // r14.w <- shadow
...
#line 1043
    iadd r15.x, r13.w, l(-1)
    add r15.x, -cb2[r15.x + 83].x, cb2[r13.w + 83].x  // r15.x <- splitSize

#line 1044
  else 
    mov r15.x, cb2[r13.w + 83].x  // r15.x <- splitSize
  endif 

#line 1045
  add r13.w, -r2.w, cb2[r13.w + 83].x
  div r13.w, r13.w, r15.x  // r13.w <- splitDist

#line 1046
  lt r15.x, r13.w, l(0.200000)
  if_nz r15.x
...
#line 1051
      mov r14.yzw, r14.wwww  // r14.y <- shadow.x; r14.z <- shadow.y; r14.w <- shadow.z
    else 

#line 1048
      mul_sat r11.w, r13.w, l(5.000000)
      mad r13.w, r11.w, l(-2.000000), l(3.000000)
      mul r11.w, r11.w, r11.w
      mul r11.w, r11.w, r13.w  // r11.w <- lerpAmt

#line 838
      ishl r6.w, r6.w, l(2)
      imad r6.w, r10.w, l(4), r6.w
      iadd r6.w, r6.w, l(4)
      dp4 r15.x, r7.xyzw, cb2[r6.w + 29].xyzw  // r15.x <- shadowPosition.x
      dp4 r15.y, r7.xyzw, cb2[r6.w + 30].xyzw  // r15.y <- shadowPosition.y
      dp4 r10.w, r7.xyzw, cb2[r6.w + 31].xyzw  // r10.w <- shadowPosition.z
      dp4 r6.w, r7.xyzw, cb2[r6.w + 32].xyzw  // r6.w <- shadowPosition.w

#line 839
      add r15.z, r10.w, -cb2[81].x  // r15.z <- shadowPosition.z
...
#line 627
      ...
      round_ni r15.xy, r7.xyxx  // r15.x <- base_uv.x; r15.y <- base_uv.y

#line 628
      add r7.xy, r7.xyxx, -r15.xyxx  // r7.x <- st.x; r7.y <- st.y
...
#line 442
      mad r16.xyzw, r7.xyyx, l(11.000000, 11.000000, 11.000000, 11.000000), l(-28.000000, -28.000000, 17.000000, 17.000000)  // r16.x <- uvW1.x; r16.y <- uvW1.y

#line 443
      mad r17.xyzw, r7.yxxy, l(5.000000, 5.000000, 5.000000, 5.000000), l(-6.000000, -6.000000, 1.000000, 1.000000)  // r17.x <- uvW0.y; r17.y <- uvW0.x

#line 445
      mad r18.xyzw, r7.xyxy, l(4.000000, 4.000000, 4.000000, 4.000000), l(-5.000000, -5.000000, -16.000000, -16.000000)
...
#line 446
      mad r15.zw, r7.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000), l(0.000000, 0.000000, 5.000000, 5.000000)
      div r15.zw, r15.zzzw, r16.wwwz
      add r18.xw, r15.wwwz, l(1.000000, 0.000000, 0.000000, 1.000000)  // r18.x <- uv2.y; r18.w <- uv2.x

#line 447
      div r7.xy, r7.xyxx, r17.zwzz
      add r20.xy, r7.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)  // r20.x <- uv3.x; r20.y <- uv3.y
...
#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r21.xyxx, t3.xxxx, s1, r7.z  // r6.w <- <SampleTextureAndCompare_id111 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r21.zwzz, t3.xxxx, s1, r7.z  // r10.w <- <SampleTextureAndCompare_id111 return value>

#line 737
      mul r10.w, r10.w, r16.x
      mad r6.w, r17.x, r6.w, r10.w  // r6.w <- shadow

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r23.xyxx, t3.xxxx, s1, r7.z  // r10.w <- <SampleTextureAndCompare_id111 return value>

#line 737
      mad r6.w, r7.x, r10.w, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r24.xyxx, t3.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id111 return value>

#line 737
      mad r6.w, r19.x, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r22.xyxx, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r16.y, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r22.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r26.x, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r23.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r15.z, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r24.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r18.x, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r25.xyxx, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r7.y, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r25.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r15.w, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r20.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r26.y, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r19.ywyy, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r16.z, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r27.xyxx, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r19.z, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r27.zwzz, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r18.z, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r18.ywyy, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r16.w, r7.x, r6.w

#line 622
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r15.xyxx, t3.xxxx, s1, r7.z

#line 737
      mad r6.w, r17.y, r7.x, r6.w

#line 739
      mul r6.w, r6.w, l(0.000370)

#line 1055
      mad r7.x, r14.x, l(0.000370), -r6.w
      mad r14.yzw, r11.wwww, r7.xxxx, r6.wwww  // r14.y <- shadow.x; r14.z <- shadow.y; r14.w <- shadow.z
...
#line 1218
  mul r7.xyz, r14.yzwy, cb2[27].xyzx
  mul r7.xyz, r6.zzzz, r7.xyzx  // r7.x <- streams.lightColorNdotL_id46.x; r7.y <- streams.lightColorNdotL_id46.y; r7.z <- streams.lightColorNdotL_id46.z

#line 1208
  mov r10.xy, r9.zwzz
  add r10.xyw, r10.xyxz, -cb2[26].xyxz
  dp3 r6.w, r10.xywx, r10.xywx
  rsq r6.w, r6.w
  mul r10.xyw, r6.wwww, r10.xyxw  // r10.x <- streams.H_id77.x; r10.y <- streams.H_id77.y; r10.w <- streams.H_id77.z

#line 1209
  dp3_sat r6.w, r8.xyzx, r10.xywx  // r6.w <- streams.NdotH_id78

#line 1210
  dp3_sat r10.x, -cb2[26].xyzx, r10.xywx  // r10.x <- streams.LdotH_id79

#line 1204
  mul r14.xyz, r7.xyzx, r11.xyzx
...
#line 707
  ...
  mad r10.xyw, r15.xyxz, r10.xxxx, r12.xyxz  // r10.x <- <FresnelSchlick_id223 return value>.x; r10.y <- <FresnelSchlick_id223 return value>.y; r10.w <- <FresnelSchlick_id223 return value>.z

#line 702
  mul r11.w, r12.w, l(0.500000)  // r11.w <- k

#line 703
  mad r13.w, -r12.w, l(0.500000), l(1.000000)
  mad r14.w, r6.z, r13.w, r11.w
  div r14.w, r6.z, r14.w  // r14.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r11.w, r3.w, r13.w, r11.w
  div r11.w, r3.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id239 return value>

#line 825
  mul r11.w, r11.w, r14.w
  mul r6.z, r3.w, r6.z
  div r6.z, r11.w, r6.z  // r6.z <- <VisibilitySmithSchlickGGX_id241 return value>

#line 819
  mul r11.w, r12.w, r12.w  // r11.w <- alphaR2

#line 820
  mul r6.w, r6.w, r6.w
  mad r13.w, r12.w, r12.w, l(-1.000000)
  mad r6.w, r6.w, r13.w, l(1.000000)
  max r6.w, r6.w, l(0.000100)  // r6.w <- d

#line 821
  mul r6.w, r6.w, r6.w
  mul r6.w, r6.w, l(3.141593)
  div r6.w, r11.w, r6.w  // r6.w <- <NormalDistributionGGX_id253 return value>
...
ftoi r7.xy, r2.xyxx
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r2.xy, r7.xyzw, t4.xyzw  // r2.x <- streams.lightData_id188.x; r2.y <- streams.lightData_id188.y
...
mov r2.z, r2.x  // r2.z <- streams.lightIndex_id189
...
#line 979
  ld_indexable(buffer)(uint,uint,uint,uint) r4.w, r2.zzzz, t5.yzwx  // r4.w <- realLightIndex

#line 980
  iadd r2.z, r2.z, l(1)  // r2.z <- streams.lightIndex_id189

#line 982
  ishl r6.z, r4.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyzw, r6.zzzz, t6.xyzw  // r14.x <- pointLight1.x; r14.y <- pointLight1.y; r14.z <- pointLight1.z; r14.w <- pointLight1.w

#line 983
  bfi r4.w, l(31), l(1), r4.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r15.xyz, r4.wwww, t6.xyzw  // r15.x <- pointLight2.x; r15.y <- pointLight2.y; r15.z <- pointLight2.z
...
#line 390
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id125 return value>
...
#line 707
  ...
  mul r6.w, r6.w, r10.w
  mad r14.xyz, r14.xyzx, r6.wwww, r11.xyzx  // r14.x <- <FresnelSchlick_id223 return value>.x; r14.y <- <FresnelSchlick_id223 return value>.y; r14.z <- <FresnelSchlick_id223 return value>.z

#line 702
  mul r6.w, r11.w, l(0.500000)  // r6.w <- k

#line 703
  mad r10.w, -r11.w, l(0.500000), l(1.000000)
  mad r12.w, r6.z, r10.w, r6.w
  div r12.w, r6.z, r12.w  // r12.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r6.w, r2.w, r10.w, r6.w
  div r6.w, r2.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id239 return value>

#line 825
  mul r6.w, r6.w, r12.w
  mul r6.z, r2.w, r6.z
  div r6.z, r6.w, r6.z  // r6.z <- <VisibilitySmithSchlickGGX_id241 return value>

#line 819
  mul r6.w, r11.w, r11.w  // r6.w <- alphaR2
...
#line 821
  ...
  div r4.w, r6.w, r4.w  // r4.w <- <NormalDistributionGGX_id253 return value>
...
#line 1345
  mad r12.xyz, r14.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r9.xywx  // r12.x <- directLightingContribution.x; r12.y <- directLightingContribution.y; r12.z <- directLightingContribution.z

#line 1331
  iadd r3.w, r3.w, l(1)

#line 1347
endloop   // r2.z <- streams.lightIndex_id189
...
mov r3.w, r2.z  // r3.w <- streams.lightIndex_id189
mov r4.w, l(0)  // r4.w <- i
loop 
  ige r6.z, r4.w, r1.w
  breakc_nz r6.z
...
#line 951
  ld_indexable(buffer)(uint,uint,uint,uint) r6.z, r3.wwww, t5.yzxw  // r6.z <- realLightIndex
...
#line 384
  mul r6.z, r6.z, r6.z  // r6.z <- <SmoothDistanceAttenuation_id136 return value>
...
#line 707
  ...
  mul r7.w, r7.w, r7.w
  mul r7.x, r7.w, r7.x
  mad r16.xyz, r16.xyzx, r7.xxxx, r11.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z
...
#line 703
  ...
  div r8.w, r6.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r7.x, r7.z, r7.w, r7.x
  div r7.x, r7.z, r7.x  // r7.x <- <VisibilityhSchlickGGX_id239 return value>

#line 825
  mul r7.x, r7.x, r8.w
  mul r6.w, r7.z, r6.w
  div r6.w, r7.x, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 821
  ...
  div r6.z, r7.x, r6.z  // r6.z <- <NormalDistributionGGX_id253 return value>
...
#line 790
add r1.w, cb0[37].z, cb0[37].z

#line 782
mov r2.w, l(1.000000)

#line 1379
mov r7.xyz, r1.xyzx  // r7.x <- streams.PositionWS_id24.x; r7.y <- streams.PositionWS_id24.y; r7.z <- streams.PositionWS_id24.z
mov r8.y, r0.w  // r8.y <- streams.alphaRoughness_id72
mov r8.z, r6.y  // r8.z <- streams.NdotV_id74
mov r9.xyz, r0.xyzx  // r9.x <- streams.normalWS_id21.x; r9.y <- streams.normalWS_id21.y; r9.z <- streams.normalWS_id21.z
mov r10.xyz, r3.xyzx  // r10.z <- streams.viewWS_id70.z; r10.x <- streams.viewWS_id70.x; r10.y <- streams.viewWS_id70.y
mov r11.xyz, r4.xyzx  // r11.x <- streams.matDiffuseVisible_id71.x; r11.y <- streams.matDiffuseVisible_id71.y; r11.z <- streams.matDiffuseVisible_id71.z
mov r12.xyz, r5.xyzx  // r12.x <- streams.matSpecularVisible_id73.x; r12.y <- streams.matSpecularVisible_id73.y; r12.z <- streams.matSpecularVisible_id73.z
...
#line 668
  add r15.xyz, -r7.xyzx, cb0[r4.w + 29].xyzx  // r15.x <- lightVector.x; r15.y <- lightVector.y; r15.z <- lightVector.z
...
#line 376
  mul r6.z, r6.z, cb0[r4.w + 31].z  // r6.z <- factor
...
#line 378
  mul r6.z, r6.z, r6.z  // r6.z <- <SmoothDistanceAttenuation_id147 return value>

#line 548
  mul r6.z, r6.z, r6.w  // r6.z <- attenuation

#line 539
  dp3 r6.w, -cb0[r4.w + 30].xyzx, r15.xyzx  // r6.w <- cd

#line 540
  mad_sat r6.w, r6.w, cb0[r4.w + 31].x, cb0[r4.w + 31].y  // r6.w <- attenuation
...
#line 790
  mul r8.x, r1.w, cb0[r3.w + 66].x
  mul r7.w, r7.w, r8.x

#line 918
  mad r2.xyz, r7.wwww, r9.xyzx, r7.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 782
  dp4 r16.x, r2.xyzw, cb0[r4.w + 38].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r2.xyzw, cb0[r4.w + 39].xyzw  // r16.y <- shadowPosition.y
  dp4 r7.w, r2.xyzw, cb0[r4.w + 40].xyzw  // r7.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[r4.w + 41].xyzw  // r2.x <- shadowPosition.w

#line 783
  add r16.z, r7.w, -cb0[r3.w + 64].x  // r16.z <- shadowPosition.z

#line 784
  div r2.xyz, r16.xyzx, r2.xxxx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 532
  mad r2.xy, r2.xyxx, cb0[37].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r8.xw, r2.xxxy  // r8.x <- base_uv.x; r8.w <- base_uv.y

#line 533
  add r2.xy, r2.xyxx, -r8.xwxx  // r2.x <- st.x; r2.y <- st.y

#line 534
  add r8.xw, r8.xxxw, l(-0.500000, 0.000000, 0.000000, -0.500000)

#line 535
  mul r8.xw, r8.xxxw, cb0[37].zzzw

#line 480
  mad r16.xy, -r2.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r16.x <- uvW0.y; r16.y <- uvW0.x

#line 482
  mad r16.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r16.z <- uvW2.x; r16.w <- uvW2.y

#line 483
  mad r17.xy, -r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r17.xy, r17.xyxx, r16.yxyy
  add r17.xw, r17.xxxy, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r17.x <- uv0.x; r17.w <- uv0.y

#line 484
  add r18.xy, r2.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r17.yz, r18.yyxy, l(0.000000, 0.142857, 0.142857, 0.000000)  // r17.y <- uv1.y; r17.z <- uv1.x

#line 485
  div r2.xy, r2.xyxx, r16.zwzz
  add r18.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r18.x <- uv2.x; r18.y <- uv2.y

#line 494
  mul r2.xy, r16.xwxx, r16.yzyy

#line 487
  mad r19.xyzw, r17.xwzw, cb0[37].zwzw, r8.xwxw

#line 491
  mov r18.zw, r17.wwwy

#line 489
  mul r20.xy, r16.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 490
  mad r21.xyzw, r17.xyzy, cb0[37].zwzw, r8.xwxw

#line 491
  mad r22.xyzw, r18.xzxw, cb0[37].zwzw, r8.xwxw
...
#line 493
  mad r17.xyzw, r17.xyzy, cb0[37].zwzw, r8.xwxw
  mul r18.zw, r16.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 494
  mad r8.xw, r18.xxxy, cb0[37].zzzw, r8.xxxw

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r19.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id161 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r19.zwzz, t0.xxxx, s1, r2.z  // r9.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mul r9.w, r9.w, r20.x
  mad r2.x, r2.x, r7.w, r9.w  // r2.x <- shadow

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r22.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mad r2.x, r16.x, r7.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.xyxx, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r20.y, r7.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r7.w, l(49.000000), r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r22.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r18.z, r7.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r16.y, r7.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r18.w, r7.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r8.xwxx, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id161 return value>
...
#line 1130
  mul r16.xyz, r6.zzzz, cb0[r4.w + 32].xyzx
  mul r2.xyz, r2.xxxx, r16.xyzx
  mul r2.xyz, r6.wwww, r2.xyzx  // r2.x <- streams.lightColorNdotL_id46.x; r2.y <- streams.lightColorNdotL_id46.y; r2.z <- streams.lightColorNdotL_id46.z

#line 1208
  add r16.xyz, r10.xyzx, r15.xyzx
...
#line 1209
  dp3_sat r4.w, r9.xyzx, r16.xyzx  // r4.w <- streams.NdotH_id78

#line 1210
  dp3_sat r6.z, r15.xyzx, r16.xyzx  // r6.z <- streams.LdotH_id79

#line 1204
  mul r15.xyz, r2.xyzx, r11.xyzx
...
#line 707
  ...
  mul r7.w, r7.w, r7.w
  mul r6.z, r6.z, r7.w
  mad r16.xyz, r16.xyzx, r6.zzzz, r12.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z

#line 702
  mul r6.z, r8.y, l(0.500000)  // r6.z <- k

#line 703
  mad r7.w, -r8.y, l(0.500000), l(1.000000)
  mad r8.x, r6.w, r7.w, r6.z
  div r8.x, r6.w, r8.x  // r8.x <- <VisibilityhSchlickGGX_id239 return value>
  mad r6.z, r8.z, r7.w, r6.z
  div r6.z, r8.z, r6.z  // r6.z <- <VisibilityhSchlickGGX_id239 return value>

#line 825
  mul r6.z, r6.z, r8.x
  mul r6.w, r8.z, r6.w
  div r6.z, r6.z, r6.w  // r6.z <- <VisibilitySmithSchlickGGX_id241 return value>

#line 819
  mul r6.w, r8.y, r8.y  // r6.w <- alphaR2

#line 820
  mul r4.w, r4.w, r4.w
  mad r7.w, r8.y, r8.y, l(-1.000000)
...
#line 899
sample_l_indexable(texture2d)(float,float,float,float) r1.xy, r6.xyxx, t2.xyzw, s0, l(0.000000)  // r1.x <- environmentLightingDFG.x; r1.y <- environmentLightingDFG.y

#line 900
mad r1.xyz, r5.xyzx, r1.xxxx, r1.yyyy  // r1.x <- <Compute_id403 return value>.x; r1.y <- <Compute_id403 return value>.y; r1.z <- <Compute_id403 return value>.z
...
#line 885
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r7.xyzx, t8.xyzw, s0, r0.w  // r3.x <- <Compute_id353 return value>.x; r3.y <- <Compute_id353 return value>.y; r3.z <- <Compute_id353 return value>.z
...
#line 1434
mad o0.xyz, r14.xyzx, l(3.141593, 3.141593, 3.141593, 0.000000), r1.xyzx
...
mov o2.xyzw, r5.xyzw
ret 
// Approximately 644 instruction slots used
***************************
*************************/
...
const static int TMaxLightCount_id198 = 2;
const static int TCascadeCountBase_id204 = 1;
const static int TLightCountBase_id205 = 2;
