...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,7>, mixin LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<2>, ShadowMapReceiverSpot<2,false>, ShadowMapFilterPcf<PerDraw.Lighting,5>
...
@G    Pixel => a2da578bac621d05fd75ec31fd21853a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
ftoi r8.xy, r2.xyxx
mov r8.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r2.xy, r8.xyzw, t4.xyzw  // r2.x <- streams.lightData_id188.x; r2.y <- streams.lightData_id188.y
...
#line 390
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id125 return value>
...
#line 384
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id136 return value>
...
#line 703
  ...
  div r8.w, r4.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id239 return value>
...
#line 1379
mov r2.xyw, r1.xyxz
mov r8.y, r2.z  // r8.y <- streams.alphaRoughness_id72
mov r8.z, r7.y  // r8.z <- streams.NdotV_id74
mov r9.xyz, r0.xyzx  // r9.x <- streams.normalWS_id21.x; r9.y <- streams.normalWS_id21.y; r9.z <- streams.normalWS_id21.z
mov r10.xyz, r4.xyzx  // r10.z <- streams.viewWS_id70.z; r10.x <- streams.viewWS_id70.x; r10.y <- streams.viewWS_id70.y
mov r11.xyz, r5.xyzx  // r11.x <- streams.matDiffuseVisible_id71.x; r11.y <- streams.matDiffuseVisible_id71.y; r11.z <- streams.matDiffuseVisible_id71.z
...
#line 668
  add r15.xyz, -r2.xywx, cb0[r4.w + 29].xyzx  // r15.x <- lightVector.x; r15.y <- lightVector.y; r15.z <- lightVector.z

#line 669
  dp3 r5.w, r15.xyzx, r15.xyzx
  sqrt r7.z, r5.w  // r7.z <- lightVectorLength

#line 670
  div r15.xyz, r15.xyzx, r7.zzzz  // r15.x <- lightVectorNorm.x; r15.y <- lightVectorNorm.y; r15.z <- lightVectorNorm.z

#line 547
  max r7.z, r5.w, l(0.000100)
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r7.z  // r7.z <- attenuation

#line 376
  mul r5.w, r5.w, cb0[r4.w + 31].z  // r5.w <- factor
...
#line 548
  mul r5.w, r5.w, r7.z  // r5.w <- attenuation

#line 539
  dp3 r7.z, -cb0[r4.w + 30].xyzx, r15.xyzx  // r7.z <- cd

#line 540
  mad_sat r7.z, r7.z, cb0[r4.w + 31].x, cb0[r4.w + 31].y  // r7.z <- attenuation
...
#line 1128
  dp3 r7.z, r9.xyzx, r15.xyzx
  max r7.z, r7.z, l(0.000100)  // r7.z <- streams.NdotL_id51
...
#line 790
  mul r8.x, r0.w, cb0[r1.w + 66].x
  mul r7.w, r7.w, r8.x

#line 918
  mad r3.xyz, r7.wwww, r9.xyzx, r2.xywx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 782
  dp4 r16.x, r3.xyzw, cb0[r4.w + 38].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r3.xyzw, cb0[r4.w + 39].xyzw  // r16.y <- shadowPosition.y
  dp4 r7.w, r3.xyzw, cb0[r4.w + 40].xyzw  // r7.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb0[r4.w + 41].xyzw  // r3.x <- shadowPosition.w

#line 783
  add r16.z, r7.w, -cb0[r1.w + 64].x  // r16.z <- shadowPosition.z
...
#line 532
  ...
  round_ni r8.xw, r3.xxxy  // r8.x <- base_uv.x; r8.w <- base_uv.y

#line 533
  add r3.xy, r3.xyxx, -r8.xwxx  // r3.x <- st.x; r3.y <- st.y
...
#line 480
  mad r16.xy, -r3.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r16.x <- uvW0.y; r16.y <- uvW0.x

#line 482
  mad r16.zw, r3.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r16.z <- uvW2.x; r16.w <- uvW2.y

#line 483
  mad r17.xy, -r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r17.xy, r17.xyxx, r16.yxyy
  add r17.xw, r17.xxxy, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r17.x <- uv0.x; r17.w <- uv0.y

#line 484
  add r18.xy, r3.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r17.yz, r18.yyxy, l(0.000000, 0.142857, 0.142857, 0.000000)  // r17.y <- uv1.y; r17.z <- uv1.x

#line 485
  div r3.xy, r3.xyxx, r16.zwzz
  add r18.xy, r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r18.x <- uv2.x; r18.y <- uv2.y

#line 494
  mul r3.xy, r16.xwxx, r16.yzyy
...
#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r19.xyxx, t0.xxxx, s1, r3.z  // r7.w <- <SampleTextureAndCompare_id161 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r19.zwzz, t0.xxxx, s1, r3.z  // r9.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mul r9.w, r9.w, r20.x
  mad r3.x, r3.x, r7.w, r9.w  // r3.x <- shadow

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r22.xyxx, t0.xxxx, s1, r3.z  // r7.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mad r3.x, r16.x, r7.w, r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.xyxx, t0.xxxx, s1, r3.z

#line 660
  mad r3.x, r20.y, r7.w, r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.zwzz, t0.xxxx, s1, r3.z

#line 660
  mad r3.x, r7.w, l(49.000000), r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r22.zwzz, t0.xxxx, s1, r3.z

#line 660
  mad r3.x, r18.z, r7.w, r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t0.xxxx, s1, r3.z

#line 660
  mad r3.x, r16.y, r7.w, r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.zwzz, t0.xxxx, s1, r3.z

#line 660
  mad r3.x, r18.w, r7.w, r3.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r8.xwxx, t0.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id161 return value>
...
#line 1130
  mul r16.xyz, r5.wwww, cb0[r4.w + 32].xyzx
  mul r3.xyz, r3.xxxx, r16.xyzx
  mul r3.xyz, r7.zzzz, r3.xyzx  // r3.x <- streams.lightColorNdotL_id46.x; r3.y <- streams.lightColorNdotL_id46.y; r3.z <- streams.lightColorNdotL_id46.z
...
#line 1210
  dp3_sat r5.w, r15.xyzx, r16.xyzx  // r5.w <- streams.LdotH_id79
...
#line 707
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r16.xyz, r16.xyzx, r5.wwww, r13.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z
...
#line 703
  ...
  mad r8.x, r7.z, r7.w, r5.w
  div r8.x, r7.z, r8.x  // r8.x <- <VisibilityhSchlickGGX_id239 return value>
...
#line 825
  mul r5.w, r5.w, r8.x
  mul r7.z, r8.z, r7.z
  div r5.w, r5.w, r7.z  // r5.w <- <VisibilitySmithSchlickGGX_id241 return value>

#line 819
  mul r7.z, r8.y, r8.y  // r7.z <- alphaR2
...
#line 821
  ...
  div r4.w, r7.z, r4.w  // r4.w <- <NormalDistributionGGX_id253 return value>
