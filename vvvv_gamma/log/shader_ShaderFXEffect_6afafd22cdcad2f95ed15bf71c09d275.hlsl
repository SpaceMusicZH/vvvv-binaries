...
//
#line 306 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_6afafd22cdcad2f95ed15bf71c09d275.hlsl"
mov o0.xyzw, v0.xyzw
mov o1.x, v1.x
ret 
// Approximately 3 instruction slots used
@G    Geometry => ead10729f6f0f170ede9a7adc827e10e
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 279 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_6afafd22cdcad2f95ed15bf71c09d275.hlsl"
...
#line 200
    ...
    movc r7.xyz, r7.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r7.x <- <CubeVert_id19 return value>.x; r7.y <- <CubeVert_id19 return value>.y; r7.z <- <CubeVert_id19 return value>.z
...
#line 200
    and r7.xyz, r1.wwww, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r7.xyz, r7.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r7.x <- <CubeVert_id19 return value>.x; r7.y <- <CubeVert_id19 return value>.y; r7.z <- <CubeVert_id19 return value>.z
...
#line 242
    dp4 r1.w, r7.xyzw, cb1[16].xyzw  // r1.w <- streams.ShadingPosition_id0.x
    dp4 r2.w, r7.xyzw, cb1[17].xyzw  // r2.w <- streams.ShadingPosition_id0.y
    dp4 r3.x, r7.xyzw, cb1[18].xyzw  // r3.x <- streams.ShadingPosition_id0.z
    dp4 r4.w, r7.xyzw, cb1[19].xyzw  // r4.w <- streams.ShadingPosition_id0.w
...
#line 200
    ...
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id19 return value>.x; r6.y <- <CubeVert_id19 return value>.y; r6.z <- <CubeVert_id19 return value>.z
...
//
#line 271 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_6afafd22cdcad2f95ed15bf71c09d275.hlsl"
...
void SpawnQuad_id25(inout GS_STREAMS streams, uint start, inout TriangleStream<GS_OUTPUT> triangleStream, float3 normal, Particle p)
{
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    if (dot(viewDir, p.AxisZ) > 0)
        SpawnQuad_id25(streams, 0, triangleStream, p.AxisZ, p);
    if (dot(viewDir, -p.AxisZ) > 0)
        SpawnQuad_id25(streams, 4, triangleStream, -p.AxisZ, p);
    if (dot(viewDir, p.AxisY) > 0)
        SpawnQuad_id25(streams, 8, triangleStream, p.AxisY, p);
    if (dot(viewDir, -p.AxisY) > 0)
        SpawnQuad_id25(streams, 12, triangleStream, -p.AxisY, p);
    if (dot(viewDir, p.AxisX) > 0)
        SpawnQuad_id25(streams, 16, triangleStream, p.AxisX, p);
    if (dot(viewDir, -p.AxisX) > 0)
        SpawnQuad_id25(streams, 20, triangleStream, -p.AxisX, p);
}
