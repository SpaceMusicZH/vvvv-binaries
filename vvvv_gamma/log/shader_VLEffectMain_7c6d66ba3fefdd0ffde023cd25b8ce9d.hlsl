...
//
#line 1694 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_7c6d66ba3fefdd0ffde023cd25b8ce9d.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => f18969ff05bfee7166b81a260b3c1623
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1659 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_7c6d66ba3fefdd0ffde023cd25b8ce9d.hlsl"
...
#line 1573
    ishl r0.z, l(1), r0.y  // r0.z <- b

#line 1574
    and r6.xyz, r0.zzzz, l(90, 51, 15, 0)
...
#line 1597
    ...
    mad r10.xyz, r10.xyzx, r1.xxxx, r2.xyzx  // r10.x <- posWorld.x; r10.y <- posWorld.y; r10.z <- posWorld.z

#line 1598
    mul r11.xyz, r8.xzyx, r6.yyyy
    mad r10.xyz, r11.xyzx, r1.yyyy, r10.xyzx

#line 1599
    mul r6.xyz, r7.yzwy, r6.zzzz
    mad r9.xyz, r6.xyzx, r1.zzzz, r10.xyzx  // r9.x <- posWorld.x; r9.y <- posWorld.y; r9.z <- posWorld.z

#line 1600
    dp4 r10.x, r9.xyzw, cb0[0].xyzw  // r10.x <- posWorld.x
    dp4 r10.y, r9.xyzw, cb0[1].xyzw  // r10.y <- posWorld.y
    dp4 r10.z, r9.xyzw, cb0[2].xyzw  // r10.z <- posWorld.z
    dp4 r10.w, r9.xyzw, cb0[3].xyzw  // r10.w <- posWorld.w

#line 1604
    dp4 r0.z, r10.xyzw, cb2[16].xyzw  // r0.z <- streams.ShadingPosition_id0.x
    dp4 r0.w, r10.xyzw, cb2[17].xyzw  // r0.w <- streams.ShadingPosition_id0.y
    dp4 r1.w, r10.xyzw, cb2[18].xyzw  // r1.w <- streams.ShadingPosition_id0.z
    dp4 r2.w, r10.xyzw, cb2[19].xyzw  // r2.w <- streams.ShadingPosition_id0.w
...
#line 1599
    ...
    mad r0.xyz, r9.xyzx, r1.zzzz, r6.xywx  // r0.x <- posWorld.x; r0.y <- posWorld.y; r0.z <- posWorld.z

#line 1600
    dp4 r6.x, r0.xyzw, cb0[0].xyzw  // r6.x <- posWorld.x
    dp4 r6.y, r0.xyzw, cb0[1].xyzw  // r6.y <- posWorld.y
    dp4 r6.z, r0.xyzw, cb0[2].xyzw  // r6.z <- posWorld.z
    dp4 r6.w, r0.xyzw, cb0[3].xyzw  // r6.w <- posWorld.w

#line 1604
    dp4 r0.x, r6.xyzw, cb2[16].xyzw  // r0.x <- streams.ShadingPosition_id0.x
    dp4 r0.y, r6.xyzw, cb2[17].xyzw  // r0.y <- streams.ShadingPosition_id0.y
    dp4 r0.z, r6.xyzw, cb2[18].xyzw  // r0.z <- streams.ShadingPosition_id0.z
    dp4 r2.w, r6.xyzw, cb2[19].xyzw  // r2.w <- streams.ShadingPosition_id0.w
...
#line 1599
    ...
    mad r0.xyz, r8.xyzx, r1.zzzz, r6.xywx  // r0.x <- posWorld.x; r0.y <- posWorld.y; r0.z <- posWorld.z
...
//
#line 1641 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_7c6d66ba3fefdd0ffde023cd25b8ce9d.hlsl"
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    float3 AxisY = or[1];
    float3 AxisZ = or[2];
    float3 viewDir = ViewInverse_id28[3].xyz;
