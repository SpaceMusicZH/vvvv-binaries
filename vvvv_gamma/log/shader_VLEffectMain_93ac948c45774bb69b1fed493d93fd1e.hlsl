...
//
#line 1695 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_93ac948c45774bb69b1fed493d93fd1e.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
mov o3.xyz, v2.xyzx
...
//
#line 1653 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_93ac948c45774bb69b1fed493d93fd1e.hlsl"
...
@G    Pixel => eb74f5fb151e6d606e439aca55d925cc
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1538 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_93ac948c45774bb69b1fed493d93fd1e.hlsl"
...
#line 790
dp2 r1.w, cb0[48].xxxx, cb0[33].zzzz
...
#line 668
  add r15.xyz, -r7.xyzx, cb0[29].xyzx  // r15.x <- lightVector.x; r15.y <- lightVector.y; r15.z <- lightVector.z
...
#line 670
  div r15.xyz, r15.xyzx, r6.zzzz  // r15.x <- lightVectorNorm.x; r15.y <- lightVectorNorm.y; r15.z <- lightVectorNorm.z
...
#line 376
  mul r4.w, r4.w, cb0[31].z  // r4.w <- factor
...
#line 378
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id147 return value>

#line 548
  mul r4.w, r4.w, r6.z  // r4.w <- attenuation

#line 539
  dp3 r6.z, -cb0[30].xyzx, r15.xyzx  // r6.z <- cd

#line 540
  mad_sat r6.z, r6.z, cb0[31].x, cb0[31].y  // r6.z <- attenuation
...
#line 918
  mad r2.xyz, r6.wwww, r9.xyzx, r7.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 782
  dp4 r16.x, r2.xyzw, cb0[34].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r2.xyzw, cb0[35].xyzw  // r16.y <- shadowPosition.y
  dp4 r6.w, r2.xyzw, cb0[36].xyzw  // r6.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[37].xyzw  // r2.x <- shadowPosition.w

#line 783
  add r16.z, r6.w, -cb0[47].x  // r16.z <- shadowPosition.z
...
#line 487
  mad r19.xyzw, r17.xwzw, cb0[33].zwzw, r8.xwxw
...
#line 490
  mad r21.xyzw, r17.xyzy, cb0[33].zwzw, r8.xwxw

#line 491
  mad r22.xyzw, r18.xzxw, cb0[33].zwzw, r8.xwxw
...
#line 493
  mad r17.xyzw, r17.xyzy, cb0[33].zwzw, r8.xwxw
  mul r18.zw, r16.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 494
  mad r8.xw, r18.xxxy, cb0[33].zzzw, r8.xxxw

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r19.xyxx, t0.xxxx, s1, r2.z  // r6.w <- <SampleTextureAndCompare_id161 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r19.zwzz, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mul r7.w, r7.w, r20.x
  mad r2.x, r2.x, r6.w, r7.w  // r2.x <- shadow

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r22.xyxx, t0.xxxx, s1, r2.z  // r6.w <- <SampleTextureAndCompare_id161 return value>

#line 660
  mad r2.x, r16.x, r6.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r21.xyxx, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r20.y, r6.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r21.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r6.w, l(49.000000), r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r22.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r18.z, r6.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r17.xyxx, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r16.y, r6.w, r2.x

#line 499
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r17.zwzz, t0.xxxx, s1, r2.z

#line 660
  mad r2.x, r18.w, r6.w, r2.x
...
#line 1130
  mul r16.xyz, r4.wwww, cb0[32].xyzx
  mul r2.xyz, r2.xxxx, r16.xyzx
  mul r2.xyz, r6.zzzz, r2.xyzx  // r2.x <- streams.lightColorNdotL_id46.x; r2.y <- streams.lightColorNdotL_id46.y; r2.z <- streams.lightColorNdotL_id46.z
...
#line 1210
  dp3_sat r6.w, r15.xyzx, r16.xyzx  // r6.w <- streams.LdotH_id79
...
#line 707
  ...
  mul r7.w, r7.w, r7.w
  mul r6.w, r6.w, r7.w
  mad r16.xyz, r16.xyzx, r6.wwww, r12.xyzx  // r16.x <- <FresnelSchlick_id223 return value>.x; r16.y <- <FresnelSchlick_id223 return value>.y; r16.z <- <FresnelSchlick_id223 return value>.z

#line 702
  mul r6.w, r8.y, l(0.500000)  // r6.w <- k

#line 703
  mad r7.w, -r8.y, l(0.500000), l(1.000000)
  mad r8.x, r6.z, r7.w, r6.w
  div r8.x, r6.z, r8.x  // r8.x <- <VisibilityhSchlickGGX_id239 return value>
  mad r6.w, r8.z, r7.w, r6.w
  div r6.w, r8.z, r6.w  // r6.w <- <VisibilityhSchlickGGX_id239 return value>
