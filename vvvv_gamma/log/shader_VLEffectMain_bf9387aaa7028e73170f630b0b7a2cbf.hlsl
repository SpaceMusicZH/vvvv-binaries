...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t2.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id86 return value>
...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t2.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id86 return value>

#line 569
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id86 return value>
...
#line 487
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t2.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id86 return value>
...
#line 487
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id86 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.zwzz, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id86 return value>
...
#line 487
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id86 return value>
...
#line 960
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id502 return value>.x; r7.y <- <ComputeDirectLightContribution_id502 return value>.y; r7.z <- <ComputeDirectLightContribution_id502 return value>.z
...
mov r7.xyz, r5.xyzx  // r7.x <- streams.matSpecularVisible_id75.x; r7.y <- streams.matSpecularVisible_id75.y; r7.z <- streams.matSpecularVisible_id75.z
mov r7.w, r0.w  // r7.w <- streams.alphaRoughness_id74
mov r8.xyz, r1.xyzx  // r8.x <- streams.normalWS_id21.x; r8.y <- streams.normalWS_id21.y; r8.z <- streams.normalWS_id21.z
mov r9.xyz, r3.xyzx  // r9.x <- streams.viewWS_id72.x; r9.y <- streams.viewWS_id72.y
mov r10.xyz, r4.xyzx
...
mov r0.yz, r6.yyzy  // r0.y <- streams.NdotV_id76; r0.z <- streams.lightIndex_id180
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r2.w, r1.w, r0.x
  breakc_nz r2.w
...
#line 971
  dp3_sat r4.w, r13.xyzx, r15.xyzx  // r4.w <- streams.LdotH_id81
...
#line 539
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r15.xyz, r15.xyzx, r4.wwww, r7.xyzx  // r15.x <- <FresnelSchlick_id170 return value>.x; r15.y <- <FresnelSchlick_id170 return value>.y; r15.z <- <FresnelSchlick_id170 return value>.z
...
#line 535
  ...
  div r4.w, r0.y, r4.w  // r4.w <- <VisibilityhSchlickGGX_id186 return value>
...
#line 712
mad r0.xyz, r5.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id324 return value>.x; r0.y <- <Compute_id324 return value>.y; r0.z <- <Compute_id324 return value>.z

#line 894
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id503 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id503 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id503 return value>.z
...
#line 697
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r7.xyzx, t7.xyzw, s0, r0.w  // r3.x <- <Compute_id274 return value>.x; r3.y <- <Compute_id274 return value>.y; r3.z <- <Compute_id274 return value>.z
