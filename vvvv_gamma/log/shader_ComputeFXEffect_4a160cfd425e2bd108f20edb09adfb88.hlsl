...
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<SMVideoBufferSelector_ShaderFXResult_13> [{Value = SMVideoBufferSelector_ShaderFX}], mixin AssignVarFloat<r_47> [{Value = mixin GetMemberFloat4Float<r> [{Value = GetVarFloat4<SMVideoBufferSelector_ShaderFXResult_13>}]}], mixin AssignVarFloat<Input_48> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat<Multiply_49> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<r_47>}, {Right = GetVarFloat<Input_48>}]}], mixin AssignVarFloat<g_50> [{Value = mixin GetMemberFloat4Float<g> [{Value = GetVarFloat4<SMVideoBufferSelector_ShaderFXResult_13>}]}], mixin AssignVarFloat<Multiply_51> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<g_50>}, {Right = GetVarFloat<Input_48>}]}], mixin AssignVarFloat<Multiply_52> [{Value = mixin MultiplyFloat [{Left = GetVarFloat<g_50>}, {Right = GetVarFloat<Input_48>}]}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_53> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Multiply_49>}, {Y = GetVarFloat<Multiply_51>}, {Z = GetVarFloat<Multiply_52>}]}], mixin AssignVarFloat3<Input_54> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i8,PerUpdate>}], mixin AssignVarFloat3<Multiply_55> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_53>}, {Right = GetVarFloat3<Input_54>}]}], mixin AssignVarFloat3<Input_56> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<Plus_57> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_55>}, {Right = GetVarFloat3<Input_56>}]}]]}]}, {Value = GetVarFloat3<Plus_57>}]
...
@C    InputValue_id306 => ShaderFX.InputValueUInt
@C    InputValue_id320 => ShaderFX.InputValueUInt.i1
...
@C    VoxelCounts_id310 => SMMidiBufferSelector_ShaderFX.VoxelCounts
@C    PlacementCounts_id311 => SMMidiBufferSelector_ShaderFX.PlacementCounts
@C    Channel_id312 => SMMidiBufferSelector_ShaderFX.Channel
@C    Blink_id313 => SMMidiBufferSelector_ShaderFX.Blink
@C    SamplerOffset_id314 => SMMidiBufferSelector_ShaderFX.SamplerOffset
@C    SamplerScale_id315 => SMMidiBufferSelector_ShaderFX.SamplerScale
***************************
******  Resources    ******
***************************
...
@R    VoxelVolume_id309 => SMMidiBufferSelector_ShaderFX.VoxelVolume [Stage: Compute, Slot: (3-3)]
...
*****     Stages      *****
***************************
@G    Compute => bede8c49a25de13eeb6dfc622dd083ac
//
...
//   uint InputValue_id306;             // Offset:  156 Size:     4
//   uint InputValue_id320;             // Offset:  160 Size:     4
//   float InputValue_id341;            // Offset:  164 Size:     4
//
// }
//
// cbuffer Globals
...
//      = 0x00100000 
//   int3 VoxelCounts_id310;            // Offset:  132 Size:    12
//   int3 PlacementCounts_id311;        // Offset:  144 Size:    12 [unused]
//   int Channel_id312;                 // Offset:  156 Size:     4 [unused]
//   float Blink_id313;                 // Offset:  160 Size:     4 [unused]
//   float2 SamplerOffset_id314;        // Offset:  164 Size:     8 [unused]
//   float2 SamplerScale_id315;         // Offset:  176 Size:     8 [unused]
//      = 0x3f800000 0x3f800000 
//
// }
//
...
// }
//
// Resource bind info for VoxelVolume_id309
// {
//
...
// VoxelVolume_id309                 texture  struct         r/o             t3      1 
...
//
#line 1479 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_4a160cfd425e2bd108f20edb09adfb88.hlsl"
...
#line 681
  mul r1.w, r0.w, r1.w  // r1.w <- <Compute_id203 return value>

#line 657
  mad r12.xyz, r1.wwww, cb1[1].xyzx, cb1[0].xyzx  // r12.x <- <Compute_id237 return value>.x; r12.y <- <Compute_id237 return value>.y; r12.z <- <Compute_id237 return value>.z
...
#line 273
  ...
  imad r1.w, r12.z, r1.w, r2.w  // r1.w <- <CalculateVoxelVolumeIndex_id61 return value>
...
#line 558
    mov r14.x, r12.x  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 560
    mov r14.x, r12.y  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 562
    mov r14.x, r12.z  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 564
    mov r14.x, r12.w  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 566
    mov r14.x, r13.x  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 568
    mov r14.x, r13.y  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 570
    mov r14.x, r13.z  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 572
    mov r14.x, r13.w  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 574
    mov r14.x, r14.y  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 576
    mov r14.x, r14.z  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 578
    mov r14.x, r14.w  // r14.x <- <SelectMidiValue_id62 return value>
    break 
...
#line 582
    mov r14.x, l(0)  // r14.x <- <SelectMidiValue_id62 return value>
    break 

#line 583
  endswitch   // r14.x <- <SelectMidiValue_id62 return value>

#line 809
  utof r1.w, cb1[10].x
  mul r1.w, r1.w, r14.x
  round_ne r1.w, r1.w
  ftou r1.w, r1.w  // r1.w <- <Compute_id87 return value>

#line 803
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r1.wwww, t6.xyzw  // r12.x <- <Compute_id91 return value>.x; r12.y <- <Compute_id91 return value>.y; r12.z <- <Compute_id91 return value>.z
...
#line 795
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t7.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id101 return value>.x; r6.z <- <Compute_id101 return value>.y; r6.w <- <Compute_id101 return value>.z

#line 787
  mad r6.yzw, -r12.xxyz, r13.xxyz, r6.yyzw
  mad r6.yzw, cb1[10].yyyy, r6.yyzw, r14.xxyz  // r6.y <- <Compute_id111 return value>.x; r6.z <- <Compute_id111 return value>.y; r6.w <- <Compute_id111 return value>.z
...
struct CS_STREAMS 
{
    ...
    uint Input_1_id305;
    float SMMidiSelectValue_ShaderFXResult_2_id308;
    uint Input_3_id319;
...
cbuffer Globals 
{
    ...
    int3 VoxelCounts_id310;
    int3 PlacementCounts_id311;
    int Channel_id312;
    float Blink_id313;
    float2 SamplerOffset_id314;
    float2 SamplerScale_id315 = float2(1, 1);
};
...
StructuredBuffer<SMMidiNoteData> VoxelVolume_id309;
...
uint CalculateVoxelVolumeIndex_id61(uint3 coordinate)
{
    return dot(coordinate, uint3(1, VoxelCounts_id310.x, VoxelCounts_id310.x * VoxelCounts_id310.y));
}
SMMidiNoteData GetVoxel_id36(uint3 coordinate)
{
    return VoxelVolume_id309[CalculateVoxelVolumeIndex_id61(coordinate)];
}
...
float2 Compute_id98(inout CS_STREAMS streams)
{
...
{
    return streams.SMMidiSelectValue_ShaderFXResult_2_id308;
}
float SelectMidiValue_id62(SMMidiNoteData x, uint i)
{
    switch (i)
...
{
    return streams.Input_1_id305;
}
SMMidiNoteData Compute_id60(inout CS_STREAMS streams)
{
    uint i = streams.DispatchThreadId_id1.x;
    uint3 uvw = float3(streams.TexCoord_id59.x, streams.TexCoord_id59.y, streams.TexCoord1_id60.x) * VoxelCounts_id310;
...
{
    return DynamicTexture_id130.SampleLevel(DynamicSampler_id131, Compute_id171(streams), Compute_id169());
}
float Compute_id168(inout CS_STREAMS streams)
{
    float4 color = Compute_id146(streams);
...
{
    return lerp(Compute_id104(streams), Compute_id106(streams), Compute_id108(streams));
}
float Compute_id102()
{
...
{
    return DynamicTexture_id334.SampleLevel(DynamicSampler_id131, Compute_id98(streams), Compute_id96());
}
float4 Compute_id95(inout CS_STREAMS streams)
{
    return SRgbToLinear_id539(Compute_id92(streams));
}
float4 Compute_id91(inout CS_STREAMS streams)
{
    return DynamicBuffer_id327[Compute_id88(streams)];
}
uint Compute_id87(inout CS_STREAMS streams)
{
    float v = Compute_id84(streams);
    uint c = Compute_id82(streams);
    return round(v * c);
}
uint Compute_id80()
{
...
float Compute_id79(inout CS_STREAMS streams)
{
    SMMidiNoteData m = Compute_id60(streams);
    return SelectMidiValue_id62(m, Compute_id76(streams));
}
uint Compute_id69()
{
...
{
    streams.Multiply_46_id179 = Compute_id245(streams);
}
void Compute_id275(inout CS_STREAMS streams)
{
    streams.Input_45_id176 = Compute_id238();
}
void Compute_id273(inout CS_STREAMS streams)
{
    streams.Plus_44_id172 = Compute_id237(streams);
}
void Compute_id271(inout CS_STREAMS streams)
{
    streams.Multiply_43_id168 = Compute_id231(streams);
}
void Compute_id269(inout CS_STREAMS streams)
{
    streams.Input_42_id165 = Compute_id224();
}
void Compute_id267(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_41_id160 = Compute_id223(streams);
}
void Compute_id265(inout CS_STREAMS streams)
{
    streams.Multiply_40_id156 = Compute_id215(streams);
}
void Compute_id263(inout CS_STREAMS streams)
{
    streams.Multiply_39_id152 = Compute_id209(streams);
}
void Compute_id261(inout CS_STREAMS streams)
{
    streams.Multiply_38_id148 = Compute_id203(streams);
}
void Compute_id259(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_37_id137 = Compute_id197(streams);
}
void Compute_id257(inout CS_STREAMS streams)
{
    streams.TextureValue_35_id129 = Compute_id174(streams);
}
void Compute_id255()
{
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_14_id118 = Compute_id168(streams);
}
...
{
    streams.Input_33_id107 = Compute_id140();
}
...
{
    streams.SMCalcLuminance_ShaderFXResult_14_id118 = Compute_id309(streams);
}
void Compute_id311(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_13_id110 = Compute_id63(streams);
}
void Compute_id134(inout CS_STREAMS streams)
{
    streams.Lerp_12_id343 = Compute_id111(streams);
}
void Compute_id132(inout CS_STREAMS streams)
{
    streams.Input_11_id340 = Compute_id102();
}
void Compute_id130(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id333 = Compute_id101(streams);
}
void Compute_id128()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id330 = Compute_id95(streams);
}
void Compute_id122(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id326 = Compute_id91(streams);
}
void Compute_id120(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id322 = Compute_id87(streams);
}
void Compute_id118(inout CS_STREAMS streams)
{
    streams.Input_3_id319 = Compute_id80();
}
void Compute_id116(inout CS_STREAMS streams)
{
    streams.SMMidiSelectValue_ShaderFXResult_2_id308 = Compute_id79(streams);
}
void Compute_id114(inout CS_STREAMS streams)
{
    streams.Input_1_id305 = Compute_id69();
}
void Compute_id112()
{
}
...
float4 Compute_id137(inout CS_STREAMS streams)
{
