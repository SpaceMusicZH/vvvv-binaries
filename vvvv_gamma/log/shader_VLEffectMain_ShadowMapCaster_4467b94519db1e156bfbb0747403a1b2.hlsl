...
//
#line 288 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_4467b94519db1e156bfbb0747403a1b2.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 4edc7724db92f04037eb4c36e744f6d5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 254 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_4467b94519db1e156bfbb0747403a1b2.hlsl"
...
#line 216
    dp4 r4.w, r2.xyzw, cb2[16].xyzw  // r4.w <- streams.ShadingPosition_id0.x
    dp4 r5.w, r2.xyzw, cb2[17].xyzw  // r5.w <- streams.ShadingPosition_id0.y
    dp4 r6.x, r2.xyzw, cb2[18].xyzw  // r6.x <- streams.ShadingPosition_id0.z
    dp4 r6.y, r2.xyzw, cb2[19].xyzw  // r6.y <- streams.ShadingPosition_id0.w

#line 228
    mov o0.xyz, r2.xyzx
    mov o0.w, l(1.000000)
    mov o1.xyz, r1.xyzx
    mov o2.xy, icb[r3.w + 0].xyxx
    mov o2.z, r6.y
    mov o3.x, r6.w
    mov o3.y, r0.x
    mov o3.z, r4.z
...
#line 190
    ishl r2.y, l(1), r1.w  // r2.y <- b

#line 191
    and r2.yzw, r2.yyyy, l(0, 0x000f0000, 0x005a0000, 0x00330000)
    movc r2.yzw, r2.yyzw, l(0,0.500000,0.500000,0.500000), l(0,-0.500000,-0.500000,-0.500000)  // r2.y <- <CubeVert_id91 return value>.x; r2.z <- <CubeVert_id91 return value>.y; r2.w <- <CubeVert_id91 return value>.z
...
#line 211
    ...
    mad r6.xyz, r8.xyzx, r1.yyyy, r6.xyzx

#line 212
    mul r2.yzw, r7.yyzw, r2.wwww
    mad r0.xyz, r2.yzwy, r1.zzzz, r6.xyzx  // r0.x <- posWorld.x; r0.y <- posWorld.y; r0.z <- posWorld.z

#line 216
    dp4 r2.y, r0.xyzw, cb2[16].xyzw  // r2.y <- streams.ShadingPosition_id0.x
    dp4 r2.z, r0.xyzw, cb2[17].xyzw  // r2.z <- streams.ShadingPosition_id0.y
    dp4 r2.w, r0.xyzw, cb2[18].xyzw  // r2.w <- streams.ShadingPosition_id0.z
    dp4 r3.w, r0.xyzw, cb2[19].xyzw  // r3.w <- streams.ShadingPosition_id0.w

#line 228
    mov o0.xyz, r0.xyzx
    mov o0.w, l(1.000000)
    mov o1.xyz, r1.xyzx
    mov o2.xy, icb[r2.x + 0].xyxx
    mov o2.z, r3.w
    mov o3.xyz, -r5.xyzx
    mov o4.xyz, -r5.xyzx
    mov o5.x, r2.y
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    p.Pos = mul(float4(p.Pos, 1), World_id31).xyz;
