...
//
#line 1272 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_05fcece09b6347205a82f6af427c8c3b.hlsl"
...
@G    Pixel => 65c5f6134692f038becc31d7cefe0dfa
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1339 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_05fcece09b6347205a82f6af427c8c3b.hlsl"
...
#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t1.xxxx, s0, r3.w  // r6.z <- <SampleTextureAndCompare_id63 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r10.zwzz, t1.xxxx, s0, r3.w  // r6.w <- <SampleTextureAndCompare_id63 return value>
...
#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.xyxx, t1.xxxx, s0, r3.w  // r6.x <- <SampleTextureAndCompare_id63 return value>

#line 653
  mad r3.y, r3.y, r6.x, r5.x  // r3.y <- shadow

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t1.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id63 return value>

#line 653
  mad r3.y, r8.x, r5.x, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r11.xyxx, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r5.y, r5.x, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r11.zwzz, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r15.x, r5.x, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r12.zwzz, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r4.z, r5.x, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t1.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id63 return value>

#line 653
  mad r3.y, r7.x, r4.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r14.xyxx, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r3.z, r4.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r14.zwzz, t1.xxxx, s0, r3.w  // r3.z <- <SampleTextureAndCompare_id63 return value>

#line 653
  mad r3.y, r4.w, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r9.zwzz, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r15.y, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r8.ywyy, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r5.z, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r16.xyxx, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r8.z, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r16.zwzz, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r7.z, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r7.ywyy, t1.xxxx, s0, r3.w

#line 653
  mad r3.y, r5.w, r3.z, r3.y

#line 561
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r4.xyxx, t1.xxxx, s0, r3.w
...
#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t1.xxxx, s0, r2.z  // r1.w <- <SampleTextureAndCompare_id63 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r10.zwzz, t1.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id63 return value>
...
#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t1.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id63 return value>

#line 653
      mad r1.w, r2.x, r2.w, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r13.xyxx, t1.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id63 return value>

#line 653
      mad r1.w, r8.x, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r11.xyxx, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r5.y, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r11.zwzz, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r15.z, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r12.zwzz, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r9.z, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r13.zwzz, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r7.x, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r14.xyxx, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r2.y, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r14.zwzz, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r9.w, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r15.xyxx, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r15.w, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r8.ywyy, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r5.z, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r16.xyxx, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r8.z, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r16.zwzz, t1.xxxx, s0, r2.z

#line 653
      mad r1.w, r7.z, r2.x, r1.w

#line 561
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r7.ywyy, t1.xxxx, s0, r2.z
...
#line 419
  mad r7.zw, -r2.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r7.z <- uvW0.y; r7.w <- uvW0.x

#line 421
  mad r8.xy, r2.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r8.x <- uvW2.x; r8.y <- uvW2.y

#line 422
  mad r8.zw, -r2.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r8.zw, r8.zzzw, r7.wwwz
  add r9.xw, r8.zzzw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r9.x <- uv0.x; r9.w <- uv0.y

#line 423
  add r8.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  mul r9.yz, r8.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r9.y <- uv1.y; r9.z <- uv1.x

#line 424
  div r2.xy, r2.xyxx, r8.xyxx
  add r10.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r10.x <- uv2.x; r10.y <- uv2.y

#line 425
  mul r2.x, r7.z, r7.w

#line 426
  mad r11.xyzw, r9.xwzw, cb0[41].zwzw, r7.xyxy
...
#line 429
  mad r12.xyzw, r9.xyzy, cb0[41].zwzw, r7.xyxy

#line 430
  mad r13.xyzw, r10.xzxw, cb0[41].zwzw, r7.xyxy
...
#line 432
  mad r9.xyzw, r9.xyzy, cb0[41].zwzw, r7.xyxy
  mul r10.zw, r8.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 433
  mad r7.xy, r10.xyxx, cb0[41].zwzz, r7.xyxx
  mul r2.y, r8.y, r8.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r11.xyxx, t0.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id113 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r11.zwzz, t0.xxxx, s0, r2.z  // r8.x <- <SampleTextureAndCompare_id113 return value>

#line 585
  mul r8.x, r8.x, r8.z
  mad r2.x, r2.x, r6.w, r8.x  // r2.x <- shadow

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r13.xyxx, t0.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id113 return value>

#line 585
  mad r2.x, r7.z, r6.w, r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r12.xyxx, t0.xxxx, s0, r2.z

#line 585
  mad r2.x, r8.w, r6.w, r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r12.zwzz, t0.xxxx, s0, r2.z

#line 585
  mad r2.x, r6.w, l(49.000000), r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r13.zwzz, t0.xxxx, s0, r2.z

#line 585
  mad r2.x, r10.z, r6.w, r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r9.xyxx, t0.xxxx, s0, r2.z

#line 585
  mad r2.x, r7.w, r6.w, r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r9.zwzz, t0.xxxx, s0, r2.z

#line 585
  mad r2.x, r10.w, r6.w, r2.x

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r7.xyxx, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id113 return value>
...
float FilterShadow_id107(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id114(base_uv, st, kernel);
