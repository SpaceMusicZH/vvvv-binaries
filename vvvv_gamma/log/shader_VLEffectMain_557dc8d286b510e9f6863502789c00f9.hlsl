...
@C    InputValue_id201 => ShaderFX.InputValueFloat4
...
@R    EnvironmentLightingDFG_LUT_id230 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
@R    ShadowMapTexture_id153 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (1-1)]
@R    LightClusters_id181 => LightClustered.LightClusters [Stage: Pixel, Slot: (2-2)]
@R    LightIndices_id182 => LightClustered.LightIndices [Stage: Pixel, Slot: (3-3)]
@R    PointLights_id186 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (4-4)]
@R    SpotLights_id187 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (5-5)]
...
*****     Stages      *****
***************************
@G    Vertex => da19bc0383a434014d75a0e3f3290aa1
//
...
//
#line 1430 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_557dc8d286b510e9f6863502789c00f9.hlsl"
mov o0.xyzw, v0.xyzw
mov o1.x, v1.x
mov o2.xyzw, v0.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => 989b1f3d259065a1a4f7df86901d2234
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1396 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_557dc8d286b510e9f6863502789c00f9.hlsl"
...
#line 1365
mul r4.xyz, r3.zzyz, r3.yxxy  // r4.y <- <rot3x3_id45 return value>._m11; r4.z <- <rot3x3_id45 return value>._m22
mul r0.w, r2.y, r2.x
mad r5.x, r0.w, r2.z, r4.x  // r5.x <- <rot3x3_id45 return value>._m00
mul r5.y, r2.z, -r3.x  // r5.y <- <rot3x3_id45 return value>._m01
mul r6.xyzw, r2.xyzy, r3.yzyx  // r6.w <- <rot3x3_id45 return value>._m20
...
#line 1365
mad r5.z, r6.x, r2.z, -r7.x  // r5.z <- <rot3x3_id45 return value>._m02
mad r8.x, -r0.w, r3.z, r6.z  // r8.x <- <rot3x3_id45 return value>._m10
mul r0.w, r3.z, r6.x
mad r8.y, -r2.y, r2.z, -r0.w  // r8.y <- <rot3x3_id45 return value>._m12

#line 1405
add r2.yzw, -r1.xxyz, cb1[21].xxyz  // r2.y <- viewDir.x; r2.z <- viewDir.y; r2.w <- viewDir.z

#line 1406
dp3 r0.w, r2.yzwy, r7.yzwy
...
#line 1316
    and r6.xyz, r1.wwww, l(90, 51, 15, 0)
    movc r6.xyz, r6.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r6.x <- <CubeVert_id65 return value>.x; r6.y <- <CubeVert_id65 return value>.y; r6.z <- <CubeVert_id65 return value>.z

#line 1339
    mul r9.xyz, r5.xyzx, r6.xxxx
    mad r9.xyz, r9.xyzx, r0.xxxx, r1.xyzx  // r9.x <- posWorld.x; r9.y <- posWorld.y; r9.z <- posWorld.z

#line 1340
    mul r10.xyz, r8.xzyx, r6.yyyy
    mad r9.xyz, r10.xyzx, r0.yyyy, r9.xyzx

#line 1341
    mul r6.xyz, r7.yzwy, r6.zzzz
    mad r3.xyz, r6.xyzx, r0.zzzz, r9.xyzx  // r3.x <- posWorld.x; r3.y <- posWorld.y; r3.z <- posWorld.z
...
#line 1346
    dp4 r1.w, r9.xyzw, cb1[16].xyzw  // r1.w <- streams.ShadingPosition_id0.x
    dp4 r3.x, r9.xyzw, cb1[17].xyzw  // r3.x <- streams.ShadingPosition_id0.y
    dp4 r3.y, r9.xyzw, cb1[18].xyzw  // r3.y <- streams.ShadingPosition_id0.z
    dp4 r3.z, r9.xyzw, cb1[19].xyzw  // r3.z <- streams.ShadingPosition_id0.w
...
#line 1340
    ...
    mad r6.xyw, r6.xyxw, r0.yyyy, r9.xyxz  // r6.x <- posWorld.x; r6.y <- posWorld.y; r6.w <- posWorld.z

#line 1341
    mul r9.xyz, r7.yzwy, r6.zzzz
    mad r3.xyz, r9.xyzx, r0.zzzz, r6.xywx  // r3.x <- posWorld.x; r3.y <- posWorld.y; r3.z <- posWorld.z
...
#line 1346
    ...
    dp4 r2.x, r6.xyzw, cb1[17].xyzw  // r2.x <- streams.ShadingPosition_id0.y
...
#line 1316
    and r3.xyz, r1.wwww, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r3.xyz, r3.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r3.x <- <CubeVert_id65 return value>.x; r3.y <- <CubeVert_id65 return value>.y; r3.z <- <CubeVert_id65 return value>.z
...
@G    Pixel => 906c4e08fc8d87165ed46484aa02d91e
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 InputValue_id201;           // Offset:    0 Size:    16
//   float InputValue_id209;            // Offset:   16 Size:     4
//   float InputValue_id218;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id230    texture  float4          2d             t0      1 
// ShadowMapTexture_id153            texture  float4          2d             t1      1 
// LightClusters_id181               texture   uint2          3d             t2      1 
// LightIndices_id182                texture    uint         buf             t3      1 
// PointLights_id186                 texture  float4         buf             t4      1 
// SpotLights_id187                  texture  float4         buf             t5      1 
...
//
#line 1381 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_557dc8d286b510e9f6863502789c00f9.hlsl"
...
#line 496
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id109 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id109 return value>
...
#line 496
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id109 return value>

#line 576
  mad r5.w, r6.z, r8.w, r5.w

#line 496
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id109 return value>
...
#line 496
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id109 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id109 return value>
...
#line 496
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id109 return value>
...
#line 546
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id193 return value>.x; r8.y <- <FresnelSchlick_id193 return value>.y; r8.z <- <FresnelSchlick_id193 return value>.z
...
#line 542
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id209 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id209 return value>

#line 644
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id211 return value>
...
#line 640
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id223 return value>
...
#line 967
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id525 return value>.x; r7.y <- <ComputeDirectLightContribution_id525 return value>.y; r7.z <- <ComputeDirectLightContribution_id525 return value>.z
...
#line 785
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t2.xyzw  // r0.x <- streams.lightData_id179.x; r0.y <- streams.lightData_id179.y

#line 954
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id264 return value>
...
#line 349
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id123 return value>
...
#line 546
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id193 return value>.x; r13.y <- <FresnelSchlick_id193 return value>.y; r13.z <- <FresnelSchlick_id193 return value>.z
...
#line 542
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id209 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id209 return value>

#line 644
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id211 return value>
...
#line 640
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id223 return value>
...
#line 932
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id276 return value>
...
mov r0.y, r6.z  // r0.y <- streams.lightIndex_id180
mov r0.z, l(0)  // r0.z <- i
loop 
  ige r1.w, r0.z, r0.x
  breakc_nz r1.w
...
#line 343
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id134 return value>
...
#line 546
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id193 return value>.x; r16.y <- <FresnelSchlick_id193 return value>.y; r16.z <- <FresnelSchlick_id193 return value>.z
...
#line 542
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id209 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id209 return value>

#line 644
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id211 return value>
...
#line 640
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id223 return value>
...
#line 719
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id347 return value>.x; r0.z <- <Compute_id347 return value>.y; r0.w <- <Compute_id347 return value>.z

#line 901
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id526 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id526 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id526 return value>.z
...
#line 704
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t6.xyzw, s0, r0.x  // r1.x <- <Compute_id297 return value>.x; r1.y <- <Compute_id297 return value>.y; r1.z <- <Compute_id297 return value>.z
...
float4 Project_id101(float4 vec, float4x4 mat)
{
    float4 vecProjected = mul(vec, mat);
    vecProjected.xyz /= vecProjected.w;
    return vecProjected;
}
float SmoothDistanceAttenuation_id134(float squaredDistance, float lightInvSquareRadius)
{
...
float SampleThickness_id112(float3 shadowSpaceCoordinate, float3 pixelPositionWS, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic)
{
    ...
    {
        float4 shadowmapPositionWorldSpace = Project_id101(float4(shadowSpaceCoordinate.xy, shadowMapDepth, 1.0), inverseWorldToShadowCascadeUV);
...
float GetAngularAttenuation_id136(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float GetDistanceAttenuation_id135(float lightVectorLength, float lightInvSquareRadius)
{
    float d2 = lightVectorLength * lightVectorLength;
    float attenuation = 1.0 / (max(d2, 0.01 * 0.01));
    attenuation *= SmoothDistanceAttenuation_id134(d2, lightInvSquareRadius);
    return attenuation;
}
...
float SampleAndFilter_id116(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id108(base_uv, st, kernel);
...
{
    float4 bottomLeftTexelWS = Project_id101(float4(0.0, 0.0, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id101(float4(ShadowMapTextureTexelSize_id155.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, bottomLeftTexelWS.xyz);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 shadowMapCoordinate = Project_id101(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
...
{
    const float4 shadowMapCoordinate = Project_id101(float4(pixelPositionWS, 1.0), worldToShadowCascadeUV);
    const float4 topRightTexelWS = Project_id101(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id155.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
    const float texelDiagonalLength = distance(topRightTexelWS.xyz, pixelPositionWS);
    const float3 positionOffsetWS = meshNormalWS * texelDiagonalLength;
    adjustedPixelPositionWS = pixelPositionWS - positionOffsetWS;
    const float4 adjustedShadowMapCoordinate = Project_id101(float4(adjustedPixelPositionWS, 1.0), worldToShadowCascadeUV);
...
float ComputeAttenuation_id137(float3 PositionWS, float3 AngleOffsetAndInvSquareRadius, float3 DirectionWS, float3 position, inout float3 lightVectorNorm)
{
    ...
    float attenuation = GetDistanceAttenuation_id135(lightVectorLength, lightInvSquareRadius);
    attenuation *= GetAngularAttenuation_id136(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    return attenuation;
}
...
float VisibilityhSchlickGGX_id209(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
    return nDotX / (nDotX * (1.0f - k) + k);
}
float3 FresnelSchlick_id193(float3 f0, float3 f90, float lOrVDotH)
{
...
float FilterShadow_id102(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id108(base_uv, st, kernel);
...
{
    streams.Input_2_id217 = Compute_id335();
}
void Compute_id326(inout PS_STREAMS streams)
{
    streams.Input_1_id208 = Compute_id323();
}
void Compute_id314(inout PS_STREAMS streams)
{
    streams.Input_0_id200 = Compute_id311();
}
float4 EvaluateSphericalHarmonics_id147(float3 sphericalColors[TOrder_id190 * TOrder_id190], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id138(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id137(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
void ProcessLight_id127(inout PS_STREAMS streams, PointLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id124(light, streams.PositionWS_id22.xyz, lightVectorNorm);
    streams.lightPositionWS_id41 = light.PositionWS;
    streams.lightColor_id43 = light.Color;
    streams.lightAttenuation_id46 = attenuation;
    streams.lightDirectionWS_id42 = lightVectorNorm;
}
float NormalDistributionGGX_id223(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    float d = max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001);
    return alphaR2 / (PI_id229 * d * d);
}
float VisibilitySmithSchlickGGX_id211(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id209(alphaR, nDotL) * VisibilityhSchlickGGX_id209(alphaR, nDotV) / (nDotL * nDotV);
}
float3 FresnelSchlick_id199(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id193(f0, 1.0f, lOrVDotH);
}
float ComputeThicknessFromCascade_id106(float3 pixelPositionWS, float3 meshNormalWS, int cascadeIndex, int lightIndex, bool isOrthographic)
{
    const int arrayIndex = cascadeIndex + lightIndex * TCascadeCountBase_id157;
    return FilterThickness_id103(pixelPositionWS, meshNormalWS, DepthRanges_id162[arrayIndex], WorldToShadowCascadeUV_id159[arrayIndex], InverseWorldToShadowCascadeUV_id160[arrayIndex], isOrthographic);
}
...
float4 Compute_id297(inout PS_STREAMS streams, float3 direction)
{
    ...
    return CubeMap_id195.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id292(float3 direction)
{
    return EvaluateSphericalHarmonics_id147(SphericalColors_id193, direction);
}
...
float3 Compute_id347(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id230.SampleLevel(LinearSampler_id113, float2(glossiness, nDotV), 0);
...
float3 ComputeSpecularTextureProjection_id133(float3 positionWS, float3 reflectionWS, int lightIndex)
{
    return 1.0f;
}
float3 ComputeTextureProjection_id132(float3 positionWS, int lightIndex)
{
    return 1.0f;
}
float3 ComputeShadow_id131(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    streams.thicknessWS_id149 = 0.0;
    return 1.0f;
}
void PrepareDirectLightCore_id130(inout PS_STREAMS streams, int lightIndexIgnored)
{
    ...
    ProcessLight_id138(streams, spotLight);
}
...
void PrepareDirectLightCore_id119(inout PS_STREAMS streams, int lightIndexIgnored)
{
    int realLightIndex = LightIndices_id182.Load(streams.lightIndex_id180);
    streams.lightIndex_id180++;
    ...
    ProcessLight_id127(streams, pointLight);
}
void PrepareLightData_id126(inout PS_STREAMS streams)
{
...
{
    return NormalDistributionGGX_id223(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id409(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id211(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id379(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id199(f0, streams.LdotH_id77);
}
...
float3 ComputeShadow_id96(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id104(OffsetScales_id164[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
...
void ResetStream_id226()
{
}
void AfterLightingAndShading_id496()
{
}
void AfterLightingAndShading_id477()
{
}
...
void PrepareEnvironmentLight_id307(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id292(sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id297(streams, sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id526(inout PS_STREAMS streams)
{
    ...
    return Compute_id347(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id470(inout PS_STREAMS streams)
{
...
{
    PrepareDirectLightCore_id130(streams, lightIndex);
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id148 = ComputeShadow_id131(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id44 *= ComputeTextureProjection_id132(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id45 *= ComputeSpecularTextureProjection_id133(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id277(inout PS_STREAMS streams)
{
    return streams.lightData_id179.y >> 16;
}
int GetMaxLightCount_id276(inout PS_STREAMS streams)
{
    return streams.lightData_id179.y >> 16;
}
...
void PrepareDirectLight_id260(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id148 = ComputeShadow_id120(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id148 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
    streams.lightSpecularColorNdotL_id45 = streams.lightColorNdotL_id44;
    streams.lightColorNdotL_id44 *= ComputeTextureProjection_id121(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id45 *= ComputeSpecularTextureProjection_id122(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id265(inout PS_STREAMS streams)
{
    return streams.lightData_id179.y & 0xFFFF;
}
int GetMaxLightCount_id264(inout PS_STREAMS streams)
{
    return streams.lightData_id179.y & 0xFFFF;
}
void PrepareDirectLights_id263(inout PS_STREAMS streams)
{
    PrepareLightData_id126(streams);
}
float3 ComputeDirectLightContribution_id525(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id379(streams, specularColor);
    float geometricShadowing = Compute_id409(streams);
    float normalDistribution = Compute_id439(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id469(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareDirectLight_id236(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id148 = ComputeShadow_id96(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id148 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
    streams.lightSpecularColorNdotL_id45 = streams.lightColorNdotL_id44;
...
void PrepareForLightingAndShading_id474()
{
}
void PrepareMaterialForLightingAndShading_id225(inout PS_STREAMS streams)
{
...
void ResetLightStream_id224(inout PS_STREAMS streams)
{
...
void ResetStream_id227(inout PS_STREAMS streams)
{
    ResetStream_id226();
...
void Compute_id557(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id224(streams);
    PrepareMaterialForLightingAndShading_id225(streams);

    {
        PrepareForLightingAndShading_id474();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id469(streams);
            }
    ...
    {
        PrepareDirectLights_id263(streams);
        const int maxLightCount = GetMaxLightCount_id264(streams);
        int count = GetLightCount_id265(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id276(streams);
        int count = GetLightCount_id277(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id470(streams);
        }
...
void ResetStream_id91(inout PS_STREAMS streams)
{
...
{
    PreTransformPosition_id67();
    TransformPosition_id68();
    PostTransformPosition_id69(streams);
}
void VSMain_id0()
{
}
void PSMain_id3(inout PS_STREAMS streams)
{
    ...
    streams.ColorTarget1_id3 = Compute_id90();
}
...
float3 CubeVert_id65(in uint vertexID)
{
    uint b = 1 << vertexID;
    return float3((0xFA55A & b) != 0, (0x5A0F33 & b) != 0, (0x33330F & b) != 0) - 0.5;
}
void GenerateNormal_VS_id70()
{
}
...
void SpawnQuad_id71(inout GS_STREAMS streams, uint start, inout TriangleStream<GS_OUTPUT> triangleStream, float3 normal, Particle p, float3 AxisX, float3 AxisY, float3 AxisZ)
{
    ...
    for (uint i = start; i < start + 4; i++)
    {
        ...
        float3 qPos = CubeVert_id65(i);
        posWorld.xyz += qPos.x * AxisX * streams.PSize_id145.x;
        posWorld.xyz += qPos.y * AxisY * streams.PSize_id145.y;
        posWorld.xyz += qPos.z * AxisZ * streams.PSize_id145.z;
...
float3x3 rot3x3_id45(float3 rotation)
{
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    uint id = streams.VertexID_id142;
    Particle p = Particles_id143[id];
    streams.PositionWS_id22 = float4(p.Position.xyz, 1);
    streams.PSize_id145 = p.Size3;
    if (dot(streams.PSize_id145, streams.PSize_id145) <= 0)
        return;
    float3x3 or = rot3x3_id45(p.Size3);
    float3 AxisX = or[0];
    float3 AxisY = or[1];
    float3 AxisZ = or[2];
    float3 viewDir = Eye_id31.xyz - p.Position;
    if (dot(viewDir, AxisZ) > 0)
        SpawnQuad_id71(streams, 0, triangleStream, AxisZ, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisZ) > 0)
        SpawnQuad_id71(streams, 4, triangleStream, -AxisZ, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, AxisY) > 0)
        SpawnQuad_id71(streams, 8, triangleStream, AxisY, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisY) > 0)
        SpawnQuad_id71(streams, 12, triangleStream, -AxisY, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, AxisX) > 0)
        SpawnQuad_id71(streams, 16, triangleStream, AxisX, p, AxisX, AxisY, AxisZ);
    if (dot(viewDir, -AxisX) > 0)
        SpawnQuad_id71(streams, 20, triangleStream, -AxisX, p, AxisX, AxisY, AxisZ);
}
