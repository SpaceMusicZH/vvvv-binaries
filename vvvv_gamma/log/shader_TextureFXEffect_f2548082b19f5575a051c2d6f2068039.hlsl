...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin DirectionalBlur_Pass0_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    DirectionalBlur_Pass0_Internal_TextureFX => 4e6389a2960b94375eea60e676da1077
...
//
#line 194 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_TextureFXEffect_f2548082b19f5575a051c2d6f2068039.hlsl"
...
@G    Pixel => e245cdc71d69c044088cb52bc5aa7551
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 173 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_TextureFXEffect_f2548082b19f5575a051c2d6f2068039.hlsl"
...
mov r2.yz, cb0[1].xxxx
mul r2.xy, r2.xyxx, cb2[5].xyxx
mul r2.xy, r2.zwzz, r2.xyxx

#line 164
mov r3.xyzw, l(0,0,0,0)  // r3.x <- col.x; r3.y <- col.y; r3.z <- col.z; r3.w <- col.w
mov r2.z, l(0)  // r2.z <- i
loop 
  ge r4.x, r2.z, l(1.000000)
  breakc_nz r4.x

#line 167
  add r2.zw, r2.zzzz, l(0.000000, 0.000000, 0.062500, -0.500000)

#line 166
  mad r4.xy, -cb2[5].zwzz, l(0.500000, 0.500000, 0.000000, 0.000000), r2.wwww
  mad r4.xy, r2.xyxx, r4.xyxx, r1.zwzz
  mad r4.xy, r4.xyxx, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
#line 178
mad r1.xyzw, r3.xyzw, l(0.062500, 0.062500, 0.062500, 0.062500), -r0.xyzw
