...
@P   - ColorTransformGroup.Transforms: Stride.Rendering.Images.FilmGrain, Stride.Rendering.Images.Vignetting, Stride.Rendering.Images.Dither.Dither, Stride.Rendering.Images.ToneMap
***************************
****  ConstantBuffers  ****
***************************
...
@C    Time_id82 => Dither.Time.Transforms[2]
@C    WhitePoint_id83 => ToneMapHejl2OperatorShader.WhitePoint.ToneMapOperator.Transforms[3]
@C    KeyValue_id88 => ToneMapShader.KeyValue.Transforms[3]
@C    LuminanceLocalFactor_id89 => ToneMapShader.LuminanceLocalFactor.Transforms[3]
@C    LuminanceAverageGlobal_id90 => ToneMapShader.LuminanceAverageGlobal.Transforms[3]
@C    Contrast_id91 => ToneMapShader.Contrast.Transforms[3]
@C    Brightness_id92 => ToneMapShader.Brightness.Transforms[3]
@C    Exposure_id93 => ToneMapShader.Exposure.Transforms[3]
***************************
******  Resources    ******
***************************
...
@S    Dither => 1809bd2d7b77559e7a006027d2eaf74d
...
//
#line 316 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_772410d7de9cc72b51fcf99f1277b60f.hlsl"
...
@G    Pixel => 0a24c0eb78b3bdad47babd6d250127d4
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float Time_id82;                   // Offset:  124 Size:     4
//   float WhitePoint_id83;             // Offset:  128 Size:     4
//      = 0x40a00000 
//   float KeyValue_id88;               // Offset:  132 Size:     4 [unused]
//      = 0x3e3851ec 
//   float LuminanceLocalFactor_id89;   // Offset:  136 Size:     4 [unused]
//      = 0x00000000 
//   float LuminanceAverageGlobal_id90; // Offset:  140 Size:     4
//   float Contrast_id91;               // Offset:  144 Size:     4
//      = 0x00000000 
//   float Brightness_id92;             // Offset:  148 Size:     4
//      = 0x00000000 
//   float Exposure_id93;               // Offset:  152 Size:     4
//      = 0x3f800000 
//
// }
//
...
//
#line 230 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_772410d7de9cc72b51fcf99f1277b60f.hlsl"
...
mul r0.xy, r0.xyxx, r1.zwzz  // r0.y <- <Quintic_id23 return value>.x
...
max r0.y, r0.y, l(0.000100)  // r0.y <- <Luma_id22 return value>
...
#line 274
mad r0.xyz, r0.xxxx, cb0[5].xxxx, r1.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
#line 187
div r1.xy, v1.xyxx, cb0[0].xyxx  // r1.x <- vScreenPos.x; r1.y <- vScreenPos.y

#line 188
add r1.xy, r1.xyxx, cb0[7].wwww
dp2 r0.w, l(131.000000, 312.000000, 0.000000, 0.000000), r1.xyxx  // r0.w <- vDither.x

#line 189
mul r1.xyz, r0.wwww, l(0.009709, 0.014085, 0.010309, 0.000000)
frc r1.xyz, r1.xyzx
add r1.xyz, r1.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)  // r1.x <- vDither.x; r1.y <- vDither.y; r1.z <- vDither.z

#line 191
mad r0.xyz, r1.xyzx, l(0.003922, 0.003922, 0.003922, 0.000000), r0.xyzx  // r0.x <- <ScreenSpaceDither_id12 return value>.x; r0.y <- <ScreenSpaceDither_id12 return value>.y; r0.z <- <ScreenSpaceDither_id12 return value>.z

#line 243
exp r0.w, cb0[8].w  // r0.w <- globalAverageLum

#line 244
mad r0.xyz, r0.wwww, cb0[9].yyyy, r0.xyzx
...
add r1.x, cb0[9].x, l(1.000000)
mad r0.xyz, r1.xxxx, r0.xyzx, r0.wwww
max r0.xyz, r0.xyzx, l(0.000100, 0.000100, 0.000100, 0.000000)  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z

#line 180
mul r0.xyz, r0.xyzx, cb0[9].zzzz  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
#line 152
mad r1.xy, cb0[8].xxxx, l(1.425000, 1.425000, 0.000000, 0.000000), l(0.050000, 0.600000, 0.000000, 0.000000)  // r1.x <- w
mad r1.xy, cb0[8].xxxx, r1.xyxx, l(0.004000, 0.049100, 0.000000, 0.000000)
div r0.w, r1.x, r1.y
...
***************************
*************************/
const static bool TAutoKeyValue_id84 = true;
const static bool TAutoExposure_id85 = false;
const static bool TUseLocalLuminance_id86 = false;
struct PS_STREAMS 
{
...
cbuffer Globals 
{
    ...
    float3 Color_id81;
    float Time_id82;
    float WhitePoint_id83 = 5.0f;
    float KeyValue_id88 = 0.18f;
    float LuminanceLocalFactor_id89 = 0.0f;
    float LuminanceAverageGlobal_id90;
    float Contrast_id91 = 0.0f;
    float Brightness_id92 = 0.0f;
    float Exposure_id93 = 1.0f;
};
...
Texture2D LuminanceTexture_id87;
float2 Quintic_id23(float2 x)
{
    return x * x * x * (x * (x * 6.0 - 15.0) + 10.0);
}
float4 Compute_id16(float4 color)
{
    float w = (1.425 * WhitePoint_id83) + 0.05f;
    w = ((WhitePoint_id83 * w + 0.004f) / ((WhitePoint_id83 * (w + 0.55f) + 0.0491f))) - 0.0821f;
    float4 vh = float4(color.rgb, WhitePoint_id83);
    float4 va = (1.425 * vh) + 0.05f;
    float4 vf = ((vh * va + 0.004f) / ((vh * (va + 0.55f) + 0.0491f))) - 0.0821f;
    return float4(vf.rgb / w, 1.0);
}
float CalculateExposure_id14(float avgLuminance)
{
    float exposure;

    {
        exposure = Exposure_id93;
    }
    return exposure;
}
float fade_id11(float t)
{
    return Quintic_id23(t);
}
...
float3 ToneMap_id13(float3 color, float avgLuminance)
{
    float exposure = CalculateExposure_id14(avgLuminance);
    color *= exposure;
    color = Compute_id16(float4(color, 1)).rgb;
    return color;
}
float3 ScreenSpaceDither_id12(inout PS_STREAMS streams, float3 input)
{
    float2 vScreenPos = streams.TexCoord_id62;
    vScreenPos /= Texture0TexelSize_id15;
    float3 vDither = dot(float2(131.0, 312.0), vScreenPos + Time_id82);
    vDither.rgb = frac(vDither.rgb / float3(103.0, 71.0, 97.0)) - float3(0.5, 0.5, 0.5);
    float d = max(input.x, max(input.y, input.z));
    return input + (vDither.rgb / 255.0);
}
static float Luma_id22(float3 color)
{
...
float4 Compute_id7(inout PS_STREAMS streams, float4 inputColor)
{
    float3 color = inputColor.rgb;
    float avgLuminance = LuminanceAverageGlobal_id90;
    avgLuminance = exp2(avgLuminance);
    avgLuminance = max(avgLuminance, 0.0001f);
    float globalAverageLum = exp2(LuminanceAverageGlobal_id90);
    color = max(color + globalAverageLum.xxx * Brightness_id92, 0.0001);
    color = max(lerp(globalAverageLum.xxx, color, Contrast_id91 + 1.0f), 0.0001);
    color = ToneMap_id13(color, avgLuminance);
    return float4(color, inputColor.a);
}
float4 Compute_id6(inout PS_STREAMS streams, float4 color)
{
    return float4(ScreenSpaceDither_id12(streams, color.rgb), color.a);
}
...
float4 Compute_id4(inout PS_STREAMS streams, float4 color)
{
    ...
    float luminance = lerp(0.0, Luma_id22(col), LuminanceFactor_id78);
...
float4 Shading_id3(inout PS_STREAMS streams)
{
    ...
    {
        color = Compute_id7(streams, color);
    }
    return color;
}
