...
//
#line 316 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_89ca25fd0e7972792c7c9fed747965b3.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 676d121c5eda83f0454ca50e2b72f984
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 283 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_89ca25fd0e7972792c7c9fed747965b3.hlsl"
...
mul r4.x, r0.z, -r3.x  // r4.x <- <rot3x3_id51 return value>._m01
mul r6.xyzw, r0.xyyz, r3.yzxy  // r6.z <- <rot3x3_id51 return value>._m20
mad r7.x, r6.x, r0.z, -r6.y  // r7.x <- <rot3x3_id51 return value>._m02
mad r5.y, -r0.w, r3.z, r6.w  // r5.y <- <rot3x3_id51 return value>._m10
mul r0.w, r3.z, r6.x
mad r7.y, -r0.y, r0.z, -r0.w  // r7.y <- <rot3x3_id51 return value>._m12
...
#line 196
    ...
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id75 return value>.x; r8.y <- <CubeVert_id75 return value>.y; r8.z <- <CubeVert_id75 return value>.z
...
#line 196
    and r5.xyz, r1.wwww, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r5.xyz, r5.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r5.x <- <CubeVert_id75 return value>.x; r5.y <- <CubeVert_id75 return value>.y; r5.z <- <CubeVert_id75 return value>.z
...
//
#line 274 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_89ca25fd0e7972792c7c9fed747965b3.hlsl"
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    if (dot(streams.PSize_id106, streams.PSize_id106) <= 0)
        return;
    float3x3 or = transpose(rot3x3_id51(p.Rot));
