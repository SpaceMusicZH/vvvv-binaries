...
@C    InputValue_id208 => ShaderFX.InputValueFloat.i4
@C    InputValue_id224 => ShaderFX.InputValueFloat3.i9
@C    InputValue_id231 => ShaderFX.InputValueFloat3.i10
@C    InputValue_id259 => ShaderFX.InputValueFloat.i2
@C    InputValue_id267 => ShaderFX.InputValueFloat3.i2
@C    InputValue_id274 => ShaderFX.InputValueFloat3.i3
@C    InputValue_id281 => ShaderFX.InputValueFloat3.i4
@C    InputValue_id291 => ShaderFX.InputValueFloat.i1
@C    InputValue_id299 => ShaderFX.InputValueFloat3
@C    InputValue_id306 => ShaderFX.InputValueFloat3.i1
@C    InputValue_id327 => ShaderFX.InputValueUInt
@C    InputValue_id348 => ShaderFX.InputValueFloat
...
@R    DynamicTexture_id241 => ObjectTexture_fx19 [Stage: Compute, Slot: (4-4)]
@R    DynamicBuffer_id334 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id341 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => 8436e08c8ada6dcc1f1a9d19555fa429
//
...
//   float3 InputValue_id224;           // Offset:   68 Size:    12
//   float3 InputValue_id231;           // Offset:   80 Size:    12
//   float InputValue_id259;            // Offset:   92 Size:     4
//   float3 InputValue_id267;           // Offset:   96 Size:    12
//   float3 InputValue_id274;           // Offset:  112 Size:    12
//   float3 InputValue_id281;           // Offset:  128 Size:    12
//   float InputValue_id291;            // Offset:  140 Size:     4
//   float3 InputValue_id299;           // Offset:  144 Size:    12
//   float3 InputValue_id306;           // Offset:  160 Size:    12
//   uint InputValue_id327;             // Offset:  172 Size:     4
//   float InputValue_id348;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicTexture_id241              texture  float4          2d             t4      1 
// DynamicBuffer_id334               texture  float4         buf             t5      1 
// DynamicTexture_id341              texture  float4          2d             t6      1 
...
//
#line 1413 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_00e20ecff50ca583c77f0e79b2c106d7.hlsl"
...
#line 674
  mad r11.xyz, cb1[8].wwww, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id563 return value>.x; r11.y <- <Compute_id563 return value>.y; r11.z <- <Compute_id563 return value>.z
...
#line 670
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id451 return value>.x; r12.y <- <Compute_id451 return value>.y; r12.z <- <Compute_id451 return value>.z
...
#line 641
  mad r12.xyz, r12.xyzx, cb1[6].xyzx, cb1[7].xyzx  // r12.x <- <Compute_id500 return value>.x; r12.y <- <Compute_id500 return value>.y; r12.z <- <Compute_id500 return value>.z

#line 633
  add r12.xyz, r12.xyzx, cb1[8].xyzx  // r12.x <- <Compute_id508 return value>.x; r12.y <- <Compute_id508 return value>.y; r12.z <- <Compute_id508 return value>.z
...
#line 617
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.xzxx, t3.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id193 return value>.x; r12.y <- <Compute_id193 return value>.y; r12.z <- <Compute_id193 return value>.z
...
#line 580
  mad r12.xyz, r1.wwww, cb1[0].xyzx, cb1[1].xyzx  // r12.x <- <Compute_id258 return value>.x; r12.y <- <Compute_id258 return value>.y; r12.z <- <Compute_id258 return value>.z

#line 572
  add r12.xyz, r12.xyzx, cb1[2].xyzx  // r12.x <- <Compute_id266 return value>.x; r12.y <- <Compute_id266 return value>.y; r12.z <- <Compute_id266 return value>.z
...
#line 540
  mul r1.w, r0.w, cb1[4].x  // r1.w <- <Compute_id388 return value>

#line 524
  mul r12.y, cb1[3].w, cb1[4].y  // r12.y <- <Compute_id410 return value>.x
  mul r12.zw, r1.wwww, cb1[4].zzzw  // r12.z <- <Compute_id410 return value>.y; r12.w <- <Compute_id410 return value>.z

#line 516
  add r12.xyz, r12.yzwy, cb1[5].xyzx  // r12.x <- <Compute_id418 return value>.x; r12.y <- <Compute_id418 return value>.y; r12.z <- <Compute_id418 return value>.z
...
#line 488
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id581 return value>.x; r14.y <- <SRgbToLinear_id581 return value>.y; r14.z <- <SRgbToLinear_id581 return value>.z
...
const static float Value_id342 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Input_13_id290;
    float3 SMVector3Join_ShaderFXResult_14_id293;
    float3 Input_15_id298;
    float3 Multiply_16_id301;
    float3 Input_17_id305;
    float3 Plus_18_id308;
    float4 TextureValue_20_id240;
    float SMCalcLuminance_ShaderFXResult_22_id247;
    float Input_23_id258;
    float3 SMVector3Join_ShaderFXResult_24_id261;
    float3 Input_25_id266;
    float3 Multiply_26_id269;
    float3 Input_27_id273;
    float3 Plus_28_id276;
    float3 Input_29_id280;
    float3 Plus_30_id283;
    ...
    float Input_48_id207;
    float Multiply_49_id210;
    float Multiply_50_id214;
    float3 SMVector3Join_ShaderFXResult_51_id218;
    float3 Input_52_id223;
    float3 Multiply_53_id226;
    float3 Input_54_id230;
    float3 Plus_55_id233;
    uint Input_3_id326;
    uint SMValueToIndex_ShaderFXResult_4_id329;
    float4 BufferItem_5_id333;
    float4 SRgbToLinear_ShaderFXResult_6_id337;
    float4 TextureValue_9_id340;
    float Input_11_id347;
    float4 Lerp_12_id350;
};
struct CS_INPUT 
{
...
cbuffer PerUpdate 
{
    ...
    float InputValue_id291;
    float3 InputValue_id299;
    float3 InputValue_id306;
    uint InputValue_id327;
    float InputValue_id348;
};
cbuffer Globals 
{
...
Texture2D DynamicTexture_id241;
Buffer<float4> DynamicBuffer_id334;
Texture2D DynamicTexture_id341;
float3 Compute_id415(inout CS_STREAMS streams)
{
    return streams.Input_54_id230;
}
float3 Compute_id413(inout CS_STREAMS streams)
{
    return streams.Multiply_53_id226;
}
float3 Compute_id407(inout CS_STREAMS streams)
{
    return streams.Input_52_id223;
}
float3 Compute_id405(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_51_id218;
}
...
{
    return streams.Multiply_49_id210;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_22_id247;
}
...
{
    return streams.TextureValue_20_id240;
}
float Compute_id446()
{
    return Value_id342;
...
{
    return streams.Input_17_id305;
}
float3 Compute_id558(inout CS_STREAMS streams)
{
    return streams.Multiply_16_id301;
}
float3 Compute_id552(inout CS_STREAMS streams)
{
    return streams.Input_15_id298;
}
float3 Compute_id550(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_14_id293;
}
float Compute_id544(inout CS_STREAMS streams)
{
    return streams.Input_13_id290;
}
float Compute_id542(inout CS_STREAMS streams)
{
    return streams.Input_13_id290;
}
...
{
    return streams.Input_11_id347;
}
float4 Compute_id127(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id340;
}
float4 Compute_id125(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id337;
}
float Compute_id117()
{
    return Value_id342;
...
float4 SRgbToLinear_id581(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id333;
}
uint Compute_id109(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id329;
}
uint Compute_id103(inout CS_STREAMS streams)
{
    return streams.Input_3_id326;
}
...
{
    float4 color = Compute_id358(streams);
...
{
    return DynamicTexture_id241.SampleLevel(DynamicSampler_id128, Compute_id448(streams), Compute_id446());
}
float3 Compute_id563(inout CS_STREAMS streams)
{
    return Compute_id558(streams) + Compute_id560(streams);
}
float3 Compute_id556()
{
...
{
    return float3(Compute_id540(streams), Compute_id542(streams), Compute_id544(streams));
}
float Compute_id538()
{
...
float Compute_id123()
{
    return InputValue_id348;
}
float4 Compute_id122(inout CS_STREAMS streams)
{
    return DynamicTexture_id341.SampleLevel(DynamicSampler_id128, Compute_id119(streams), Compute_id117());
}
float4 Compute_id116(inout CS_STREAMS streams)
{
    return SRgbToLinear_id581(Compute_id113(streams));
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return DynamicBuffer_id334[Compute_id109(streams)];
}
...
{
    streams.Plus_55_id233 = Compute_id418(streams);
}
void Compute_id438(inout CS_STREAMS streams)
{
    streams.Input_54_id230 = Compute_id411();
}
void Compute_id436(inout CS_STREAMS streams)
{
    streams.Multiply_53_id226 = Compute_id410(streams);
}
void Compute_id434(inout CS_STREAMS streams)
{
    streams.Input_52_id223 = Compute_id403();
}
void Compute_id432(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_51_id218 = Compute_id402(streams);
}
void Compute_id430(inout CS_STREAMS streams)
{
    streams.Multiply_50_id214 = Compute_id394(streams);
}
void Compute_id428(inout CS_STREAMS streams)
{
    streams.Multiply_49_id210 = Compute_id388(streams);
}
void Compute_id426(inout CS_STREAMS streams)
{
    streams.Input_48_id207 = Compute_id381();
}
void Compute_id424(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id380(streams);
}
...
{
    streams.Plus_30_id283 = Compute_id508(streams);
}
void Compute_id530(inout CS_STREAMS streams)
{
    streams.Input_29_id280 = Compute_id501();
}
void Compute_id528(inout CS_STREAMS streams)
{
    streams.Plus_28_id276 = Compute_id500(streams);
}
void Compute_id526(inout CS_STREAMS streams)
{
    streams.Input_27_id273 = Compute_id493();
}
void Compute_id524(inout CS_STREAMS streams)
{
    streams.Multiply_26_id269 = Compute_id492(streams);
}
void Compute_id522(inout CS_STREAMS streams)
{
    streams.Input_25_id266 = Compute_id485();
}
void Compute_id520(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id261 = Compute_id484(streams);
}
void Compute_id518(inout CS_STREAMS streams)
{
    streams.Input_23_id258 = Compute_id475();
}
void Compute_id516(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id247 = Compute_id474(streams);
}
void Compute_id514(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id240 = Compute_id451(streams);
}
void Compute_id512()
{
}
...
{
    streams.Plus_18_id308 = Compute_id563(streams);
}
void Compute_id573(inout CS_STREAMS streams)
{
    streams.Input_17_id305 = Compute_id556();
}
void Compute_id571(inout CS_STREAMS streams)
{
    streams.Multiply_16_id301 = Compute_id555(streams);
}
void Compute_id569(inout CS_STREAMS streams)
{
    streams.Input_15_id298 = Compute_id548();
}
void Compute_id567(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id293 = Compute_id547(streams);
}
void Compute_id565(inout CS_STREAMS streams)
{
    streams.Input_13_id290 = Compute_id538();
}
...
{
    streams.Lerp_12_id350 = Compute_id132(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_11_id347 = Compute_id123();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id340 = Compute_id122(streams);
}
void Compute_id149()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id337 = Compute_id116(streams);
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id333 = Compute_id112(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id329 = Compute_id108(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.Input_3_id326 = Compute_id101();
}
