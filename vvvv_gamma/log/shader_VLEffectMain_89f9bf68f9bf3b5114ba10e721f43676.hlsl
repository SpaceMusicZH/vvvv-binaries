...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,3>, LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<3>, ShadowMapReceiverSpot<3,false>, ShadowMapFilterPcf<PerDraw.Lighting,3>
...
//
#line 1495 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_89f9bf68f9bf3b5114ba10e721f43676.hlsl"
...
@G    Pixel => 069a1fe90ad750c0ebc4f7b27a29c0cf
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1595 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_89f9bf68f9bf3b5114ba10e721f43676.hlsl"
...
#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r11.xyxx, t3.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id76 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r11.zwzz, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id76 return value>
...
#line 590
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t3.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id76 return value>
...
#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r11.xyxx, t3.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id76 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.y, r11.zwzz, t3.xxxx, s1, r7.z  // r7.y <- <SampleTextureAndCompare_id76 return value>
...
#line 590
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t3.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id76 return value>
...
#line 436
  mad r12.yw, -r2.yyyx, l(0.000000, 2.000000, 0.000000, 2.000000), l(0.000000, 3.000000, 0.000000, 3.000000)  // r12.y <- uvW0.y; r12.w <- uvW0.x
...
#line 441
  mad r18.xyzw, r17.zwxw, cb0[41].zwzw, r6.zwzw

#line 442
  mul r12.yw, r12.yyyw, r16.xxxy

#line 443
  mad r17.xyzw, r17.zyxy, cb0[41].zwzw, r6.zwzw
  mul r2.y, r16.y, r16.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id126 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id126 return value>
...
#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id126 return value>

#line 628
  mad r2.x, r12.w, r4.w, r2.x

#line 467
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r17.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id126 return value>
...
const static int TFilterSize_id170 = 3;
...
const static int TFilterSize_id203 = 3;
...
float SampleAndFilter_id83(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[4];
        normalizationFactor = Get3x3FilterKernel_id78(base_uv, st, kernel);
...
float FilterShadow_id120(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id128(base_uv, st, kernel);
...
float FilterShadow_id69(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id78(base_uv, st, kernel);
