...
*****     Stages      *****
***************************
@G    Compute => 11279cae429e2074702723253da97176
//
...
//   float InputValue_id344;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
//
#line 1432 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_387e9b77fe4191167345eba673b37c48.hlsl"
...
#line 729
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t3.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id118 return value>.x; r6.z <- <Compute_id118 return value>.y; r6.w <- <Compute_id118 return value>.z
...
struct CS_STREAMS 
{
    ...
    float r_46_id194;
    float Input_47_id197;
    float Multiply_48_id200;
    float g_49_id204;
    float Multiply_50_id207;
    float Multiply_51_id211;
    float3 SMVector3Join_ShaderFXResult_52_id215;
    float3 Input_53_id220;
    float3 Multiply_54_id223;
    float3 Input_55_id227;
    float3 Plus_56_id230;
    uint Input_3_id323;
...
{
    return streams.Input_55_id227;
}
float3 Compute_id398(inout CS_STREAMS streams)
{
    return streams.Multiply_54_id223;
}
float3 Compute_id392(inout CS_STREAMS streams)
{
    return streams.Input_53_id220;
}
float3 Compute_id390(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_52_id215;
}
...
{
    return DynamicTexture_id127.SampleLevel(DynamicSampler_id128, Compute_id115(streams), Compute_id113());
}
...
{
    streams.Plus_56_id230 = Compute_id403(streams);
}
void Compute_id425(inout CS_STREAMS streams)
{
    streams.Input_55_id227 = Compute_id396();
}
void Compute_id423(inout CS_STREAMS streams)
{
    streams.Multiply_54_id223 = Compute_id395(streams);
}
void Compute_id421(inout CS_STREAMS streams)
{
    streams.Input_53_id220 = Compute_id388();
}
void Compute_id419(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_52_id215 = Compute_id387(streams);
}
void Compute_id417(inout CS_STREAMS streams)
{
    streams.Multiply_51_id211 = Compute_id379(streams);
}
void Compute_id415(inout CS_STREAMS streams)
{
    streams.Multiply_50_id207 = Compute_id373(streams);
}
void Compute_id413(inout CS_STREAMS streams)
{
    streams.g_49_id204 = Compute_id367(streams);
}
void Compute_id411(inout CS_STREAMS streams)
{
    streams.Multiply_48_id200 = Compute_id363(streams);
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Input_47_id197 = Compute_id356();
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.r_46_id194 = Compute_id355(streams);
}
...
{
    streams.Multiply_45_id186 = Compute_id270(streams);
}
void Compute_id304(inout CS_STREAMS streams)
{
    streams.Input_44_id183 = Compute_id263();
}
void Compute_id302(inout CS_STREAMS streams)
{
    streams.Plus_43_id179 = Compute_id262(streams);
}
void Compute_id300(inout CS_STREAMS streams)
{
    streams.Input_42_id176 = Compute_id255();
}
void Compute_id298(inout CS_STREAMS streams)
{
    streams.Plus_41_id172 = Compute_id254(streams);
}
void Compute_id296(inout CS_STREAMS streams)
{
    streams.Input_40_id169 = Compute_id247();
}
void Compute_id294(inout CS_STREAMS streams)
{
    streams.Multiply_39_id165 = Compute_id246(streams);
}
void Compute_id292(inout CS_STREAMS streams)
{
    streams.Input_38_id162 = Compute_id239();
}
void Compute_id290(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_37_id157 = Compute_id238(streams);
}
void Compute_id288(inout CS_STREAMS streams)
{
    streams.Multiply_36_id153 = Compute_id230(streams);
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Multiply_35_id149 = Compute_id224(streams);
}
void Compute_id284(inout CS_STREAMS streams)
{
    streams.Multiply_34_id145 = Compute_id218(streams);
}
void Compute_id282(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_33_id134 = Compute_id212(streams);
}
void Compute_id280(inout CS_STREAMS streams)
{
    streams.TextureValue_31_id126 = Compute_id189(streams);
}
void Compute_id278()
{
}
...
{
    streams.Lerp_12_id346 = Compute_id128(streams);
}
void Compute_id149(inout CS_STREAMS streams)
{
    streams.Input_11_id343 = Compute_id119();
}
