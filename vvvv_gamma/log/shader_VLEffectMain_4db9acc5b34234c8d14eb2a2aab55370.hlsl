...
@C    constantColor_id197 => Material.DiffuseValue
...
//
#line 1137 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_4db9acc5b34234c8d14eb2a2aab55370.hlsl"
...
@G    Pixel => 039f1c86f8d48b59e6b2c16b5c01502a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 constantColor_id197;        // Offset:    0 Size:    16
//
// }
//
// cbuffer PerView
...
//
#line 1204 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_4db9acc5b34234c8d14eb2a2aab55370.hlsl"
...
#line 876
  ...
  mul r2.xyz, r2.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id229 return value>.x; r2.y <- <ComputeDirectLightContribution_id229 return value>.y; r2.z <- <ComputeDirectLightContribution_id229 return value>.z
...
#line 867
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id167 return value>
...
#line 845
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id179 return value>
...
#line 797
mul r0.xyz, r0.xyzx, cb1[0].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id230 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id230 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id230 return value>.z
...
float4 EvaluateSphericalHarmonics_id110(float3 sphericalColors[TOrder_id187 * TOrder_id187], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float4 Compute_id213(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id208(float3 direction)
{
    return EvaluateSphericalHarmonics_id110(SphericalColors_id190, direction);
}
...
void ResetStream_id129()
{
}
void AfterLightingAndShading_id237()
{
}
void PrepareEnvironmentLight_id226(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id223(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id208(sampleDirection).rgb * Intensity_id194 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id213(streams, sampleDirection).rgb * Intensity_id194 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id230(inout PS_STREAMS streams)
{
...
void PrepareDirectLights_id186()
{
}
...
int GetLightCount_id180(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
int GetMaxLightCount_id179(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
...
float3 ComputeDirectLightContribution_id229(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id200 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
int GetLightCount_id141()
{
    return LightCount_id86;
}
int GetMaxLightCount_id142()
{
...
void PrepareForLightingAndShading_id234()
{
}
void PrepareMaterialForLightingAndShading_id128(inout PS_STREAMS streams)
{
...
void ResetLightStream_id127(inout PS_STREAMS streams)
{
...
void Compute_id271(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id127(streams);
    PrepareMaterialForLightingAndShading_id128(streams);

    {
        PrepareForLightingAndShading_id234();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id137();
        const int maxLightCount = GetMaxLightCount_id142();
        int count = GetLightCount_id141();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id229(streams);
            }
        }
    }
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id179(streams);
        int count = GetLightCount_id180(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id230(streams);
        }
    }
    ...
    {
        PrepareEnvironmentLight_id226(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id230(streams);
        }
    }
    streams.shadingColor_id73 += directLightingContribution * PI_id200 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id237();
    }
}
void Compute_id255(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id227();
