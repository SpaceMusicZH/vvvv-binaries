...
*****     Stages      *****
***************************
@G    Vertex => 015337cc84c27bc8cfdd48f66ab0235c
//
...
//
#line 1276 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7997f34e9e51618550d363733692bbb.hlsl"
...
@G    Pixel => 4ea95769e17f12db559ae1dfa64b9f79
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1340 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_a7997f34e9e51618550d363733692bbb.hlsl"
...
#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t2.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id73 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id73 return value>
...
#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id73 return value>

#line 563
  mad r5.w, r6.z, r8.w, r5.w

#line 481
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id73 return value>
...
#line 481
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id73 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id73 return value>
...
#line 481
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id73 return value>
...
#line 533
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id157 return value>.x; r8.y <- <FresnelSchlick_id157 return value>.y; r8.z <- <FresnelSchlick_id157 return value>.z
...
#line 529
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id173 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id173 return value>

#line 631
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 627
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id187 return value>
...
#line 533
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id157 return value>.x; r13.y <- <FresnelSchlick_id157 return value>.y; r13.z <- <FresnelSchlick_id157 return value>.z
...
#line 529
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id173 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id173 return value>

#line 631
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 627
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id187 return value>
...
#line 533
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id157 return value>.x; r16.y <- <FresnelSchlick_id157 return value>.y; r16.z <- <FresnelSchlick_id157 return value>.z
...
#line 529
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id173 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id173 return value>

#line 631
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 627
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id187 return value>
...
#line 706
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id311 return value>.x; r0.z <- <Compute_id311 return value>.y; r0.w <- <Compute_id311 return value>.z

#line 888
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id490 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id490 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id490 return value>.z
...
#line 691
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.x  // r1.x <- <Compute_id261 return value>.x; r1.y <- <Compute_id261 return value>.y; r1.z <- <Compute_id261 return value>.z
...
{
    const float shadowMapDepth = ShadowMapTexture_id151.SampleLevel(LinearBorderSampler_id114, shadowSpaceCoordinate.xy, 0).r;
    float thickness;
    if (isOrthographic)
    {
...
void CalculateAdjustedShadowSpacePixelPosition_id79(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id65(float4(ShadowMapTextureTexelSize_id153.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
...
void CalculateAdjustedShadowSpacePixelPositionPerspective_id78(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id65(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id153.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
...
{
    return ShadowMapTexture_id151.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id115, position, positionDepth);
}
...
float3 FresnelSchlick_id157(float3 f0, float3 f90, float lOrVDotH)
{
...
{
    streams.Input_2_id215 = Compute_id299();
}
void Compute_id290(inout PS_STREAMS streams)
{
    streams.Input_1_id206 = Compute_id287();
}
void Compute_id278(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id198 = Compute_id275(streams);
}
float4 EvaluateSphericalHarmonics_id111(float3 sphericalColors[TOrder_id188 * TOrder_id188], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float NormalDistributionGGX_id187(float alphaR, float nDotH)
{
...
float3 FresnelSchlick_id163(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id157(f0, 1.0f, lOrVDotH);
}
float ComputeThicknessFromCascade_id70(float3 pixelPositionWS, float3 meshNormalWS, int cascadeIndex, int lightIndex, bool isOrthographic)
{
    ...
    return FilterThickness_id67(pixelPositionWS, meshNormalWS, DepthRanges_id160[arrayIndex], WorldToShadowCascadeUV_id157[arrayIndex], InverseWorldToShadowCascadeUV_id158[arrayIndex], isOrthographic);
}
...
float4 Compute_id261(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id192;
    return CubeMap_id193.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id256(float3 direction)
{
    return EvaluateSphericalHarmonics_id111(SphericalColors_id191, direction);
}
...
float3 Compute_id311(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id228.SampleLevel(LinearSampler_id113, float2(glossiness, nDotV), 0);
    return specularColor * environmentLightingDFG.r + environmentLightingDFG.g;
}
void PrepareEnvironmentLight_id106(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
...
{
    return NormalDistributionGGX_id187(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id373(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id175(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id343(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id163(f0, streams.LdotH_id77);
}
...
float3 ComputeShadow_id60(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id68(OffsetScales_id162[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
...
void PrepareEnvironmentLight_id271(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id256(sampleDirection).rgb * Intensity_id195 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id261(streams, sampleDirection).rgb * Intensity_id195 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
...
{
    PrepareEnvironmentLight_id106(streams);
    float3 lightColor = AmbientLight_id186 * streams.matAmbientOcclusion_id57;
...
void PrepareDirectLight_id237(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id146 = ComputeShadow_id95(streams, streams.PositionWS_id22.xyz, lightIndex);
...
void PrepareDirectLight_id224(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id146 = ComputeShadow_id84(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id146 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
    streams.lightSpecularColorNdotL_id45 = streams.lightColorNdotL_id44;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id227 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareMaterialForLightingAndShading_id189(inout PS_STREAMS streams)
{
...
void ResetLightStream_id188(inout PS_STREAMS streams)
{
...
void Compute_id521(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id188(streams);
    PrepareMaterialForLightingAndShading_id189(streams);
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id227 + environmentLightingContribution;
