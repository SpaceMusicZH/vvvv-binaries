...
//
#line 234 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_SSLRResolvePassEffect_0c7eb0305b7fc7781eec1c43e2b8f3ef.hlsl"
...
@G    Pixel => 1f1ebb698eab5629f30fd795500db7d5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   v1.x <- __input__.TexCoord_id62.x; v1.y <- __input__.TexCoord_id62.y
//
#line 184 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_SSLRResolvePassEffect_0c7eb0305b7fc7781eec1c43e2b8f3ef.hlsl"
...
#line 213
      sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r4.xyxx, t0.xyzw, s1, r0.z  // r1.x <- sampleColor.x; r1.y <- sampleColor.y; r1.z <- sampleColor.z
...
#line 216
    mul r0.xyzw, r3.xyzw, l(0.250000, 0.250000, 0.250000, 0.250000)  // r0.x <- result.x; r0.y <- result.y; r0.z <- result.z; r0.w <- result.w
...
const static bool ReduceHighlights_id88 = false;
