...
@C    InputValue_id269 => ShaderFX.InputValueUInt
@C    InputValue_id291 => ShaderFX.InputValueFloat
...
@C    VoxelCounts_id251 => SMVideoBufferSelector_ShaderFX.VoxelCounts
@C    PlacementCounts_id252 => SMVideoBufferSelector_ShaderFX.PlacementCounts
@C    SamplerOffset_id253 => SMVideoBufferSelector_ShaderFX.SamplerOffset
@C    SamplerScale_id254 => SMVideoBufferSelector_ShaderFX.SamplerScale
@C    PlacementLevelCount_id255 => SMVideoBufferSelector_ShaderFX.PlacementLevelCount
***************************
******  Resources    ******
***************************
@R    DynamicSampler_id284 => ObjectSampler_fx8 [Stage: Compute, Slot: (0-0)]
...
@R    VoxelVolume_id250 => SMVideoBufferSelector_ShaderFX.VoxelVolume [Stage: Compute, Slot: (2-2)]
@R    DynamicBuffer_id276 => ObjectBuffer_fx0 [Stage: Compute, Slot: (3-3)]
@R    DynamicTexture_id283 => ObjectTexture_fx7 [Stage: Compute, Slot: (4-4)]
...
*****     Stages      *****
***************************
@G    Compute => 573d18b5845b5e1ffe46a9a79a52ae81
//
...
//   uint InputValue_id269;             // Offset:  220 Size:     4
//   float InputValue_id291;            // Offset:  224 Size:     4
//
// }
//
// cbuffer Globals
...
//   int3 VoxelCounts_id251;            // Offset:   84 Size:    12
//   int3 PlacementCounts_id252;        // Offset:   96 Size:    12 [unused]
//   float2 SamplerOffset_id253;        // Offset:  112 Size:     8 [unused]
//   float2 SamplerScale_id254;         // Offset:  120 Size:     8 [unused]
//      = 0x3f800000 0x3f800000 
//   uint PlacementLevelCount_id255;    // Offset:  128 Size:     4 [unused]
//      = 0x00100000 
//
// }
//
...
// }
//
// Resource bind info for VoxelVolume_id250
// {
//
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// DynamicSampler_id284              sampler      NA          NA             s0      1 
// Damping_id97                      texture  struct         r/o             t0      1 
// PlacementVertices_id104           texture  struct         r/o             t1      1 
// VoxelVolume_id250                 texture  struct         r/o             t2      1 
// DynamicBuffer_id276               texture  float4         buf             t3      1 
// DynamicTexture_id283              texture  float4          2d             t4      1 
...
//
#line 1213 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_388f120fc9ac79f92007d5a1644f35fb.hlsl"
...
#line 586
  mad r11.xyz, cb1[10].wwww, cb1[11].xyzx, cb1[12].xyzx  // r11.x <- <Compute_id389 return value>.x; r11.y <- <Compute_id389 return value>.y; r11.z <- <Compute_id389 return value>.z
...
#line 578
  ...
  movc r11.xyz, r12.xyzx, r13.xyzx, r11.xyzx  // r11.x <- <Compute_id397 return value>.x; r11.y <- <Compute_id397 return value>.y; r11.z <- <Compute_id397 return value>.z
...
#line 552
  mad r12.xyz, cb1[6].wwww, cb1[7].xyzx, cb1[8].xyzx  // r12.x <- <Compute_id322 return value>.x; r12.y <- <Compute_id322 return value>.y; r12.z <- <Compute_id322 return value>.z
...
#line 544
  ...
  movc r12.xyz, r13.xyzx, r14.xyzx, r12.xyzx  // r12.x <- <Compute_id330 return value>.x; r12.y <- <Compute_id330 return value>.y; r12.z <- <Compute_id330 return value>.z

#line 534
  add r12.xyz, r12.xyzx, cb1[10].xyzx  // r12.x <- <Compute_id338 return value>.x; r12.y <- <Compute_id338 return value>.y; r12.z <- <Compute_id338 return value>.z
...
#line 502
  ...
  movc r12.xyz, r13.xyzx, r14.xyzx, r12.xyzx  // r12.x <- <Compute_id172 return value>.x; r12.y <- <Compute_id172 return value>.y; r12.z <- <Compute_id172 return value>.z
...
#line 460
  ...
  movc r12.xyz, r13.xyzx, r14.xyzx, r12.xyzx  // r12.x <- <Compute_id275 return value>.x; r12.y <- <Compute_id275 return value>.y; r12.z <- <Compute_id275 return value>.z
...
#line 233
  ...
  imad r0.w, r12.z, r0.w, r1.w  // r0.w <- <CalculateVoxelVolumeIndex_id41 return value>
...
#line 430
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id419 return value>.x; r14.y <- <SRgbToLinear_id419 return value>.y; r14.z <- <SRgbToLinear_id419 return value>.z
...
#line 622
  ...
  mad r6.yzw, cb1[14].xxxx, r6.yyzw, r14.xxyz  // r6.y <- <Compute_id110 return value>.x; r6.z <- <Compute_id110 return value>.y; r6.w <- <Compute_id110 return value>.z
...
const static float Value_id285 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float4 SMVideoBufferSelector_ShaderFXResult_1_id249;
    float SMCalcLuminance_ShaderFXResult_2_id257;
    uint Input_3_id268;
    uint SMValueToIndex_ShaderFXResult_4_id271;
    float4 BufferItem_5_id275;
    float4 SRgbToLinear_ShaderFXResult_6_id279;
    float4 TextureValue_9_id282;
    float Input_11_id290;
    float4 Lerp_12_id293;
};
struct CS_INPUT 
{
...
cbuffer Globals 
{
    ...
    bool Reset_id95;
    int3 VoxelCounts_id251;
    int3 PlacementCounts_id252;
    float2 SamplerOffset_id253;
    float2 SamplerScale_id254 = float2(1, 1);
    uint PlacementLevelCount_id255 = 1048576;
};
...
StructuredBuffer<float4> VoxelVolume_id250;
Buffer<float4> DynamicBuffer_id276;
Texture2D DynamicTexture_id283;
SamplerState DynamicSampler_id284;
uint CalculateVoxelVolumeIndex_id41(uint3 coordinate)
{
    return dot(coordinate, uint3(1, VoxelCounts_id251.x, VoxelCounts_id251.x * VoxelCounts_id251.y));
}
...
float Compute_id299(inout CS_STREAMS streams)
{
    return streams.Input_21_id178;
}
...
{
    return streams.SMVideoBufferSelector_ShaderFXResult_1_id249;
}
float4 GetVoxel_id32(uint3 coordinate)
{
    return VoxelVolume_id250[CalculateVoxelVolumeIndex_id41(coordinate)];
}
float Compute_id107(inout CS_STREAMS streams)
{
    return streams.Input_11_id290;
}
float4 Compute_id105(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id282;
}
float4 Compute_id103(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id279;
}
float Compute_id95()
{
    return Value_id285;
...
float4 SRgbToLinear_id419(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id275;
}
uint Compute_id87(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id271;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_2_id257;
}
...
{
    float3 v = Compute_id272(streams);
    float3 s = Compute_id270(streams);
...
{
    float3 v = Compute_id169(streams);
    float3 s = Compute_id167(streams);
    return s != 0 ? round(v / s) * s : v;
}
...
float3 Compute_id331()
{
    return InputValue_id208;
}
float3 Compute_id330(inout CS_STREAMS streams)
{
    float3 v = Compute_id327(streams);
    float3 s = Compute_id325(streams);
    return s != 0 ? round(v / s) * s : v;
}
...
{
    return Compute_id309(streams) * Compute_id311(streams);
}
float3 Compute_id307()
{
    return InputValue_id187;
}
float3 Compute_id306(inout CS_STREAMS streams)
{
    return float3(Compute_id299(streams), Compute_id301(streams), Compute_id303(streams));
}
float Compute_id297()
{
...
{
    float3 v = Compute_id394(streams);
    float3 s = Compute_id392(streams);
    return s != 0 ? round(v / s) * s : v;
}
float3 Compute_id390()
{
...
float4 Compute_id46(inout CS_STREAMS streams)
{
    ...
    uint3 uvw = float3(streams.TexCoord_id59.x, streams.TexCoord_id59.y, streams.TexCoord1_id60.x) * VoxelCounts_id251;
...
{
    return DynamicTexture_id283.SampleLevel(DynamicSampler_id284, Compute_id97(streams), Compute_id95());
}
float4 Compute_id94(inout CS_STREAMS streams)
{
    return SRgbToLinear_id419(Compute_id91(streams));
}
float4 Compute_id90(inout CS_STREAMS streams)
{
    return DynamicBuffer_id276[Compute_id87(streams)];
}
...
{
    streams.SMQuantize_ShaderFXResult_48_id171 = Compute_id275(streams);
}
void Compute_id289(inout CS_STREAMS streams)
{
    streams.Input_47_id168 = Compute_id268();
}
void Compute_id287(inout CS_STREAMS streams)
{
    streams.Plus_46_id164 = Compute_id267(streams);
}
void Compute_id285(inout CS_STREAMS streams)
{
    streams.Input_45_id161 = Compute_id260();
}
void Compute_id283(inout CS_STREAMS streams)
{
    streams.Multiply_44_id157 = Compute_id259(streams);
}
void Compute_id281(inout CS_STREAMS streams)
{
    streams.Input_43_id154 = Compute_id252();
}
void Compute_id279(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_42_id149 = Compute_id251(streams);
}
void Compute_id277(inout CS_STREAMS streams)
{
    streams.Input_41_id146 = Compute_id242();
}
void Compute_id200(inout CS_STREAMS streams)
{
    streams.Multiply_40_id139 = Compute_id180(streams);
}
void Compute_id198(inout CS_STREAMS streams)
{
    streams.Input_39_id136 = Compute_id173();
}
void Compute_id196(inout CS_STREAMS streams)
{
    streams.SMQuantize_ShaderFXResult_38_id132 = Compute_id172(streams);
}
void Compute_id194(inout CS_STREAMS streams)
{
    streams.Input_37_id129 = Compute_id165();
}
void Compute_id192(inout CS_STREAMS streams)
{
    streams.Plus_36_id125 = Compute_id164(streams);
}
void Compute_id190(inout CS_STREAMS streams)
{
    streams.Multiply_35_id121 = Compute_id158(streams);
}
void Compute_id188(inout CS_STREAMS streams)
{
    streams.Input_34_id118 = Compute_id151();
}
void Compute_id186(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_33_id113 = Compute_id150(streams);
}
void Compute_id184(inout CS_STREAMS streams)
{
    streams.Input_32_id110 = Compute_id141();
}
void Compute_id182(inout CS_STREAMS streams)
{
    streams.Input_31_id107 = Compute_id139();
}
void Compute_id358(inout CS_STREAMS streams)
{
    streams.Plus_30_id210 = Compute_id338(streams);
}
void Compute_id356(inout CS_STREAMS streams)
{
    streams.Input_29_id207 = Compute_id331();
}
void Compute_id354(inout CS_STREAMS streams)
{
    streams.SMQuantize_ShaderFXResult_28_id203 = Compute_id330(streams);
}
void Compute_id352(inout CS_STREAMS streams)
{
    streams.Input_27_id200 = Compute_id323();
}
void Compute_id350(inout CS_STREAMS streams)
{
    streams.Plus_26_id196 = Compute_id322(streams);
}
void Compute_id348(inout CS_STREAMS streams)
{
    streams.Input_25_id193 = Compute_id315();
}
void Compute_id346(inout CS_STREAMS streams)
{
    streams.Multiply_24_id189 = Compute_id314(streams);
}
void Compute_id344(inout CS_STREAMS streams)
{
    streams.Input_23_id186 = Compute_id307();
}
void Compute_id342(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_22_id181 = Compute_id306(streams);
}
void Compute_id340(inout CS_STREAMS streams)
{
    streams.Input_21_id178 = Compute_id297();
}
void Compute_id413(inout CS_STREAMS streams)
{
    streams.SMQuantize_ShaderFXResult_20_id242 = Compute_id397(streams);
}
void Compute_id411(inout CS_STREAMS streams)
{
    streams.Input_19_id239 = Compute_id390();
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Plus_18_id235 = Compute_id389(streams);
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.Input_17_id232 = Compute_id382();
}
void Compute_id405(inout CS_STREAMS streams)
{
    streams.Multiply_16_id228 = Compute_id381(streams);
}
void Compute_id403(inout CS_STREAMS streams)
{
    streams.Input_15_id225 = Compute_id374();
}
void Compute_id401(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id220 = Compute_id373(streams);
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.Input_13_id217 = Compute_id364();
}
void Compute_id236(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id257 = Compute_id232(streams);
}
void Compute_id234(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id249 = Compute_id46(streams);
}
void Compute_id133(inout CS_STREAMS streams)
{
    streams.Lerp_12_id293 = Compute_id110(streams);
}
void Compute_id131(inout CS_STREAMS streams)
{
    streams.Input_11_id290 = Compute_id101();
}
void Compute_id129(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id282 = Compute_id100(streams);
}
void Compute_id127()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id279 = Compute_id94(streams);
}
void Compute_id121(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id275 = Compute_id90(streams);
}
void Compute_id119(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id271 = Compute_id86(streams);
}
void Compute_id117(inout CS_STREAMS streams)
{
    streams.Input_3_id268 = Compute_id79();
}
void Compute_id115(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id257 = Compute_id78(streams);
}
void Compute_id113(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id249 = Compute_id40(streams);
}
void Compute_id111()
{
}
