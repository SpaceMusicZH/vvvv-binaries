...
@C    AmbientLight_id195 => LightSimpleAmbient.AmbientLight.environmentLights[0]
@C    SphericalColors_id200 => SphericalHarmonicsEnvironmentColor.SphericalColors.lightDiffuseColor.environmentLights[1]
@C    MipCount_id201 => RoughnessCubeMapEnvironmentColor.MipCount.lightSpecularColor.environmentLights[1]
@C    SkyMatrix_id203 => LightSkyboxShader.SkyMatrix.environmentLights[1]
@C    Intensity_id204 => LightSkyboxShader.Intensity.environmentLights[1]
...
@R    ParticlesBuffer_id149 => SMSphereImpostor_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id208 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id208 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
...
@R    SpotLights_id194 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    CubeMap_id202 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
@R    CubeMap_id202 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
...
@R    ParticlesBuffer_id208 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id237 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
@R    CubeMap_id202 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (7-7)]
...
//
#line 1436 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ce9ae4213ed1aeb323cec6d18c265f91.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
mov o3.xyz, v2.xyzx
...
//      = 0x3dcccccd 
//   float InputValue_id216;            // Offset:    4 Size:     4 [unused]
//   float InputValue_id225;            // Offset:    8 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id195;         // Offset: 1408 Size:    12 [unused]
//   float3 SphericalColors_id200[9];   // Offset: 1424 Size:   140 [unused]
//   float MipCount_id201;              // Offset: 1564 Size:     4 [unused]
//   float4x4 SkyMatrix_id203;          // Offset: 1568 Size:    64 [unused]
//   float Intensity_id204;             // Offset: 1632 Size:     4 [unused]
...
//
#line 1394 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ce9ae4213ed1aeb323cec6d18c265f91.hlsl"
...
@G    Pixel => e65160292923af46840a57720f51f6f0
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x3dcccccd 
//   float InputValue_id216;            // Offset:    4 Size:     4
//   float InputValue_id225;            // Offset:    8 Size:     4
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id195;         // Offset: 1408 Size:    12
//   float3 SphericalColors_id200[9];   // Offset: 1424 Size:   140
//   float MipCount_id201;              // Offset: 1564 Size:     4
//   float4x4 SkyMatrix_id203;          // Offset: 1568 Size:    64
//   float Intensity_id204;             // Offset: 1632 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
// Resource bind info for ParticlesBuffer_id208
// {
//
//   struct SMGridParticle
//   {
...
// ParticlesBuffer_id208             texture  struct         r/o             t0      1 
// EnvironmentLightingDFG_LUT_id237    texture  float4          2d             t1      1 
...
// CubeMap_id202                     texture  float4        cube             t7      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
// PerMaterial                       cbuffer      NA          NA            cb1      1 
// PerView                           cbuffer      NA          NA            cb2      1 
//
...
//
#line 1291 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ce9ae4213ed1aeb323cec6d18c265f91.hlsl"
...
#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r13.xyxx, t2.xxxx, s1, r9.z  // r10.z <- <SampleTextureAndCompare_id99 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r13.zwzz, t2.xxxx, s1, r9.z  // r10.w <- <SampleTextureAndCompare_id99 return value>
...
#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r15.xyxx, t2.xxxx, s1, r9.z  // r7.z <- <SampleTextureAndCompare_id99 return value>

#line 589
  mad r6.w, r10.x, r7.z, r6.w

#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r14.xyxx, t2.xxxx, s1, r9.z

#line 589
  mad r6.w, r7.w, r7.z, r6.w

#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r14.zwzz, t2.xxxx, s1, r9.z

#line 589
  mad r6.w, r7.z, l(49.000000), r6.w

#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r15.zwzz, t2.xxxx, s1, r9.z

#line 589
  mad r6.w, r12.z, r7.z, r6.w

#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.z, r11.xyxx, t2.xxxx, s1, r9.z
...
#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r13.xyxx, t2.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id99 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r13.zwzz, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id99 return value>
...
#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t2.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id99 return value>

#line 589
      mad r3.w, r10.x, r5.w, r3.w

#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t2.xxxx, s1, r8.z

#line 589
      mad r3.w, r7.w, r5.w, r3.w

#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.zwzz, t2.xxxx, s1, r8.z

#line 589
      mad r3.w, r5.w, l(49.000000), r3.w

#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.zwzz, t2.xxxx, s1, r8.z

#line 589
      mad r3.w, r12.z, r5.w, r3.w

#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r11.xyxx, t2.xxxx, s1, r8.z
...
#line 559
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r9.xyz, r9.xyzx, r1.wwww, r6.xyzx  // r9.x <- <FresnelSchlick_id183 return value>.x; r9.y <- <FresnelSchlick_id183 return value>.y; r9.z <- <FresnelSchlick_id183 return value>.z
...
#line 555
  ...
  div r1.w, r7.y, r1.w  // r1.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 980
  mul r8.xyz, r8.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r8.x <- <ComputeDirectLightContribution_id515 return value>.x; r8.y <- <ComputeDirectLightContribution_id515 return value>.y; r8.z <- <ComputeDirectLightContribution_id515 return value>.z
...
#line 967
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id254 return value>
...
#line 559
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r14.xyz, r14.xyzx, r4.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id183 return value>.x; r14.y <- <FresnelSchlick_id183 return value>.y; r14.z <- <FresnelSchlick_id183 return value>.z
...
#line 555
  ...
  div r6.w, r3.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r4.w, r7.w, r5.w, r4.w
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 945
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id266 return value>
...
#line 559
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r16.xyz, r16.xyzx, r5.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id183 return value>.x; r16.y <- <FresnelSchlick_id183 return value>.y; r16.z <- <FresnelSchlick_id183 return value>.z
...
#line 555
  ...
  div r7.w, r4.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r5.w, r3.z, r6.w, r5.w
  div r5.w, r3.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 732
mad r1.xyz, r6.xyzx, r1.xxxx, r1.yyyy  // r1.x <- <Compute_id337 return value>.x; r1.y <- <Compute_id337 return value>.y; r1.z <- <Compute_id337 return value>.z

#line 914
mul r2.xyz, r1.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id516 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id516 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id516 return value>.z
...
#line 717
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r4.xyzx, t7.xyzw, s0, r0.x  // r0.x <- <Compute_id287 return value>.x; r0.y <- <Compute_id287 return value>.y; r0.z <- <Compute_id287 return value>.z
...
const static int TOrder_id197 = 3;
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id207;
    float Input_1_id215;
    float Input_2_id224;
...
cbuffer PerView 
{
    ...
    float3 AmbientLight_id195;
    float3 SphericalColors_id200[TOrder_id199 * TOrder_id199];
    float MipCount_id201;
    float4x4 SkyMatrix_id203;
    float Intensity_id204;
...
StructuredBuffer<SMGridParticle> ParticlesBuffer_id208;
...
float SampleAndFilter_id106(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[9];
        normalizationFactor = Get5x5FilterKernel_id100(base_uv, st, kernel);
...
float4 Compute_id301(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id208[id];
...
float FilterShadow_id92(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id100(base_uv, st, kernel);
...
{
    streams.Input_2_id224 = Compute_id325();
}
void Compute_id316(inout PS_STREAMS streams)
{
    streams.Input_1_id215 = Compute_id313();
}
void Compute_id304(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id207 = Compute_id301(streams);
}
float4 EvaluateSphericalHarmonics_id137(float3 sphericalColors[TOrder_id197 * TOrder_id197], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
{
    return streams.ColorPerParticle_ShaderFXResult_0_id207;
}
...
float4 Compute_id287(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id201;
    return CubeMap_id202.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id282(float3 direction)
{
    return EvaluateSphericalHarmonics_id137(SphericalColors_id200, direction);
}
...
float3 Compute_id337(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id237.SampleLevel(LinearSampler_id113, float2(glossiness, nDotV), 0);
...
float Compute_id334(inout PS_STREAMS streams)
{
...
void AfterLightingAndShading_id467()
{
}
void PrepareEnvironmentLight_id300(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id297(inout PS_STREAMS streams)
{
    ...
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id203);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id47 = Compute_id282(sampleDirection).rgb * Intensity_id204 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    sampleDirection = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id203);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id287(streams, sampleDirection).rgb * Intensity_id204 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id516(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id337(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
void PrepareEnvironmentLight_id292(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id195 * streams.matAmbientOcclusion_id57;
...
float3 ComputeDirectLightContribution_id515(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id369(streams, specularColor);
    float geometricShadowing = Compute_id399(streams);
    float normalDistribution = Compute_id429(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id236 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id464()
{
}
...
{
    float x = Compute_id334(streams);
    return float4(x, x, x, x);
}
float4 Compute_id324(inout PS_STREAMS streams)
{
    float x = Compute_id322(streams);
    return float4(x, x, x, x);
}
...
void Compute_id547(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id464();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id515(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id516(streams);
        }
    }
    ...
    {
        PrepareEnvironmentLight_id300(streams);
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id236 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id467();
    }
...
{
    float metalness = Compute_id336(streams).r;
...
{
    float glossiness = Compute_id324(streams).r;
...
{
    float4 colorBase = Compute_id312(streams);
