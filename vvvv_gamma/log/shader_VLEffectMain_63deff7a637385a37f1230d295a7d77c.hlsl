...
@R    ParticlesBuffer_id195 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id195 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
...
@R    ParticlesBuffer_id195 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id224 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
@R    CubeMap_id189 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (7-7)]
...
*****     Stages      *****
***************************
@G    Vertex => 7ec89d44955897703d140294e012b6b7
//
...
//
#line 1260 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_63deff7a637385a37f1230d295a7d77c.hlsl"
...
@G    Pixel => 6e8581f3dc286505b286efb5f235ffb9
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float InputValue_id203;            // Offset:    0 Size:     4
//   float InputValue_id212;            // Offset:    4 Size:     4
//
// }
//
// cbuffer PerView
...
// }
//
// Resource bind info for ParticlesBuffer_id195
// {
//
...
// ParticlesBuffer_id195             texture  struct         r/o             t0      1 
// EnvironmentLightingDFG_LUT_id224    texture  float4          2d             t1      1 
...
// CubeMap_id189                     texture  float4        cube             t7      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 1328 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_63deff7a637385a37f1230d295a7d77c.hlsl"
...
#line 525
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id151 return value>.x; r8.y <- <FresnelSchlick_id151 return value>.y; r8.z <- <FresnelSchlick_id151 return value>.z
...
#line 946
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id483 return value>.x; r7.y <- <ComputeDirectLightContribution_id483 return value>.y; r7.z <- <ComputeDirectLightContribution_id483 return value>.z
...
#line 933
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id222 return value>
...
#line 698
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id305 return value>.x; r0.z <- <Compute_id305 return value>.y; r0.w <- <Compute_id305 return value>.z

#line 880
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id484 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id484 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id484 return value>.z
...
#line 683
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.x  // r1.x <- <Compute_id255 return value>.x; r1.y <- <Compute_id255 return value>.y; r1.z <- <Compute_id255 return value>.z
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id194;
    float Input_1_id202;
    float Input_2_id211;
...
StructuredBuffer<SMGridParticle> ParticlesBuffer_id195;
...
float4 Compute_id269(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id195[id];
...
{
    streams.ColorPerParticle_ShaderFXResult_0_id194 = Compute_id269(streams);
}
...
{
    return streams.ColorPerParticle_ShaderFXResult_0_id194;
}
