...
@G    Pixel => 84c86bb4c12cca323c8b9195c8ebd859
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
mov r7.yz, v0.yyzy  // r7.y <- streams.PositionWS_id22.y; r7.z <- streams.PositionWS_id22.z
...
#line 469
  mov r7.x, r6.w
  add r9.xyz, -r7.xyzx, cb0[29].xyzx  // r9.x <- lightVector.x; r9.y <- lightVector.y; r9.z <- lightVector.z
...
#line 349
  mul r4.w, r4.w, cb0[29].w  // r4.w <- factor
...
#line 351
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id71 return value>
...
#line 573
  add r2.xyz, r7.xyzx, -cb0[29].xyzx  // r2.x <- lightDelta.x; r2.y <- lightDelta.y; r2.z <- lightDelta.z
...
#line 604
  add r2.z, |r2.y|, -cb0[80].x  // r2.z <- lightSpaceZ

#line 605
  div r2.z, cb0[82].y, r2.z
  add r2.z, r2.z, cb0[82].x  // r2.z <- depth
...
#line 601
    ishl r2.x, r2.x, l(2)
    dp4 r9.x, r5.xyzw, cb0[r2.x + 32].xyzw  // r9.x <- projectedPosition.x
    dp4 r9.y, r5.xyzw, cb0[r2.x + 33].xyzw  // r9.y <- projectedPosition.y
    dp4 r2.x, r5.xyzw, cb0[r2.x + 35].xyzw  // r2.x <- projectedPosition.w

#line 602
    div r2.xy, r9.xyxx, r2.xxxx  // r2.x <- projectedPosition.x; r2.y <- projectedPosition.y

#line 448
    mad r2.xy, r2.xyxx, cb0[31].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
#line 294
    mad r12.xyzw, r10.xwzw, cb0[31].zwzw, r3.ywyw
...
#line 297
    mad r13.xyzw, r10.xyzy, cb0[31].zwzw, r3.ywyw

#line 298
    mad r14.xyzw, r11.xzxw, cb0[31].zwzw, r3.ywyw
...
#line 300
    mad r10.xyzw, r10.xyzy, cb0[31].zwzw, r3.ywyw
    mul r11.zw, r9.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 301
    mad r3.yw, r11.xxxy, cb0[31].zzzw, r3.yyyw
    mul r2.y, r9.y, r9.x

#line 443
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r12.xyxx, t0.xxxx, s0, r2.z  // r5.z <- <SampleTextureAndCompare_id83 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r12.zwzz, t0.xxxx, s0, r2.z  // r7.x <- <SampleTextureAndCompare_id83 return value>
...
#line 443
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.z, r14.xyxx, t0.xxxx, s0, r2.z  // r5.z <- <SampleTextureAndCompare_id83 return value>

#line 510
    mad r2.x, r5.x, r5.z, r2.x

#line 443
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t0.xxxx, s0, r2.z  // r5.x <- <SampleTextureAndCompare_id83 return value>
...
#line 443
    sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r3.ywyy, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id83 return value>
...
#line 709
  mul r5.xyz, r4.wwww, cb0[30].xyzx
