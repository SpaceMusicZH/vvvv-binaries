...
//
#line 288 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_eed4a2f6eae0659ff06a89e755580075.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => 04d65d4280b516d115a2221162bc5b94
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 255 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_eed4a2f6eae0659ff06a89e755580075.hlsl"
...
#line 217
    dp4 r3.x, r8.xyzw, cb2[16].xyzw  // r3.x <- streams.ShadingPosition_id0.x
    dp4 r3.y, r8.xyzw, cb2[17].xyzw  // r3.y <- streams.ShadingPosition_id0.y
    dp4 r3.z, r8.xyzw, cb2[18].xyzw  // r3.z <- streams.ShadingPosition_id0.z
...
#line 191
    and r8.xyz, r4.wwww, l(0x0000a55a, 3891, 0x0000330f, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id91 return value>.x; r8.y <- <CubeVert_id91 return value>.y; r8.z <- <CubeVert_id91 return value>.z
...
#line 191
    and r8.xyz, r4.wwww, l(0x0000a500, 3840, 0x00003300, 0)
    movc r8.xyz, r8.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r8.x <- <CubeVert_id91 return value>.x; r8.y <- <CubeVert_id91 return value>.y; r8.z <- <CubeVert_id91 return value>.z
...
#line 191
    and r5.xyz, r2.wwww, l(0x000f0000, 0x005a0000, 0x00330000, 0)
...
#line 217
    dp4 r2.w, r5.xyzw, cb2[16].xyzw  // r2.w <- streams.ShadingPosition_id0.x
    dp4 r3.x, r5.xyzw, cb2[17].xyzw  // r3.x <- streams.ShadingPosition_id0.y
    dp4 r3.y, r5.xyzw, cb2[18].xyzw  // r3.y <- streams.ShadingPosition_id0.z
    dp4 r3.z, r5.xyzw, cb2[19].xyzw  // r3.z <- streams.ShadingPosition_id0.w
