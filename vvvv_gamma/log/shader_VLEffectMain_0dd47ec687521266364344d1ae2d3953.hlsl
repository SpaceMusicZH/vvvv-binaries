...
//
#line 1587 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_0dd47ec687521266364344d1ae2d3953.hlsl"
...
@G    Pixel => 785c3c32bd7c81396342f0dcfdbf8176
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1659 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_0dd47ec687521266364344d1ae2d3953.hlsl"
...
#line 701
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r9.xyz, r9.xyzx, r3.wwww, r4.xyzx  // r9.x <- <FresnelSchlick_id183 return value>.x; r9.y <- <FresnelSchlick_id183 return value>.y; r9.z <- <FresnelSchlick_id183 return value>.z
...
#line 697
  ...
  div r3.w, r6.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id199 return value>

#line 843
  mul r3.w, r3.w, r5.w
  mul r1.w, r6.y, r1.w
  div r1.w, r3.w, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 839
  ...
  div r2.w, r3.w, r2.w  // r2.w <- <NormalDistributionGGX_id213 return value>
...
#line 1245
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id541 return value>.x; r7.y <- <ComputeDirectLightContribution_id541 return value>.y; r7.z <- <ComputeDirectLightContribution_id541 return value>.z
...
#line 1232
and r1.w, r0.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id254 return value>
...
#line 701
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r14.xyz, r14.xyzx, r5.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id183 return value>.x; r14.y <- <FresnelSchlick_id183 return value>.y; r14.z <- <FresnelSchlick_id183 return value>.z
...
#line 697
  ...
  div r11.w, r4.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r5.w, r6.w, r7.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 701
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r17.xyz, r17.xyzx, r4.wwww, r11.xyzx  // r17.x <- <FresnelSchlick_id183 return value>.x; r17.y <- <FresnelSchlick_id183 return value>.y; r17.z <- <FresnelSchlick_id183 return value>.z
...
#line 697
  ...
  div r4.w, r14.y, r4.w  // r4.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 403
  mul r0.x, r0.x, r0.x  // r0.x <- <SmoothDistanceAttenuation_id109 return value>
...
#line 641
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r13.xyxx, t0.xxxx, s1, r1.w  // r4.w <- <SampleTextureAndCompare_id121 return value>
    sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r13.zwzz, t0.xxxx, s1, r1.w  // r5.w <- <SampleTextureAndCompare_id121 return value>
...
#line 641
    sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t0.xxxx, s1, r1.w  // r4.w <- <SampleTextureAndCompare_id121 return value>
...
#line 641
    sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t0.xxxx, s1, r1.w  // r1.w <- <SampleTextureAndCompare_id121 return value>
...
#line 701
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r7.xyz, r7.xyzx, r0.zzzz, r4.xyzx  // r7.x <- <FresnelSchlick_id183 return value>.x; r7.y <- <FresnelSchlick_id183 return value>.y; r7.z <- <FresnelSchlick_id183 return value>.z
...
#line 697
  ...
  div r2.w, r0.y, r2.w  // r2.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r0.z, r6.y, r1.w, r0.z
  div r0.z, r6.y, r0.z  // r0.z <- <VisibilityhSchlickGGX_id199 return value>

#line 843
  mul r0.z, r0.z, r2.w
  mul r0.y, r6.y, r0.y
  div r0.y, r0.z, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 839
  ...
  div r0.x, r0.z, r0.x  // r0.x <- <NormalDistributionGGX_id213 return value>
...
#line 918
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id363 return value>.x; r0.z <- <Compute_id363 return value>.y; r0.w <- <Compute_id363 return value>.z

#line 1157
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id542 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id542 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id542 return value>.z
...
#line 903
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r6.xyzx, t7.xyzw, s0, r0.x  // r3.x <- <Compute_id313 return value>.x; r3.y <- <Compute_id313 return value>.y; r3.z <- <Compute_id313 return value>.z
