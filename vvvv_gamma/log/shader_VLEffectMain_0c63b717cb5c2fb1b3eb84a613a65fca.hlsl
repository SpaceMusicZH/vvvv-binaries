...
//
#line 1244 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_0c63b717cb5c2fb1b3eb84a613a65fca.hlsl"
...
@G    Pixel => d46b7401c842f720b244a85e9bce9565
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1311 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_0c63b717cb5c2fb1b3eb84a613a65fca.hlsl"
...
#line 459
  sample_c_lz_indexable(texture2d)(float,float,float,float) r15.x, r18.xyxx, t1.xxxx, s1, r13.z  // r15.x <- <SampleTextureAndCompare_id67 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r15.y, r18.zwzz, t1.xxxx, s1, r13.z  // r15.y <- <SampleTextureAndCompare_id67 return value>
...
#line 459
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.x, r20.xyxx, t1.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id67 return value>
...
#line 459
      sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r17.xyxx, t1.xxxx, s1, r6.z  // r10.w <- <SampleTextureAndCompare_id67 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r13.w, r17.zwzz, t1.xxxx, s1, r6.z  // r13.w <- <SampleTextureAndCompare_id67 return value>
...
#line 459
      sample_c_lz_indexable(texture2d)(float,float,float,float) r10.w, r20.xyxx, t1.xxxx, s1, r6.z  // r10.w <- <SampleTextureAndCompare_id67 return value>
...
#line 459
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r6.xyxx, t1.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id67 return value>
