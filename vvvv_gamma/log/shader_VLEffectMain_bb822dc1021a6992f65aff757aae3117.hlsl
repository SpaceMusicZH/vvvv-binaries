...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,7>, LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<8>, mixin LightSpotGroup<2>, ShadowMapReceiverSpot<2,false>, ShadowMapFilterPcf<PerDraw.Lighting,3>
...
@R    ParticlesBuffer_id149 => SMBoxImpostor_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id229 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
@R    ParticlesBuffer_id229 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: None, Slot: (-1--1)]
...
@R    ShadowMapTexture_id201 => ShadowMap.ShadowMapTexture.directLightGroups[4] [Stage: Pixel, Slot: (0-0)]
@R    ParticlesBuffer_id229 => ColorPerParticle_ShaderFX.ParticlesBuffer [Stage: Pixel, Slot: (1-1)]
...
//
#line 1784 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb822dc1021a6992f65aff757aae3117.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//   int LightCount_id198;              // Offset:  972 Size:     4 [unused]
//   
//   struct SpotLightData
//   {
//       
...
//
//   } Lights_id200[2];                 // Offset:  976 Size:   124 [unused]
//   float2 ShadowMapTextureSize_id202; // Offset: 1104 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id203;// Offset: 1112 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id207[2];// Offset: 1120 Size:   128 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id208[2];// Offset: 1248 Size:   128 [unused]
//   float4x4 ViewMatrices_id209[2];    // Offset: 1376 Size:   128 [unused]
//   float2 DepthRanges_id210[2];       // Offset: 1504 Size:    24 [unused]
//   float DepthBiases_id211[2];        // Offset: 1536 Size:    20 [unused]
//   float OffsetScales_id212[2];       // Offset: 1568 Size:    20 [unused]
...
//      = 0x3dcccccd 
//   float InputValue_id237;            // Offset:    4 Size:     4 [unused]
//   float InputValue_id246;            // Offset:    8 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//
#line 1749 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb822dc1021a6992f65aff757aae3117.hlsl"
...
@G    Pixel => 393204e37e521768d98e2507d30cf337
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   int LightCount_id198;              // Offset:  972 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset: 1024
//
//   } Lights_id200[2];                 // Offset:  976 Size:   124
//   float2 ShadowMapTextureSize_id202; // Offset: 1104 Size:     8
//   float2 ShadowMapTextureTexelSize_id203;// Offset: 1112 Size:     8
//   float4x4 WorldToShadowCascadeUV_id207[2];// Offset: 1120 Size:   128
//   float4x4 InverseWorldToShadowCascadeUV_id208[2];// Offset: 1248 Size:   128 [unused]
//   float4x4 ViewMatrices_id209[2];    // Offset: 1376 Size:   128 [unused]
//   float2 DepthRanges_id210[2];       // Offset: 1504 Size:    24 [unused]
//   float DepthBiases_id211[2];        // Offset: 1536 Size:    20
//   float OffsetScales_id212[2];       // Offset: 1568 Size:    20
//   float4 _padding_PerDraw_Lighting;  // Offset: 1600 Size:    16 [unused]
//
// }
//
...
//      = 0x3dcccccd 
//   float InputValue_id237;            // Offset:    4 Size:     4
//   float InputValue_id246;            // Offset:    8 Size:     4
//
// }
//
// cbuffer PerView
...
// }
//
// Resource bind info for ParticlesBuffer_id229
// {
//
//   struct SMGridParticle
//   {
...
// ShadowMapTexture_id201            texture  float4          2d             t0      1 
// ParticlesBuffer_id229             texture  struct         r/o             t1      1 
...
//
#line 1733 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_bb822dc1021a6992f65aff757aae3117.hlsl"
...
#line 630
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t3.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id129 return value>
...
#line 630
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id129 return value>

#line 758
  mad r5.w, r6.z, r8.w, r5.w

#line 630
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t3.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id129 return value>
...
#line 630
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t3.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id129 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id129 return value>
...
#line 630
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id129 return value>
...
#line 728
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id252 return value>.x; r8.y <- <FresnelSchlick_id252 return value>.y; r8.z <- <FresnelSchlick_id252 return value>.z
...
#line 724
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id268 return value>

#line 854
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 850
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id282 return value>
...
#line 1272
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id622 return value>.x; r7.y <- <ComputeDirectLightContribution_id622 return value>.y; r7.z <- <ComputeDirectLightContribution_id622 return value>.z
...
#line 1046
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t4.xyzw  // r0.x <- streams.lightData_id186.x; r0.y <- streams.lightData_id186.y

#line 1259
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id323 return value>
...
#line 384
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id143 return value>
...
#line 728
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id252 return value>.x; r13.y <- <FresnelSchlick_id252 return value>.y; r13.z <- <FresnelSchlick_id252 return value>.z
...
#line 724
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id268 return value>

#line 854
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 850
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id282 return value>
...
#line 378
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id154 return value>
...
#line 728
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id252 return value>.x; r16.y <- <FresnelSchlick_id252 return value>.y; r16.z <- <FresnelSchlick_id252 return value>.z
...
#line 724
  ...
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id268 return value>
...
#line 372
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id165 return value>
...
#line 728
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id252 return value>.x; r15.y <- <FresnelSchlick_id252 return value>.y; r15.z <- <FresnelSchlick_id252 return value>.z
...
#line 724
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id268 return value>
  mad r3.w, r10.z, r5.w, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id268 return value>

#line 854
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id190 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.zwzz, t0.xxxx, s1, r2.z  // r5.w <- <SampleTextureAndCompare_id190 return value>
...
#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t0.xxxx, s1, r2.z  // r4.w <- <SampleTextureAndCompare_id190 return value>

#line 668
  mad r2.x, r13.w, r4.w, r2.x

#line 493
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r17.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id190 return value>
...
#line 728
  ...
  mul r4.w, r4.w, r4.w
  mul r1.w, r1.w, r4.w
  mad r16.xyz, r16.xyzx, r1.wwww, r12.xyzx  // r16.x <- <FresnelSchlick_id252 return value>.x; r16.y <- <FresnelSchlick_id252 return value>.y; r16.z <- <FresnelSchlick_id252 return value>.z
...
#line 724
  ...
  div r5.w, r3.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r1.w, r13.z, r4.w, r1.w
  div r1.w, r13.z, r1.w  // r1.w <- <VisibilityhSchlickGGX_id268 return value>

#line 854
  mul r1.w, r1.w, r5.w
  mul r3.w, r13.z, r3.w
  div r1.w, r1.w, r3.w  // r1.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 850
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, l(3.141593)
  div r0.z, r3.w, r0.z  // r0.z <- <NormalDistributionGGX_id282 return value>
...
#line 929
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id444 return value>.x; r0.z <- <Compute_id444 return value>.y; r0.w <- <Compute_id444 return value>.z

#line 1162
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id623 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id623 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id623 return value>.z
...
#line 914
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t8.xyzw, s0, r0.x  // r1.x <- <Compute_id394 return value>.x; r1.y <- <Compute_id394 return value>.y; r1.z <- <Compute_id394 return value>.z
...
mov o0.w, l(1.000000)
ret 
// Approximately 657 instruction slots used
***************************
*************************/
...
const static int TMaxLightCount_id199 = 2;
const static int TCascadeCountBase_id205 = 1;
const static int TLightCountBase_id206 = 2;
const static bool TCascadeDebug_id214 = false;
const static int TFilterSize_id215 = 3;
...
struct PS_STREAMS 
{
    ...
    float4 ColorPerParticle_ShaderFXResult_0_id228;
    float Input_1_id236;
    float Input_2_id245;
...
StructuredBuffer<SMGridParticle> ParticlesBuffer_id229;
...
{
    return ShadowMapTexture_id201.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id115, position, positionDepth);
}
...
float4 Compute_id408(inout PS_STREAMS streams)
{
    ...
    SMGridParticle p = ParticlesBuffer_id229[id];
...
float FilterShadow_id184(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id192(base_uv, st, kernel);
...
{
    streams.Input_2_id245 = Compute_id432();
}
void Compute_id423(inout PS_STREAMS streams)
{
    streams.Input_1_id236 = Compute_id420();
}
void Compute_id411(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id228 = Compute_id408(streams);
}
float4 EvaluateSphericalHarmonics_id206(float3 sphericalColors[TOrder_id218 * TOrder_id218], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id180(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id179(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float Compute_id438(inout PS_STREAMS streams)
{
...
{
    return streams.ColorPerParticle_ShaderFXResult_0_id228;
}
...
float4 Compute_id394(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id222;
    return CubeMap_id223.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id389(float3 direction)
{
    return EvaluateSphericalHarmonics_id206(SphericalColors_id221, direction);
}
...
float3 Compute_id444(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id258.SampleLevel(LinearSampler_id113, float2(glossiness, nDotV), 0);
...
float3 ComputeShadow_id173(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id186(OffsetScales_id212[lightIndex], streams.NdotL_id49, streams.normalWS_id19);
...
float Compute_id536(inout PS_STREAMS streams)
{
    return NormalDistributionGGX_id282(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id506(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id270(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id476(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id258(f0, streams.LdotH_id77);
}
...
void AfterLightingAndShading_id593()
{
}
void AfterLightingAndShading_id574()
{
}
void PrepareEnvironmentLight_id407(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id404(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id210(streams);
    float ambientAccessibility = streams.matAmbientOcclusion_id57;
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id224);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id47 = Compute_id389(sampleDirection).rgb * Intensity_id225 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id394(streams, sampleDirection).rgb * Intensity_id225 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id623(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id444(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id567(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor * streams.envLightDiffuseColor_id47;
}
void PrepareEnvironmentLight_id399(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id201(streams);
    float3 lightColor = AmbientLight_id216 * streams.matAmbientOcclusion_id57;
    streams.envLightDiffuseColor_id47 = lightColor;
    streams.envLightSpecularColor_id48 = lightColor;
}
void PrepareDirectLight_id356(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id155 = ComputeShadow_id173(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id44 *= ComputeTextureProjection_id174(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id45 *= ComputeSpecularTextureProjection_id175(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
int GetLightCount_id358()
{
    return LightCount_id198;
}
int GetMaxLightCount_id359()
{
    return TMaxLightCount_id199;
}
void PrepareDirectLights_id354()
{
}
...
float3 ComputeDirectLightContribution_id622(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id476(streams, specularColor);
    float geometricShadowing = Compute_id506(streams);
    float normalDistribution = Compute_id536(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id566(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id257 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id590()
{
}
void PrepareForLightingAndShading_id571()
{
}
...
void Compute_id654(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id571();
    }

    {
        PrepareForLightingAndShading_id590();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id566(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id622(streams);
            }
        }
    }
    ...
    {
        PrepareDirectLights_id354();
        const int maxLightCount = GetMaxLightCount_id359();
        int count = GetLightCount_id358();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id356(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareEnvironmentLight_id399(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id567(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id623(streams);
        }
    }

    {
        PrepareEnvironmentLight_id404(streams);
    ...
    {
        PrepareEnvironmentLight_id407(streams);
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id257 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id574();
    }

    {
        AfterLightingAndShading_id593();
    }
}
void Compute_id638(inout PS_STREAMS streams)
{
    float metalness = Compute_id443(streams).r;
...
{
    float glossiness = Compute_id431(streams).r;
...
{
    float4 colorBase = Compute_id419(streams);
