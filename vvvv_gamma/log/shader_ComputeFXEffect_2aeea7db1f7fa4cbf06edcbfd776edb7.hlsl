...
@C    InputValue_id260 => ShaderFX.InputValueFloat.i2
@C    InputValue_id268 => ShaderFX.InputValueFloat3.i2
@C    InputValue_id275 => ShaderFX.InputValueFloat3.i3
@C    InputValue_id282 => ShaderFX.InputValueFloat3.i4
@C    InputValue_id292 => ShaderFX.InputValueFloat.i1
@C    InputValue_id300 => ShaderFX.InputValueFloat3
@C    InputValue_id307 => ShaderFX.InputValueFloat3.i1
@C    InputValue_id328 => ShaderFX.InputValueUInt
@C    InputValue_id349 => ShaderFX.InputValueFloat
...
@R    DynamicBuffer_id335 => ObjectBuffer_fx0 [Stage: Compute, Slot: (5-5)]
@R    DynamicTexture_id342 => ObjectTexture_fx7 [Stage: Compute, Slot: (6-6)]
...
*****     Stages      *****
***************************
@G    Compute => 52182062fd010cc1927adcd217b8e9a5
//
...
//   float InputValue_id260;            // Offset:   92 Size:     4
//   float3 InputValue_id268;           // Offset:   96 Size:    12
//   float3 InputValue_id275;           // Offset:  112 Size:    12
//   float3 InputValue_id282;           // Offset:  128 Size:    12
//   float InputValue_id292;            // Offset:  140 Size:     4
//   float3 InputValue_id300;           // Offset:  144 Size:    12
//   float3 InputValue_id307;           // Offset:  160 Size:    12
//   uint InputValue_id328;             // Offset:  172 Size:     4
//   float InputValue_id349;            // Offset:  176 Size:     4
//
// }
//
// cbuffer Globals
...
// DynamicBuffer_id335               texture  float4         buf             t5      1 
// DynamicTexture_id342              texture  float4          2d             t6      1 
...
//
#line 1420 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_2aeea7db1f7fa4cbf06edcbfd776edb7.hlsl"
...
#line 681
  mad r11.xyz, cb1[8].wwww, cb1[9].xyzx, cb1[10].xyzx  // r11.x <- <Compute_id567 return value>.x; r11.y <- <Compute_id567 return value>.y; r11.z <- <Compute_id567 return value>.z
...
#line 677
  sample_l_indexable(texture2d)(float,float,float,float) r12.xyz, r6.zyzz, t4.xyzw, s0, l(0.000000)  // r12.x <- <Compute_id455 return value>.x; r12.y <- <Compute_id455 return value>.y; r12.z <- <Compute_id455 return value>.z
...
#line 648
  mad r12.xyz, r12.xyzx, cb1[6].xyzx, cb1[7].xyzx  // r12.x <- <Compute_id504 return value>.x; r12.y <- <Compute_id504 return value>.y; r12.z <- <Compute_id504 return value>.z

#line 640
  add r12.xyz, r12.xyzx, cb1[8].xyzx  // r12.x <- <Compute_id512 return value>.x; r12.y <- <Compute_id512 return value>.y; r12.z <- <Compute_id512 return value>.z
...
#line 551
  mul r1.w, r0.w, cb1[3].w  // r1.w <- <Compute_id386 return value>

#line 523
  mad r12.xyz, r1.wwww, cb1[4].xyzx, cb1[5].xyzx  // r12.x <- <Compute_id422 return value>.x; r12.y <- <Compute_id422 return value>.y; r12.z <- <Compute_id422 return value>.z
...
#line 495
  ...
  mul r14.xyz, r12.xyzx, r13.xyzx  // r14.x <- <SRgbToLinear_id585 return value>.x; r14.y <- <SRgbToLinear_id585 return value>.y; r14.z <- <SRgbToLinear_id585 return value>.z
...
const static float Value_id343 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Input_13_id291;
    float3 SMVector3Join_ShaderFXResult_14_id294;
    float3 Input_15_id299;
    float3 Multiply_16_id302;
    float3 Input_17_id306;
    float3 Plus_18_id309;
    float4 TextureValue_20_id241;
    float SMCalcLuminance_ShaderFXResult_22_id248;
    float Input_23_id259;
    float3 SMVector3Join_ShaderFXResult_24_id262;
    float3 Input_25_id267;
    float3 Multiply_26_id270;
    float3 Input_27_id274;
    float3 Plus_28_id277;
    float3 Input_29_id281;
    float3 Plus_30_id284;
    ...
    float Input_47_id204;
    float Multiply_48_id207;
    float Multiply_49_id211;
    float Multiply_50_id215;
    float3 SMVector3Join_ShaderFXResult_51_id219;
    float3 Input_52_id224;
    float3 Multiply_53_id227;
    float3 Input_54_id231;
    float3 Plus_55_id234;
    uint Input_3_id327;
    uint SMValueToIndex_ShaderFXResult_4_id330;
    float4 BufferItem_5_id334;
    float4 SRgbToLinear_ShaderFXResult_6_id338;
    float4 TextureValue_9_id341;
    float Input_11_id348;
    float4 Lerp_12_id351;
};
struct CS_INPUT 
{
...
{
    return streams.Input_11_id348;
}
float4 Compute_id127(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id341;
}
float4 Compute_id125(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id338;
}
float Compute_id117()
{
    return Value_id343;
...
float4 SRgbToLinear_id585(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id334;
}
uint Compute_id109(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id330;
}
uint Compute_id103(inout CS_STREAMS streams)
{
    return streams.Input_3_id327;
}
...
{
    float4 color = Compute_id356(streams);
...
{
    return DynamicTexture_id242.SampleLevel(DynamicSampler_id128, Compute_id452(streams), Compute_id450());
}
float3 Compute_id567(inout CS_STREAMS streams)
{
    return Compute_id562(streams) + Compute_id564(streams);
}
float3 Compute_id560()
{
...
{
    return float3(Compute_id544(streams), Compute_id546(streams), Compute_id548(streams));
}
float Compute_id542()
{
...
{
    return DynamicTexture_id342.SampleLevel(DynamicSampler_id128, Compute_id119(streams), Compute_id117());
}
float4 Compute_id116(inout CS_STREAMS streams)
{
    return SRgbToLinear_id585(Compute_id113(streams));
}
float4 Compute_id112(inout CS_STREAMS streams)
{
    return DynamicBuffer_id335[Compute_id109(streams)];
}
...
{
    streams.Plus_55_id234 = Compute_id422(streams);
}
void Compute_id442(inout CS_STREAMS streams)
{
    streams.Input_54_id231 = Compute_id415();
}
void Compute_id440(inout CS_STREAMS streams)
{
    streams.Multiply_53_id227 = Compute_id414(streams);
}
void Compute_id438(inout CS_STREAMS streams)
{
    streams.Input_52_id224 = Compute_id407();
}
void Compute_id436(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_51_id219 = Compute_id406(streams);
}
void Compute_id434(inout CS_STREAMS streams)
{
    streams.Multiply_50_id215 = Compute_id398(streams);
}
void Compute_id432(inout CS_STREAMS streams)
{
    streams.Multiply_49_id211 = Compute_id392(streams);
}
void Compute_id430(inout CS_STREAMS streams)
{
    streams.Multiply_48_id207 = Compute_id386(streams);
}
void Compute_id428(inout CS_STREAMS streams)
{
    streams.Input_47_id204 = Compute_id379();
}
void Compute_id426(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_2_id115 = Compute_id378(streams);
}
...
{
    streams.Plus_30_id284 = Compute_id512(streams);
}
void Compute_id534(inout CS_STREAMS streams)
{
    streams.Input_29_id281 = Compute_id505();
}
void Compute_id532(inout CS_STREAMS streams)
{
    streams.Plus_28_id277 = Compute_id504(streams);
}
void Compute_id530(inout CS_STREAMS streams)
{
    streams.Input_27_id274 = Compute_id497();
}
void Compute_id528(inout CS_STREAMS streams)
{
    streams.Multiply_26_id270 = Compute_id496(streams);
}
void Compute_id526(inout CS_STREAMS streams)
{
    streams.Input_25_id267 = Compute_id489();
}
void Compute_id524(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_24_id262 = Compute_id488(streams);
}
void Compute_id522(inout CS_STREAMS streams)
{
    streams.Input_23_id259 = Compute_id479();
}
void Compute_id520(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_22_id248 = Compute_id478(streams);
}
void Compute_id518(inout CS_STREAMS streams)
{
    streams.TextureValue_20_id241 = Compute_id455(streams);
}
void Compute_id516()
{
}
...
{
    streams.Plus_18_id309 = Compute_id567(streams);
}
void Compute_id577(inout CS_STREAMS streams)
{
    streams.Input_17_id306 = Compute_id560();
}
void Compute_id575(inout CS_STREAMS streams)
{
    streams.Multiply_16_id302 = Compute_id559(streams);
}
void Compute_id573(inout CS_STREAMS streams)
{
    streams.Input_15_id299 = Compute_id552();
}
void Compute_id571(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_14_id294 = Compute_id551(streams);
}
void Compute_id569(inout CS_STREAMS streams)
{
    streams.Input_13_id291 = Compute_id542();
}
...
{
    streams.Lerp_12_id351 = Compute_id132(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_11_id348 = Compute_id123();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id341 = Compute_id122(streams);
}
void Compute_id149()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id338 = Compute_id116(streams);
}
void Compute_id143(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id334 = Compute_id112(streams);
}
void Compute_id141(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id330 = Compute_id108(streams);
}
void Compute_id139(inout CS_STREAMS streams)
{
    streams.Input_3_id327 = Compute_id101();
}
