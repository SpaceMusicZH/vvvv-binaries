...
@P   - AmbientOcclusionWithOrthoRawAO.Count: 32
...
*****     Sources     *****
***************************
@S    AmbientOcclusionWithOrthoRawAOShader => d718cd9a22a257abd5b5de93cb9910c5
...
//
#line 226 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_AmbientOcclusionWithOrthoRawAOEffect_6071f4aff8fa9a8eb905baeb4d16e173.hlsl"
...
@G    Pixel => c14090f8ff51254052886b0103761ef8
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 180 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_AmbientOcclusionWithOrthoRawAOEffect_6071f4aff8fa9a8eb905baeb4d16e173.hlsl"
...
#line 157
  mad r5.x, r5.x, l(0.927752), r1.x  // r5.x <- angle

#line 158
  sincos r5.x, r6.x, r5.x  // r5.x <- offset.y; r6.x <- offset.x

#line 159
  mul r5.y, r5.y, l(0.021094)  // r5.y <- ssRadius
...
mad r0.x, -r0.x, l(0.156250), l(1.000000)
...
***************************
*************************/
const static int SamplesCount_id79 = 32;
