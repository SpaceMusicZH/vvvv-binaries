...
//
#line 787 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_410bb0ffa1795bc8d74eb85faf3cc318.hlsl"
...
@G    Pixel => 20efc626e5ce2bef7c3f432046dfe1a2
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 853 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_410bb0ffa1795bc8d74eb85faf3cc318.hlsl"
...
#line 537
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id125 return value>
...
#line 515
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id137 return value>
...
#line 271
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id68 return value>
...
#line 332
mad r1.yzw, cb2[45].xxyz, r0.yyyy, cb2[44].xxyz  // r1.y <- color.x; r1.z <- color.y; r1.w <- color.z

#line 333
mad r1.yzw, cb2[46].xxyz, -r0.zzzz, r1.yyzw

#line 334
mad r1.yzw, cb2[47].xxyz, r0.xxxx, r1.yyzw

#line 337
mul r2.xyz, r0.yyyy, cb2[48].xyzx
mad r1.yzw, r2.xxyz, r0.xxxx, r1.yyzw

#line 338
mul r2.xyz, r0.yyyy, cb2[49].xyzx
mad r1.yzw, r2.xxyz, -r0.zzzz, r1.yyzw

#line 339
mad r0.y, r1.x, l(3.000000), l(-1.000000)
mad r1.xyz, cb2[50].xyzx, r0.yyyy, r1.yzwy  // r1.x <- color.x; r1.y <- color.y; r1.z <- color.z

#line 340
mul r2.xyz, r0.xxxx, cb2[51].xyzx
mad r1.xyz, r2.xyzx, -r0.zzzz, r1.xyzx

#line 341
mad r0.x, r0.x, r0.x, -r0.w
mad r0.xyz, cb2[52].xyzx, r0.xxxx, r1.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
#line 489
mul r0.xyz, r0.xyzx, cb1[0].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id175 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id175 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id175 return value>.z
...
float4 EvaluateSphericalHarmonics_id81(float3 sphericalColors[TOrder_id106 * TOrder_id106], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float4 Compute_id158(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id153(float3 direction)
{
    return EvaluateSphericalHarmonics_id81(SphericalColors_id109, direction);
}
...
void ResetStream_id100()
{
}
void AfterLightingAndShading_id182()
{
}
void PrepareEnvironmentLight_id171(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
void PrepareEnvironmentLight_id168(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id153(sampleDirection).rgb * Intensity_id171 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id158(streams, sampleDirection).rgb * Intensity_id171 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id175(inout PS_STREAMS streams)
{
...
int GetLightCount_id138(inout PS_STREAMS streams)
{
    return streams.lightData_id95.y >> 16;
}
int GetMaxLightCount_id137(inout PS_STREAMS streams)
{
    return streams.lightData_id95.y >> 16;
}
...
void PrepareDirectLights_id124(inout PS_STREAMS streams)
{
    PrepareLightData_id60(streams);
}
float3 ComputeDirectLightContribution_id174(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareDirectLight_id110(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id112()
{
    return LightCount_id86;
}
int GetMaxLightCount_id113()
{
    return TMaxLightCount_id87;
}
void PrepareDirectLights_id108()
{
}
void PrepareForLightingAndShading_id179()
{
}
void PrepareMaterialForLightingAndShading_id99(inout PS_STREAMS streams)
{
...
void ResetLightStream_id98(inout PS_STREAMS streams)
{
...
void Compute_id216(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id98(streams);
    PrepareMaterialForLightingAndShading_id99(streams);

    {
        PrepareForLightingAndShading_id179();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id108();
        const int maxLightCount = GetMaxLightCount_id113();
        int count = GetLightCount_id112();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id110(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);

            {
                directLightingContribution += ComputeDirectLightContribution_id174(streams);
            }
        }
    }

    {
        PrepareDirectLights_id124(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id137(streams);
        int count = GetLightCount_id138(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id175(streams);
        }
    }

    {
        PrepareEnvironmentLight_id168(streams);
    ...
    {
        PrepareEnvironmentLight_id171(streams);
    ...
    {
        AfterLightingAndShading_id182();
    }
}
void Compute_id200(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id172();
