...
//
#line 316 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_3fd3a26d2b9afe3ad62bffcf6c604505.hlsl"
mov o0.x, v0.x
mov o1.xyzw, v1.xyzw
ret 
// Approximately 3 instruction slots used
@G    Geometry => bf05b12817a4a85fa06cf0977db0b581
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 282 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_3fd3a26d2b9afe3ad62bffcf6c604505.hlsl"
...
#line 253
mul r4.xyz, r2.zzyz, r2.yxxy  // r4.y <- <rot3x3_id51 return value>._m11; r4.z <- <rot3x3_id51 return value>._m22
mul r0.w, r0.y, r0.x
mad r5.x, r0.w, r0.z, r4.x  // r5.x <- <rot3x3_id51 return value>._m00
mul r5.y, r0.z, -r2.x  // r5.y <- <rot3x3_id51 return value>._m01
mul r6.xyzw, r0.xyzy, r2.yzyx  // r6.w <- <rot3x3_id51 return value>._m20
...
mad r4.x, -r0.w, r2.z, r6.z  // r4.x <- <rot3x3_id51 return value>._m10
mul r0.x, r2.z, r6.x
mad r4.z, -r0.y, r0.z, -r0.x  // r4.z <- <rot3x3_id51 return value>._m12

#line 292
add r0.xyz, -r3.xyzx, cb2[21].xyzx  // r0.x <- viewDir.x; r0.y <- viewDir.y; r0.z <- viewDir.z
...
#line 238
    ...
    dp4 r2.x, r2.xyzw, cb2[19].xyzw  // r2.x <- streams.ShadingPosition_id0.w
...
#line 196
    and r2.xyz, r2.xxxx, l(0x000fa55a, 0x005a0f33, 0x0033330f, 0)
    movc r2.xyz, r2.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r2.x <- <CubeVert_id75 return value>.x; r2.y <- <CubeVert_id75 return value>.y; r2.z <- <CubeVert_id75 return value>.z
...
#line 238
    ...
    dp4 r0.x, r0.xyzw, cb2[19].xyzw  // r0.x <- streams.ShadingPosition_id0.w
...
//
#line 273 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ShaderFXEffect_3fd3a26d2b9afe3ad62bffcf6c604505.hlsl"
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    p.Pos = mul(float4(p.Pos, 1), World_id30).xyz;
