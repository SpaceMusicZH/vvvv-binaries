...
//
#line 1694 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_c2a822ef84eceae117fa37098e429732.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => 6b64e1111bd42b1ece350737a74f19aa
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
//   } Lights_id199[3];                 // Offset:  464 Size:   188 [unused]
//   float2 ShadowMapTextureSize_id201; // Offset:  656 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id202;// Offset:  664 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id206[3];// Offset:  672 Size:   192 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id207[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id208[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id209[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id210[3];        // Offset: 1296 Size:    36 [unused]
//   float OffsetScales_id211[3];       // Offset: 1344 Size:    36 [unused]
...
//
#line 1659 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_c2a822ef84eceae117fa37098e429732.hlsl"
...
@G    Pixel => 35e7fd139244049f3d7c57fac30757dd
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id199[3];                 // Offset:  464 Size:   188
//   float2 ShadowMapTextureSize_id201; // Offset:  656 Size:     8
//   float2 ShadowMapTextureTexelSize_id202;// Offset:  664 Size:     8
//   float4x4 WorldToShadowCascadeUV_id206[3];// Offset:  672 Size:   192
//   float4x4 InverseWorldToShadowCascadeUV_id207[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id208[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id209[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id210[3];        // Offset: 1296 Size:    36
//   float OffsetScales_id211[3];       // Offset: 1344 Size:    36
//   float4 _padding_PerDraw_Lighting;  // Offset: 1392 Size:    16 [unused]
//
// }
//
...
//
#line 1641 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_c2a822ef84eceae117fa37098e429732.hlsl"
...
#line 986
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t4.xyzw  // r0.x <- streams.lightData_id188.x; r0.y <- streams.lightData_id188.y
...
#line 942
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r0.zzzz, t5.yzwx  // r2.w <- realLightIndex
...
#line 698
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r15.xyz, r15.xyzx, r4.wwww, r7.xyzx  // r15.x <- <FresnelSchlick_id252 return value>.x; r15.y <- <FresnelSchlick_id252 return value>.y; r15.z <- <FresnelSchlick_id252 return value>.z
...
#line 694
  ...
  div r4.w, r0.y, r4.w  // r4.w <- <VisibilityhSchlickGGX_id268 return value>
...
mov r8.xyz, r5.xyzx  // r8.x <- streams.matSpecularVisible_id73.x; r8.y <- streams.matSpecularVisible_id73.y; r8.z <- streams.matSpecularVisible_id73.z
mov r8.w, r0.w  // r8.w <- streams.alphaRoughness_id72
mov r9.xyz, r1.xyzx  // r9.x <- streams.normalWS_id21.x; r9.y <- streams.normalWS_id21.y; r9.z <- streams.normalWS_id21.z
mov r10.xyz, r3.xyzx  // r10.x <- streams.viewWS_id70.x; r10.y <- streams.viewWS_id70.y; r10.z <- streams.viewWS_id70.z
mov r12.xyz, r4.xyzx  // r12.x <- streams.matDiffuseVisible_id71.x; r12.y <- streams.matDiffuseVisible_id71.y; r12.z <- streams.matDiffuseVisible_id71.z
...
#line 369
  mul r3.w, r3.w, r3.w  // r3.w <- <SmoothDistanceAttenuation_id176 return value>
...
#line 781
  mul r6.w, r0.x, cb0[r0.z + 84].x
  mul r6.z, r6.z, r6.w

#line 909
  mad r2.xyz, r6.zzzz, r9.xyzx, r7.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 773
  dp4 r15.x, r2.xyzw, cb0[r1.w + 42].xyzw  // r15.x <- shadowPosition.x
  dp4 r15.y, r2.xyzw, cb0[r1.w + 43].xyzw  // r15.y <- shadowPosition.y
  dp4 r6.z, r2.xyzw, cb0[r1.w + 44].xyzw  // r6.z <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[r1.w + 45].xyzw  // r2.x <- shadowPosition.w

#line 774
  add r15.z, r6.z, -cb0[r0.z + 81].x  // r15.z <- shadowPosition.z
...
#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id190 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r18.zwzz, t0.xxxx, s1, r2.z  // r9.w <- <SampleTextureAndCompare_id190 return value>
...
#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id190 return value>

#line 651
  mad r2.x, r15.x, r7.w, r2.x

#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r20.xyxx, t0.xxxx, s1, r2.z

#line 651
  mad r2.x, r19.y, r7.w, r2.x

#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r20.zwzz, t0.xxxx, s1, r2.z
...
#line 651
  mad r2.x, r17.z, r7.w, r2.x

#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r16.xyxx, t0.xxxx, s1, r2.z

#line 651
  mad r2.x, r15.y, r7.w, r2.x

#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r16.zwzz, t0.xxxx, s1, r2.z

#line 651
  mad r2.x, r17.w, r7.w, r2.x

#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id190 return value>
...
#line 694
  mad r6.z, -r8.w, l(0.500000), l(1.000000)
  mad r6.w, r4.w, r6.z, r3.w
  div r6.w, r4.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r3.w, r0.y, r6.z, r3.w
...
#line 812
  ...
  div r1.w, r4.w, r1.w  // r1.w <- <NormalDistributionGGX_id282 return value>
...
const static int TMaxLightCount_id198 = 3;
const static int TCascadeCountBase_id204 = 1;
const static int TLightCountBase_id205 = 3;
