...
//
#line 1272 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f30cd61519317db3f7a01ac94dce2b54.hlsl"
...
@G    Pixel => 67d39190ce28502bd3bd0b8865d41dee
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1339 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f30cd61519317db3f7a01ac94dce2b54.hlsl"
...
#line 686
  mov r2.w, l(1.000000)
  dp4 r3.x, r2.xyzw, cb0[34].xyzw  // r3.x <- shadowPosition.x
  dp4 r3.y, r2.xyzw, cb0[35].xyzw  // r3.y <- shadowPosition.y
  dp4 r0.y, r2.xyzw, cb0[36].xyzw  // r0.y <- shadowPosition.z
  dp4 r0.z, r2.xyzw, cb0[37].xyzw  // r0.z <- shadowPosition.w

#line 687
  add r3.z, r0.y, -cb0[47].x  // r3.z <- shadowPosition.z

#line 688
  div r2.xyz, r3.xyzx, r0.zzzz  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 471
  mad r0.yz, r2.xxyx, cb0[33].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
...
#line 474
  mul r2.xy, r2.xyxx, cb0[33].zwzz

#line 407
  mad r3.xy, -r0.zyzz, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)  // r3.x <- uvW0.y; r3.y <- uvW0.x

#line 408
  mad r3.zw, r0.yyyz, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r3.z <- uvW1.x; r3.w <- uvW1.y

#line 409
  add r5.xy, -r0.yzyy, l(2.000000, 2.000000, 0.000000, 0.000000)
  div r5.xy, r5.xyxx, r3.yxyy
  add r5.zw, r5.xxxy, l(0.000000, 0.000000, -1.000000, -1.000000)  // r5.z <- uv0.x; r5.w <- uv0.y

#line 410
  div r0.yz, r0.yyzy, r3.zzwz
  add r5.xy, r0.yzyy, l(1.000000, 1.000000, 0.000000, 0.000000)  // r5.x <- uv1.x; r5.y <- uv1.y

#line 414
  mul r0.yz, r3.xxwx, r3.yyzy

#line 412
  mad r6.xyzw, r5.zwxw, cb0[33].zwzw, r2.xyxy

#line 413
  mul r3.xy, r3.xyxx, r3.zwzz

#line 414
  mad r5.xyzw, r5.zyxy, cb0[33].zwzw, r2.xyxy

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t0.xxxx, s0, r2.z  // r1.w <- <SampleTextureAndCompare_id113 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r6.zwzz, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id113 return value>

#line 585
  mul r2.x, r2.x, r3.x
  mad r0.y, r0.y, r1.w, r2.x  // r0.y <- shadow

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r5.xyxx, t0.xxxx, s0, r2.z  // r1.w <- <SampleTextureAndCompare_id113 return value>

#line 585
  mad r0.y, r3.y, r1.w, r0.y

#line 438
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r5.zwzz, t0.xxxx, s0, r2.z
...
#line 946
  mul r2.xyz, r0.wwww, cb0[32].xyzx
