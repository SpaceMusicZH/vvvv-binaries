...
@P Rot: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_20> [{Value = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_21> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_20>}, {Y = GetVarFloat<Input_20>}, {Z = GetVarFloat<Input_20>}]}], mixin AssignVarFloat3<Input_22> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i2,PerUpdate>}], mixin AssignVarFloat3<Multiply_23> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_21>}, {Right = GetVarFloat3<Input_22>}]}], mixin AssignVarFloat3<Input_24> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i3,PerUpdate>}], mixin AssignVarFloat3<Plus_25> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_23>}, {Right = GetVarFloat3<Input_24>}]}], mixin AssignVarFloat3<Input_26> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i4,PerUpdate>}], mixin AssignVarFloat3<Plus_27> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Plus_25>}, {Right = GetVarFloat3<Input_26>}]}]]}]}, {Value = GetVarFloat3<Plus_27>}]
@P Dim: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat3<Input_28> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i5,PerUpdate>}], mixin AssignVarFloat<Input_29> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_30> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_29>}, {Y = GetVarFloat<Input_29>}, {Z = GetVarFloat<Input_29>}]}], mixin AssignVarFloat3<Input_31> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i6,PerUpdate>}], mixin AssignVarFloat3<Multiply_32> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_30>}, {Right = GetVarFloat3<Input_31>}]}], mixin AssignVarFloat3<Plus_33> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Input_28>}, {Right = GetVarFloat3<Multiply_32>}]}], mixin AssignVarFloat3<Input_34> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i7,PerUpdate>}], mixin AssignVarFloat3<Multiply_35> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<Plus_33>}, {Right = GetVarFloat3<Input_34>}]}]]}]}, {Value = GetVarFloat3<Multiply_35>}]
@P Piv: mixin DoFloat3 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_36> [{Value = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}], mixin AssignVarFloat3<SMVector3Join_ShaderFXResult_37> [{Value = mixin SMVector3Join_ShaderFX [{X = GetVarFloat<Input_36>}, {Y = GetVarFloat<Input_36>}, {Z = GetVarFloat<Input_36>}]}], mixin AssignVarFloat3<Input_38> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i8,PerUpdate>}], mixin AssignVarFloat3<Multiply_39> [{Value = mixin MultiplyFloat3 [{Left = GetVarFloat3<SMVector3Join_ShaderFXResult_37>}, {Right = GetVarFloat3<Input_38>}]}], mixin AssignVarFloat3<Input_40> [{Value = InputFloat3<ShaderFX.InputValueFloat3.i9,PerUpdate>}], mixin AssignVarFloat3<Plus_41> [{Value = mixin PlusFloat3 [{Left = GetVarFloat3<Multiply_39>}, {Right = GetVarFloat3<Input_40>}]}]]}]}, {Value = GetVarFloat3<Plus_41>}]
...
@C    InputValue_id233 => ShaderFX.InputValueUInt
...
******  Resources    ******
***************************
@R    DynamicSampler_id248 => ObjectSampler_fx8 [Stage: Compute, Slot: (0-0)]
...
@R    DynamicBuffer_id240 => ObjectBuffer_fx0 [Stage: Compute, Slot: (3-3)]
@R    DynamicTexture_id247 => ObjectTexture_fx7 [Stage: Compute, Slot: (4-4)]
...
*****     Stages      *****
***************************
@G    Compute => cac05a481ffc8b3b9ecf584c03d3503c
//
...
//   uint InputValue_id233;             // Offset:  156 Size:     4
//   float InputValue_id255;            // Offset:  160 Size:     4
//
// }
//
// cbuffer Globals
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// DynamicSampler_id248              sampler      NA          NA             s0      1 
...
// DynamicBuffer_id240               texture  float4         buf             t3      1 
// DynamicTexture_id247              texture  float4          2d             t4      1 
...
//
#line 1053 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_5f2f1f1ba5a82763964582f656f8796a.hlsl"
...
#line 491
  mad r11.xyz, cb1[7].wwww, cb1[8].xyzx, cb1[9].xyzx  // r11.x <- <Compute_id330 return value>.x; r11.y <- <Compute_id330 return value>.y; r11.z <- <Compute_id330 return value>.z
...
#line 467
  mad r12.xyz, cb1[4].wwww, cb1[5].xyzx, cb1[6].xyzx  // r12.x <- <Compute_id275 return value>.x; r12.y <- <Compute_id275 return value>.y; r12.z <- <Compute_id275 return value>.z

#line 459
  add r12.xyz, r12.xyzx, cb1[7].xyzx  // r12.x <- <Compute_id283 return value>.x; r12.y <- <Compute_id283 return value>.y; r12.z <- <Compute_id283 return value>.z
...
#line 435
  mad r12.xyz, cb1[0].wwww, cb1[1].xyzx, cb1[0].xyzx  // r12.x <- <Compute_id141 return value>.x; r12.y <- <Compute_id141 return value>.y; r12.z <- <Compute_id141 return value>.z

#line 427
  mul r13.xyz, r12.xyzx, cb1[2].xyzx  // r13.x <- <Compute_id149 return value>.x; r13.y <- <Compute_id149 return value>.y; r13.z <- <Compute_id149 return value>.z
...
#line 403
  mad r12.xyz, cb1[2].wwww, cb1[3].xyzx, cb1[4].xyzx  // r12.x <- <Compute_id232 return value>.x; r12.y <- <Compute_id232 return value>.y; r12.z <- <Compute_id232 return value>.z
...
#line 549
  ...
  mul r0.w, r0.w, r12.y
  round_ne r0.w, r0.w
  ftou r0.w, r0.w  // r0.w <- <Compute_id63 return value>

#line 543
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r0.wwww, t3.xyzw  // r13.x <- <Compute_id67 return value>.x; r13.y <- <Compute_id67 return value>.y; r13.z <- <Compute_id67 return value>.z
...
#line 379
  ...
  mul r15.xyz, r13.xyzx, r14.xyzx  // r15.x <- <SRgbToLinear_id348 return value>.x; r15.y <- <SRgbToLinear_id348 return value>.y; r15.z <- <SRgbToLinear_id348 return value>.z

#line 535
  sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.xyxx, t4.wxyz, s0, l(0.000000)  // r6.y <- <Compute_id77 return value>.x; r6.z <- <Compute_id77 return value>.y; r6.w <- <Compute_id77 return value>.z

#line 527
  mad r6.yzw, -r13.xxyz, r14.xxyz, r6.yyzw
  mad r6.yzw, cb1[10].xxxx, r6.yyzw, r15.xxyz  // r6.y <- <Compute_id87 return value>.x; r6.z <- <Compute_id87 return value>.y; r6.w <- <Compute_id87 return value>.z
...
#line 350
  dp3 r0.w, r12.xzwx, l(0.299000, 0.587000, 0.114000, 0.000000)  // r0.w <- <Luminance_id47 return value>
...
const static float Value_id249 = 0;
struct CS_STREAMS 
{
    uint3 GroupId_id0;
    ...
    float Input_14_id196;
    float3 SMVector3Join_ShaderFXResult_15_id199;
    float3 Input_16_id204;
    float3 Multiply_17_id207;
    float3 Input_18_id211;
    float3 Plus_19_id214;
    float Input_20_id164;
    float3 SMVector3Join_ShaderFXResult_21_id167;
    float3 Input_22_id172;
    float3 Multiply_23_id175;
    float3 Input_24_id179;
    float3 Plus_25_id182;
    float3 Input_26_id186;
    float3 Plus_27_id189;
    float3 Input_28_id107;
    float Input_29_id110;
    float3 SMVector3Join_ShaderFXResult_30_id113;
    float3 Input_31_id118;
    float3 Multiply_32_id121;
    float3 Plus_33_id125;
    float3 Input_34_id129;
    float3 Multiply_35_id132;
    float Input_36_id139;
    float3 SMVector3Join_ShaderFXResult_37_id142;
    float3 Input_38_id147;
    float3 Multiply_39_id150;
    float3 Input_40_id154;
    float3 Plus_41_id157;
    float4 SMVideoBufferSelector_ShaderFXResult_1_id221;
    float g_2_id229;
    uint Input_3_id232;
    uint SMValueToIndex_ShaderFXResult_4_id235;
    float4 BufferItem_5_id239;
    float4 SRgbToLinear_ShaderFXResult_6_id243;
    float4 TextureValue_9_id246;
    float Input_11_id254;
    float4 Lerp_12_id257;
    float SMCalcLuminance_ShaderFXResult_13_id266;
};
struct CS_INPUT 
{
...
Buffer<float4> DynamicBuffer_id240;
Texture2D DynamicTexture_id247;
SamplerState DynamicSampler_id248;
float3 Compute_id229(inout CS_STREAMS streams)
{
    return streams.Input_40_id154;
}
float3 Compute_id227(inout CS_STREAMS streams)
{
    return streams.Multiply_39_id150;
}
float3 Compute_id221(inout CS_STREAMS streams)
{
    return streams.Input_38_id147;
}
float3 Compute_id219(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_37_id142;
}
float Compute_id213(inout CS_STREAMS streams)
{
    return streams.Input_36_id139;
}
...
{
    return streams.Input_18_id211;
}
float3 Compute_id325(inout CS_STREAMS streams)
{
    return streams.Multiply_17_id207;
}
float3 Compute_id319(inout CS_STREAMS streams)
{
    return streams.Input_16_id204;
}
float3 Compute_id317(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_15_id199;
}
float Compute_id311(inout CS_STREAMS streams)
{
    return streams.Input_14_id196;
}
...
{
    return streams.Input_11_id254;
}
float4 Compute_id82(inout CS_STREAMS streams)
{
    return streams.TextureValue_9_id246;
}
float4 Compute_id80(inout CS_STREAMS streams)
{
    return streams.SRgbToLinear_ShaderFXResult_6_id243;
}
float Compute_id72()
{
    return Value_id249;
}
float2 Compute_id74(inout CS_STREAMS streams)
{
    return streams.TexCoord_id59;
}
float4 SRgbToLinear_id348(float4 sRGBa)
{
...
{
    return streams.BufferItem_5_id239;
}
uint Compute_id64(inout CS_STREAMS streams)
{
    return streams.SMValueToIndex_ShaderFXResult_4_id235;
}
uint Compute_id58(inout CS_STREAMS streams)
{
    return streams.Input_3_id232;
}
float Compute_id60(inout CS_STREAMS streams)
{
    return streams.g_2_id229;
}
...
float3 Compute_id217()
{
    return InputValue_id148;
}
float3 Compute_id216(inout CS_STREAMS streams)
{
    return float3(Compute_id209(streams), Compute_id211(streams), Compute_id213(streams));
}
float Compute_id207()
{
...
{
    return Compute_id144(streams) * Compute_id146(streams);
}
float3 Compute_id142()
{
...
{
    return Compute_id130(streams) * Compute_id132(streams);
}
float3 Compute_id128()
{
    return InputValue_id119;
}
float3 Compute_id127(inout CS_STREAMS streams)
{
    return float3(Compute_id120(streams), Compute_id122(streams), Compute_id124(streams));
}
float Compute_id118()
{
    return InputValue_id111;
}
float3 Compute_id116()
{
    return InputValue_id108;
}
float3 Compute_id283(inout CS_STREAMS streams)
{
    return Compute_id278(streams) + Compute_id280(streams);
}
float3 Compute_id276()
{
...
{
    return float3(Compute_id252(streams), Compute_id254(streams), Compute_id256(streams));
}
float Compute_id250()
{
...
{
    return Compute_id325(streams) + Compute_id327(streams);
}
float3 Compute_id323()
{
    return InputValue_id212;
}
float3 Compute_id322(inout CS_STREAMS streams)
{
    return Compute_id317(streams) * Compute_id319(streams);
}
float3 Compute_id315()
{
    return InputValue_id205;
}
float3 Compute_id314(inout CS_STREAMS streams)
{
    return float3(Compute_id307(streams), Compute_id309(streams), Compute_id311(streams));
}
float Compute_id305()
{
...
{
    return lerp(Compute_id80(streams), Compute_id82(streams), Compute_id84(streams));
}
float Compute_id78()
{
...
{
    return DynamicTexture_id247.SampleLevel(DynamicSampler_id248, Compute_id74(streams), Compute_id72());
}
float4 Compute_id71(inout CS_STREAMS streams)
{
    return SRgbToLinear_id348(Compute_id68(streams));
}
float4 Compute_id67(inout CS_STREAMS streams)
{
    return DynamicBuffer_id240[Compute_id64(streams)];
}
uint Compute_id63(inout CS_STREAMS streams)
{
    float v = Compute_id60(streams);
    uint c = Compute_id58(streams);
    return round(v * c);
}
uint Compute_id56()
{
...
{
    streams.Plus_41_id157 = Compute_id232(streams);
}
void Compute_id242(inout CS_STREAMS streams)
{
    streams.Input_40_id154 = Compute_id225();
}
void Compute_id240(inout CS_STREAMS streams)
{
    streams.Multiply_39_id150 = Compute_id224(streams);
}
void Compute_id238(inout CS_STREAMS streams)
{
    streams.Input_38_id147 = Compute_id217();
}
void Compute_id236(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_37_id142 = Compute_id216(streams);
}
void Compute_id234(inout CS_STREAMS streams)
{
    streams.Input_36_id139 = Compute_id207();
}
void Compute_id165(inout CS_STREAMS streams)
{
    streams.Multiply_35_id132 = Compute_id149(streams);
}
void Compute_id163(inout CS_STREAMS streams)
{
    streams.Input_34_id129 = Compute_id142();
}
void Compute_id161(inout CS_STREAMS streams)
{
    streams.Plus_33_id125 = Compute_id141(streams);
}
void Compute_id159(inout CS_STREAMS streams)
{
    streams.Multiply_32_id121 = Compute_id135(streams);
}
void Compute_id157(inout CS_STREAMS streams)
{
    streams.Input_31_id118 = Compute_id128();
}
void Compute_id155(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_30_id113 = Compute_id127(streams);
}
void Compute_id153(inout CS_STREAMS streams)
{
    streams.Input_29_id110 = Compute_id118();
}
void Compute_id151(inout CS_STREAMS streams)
{
    streams.Input_28_id107 = Compute_id116();
}
void Compute_id299(inout CS_STREAMS streams)
{
    streams.Plus_27_id189 = Compute_id283(streams);
}
void Compute_id297(inout CS_STREAMS streams)
{
    streams.Input_26_id186 = Compute_id276();
}
void Compute_id295(inout CS_STREAMS streams)
{
    streams.Plus_25_id182 = Compute_id275(streams);
}
void Compute_id293(inout CS_STREAMS streams)
{
    streams.Input_24_id179 = Compute_id268();
}
void Compute_id291(inout CS_STREAMS streams)
{
    streams.Multiply_23_id175 = Compute_id267(streams);
}
void Compute_id289(inout CS_STREAMS streams)
{
    streams.Input_22_id172 = Compute_id260();
}
void Compute_id287(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_21_id167 = Compute_id259(streams);
}
void Compute_id285(inout CS_STREAMS streams)
{
    streams.Input_20_id164 = Compute_id250();
}
void Compute_id342(inout CS_STREAMS streams)
{
    streams.Plus_19_id214 = Compute_id330(streams);
}
void Compute_id340(inout CS_STREAMS streams)
{
    streams.Input_18_id211 = Compute_id323();
}
void Compute_id338(inout CS_STREAMS streams)
{
    streams.Multiply_17_id207 = Compute_id322(streams);
}
void Compute_id336(inout CS_STREAMS streams)
{
    streams.Input_16_id204 = Compute_id315();
}
void Compute_id334(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_15_id199 = Compute_id314(streams);
}
void Compute_id332(inout CS_STREAMS streams)
{
    streams.Input_14_id196 = Compute_id305();
}
void Compute_id201(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_13_id266 = Compute_id197(streams);
}
void Compute_id199(inout CS_STREAMS streams)
{
    streams.SMVideoBufferSelector_ShaderFXResult_1_id221 = Compute_id42(streams);
}
void Compute_id110(inout CS_STREAMS streams)
{
    streams.Lerp_12_id257 = Compute_id87(streams);
}
void Compute_id108(inout CS_STREAMS streams)
{
    streams.Input_11_id254 = Compute_id78();
}
void Compute_id106(inout CS_STREAMS streams)
{
    streams.TextureValue_9_id246 = Compute_id77(streams);
}
void Compute_id104()
{
}
...
{
    streams.SRgbToLinear_ShaderFXResult_6_id243 = Compute_id71(streams);
}
void Compute_id98(inout CS_STREAMS streams)
{
    streams.BufferItem_5_id239 = Compute_id67(streams);
}
void Compute_id96(inout CS_STREAMS streams)
{
    streams.SMValueToIndex_ShaderFXResult_4_id235 = Compute_id63(streams);
}
void Compute_id94(inout CS_STREAMS streams)
{
    streams.Input_3_id232 = Compute_id56();
}
void Compute_id92(inout CS_STREAMS streams)
{
    streams.g_2_id229 = Compute_id55(streams);
}
...
{
    return streams.Multiply_35_id132;
}
...
{
    return streams.SMCalcLuminance_ShaderFXResult_13_id266;
}
