...
@S    SMBoxImpostor_ShaderFX => 431b2e655ef04ff671b67384566fc986
...
//
#line 1694 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_122d8184ab2eeb4c06f6432cbce4bf7d.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => 4dd63bbc277b64174dca75b10e27dfc6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1658 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_122d8184ab2eeb4c06f6432cbce4bf7d.hlsl"
...
#line 1659
mov r2.w, l(1.000000)
dp4 r3.x, r2.xyzw, cb0[0].xyzw  // r3.x <- p.Pos.x
dp4 r3.y, r2.xyzw, cb0[1].xyzw  // r3.y <- p.Pos.y
dp4 r3.z, r2.xyzw, cb0[2].xyzw  // r3.z <- p.Pos.z

#line 1621
mul r0.xyz, r0.xyzx, l(-6.283185, 6.283185, -6.283185, 0.000000)  // r0.x <- z.x; r0.y <- z.y; r0.z <- z.z

#line 1622
sincos r0.xyz, r2.xyz, r0.xyzx  // r2.x <- x.x; r2.y <- x.y; r2.z <- x.z; r0.x <- y.x; r0.y <- y.y; r0.z <- y.z

#line 1623
mul r4.xyz, r2.zzyz, r2.yxxy  // r4.y <- <rot3x3_id67 return value>._m11; r4.z <- <rot3x3_id67 return value>._m22
mul r0.w, r0.y, r0.x
mad r5.x, r0.w, r0.z, r4.x  // r5.x <- <rot3x3_id67 return value>._m00
mul r5.y, r0.z, -r2.x  // r5.y <- <rot3x3_id67 return value>._m01
mul r6.xyzw, r0.xyzy, r2.yzyx  // r6.w <- <rot3x3_id67 return value>._m20
...
mad r8.x, -r0.w, r2.z, r6.z  // r8.x <- <rot3x3_id67 return value>._m10
mul r0.w, r2.z, r6.x
mad r8.y, -r0.y, r0.z, -r0.w  // r8.y <- <rot3x3_id67 return value>._m12

#line 1668
add r0.yzw, -r3.xxyz, cb2[21].xxyz  // r0.y <- viewDir.x; r0.z <- viewDir.y; r0.w <- viewDir.z
...
#line 1573
    ishl r3.w, l(1), r1.w  // r3.w <- b

#line 1574
    and r6.xyz, r3.wwww, l(90, 51, 15, 0)
...
#line 1597
    ...
    mad r9.xyz, r9.xyzx, r1.xxxx, r3.xyzx  // r9.x <- posWorld.x; r9.y <- posWorld.y; r9.z <- posWorld.z
...
#line 1599
    ...
    mad r2.xyz, r6.xyzx, r1.zzzz, r9.xyzx  // r2.x <- posWorld.x; r2.y <- posWorld.y; r2.z <- posWorld.z

#line 1603
    dp4 r3.w, r2.xyzw, cb2[16].xyzw  // r3.w <- streams.ShadingPosition_id0.x
    dp4 r4.w, r2.xyzw, cb2[17].xyzw  // r4.w <- streams.ShadingPosition_id0.y
    dp4 r5.w, r2.xyzw, cb2[18].xyzw  // r5.w <- streams.ShadingPosition_id0.z
    dp4 r6.x, r2.xyzw, cb2[19].xyzw  // r6.x <- streams.ShadingPosition_id0.w
...
#line 1599
    ...
    mad r2.xyz, r9.xyzx, r1.zzzz, r6.xywx  // r2.x <- posWorld.x; r2.y <- posWorld.y; r2.z <- posWorld.z

#line 1603
    dp4 r1.w, r2.xyzw, cb2[16].xyzw  // r1.w <- streams.ShadingPosition_id0.x
    dp4 r3.w, r2.xyzw, cb2[17].xyzw  // r3.w <- streams.ShadingPosition_id0.y
    dp4 r4.w, r2.xyzw, cb2[18].xyzw  // r4.w <- streams.ShadingPosition_id0.z
    dp4 r5.w, r2.xyzw, cb2[19].xyzw  // r5.w <- streams.ShadingPosition_id0.w
...
#line 1597
    ...
    mad r8.xyz, r8.xyzx, r1.xxxx, r3.xyzx  // r8.x <- posWorld.x; r8.y <- posWorld.y; r8.z <- posWorld.z
...
#line 1599
    ...
    mad r2.xyz, r8.xyzx, r1.zzzz, r6.xywx  // r2.x <- posWorld.x; r2.y <- posWorld.y; r2.z <- posWorld.z
...
#line 1573
    ishl r2.x, l(1), r1.w  // r2.x <- b

#line 1574
    and r2.xyz, r2.xxxx, l(0x000f0000, 0x005a0000, 0x00330000, 0)
    movc r2.xyz, r2.xyzx, l(0.500000,0.500000,0.500000,0), l(-0.500000,-0.500000,-0.500000,0)  // r2.x <- <CubeVert_id91 return value>.x; r2.y <- <CubeVert_id91 return value>.y; r2.z <- <CubeVert_id91 return value>.z

#line 1597
    mul r6.xyz, r5.xyzx, r2.xxxx
    mad r6.xyz, r6.xyzx, r1.xxxx, r3.xyzx  // r6.x <- posWorld.x; r6.y <- posWorld.y; r6.z <- posWorld.z

#line 1598
    mul r2.xyw, r4.xyxz, r2.yyyy
    mad r2.xyw, r2.xyxw, r1.yyyy, r6.xyxz  // r2.x <- posWorld.x; r2.y <- posWorld.y; r2.w <- posWorld.z

#line 1599
    mul r6.xyz, r7.yzwy, r2.zzzz
    mad r0.xyz, r6.xyzx, r1.zzzz, r2.xywx  // r0.x <- posWorld.x; r0.y <- posWorld.y; r0.z <- posWorld.z

#line 1603
    dp4 r2.x, r0.xyzw, cb2[16].xyzw  // r2.x <- streams.ShadingPosition_id0.x
    dp4 r2.y, r0.xyzw, cb2[17].xyzw  // r2.y <- streams.ShadingPosition_id0.y
    dp4 r2.z, r0.xyzw, cb2[18].xyzw  // r2.z <- streams.ShadingPosition_id0.z
    dp4 r2.w, r0.xyzw, cb2[19].xyzw  // r2.w <- streams.ShadingPosition_id0.w
...
@G    Pixel => 955988ea867fe00b29584ad528bdcd2f
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1640 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_122d8184ab2eeb4c06f6432cbce4bf7d.hlsl"
...
#line 613
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id140 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t3.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id140 return value>
...
#line 613
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t3.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id140 return value>

#line 728
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 613
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t3.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id140 return value>
...
#line 613
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t3.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id140 return value>
...
#line 613
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t3.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id140 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.zwzz, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id140 return value>
...
#line 613
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r17.xyxx, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id140 return value>
...
#line 698
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r9.xyz, r9.xyzx, r3.wwww, r5.xyzx  // r9.x <- <FresnelSchlick_id252 return value>.x; r9.y <- <FresnelSchlick_id252 return value>.y; r9.z <- <FresnelSchlick_id252 return value>.z
...
#line 694
  ...
  div r6.z, r1.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id268 return value>
  mad r3.w, r6.y, r4.w, r3.w
  div r3.w, r6.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id268 return value>

#line 816
  mul r3.w, r3.w, r6.z
  mul r1.w, r6.y, r1.w
  div r1.w, r3.w, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 812
  ...
  div r2.w, r3.w, r2.w  // r2.w <- <NormalDistributionGGX_id282 return value>
...
#line 1190
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id610 return value>.x; r7.y <- <ComputeDirectLightContribution_id610 return value>.y; r7.z <- <ComputeDirectLightContribution_id610 return value>.z
...
ftoi r8.xy, r0.xyxx
mov r8.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r8.xyzw, t4.xyzw  // r0.x <- streams.lightData_id188.x; r0.y <- streams.lightData_id188.y

#line 1177
and r1.w, r0.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id323 return value>
...
#line 698
  ...
  mul r7.w, r7.w, r11.w
  mad r14.xyz, r14.xyzx, r7.wwww, r12.xyzx  // r14.x <- <FresnelSchlick_id252 return value>.x; r14.y <- <FresnelSchlick_id252 return value>.y; r14.z <- <FresnelSchlick_id252 return value>.z
...
#line 694
  ...
  div r13.w, r4.w, r13.w  // r13.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r7.w, r6.w, r11.w, r7.w
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id268 return value>

#line 816
  mul r7.w, r7.w, r13.w
  mul r4.w, r6.w, r4.w
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 812
  ...
  div r3.w, r7.w, r3.w  // r3.w <- <NormalDistributionGGX_id282 return value>
...
#line 698
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r16.xyz, r16.xyzx, r7.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id252 return value>.x; r16.y <- <FresnelSchlick_id252 return value>.y; r16.z <- <FresnelSchlick_id252 return value>.z
...
#line 694
  ...
  div r9.w, r6.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r7.w, r1.w, r8.w, r7.w
  div r7.w, r1.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id268 return value>

#line 816
  mul r7.w, r7.w, r9.w
  mul r6.w, r1.w, r6.w
  div r6.w, r7.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 812
  ...
  div r4.w, r7.w, r4.w  // r4.w <- <NormalDistributionGGX_id282 return value>
...
#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.xyxx, t0.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id190 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r13.zwzz, t0.xxxx, s1, r8.z  // r4.w <- <SampleTextureAndCompare_id190 return value>
...
#line 490
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t0.xxxx, s1, r8.z  // r3.w <- <SampleTextureAndCompare_id190 return value>
...
#line 698
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r7.xyz, r7.xyzx, r0.zzzz, r5.xyzx  // r7.x <- <FresnelSchlick_id252 return value>.x; r7.y <- <FresnelSchlick_id252 return value>.y; r7.z <- <FresnelSchlick_id252 return value>.z
...
#line 694
  ...
  div r2.w, r0.y, r2.w  // r2.w <- <VisibilityhSchlickGGX_id268 return value>
  mad r0.z, r6.y, r1.w, r0.z
  div r0.z, r6.y, r0.z  // r0.z <- <VisibilityhSchlickGGX_id268 return value>

#line 816
  mul r0.z, r0.z, r2.w
  mul r0.y, r6.y, r0.y
  div r0.y, r0.z, r0.y  // r0.y <- <VisibilitySmithSchlickGGX_id270 return value>
...
#line 812
  ...
  div r0.x, r0.z, r0.x  // r0.x <- <NormalDistributionGGX_id282 return value>
...
#line 891
mad r0.xyz, r5.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id432 return value>.x; r0.y <- <Compute_id432 return value>.y; r0.z <- <Compute_id432 return value>.z

#line 1102
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id611 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id611 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id611 return value>.z
...
#line 876
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r7.xyzx, t8.xyzw, s0, r0.w  // r3.x <- <Compute_id382 return value>.x; r3.y <- <Compute_id382 return value>.y; r3.z <- <Compute_id382 return value>.z
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    p.Pos = mul(float4(p.Pos, 1), World_id34).xyz;
