...
SMMappingValues ComputeDamping_id25(inout CS_STREAMS streams)
{
    ...
    {
        m.Trans = lerp(Compute_id32(), m.Trans, Damping_id97[0]);
        m.Rot = lerp(Compute_id33(), m.Rot, Damping_id97[1]);
        m.Dim = lerp(Compute_id34(), m.Dim, Damping_id97[2]);
        m.Piv = lerp(Compute_id35(), m.Piv, Damping_id97[3]);
    }
