...
//
//   } Lights_id186[3];                 // Offset:  464 Size:   188 [unused]
//   float2 ShadowMapTextureSize_id188; // Offset:  656 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id189;// Offset:  664 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id193[3];// Offset:  672 Size:   192 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id194[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id195[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id196[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id197[3];        // Offset: 1296 Size:    36 [unused]
//   float OffsetScales_id198[3];       // Offset: 1344 Size:    36 [unused]
...
//
#line 1491 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_2db63cd192c4dee875f61fefbd83c67e.hlsl"
...
@G    Pixel => 0ecf19930d84300e22b30d797d168685
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  512
//
//   } Lights_id186[3];                 // Offset:  464 Size:   188
//   float2 ShadowMapTextureSize_id188; // Offset:  656 Size:     8
//   float2 ShadowMapTextureTexelSize_id189;// Offset:  664 Size:     8
//   float4x4 WorldToShadowCascadeUV_id193[3];// Offset:  672 Size:   192
//   float4x4 InverseWorldToShadowCascadeUV_id194[3];// Offset:  864 Size:   192 [unused]
//   float4x4 ViewMatrices_id195[3];    // Offset: 1056 Size:   192 [unused]
//   float2 DepthRanges_id196[3];       // Offset: 1248 Size:    40 [unused]
//   float DepthBiases_id197[3];        // Offset: 1296 Size:    36
//   float OffsetScales_id198[3];       // Offset: 1344 Size:    36
//   float4 _padding_PerDraw_Lighting;  // Offset: 1392 Size:    16 [unused]
//
// }
//
...
//
#line 1568 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_2db63cd192c4dee875f61fefbd83c67e.hlsl"
...
#line 653
  ...
  div r5.w, r1.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id207 return value>
...
#line 945
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t3.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
#line 1160
  dp3_sat r5.w, r13.xyzx, r9.xywx  // r5.w <- streams.LdotH_id79
...
#line 657
  ...
  mul r5.w, r5.w, r10.w
  mad r13.xyz, r13.xyzx, r5.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id191 return value>.x; r13.y <- <FresnelSchlick_id191 return value>.y; r13.z <- <FresnelSchlick_id191 return value>.z
...
#line 653
  ...
  div r12.w, r3.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id207 return value>
  mad r5.w, r6.w, r10.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id207 return value>

#line 775
  mul r5.w, r5.w, r12.w
  mul r3.w, r6.w, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id209 return value>
...
mov r0.yz, r6.yyzy  // r0.y <- streams.NdotV_id74; r0.z <- streams.lightIndex_id176
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r2.w, r1.w, r0.x
  breakc_nz r2.w
...
#line 902
  iadd r0.z, r0.z, l(1)  // r0.z <- streams.lightIndex_id176
...
#line 653
  ...
  div r8.w, r3.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id207 return value>
...
#line 1321
endloop   // r0.z <- streams.lightIndex_id176
...
#line 491
  dp3 r5.w, -cb0[r1.w + 30].xyzx, r14.xyzx  // r5.w <- cd

#line 492
  mad_sat r5.w, r5.w, cb0[r1.w + 31].x, cb0[r1.w + 31].y  // r5.w <- attenuation
...
#line 451
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id129 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r18.zwzz, t0.xxxx, s1, r2.z  // r9.w <- <SampleTextureAndCompare_id129 return value>
...
#line 451
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r21.xyxx, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id129 return value>
...
#line 451
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id129 return value>
...
#line 1080
  ...
  mul r2.xyz, r5.wwww, r2.xyzx  // r2.x <- streams.lightColorNdotL_id46.x; r2.y <- streams.lightColorNdotL_id46.y; r2.z <- streams.lightColorNdotL_id46.z
...
#line 657
  ...
  mul r6.z, r6.z, r6.z
  mul r3.w, r3.w, r6.z
  mad r15.xyz, r15.xyzx, r3.wwww, r8.xyzx  // r15.x <- <FresnelSchlick_id191 return value>.x; r15.y <- <FresnelSchlick_id191 return value>.y; r15.z <- <FresnelSchlick_id191 return value>.z
...
#line 653
  ...
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id207 return value>
  mad r3.w, r0.y, r6.z, r3.w
  div r3.w, r0.y, r3.w  // r3.w <- <VisibilityhSchlickGGX_id207 return value>

#line 775
  mul r3.w, r3.w, r6.w
  mul r5.w, r0.y, r5.w
  div r3.w, r3.w, r5.w  // r3.w <- <VisibilitySmithSchlickGGX_id209 return value>
...
#line 771
  ...
  div r1.w, r5.w, r1.w  // r1.w <- <NormalDistributionGGX_id221 return value>
...
const static int TMaxLightCount_id185 = 3;
const static int TCascadeCountBase_id191 = 1;
const static int TLightCountBase_id192 = 3;
