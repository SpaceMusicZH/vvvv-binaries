...
@P   - ColorTransformGroup.Transforms: Stride.Rendering.Images.FilmGrain, Stride.Rendering.Images.Vignetting, Stride.Rendering.Images.Dither.Dither
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 264 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_a6bf9819f5f69a178470b3017e9d44ec.hlsl"
...
@G    Pixel => 912e53de39e52467ecef2f17467f2245
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 194 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_a6bf9819f5f69a178470b3017e9d44ec.hlsl"
...
mul r0.xy, r0.xyxx, r1.zwzz  // r0.y <- <Quintic_id17 return value>.x
...
max r0.y, r0.y, l(0.000100)  // r0.y <- <Luma_id16 return value>
...
float2 Quintic_id17(float2 x)
{
    return x * x * x * (x * (x * 6.0 - 15.0) + 10.0);
}
float fade_id10(float t)
{
    return Quintic_id17(t);
}
...
float3 ScreenSpaceDither_id11(inout PS_STREAMS streams, float3 input)
{
...
static float Luma_id16(float3 color)
{
...
{
    return float4(ScreenSpaceDither_id11(streams, color.rgb), color.a);
}
...
float4 Compute_id4(inout PS_STREAMS streams, float4 color)
{
    ...
    float luminance = lerp(0.0, Luma_id16(col), LuminanceFactor_id78);
