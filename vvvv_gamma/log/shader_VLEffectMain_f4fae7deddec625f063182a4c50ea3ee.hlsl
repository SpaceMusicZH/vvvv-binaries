...
//
#line 1458 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f4fae7deddec625f063182a4c50ea3ee.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
...
//
#line 1423 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f4fae7deddec625f063182a4c50ea3ee.hlsl"
...
@G    Pixel => 417d7df30a1df073121a00d7f19f5837
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1405 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_f4fae7deddec625f063182a4c50ea3ee.hlsl"
...
#line 504
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.w, r20.xyxx, t2.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id139 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r16.z, r20.zwzz, t2.xxxx, s1, r13.z  // r16.z <- <SampleTextureAndCompare_id139 return value>
...
#line 504
  sample_c_lz_indexable(texture2d)(float,float,float,float) r15.x, r22.xyxx, t2.xxxx, s1, r13.z  // r15.x <- <SampleTextureAndCompare_id139 return value>

#line 586
  mad r13.x, r13.x, r15.x, r13.w  // r13.x <- shadow

#line 504
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.w, r23.xyxx, t2.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id139 return value>
...
#line 504
  sample_c_lz_indexable(texture2d)(float,float,float,float) r13.y, r24.zwzz, t2.xxxx, s1, r13.z  // r13.y <- <SampleTextureAndCompare_id139 return value>
...
#line 504
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r20.xyxx, t2.xxxx, s1, r6.z  // r5.w <- <SampleTextureAndCompare_id139 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r20.zwzz, t2.xxxx, s1, r6.z  // r9.w <- <SampleTextureAndCompare_id139 return value>
...
#line 504
      sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r22.xyxx, t2.xxxx, s1, r6.z  // r9.w <- <SampleTextureAndCompare_id139 return value>

#line 586
      mad r5.w, r6.x, r9.w, r5.w

#line 504
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r23.xyxx, t2.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id139 return value>
...
#line 556
  ...
  mul r9.y, r9.y, r9.y
  mul r9.x, r9.y, r9.x
  mad r9.xyw, r14.xyxz, r9.xxxx, r11.xyxz  // r9.x <- <FresnelSchlick_id223 return value>.x; r9.y <- <FresnelSchlick_id223 return value>.y; r9.w <- <FresnelSchlick_id223 return value>.z
...
#line 552
  ...
  div r13.w, r5.z, r13.w  // r13.w <- <VisibilityhSchlickGGX_id239 return value>
  mad r10.w, r1.w, r12.w, r10.w
  div r10.w, r1.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id239 return value>

#line 654
  mul r10.w, r10.w, r13.w
  mul r5.z, r1.w, r5.z
  div r5.z, r10.w, r5.z  // r5.z <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 650
  ...
  div r5.w, r10.w, r5.w  // r5.w <- <NormalDistributionGGX_id253 return value>
...
#line 795
mov r6.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r6.xyzw, t3.xyzw  // r0.x <- streams.lightData_id188.x; r0.y <- streams.lightData_id188.y

#line 964
and r0.w, r0.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id294 return value>
...
#line 556
  ...
  mul r8.y, r8.y, r8.y
  mul r8.x, r8.y, r8.x
  mad r8.xyw, r15.xyxz, r8.xxxx, r10.xyxz  // r8.x <- <FresnelSchlick_id223 return value>.x; r8.y <- <FresnelSchlick_id223 return value>.y; r8.w <- <FresnelSchlick_id223 return value>.z
...
#line 552
  ...
  div r9.w, r5.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id239 return value>

#line 654
  mul r9.w, r9.w, r12.w
  mul r3.w, r5.w, r3.w
  div r3.w, r9.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 650
  ...
  div r2.w, r9.w, r2.w  // r2.w <- <NormalDistributionGGX_id253 return value>
...
#line 556
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r15.xyz, r15.xyzx, r5.wwww, r7.xyzx  // r15.x <- <FresnelSchlick_id223 return value>.x; r15.y <- <FresnelSchlick_id223 return value>.y; r15.z <- <FresnelSchlick_id223 return value>.z
...
#line 552
  ...
  div r5.w, r0.y, r5.w  // r5.w <- <VisibilityhSchlickGGX_id239 return value>

#line 654
  mul r5.w, r5.w, r8.w
  mul r3.w, r0.y, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id241 return value>
...
#line 650
  mul r2.w, r2.w, r2.w
  mul r2.w, r2.w, l(3.141593)
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id253 return value>
...
#line 729
mad r0.xyz, r4.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id377 return value>.x; r0.y <- <Compute_id377 return value>.y; r0.z <- <Compute_id377 return value>.z

#line 911
mul r5.xyz, r0.xyzx, cb2[88].xyzx  // r5.x <- <ComputeEnvironmentLightContribution_id556 return value>.x; r5.y <- <ComputeEnvironmentLightContribution_id556 return value>.y; r5.z <- <ComputeEnvironmentLightContribution_id556 return value>.z
...
#line 714
sample_l_indexable(texturecube)(float,float,float,float) r2.xyz, r7.xyzx, t7.xyzw, s0, r0.w  // r2.x <- <Compute_id327 return value>.x; r2.y <- <Compute_id327 return value>.y; r2.z <- <Compute_id327 return value>.z
