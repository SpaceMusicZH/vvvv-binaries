...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Kaleidoscope_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Divisions_id88 => Kaleidoscope_TextureFX.Divisions
@C    Iterations_id89 => Kaleidoscope_TextureFX.Iterations
@C    IterationZoom_id90 => Kaleidoscope_TextureFX.IterationZoom
@C    Rotation_id91 => Kaleidoscope_TextureFX.Rotation
@C    Zoom_id92 => Kaleidoscope_TextureFX.Zoom
@C    Center_id93 => Kaleidoscope_TextureFX.Center
@C    CellOffset_id94 => Kaleidoscope_TextureFX.CellOffset
@C    CellRotation_id95 => Kaleidoscope_TextureFX.CellRotation
@C    CellScale_id96 => Kaleidoscope_TextureFX.CellScale
@C    ControlFactor_id97 => Kaleidoscope_TextureFX.ControlFactor
@C    Aspect_id98 => Kaleidoscope_TextureFX.Aspect
***************************
******  Resources    ******
***************************
...
@R    s0_id99 => Kaleidoscope_TextureFX.s0 [Stage: Pixel, Slot: (2-2)]
...
*****     Sources     *****
***************************
@S    Kaleidoscope_TextureFX => a3caebd4fb88fc4c67ac1b8bb1a53e02
...
//
#line 225 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_2bd405f71b40a36dc2e55e664ed3b86e.hlsl"
...
@G    Pixel => a804eb8b3df971b2bf5e4f3339f83a24
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x00000005 
//   float IterationZoom_id90;          // Offset:   88 Size:     4
//      = 0x00000000 
//   float Rotation_id91;               // Offset:   92 Size:     4
//      = 0x00000000 
//   float Zoom_id92;                   // Offset:   96 Size:     4
//      = 0x3f000000 
//   float2 Center_id93;                // Offset:  100 Size:     8
//      = 0x00000000 0x00000000 
//   float2 CellOffset_id94;            // Offset:  112 Size:     8
//      = 0x00000000 0x00000000 
//   float CellRotation_id95;           // Offset:  120 Size:     4
//      = 0x00000000 
//   float2 CellScale_id96;             // Offset:  128 Size:     8
//      = 0x3f800000 0x3f800000 
//   float4 ControlFactor_id97;         // Offset:  144 Size:    16
//      = 0x3f800000 0x00000000 0x00000000 0x00000000 
//   bool Aspect_id98;                  // Offset:  160 Size:     4
//      = 0xffffffff 
//
// }
//
...
//
#line 204 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_2bd405f71b40a36dc2e55e664ed3b86e.hlsl"
...
movc r1.z, cb2[10].x, l(1.000000), l(0)
...
#line 180
mul r2.x, r1.z, cb2[9].x

#line 179
mad r2.x, r2.x, l(3.000000), cb2[7].z  // r2.x <- cr

#line 180
mad r1.zw, cb2[9].zzzw, r1.zzzw, cb2[7].xxxy  // r1.z <- co.x; r1.w <- co.y

#line 181
itof r2.y, cb2[5].x  // r2.y <- sz

#line 182
mad r2.z, cb2[6].x, l(5.000000), l(-1.000000)
exp r2.z, r2.z  // r2.z <- zz

#line 183
sample_l_indexable(texture2d)(float,float,float,float) r2.w, v1.xyxx, t1.yzwx, s2, l(1.000000)
mul r2.w, r2.w, cb2[9].y
exp r2.w, r2.w
mul r2.z, r2.w, r2.z

#line 185
add r3.xy, v1.yxyy, cb2[6].zyzz
add r3.xy, r3.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mul r3.xy, r1.yxyy, r3.xyxx

#line 190
mul r3.zw, cb2[5].wwwz, l(0.000000, 0.000000, 6.283185, 0.100000)

#line 158
sincos r4.x, r5.x, r3.z
mul r4.xy, r3.xyxx, r4.xxxx
mad r6.y, r5.x, r3.y, r4.x  // r6.y <- <r2d_id29 return value>.x
mad r6.x, r5.x, r3.x, -r4.y  // r6.x <- <r2d_id29 return value>.y

#line 185
mul r2.zw, r2.zzzz, r6.xxxy
...
mad r3.x, r3.x, l(0.159155), l(0.500000)  // r3.x <- an

#line 164
mad r3.x, r3.x, r2.y, l(0.500000)
round_ni r3.x, r3.x
div r3.x, r3.x, r2.y

#line 157
mul r3.x, r3.x, l(6.283185)

#line 158
sincos r3.x, r4.x, r3.x
mul r3.xy, r2.zwzz, r3.xxxx
mad r2.w, r4.x, r2.w, r3.x  // r2.w <- <r2d_id29 return value>.x
mad r3.y, r4.x, r2.z, -r3.y  // r3.y <- <r2d_id29 return value>.y

#line 165
mov r3.x, |r2.w|  // r3.x <- xx.x

#line 166
add r2.zw, r3.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)  // r2.z <- xx.x; r2.w <- xx.y

#line 188
iadd r3.x, cb2[5].y, l(-1)
imin r3.x, r3.x, l(90)
itof r3.x, r3.x
...
#line 188
mov r3.zw, r2.wwwz  // r3.z <- xx.y; r3.w <- xx.x
mov r4.x, l(0)  // r4.x <- i
loop 
  ge r4.y, r4.x, r3.x
  breakc_nz r4.y
...
#line 190
  mul r5.xy, r3.yyyy, r3.wzww  // r5.x <- xx.x; r5.y <- xx.y
...
mad r1.xy, r1.xyxx, cb2[8].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)  // r1.x <- xx.x; r1.y <- xx.y

#line 199
sample_l_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s2, l(0.000000)  // r1.x <- col.x; r1.y <- col.y; r1.z <- col.z; r1.w <- col.w
...
cbuffer Globals 
{
    ...
    float IterationZoom_id90 = 0.0f;
    float Rotation_id91 = 0.0f;
    float Zoom_id92 = 0.5f;
    float2 Center_id93 = float2(0.0f, 0.0f);
    float2 CellOffset_id94 = float2(0.0f, 0.0f);
    float CellRotation_id95 = 0.0f;
    float2 CellScale_id96 = float2(1.0f, 1.0f);
    float4 ControlFactor_id97 = float4(1.0f, 0.0f, 0.0f, 0.0f);
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float2 asp = lerp(1, R / R.x, Aspect_id98);
    float4 mask = Texture1_id16.SampleLevel(Sampler1_id53, uv, 1);
    float cr = CellRotation_id95 + ControlFactor_id97.x * 3 * mask.r;
    float2 co = CellOffset_id94 + mask.xy * ControlFactor_id97.zw;
    float sz = Divisions_id88;
    float zz = pow(2, Zoom_id92 * 5 - 1);
    zz *= pow(2, ControlFactor_id97.y * (Texture1_id16.SampleLevel(s0_id99, uv, 1).r));
    float2 Off = Center_id93;
    float2 dx = r2d_id29((uv - .5 + Off) * asp, Rotation_id91) * zz + .5;
    float2 xx = kal_id30(dx, sz);

    for (float i = 0; i < min(Iterations_id89 - 1, 90); i++)
    {
        xx *= pow(2, IterationZoom_id90 * 0.1);
        if (xx.y > 1)
        {
            xx = kal_id30(float2(xx.x, 2 - xx.y), sz);
        }
    }
    xx = r2d_id29(xx - .5, cr - Rotation_id91) / asp + .5;
    xx += co * 2 - 1;
    xx = (xx - .5) * CellScale_id96 + .5;
    float4 col = Texture0_id14.SampleLevel(s0_id99, xx, 0);
    return col;
}
