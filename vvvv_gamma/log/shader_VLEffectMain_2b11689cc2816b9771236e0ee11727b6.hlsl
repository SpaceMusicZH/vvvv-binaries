...
@C    InputValue_id198 => ShaderFX.InputValueFloat4
@C    InputValue_id206 => ShaderFX.InputValueFloat
...
@C    SphericalColors_id190 => SphericalHarmonicsEnvironmentColor.SphericalColors.lightDiffuseColor.environmentLights[1]
@C    MipCount_id191 => RoughnessCubeMapEnvironmentColor.MipCount.lightSpecularColor.environmentLights[1]
@C    SkyMatrix_id193 => LightSkyboxShader.SkyMatrix.environmentLights[1]
@C    Intensity_id194 => LightSkyboxShader.Intensity.environmentLights[1]
@C    _padding_PerView_Lighting => _padding_PerView_Lighting
***************************
******  Resources    ******
***************************
@R    PerMaterial => PerMaterial [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id227 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id227 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    SpotLights_id181 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    CubeMap_id192 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
@R    CubeMap_id192 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id227 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
@R    CubeMap_id192 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (6-6)]
...
//   float3 AmbientLight_id185;         // Offset: 1408 Size:    12 [unused]
//   float3 SphericalColors_id190[9];   // Offset: 1424 Size:   140 [unused]
//   float MipCount_id191;              // Offset: 1564 Size:     4 [unused]
//   float4x4 SkyMatrix_id193;          // Offset: 1568 Size:    64 [unused]
//   float Intensity_id194;             // Offset: 1632 Size:     4 [unused]
...
//
#line 1358 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_VLEffectMain_2b11689cc2816b9771236e0ee11727b6.hlsl"
...
@G    Pixel => b6cde80b5e4a3e7dcdce194db9726d85
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 InputValue_id198;           // Offset:    0 Size:    16
//   float InputValue_id206;            // Offset:   16 Size:     4
//   float InputValue_id215;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
//   float3 AmbientLight_id185;         // Offset: 1408 Size:    12
//   float3 SphericalColors_id190[9];   // Offset: 1424 Size:   140
//   float MipCount_id191;              // Offset: 1564 Size:     4
//   float4x4 SkyMatrix_id193;          // Offset: 1568 Size:    64
//   float Intensity_id194;             // Offset: 1632 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset: 1648 Size:    16 [unused]
//
// }
//
...
// EnvironmentLightingDFG_LUT_id227    texture  float4          2d             t0      1 
...
// CubeMap_id192                     texture  float4        cube             t6      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 1425 "C:\Program Files\vvvv\vvvv_gamma_2022.5.0-0485-g8f46e4a34a\log\shader_VLEffectMain_2b11689cc2816b9771236e0ee11727b6.hlsl"
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r11.xyxx, t1.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id67 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r11.zwzz, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id67 return value>
...
#line 484
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id67 return value>
...
#line 484
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r11.xyxx, t1.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id67 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.y, r11.zwzz, t1.xxxx, s1, r7.z  // r7.y <- <SampleTextureAndCompare_id67 return value>
...
#line 484
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t1.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id67 return value>
...
#line 547
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id162 return value>.x; r8.y <- <FresnelSchlick_id162 return value>.y; r8.z <- <FresnelSchlick_id162 return value>.z
...
#line 543
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id178 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id178 return value>

#line 653
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id180 return value>
...
#line 649
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id192 return value>
...
#line 1020
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id506 return value>.x; r7.y <- <ComputeDirectLightContribution_id506 return value>.y; r7.z <- <ComputeDirectLightContribution_id506 return value>.z
...
#line 1007
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id233 return value>
...
#line 547
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id162 return value>.x; r13.y <- <FresnelSchlick_id162 return value>.y; r13.z <- <FresnelSchlick_id162 return value>.z
...
#line 543
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id178 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id178 return value>

#line 653
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id180 return value>
...
#line 649
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id192 return value>
...
#line 985
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id245 return value>
...
#line 547
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id162 return value>.x; r16.y <- <FresnelSchlick_id162 return value>.y; r16.z <- <FresnelSchlick_id162 return value>.z
...
#line 543
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id178 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id178 return value>

#line 653
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id180 return value>
...
#line 649
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id192 return value>
...
#line 547
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id162 return value>.x; r15.y <- <FresnelSchlick_id162 return value>.y; r15.z <- <FresnelSchlick_id162 return value>.z
...
#line 543
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id178 return value>
  mad r3.w, r10.z, r5.w, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id178 return value>
...
#line 728
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id328 return value>.x; r0.z <- <Compute_id328 return value>.y; r0.w <- <Compute_id328 return value>.z

#line 932
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id507 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id507 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id507 return value>.z
...
#line 713
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t6.xyzw, s0, r0.x  // r1.x <- <Compute_id278 return value>.x; r1.y <- <Compute_id278 return value>.y; r1.z <- <Compute_id278 return value>.z
...
const static bool TInvert_id212 = true;
const static bool TIsEnergyConservative_id224 = false;
static const float PI_id226 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
cbuffer PerMaterial 
{
    float4 InputValue_id198;
    float InputValue_id206;
...
cbuffer PerView 
{
    ...
    float3 SphericalColors_id190[TOrder_id189 * TOrder_id189];
    float MipCount_id191;
    float4x4 SkyMatrix_id193;
    float Intensity_id194;
...
Texture2D EnvironmentLightingDFG_LUT_id227;
...
{
    streams.Input_2_id214 = Compute_id316();
}
void Compute_id307(inout PS_STREAMS streams)
{
    streams.Input_1_id205 = Compute_id304();
}
void Compute_id295(inout PS_STREAMS streams)
{
    streams.Input_0_id197 = Compute_id292();
}
float4 EvaluateSphericalHarmonics_id116(float3 sphericalColors[TOrder_id187 * TOrder_id187], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float Compute_id322(inout PS_STREAMS streams)
{
    return streams.Input_2_id214;
}
void Compute_id321(inout PS_STREAMS streams)
{
...
float4 Compute_id278(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id191;
    return CubeMap_id192.SampleLevel(LinearSampler_id122, direction, mipLevel);
}
float4 Compute_id273(float3 direction)
{
    return EvaluateSphericalHarmonics_id116(SphericalColors_id190, direction);
}
...
float3 Compute_id328(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id227.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
{
    return NormalDistributionGGX_id192(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id390(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id180(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id360(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id168(f0, streams.LdotH_id77);
}
...
void PrepareEnvironmentLight_id288(inout PS_STREAMS streams)
{
    PrepareEnvironmentLight_id120(streams);
    float ambientAccessibility = streams.matAmbientOcclusion_id57;
    float3 sampleDirection = mul(streams.normalWS_id19, (float3x3)SkyMatrix_id193);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id47 = Compute_id273(sampleDirection).rgb * Intensity_id194 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    sampleDirection = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id193);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id278(streams, sampleDirection).rgb * Intensity_id194 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id507(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id328(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id451(inout PS_STREAMS streams)
{
...
void PrepareDirectLights_id252()
{
}
...
float3 ComputeDirectLightContribution_id506(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id360(streams, specularColor);
    float geometricShadowing = Compute_id390(streams);
    float normalDistribution = Compute_id420(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id450(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id226 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void Compute_id538(inout PS_STREAMS streams)
{
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id450(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id506(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id451(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id507(streams);
        }
    }

    {
        PrepareEnvironmentLight_id288(streams);
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id226 + environmentLightingContribution;
...
{
    float metalness = Compute_id327(streams).r;
...
{
    float glossiness = Compute_id315(streams).r;
...
{
    float4 colorBase = Compute_id303(streams);
