...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin FuseCommonDrawSphereImposterExtension_ShaderFX [{Provider = SphereProvider}, {ShadingColor0 = ComputeColor}]
...
@S    FuseCommonDrawSphereImposterExtension_ShaderFX => fa497169358031c4d67fa82cf35efed0
...
@G    Geometry => f5a7521256a5dfb363bf7f274334e946
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// SPHERESIZE_ID97_SEM      0   x           1     NONE   float   x   
...
dp4 r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[15].xyzw  // r1.w <- cameraSpherePos.w
...
#line 286
  mul r2.xy, l(1.500000, 1.500000, 0.000000, 0.000000), icb[r0.z + 0].xyxx  // r2.x <- streams.TexCoord_id86.x; r2.y <- streams.TexCoord_id86.y

#line 287
  lt r2.zw, l(0.000000, 0.000000, 0.000000, 0.000000), icb[r0.z + 0].xxxy
  lt r3.xy, icb[r0.z + 0].xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
  iadd r2.zw, -r2.zzzw, r3.xxxy
  itof r2.zw, r2.zzzw

#line 289
  mad r1.xy, r2.zwzz, l(0.150000, 0.150000, 0.000000, 0.000000), r0.xyxx  // r1.x <- viewCornerPos.x; r1.y <- viewCornerPos.y

#line 290
  dp4 r0.w, r1.xyzw, cb1[8].xyzw  // r0.w <- streams.ShadingPosition_id0.x
  dp4 r2.z, r1.xyzw, cb1[9].xyzw  // r2.z <- streams.ShadingPosition_id0.y
...
@G    Pixel => f2f6429c2eda55589fa5641e20841d58
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   v1.x <- __input__.sphereSize_id97; v1.y <- __input__.TexCoord_id86.x; v1.z <- __input__.TexCoord_id86.y; 
...
***************************
*************************/
static const float3 QuadPositions_id98[4] = { float3(-1, 1, 0), float3(1, 1, 0), float3(-1, -1, 0), float3(1, -1, 0)};
struct PS_STREAMS 
{
    float sphereSize_id97;
...
struct PS_INPUT 
{
    ...
    float sphereSize_id97 : SPHERESIZE_ID97_SEM;
...
void sphereImpostor_id21(float2 screenCoord, float3 spherePos, float sphereRadius, out float3 pos, out float3 normal)
{
...
{
    float3 p, n;
    float size = streams.sphereSize_id97;
    sphereImpostor_id21(streams.TexCoord_id86, streams.PositionWS_id16.xyz, size, p, n);
    return StrideShadingWorldNormal_id17(streams, p, n);
}
void PSMain_id1()
{
}
void PostTransformPosition_id20(inout VS_STREAMS streams)
{
    streams.ShadingPosition_id0 = streams.Position_id15;
}
void TransformPosition_id19()
{
}
void PreTransformPosition_id18()
{
}
...
float getSphereSize_id24()
{
    return 0.1;
}
float3 getSpherePos_id23()
{
    return 1;
}
void BaseTransformVS_id15(inout VS_STREAMS streams)
{
    PreTransformPosition_id18();
    TransformPosition_id19();
    PostTransformPosition_id20(streams);
}
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    streams.sphereSize_id97 = __input__.sphereSize_id97;
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    streams.PositionWS_id16 = float4(getSpherePos_id23(), 1);
    streams.sphereSize_id97 = getSphereSize_id24();
    float padding = 1.5;
    float2 offset;
    float4 cameraSpherePos = mul(streams.PositionWS_id16, WorldView_id33);

    for (int i = 0; i < 4; i++)
    {
        streams.TexCoord_id86 = QuadPositions_id98[i].xy * padding;
        offset = sign(QuadPositions_id98[i].xy) * streams.sphereSize_id97;
...

        {
            ...
            output.sphereSize_id97 = streams.sphereSize_id97;
