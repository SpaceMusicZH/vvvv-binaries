...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Anaglyph_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Boost_id88 => Anaglyph_TextureFX.Boost
@C    Distance_id89 => Anaglyph_TextureFX.Distance
@C    MapBlur_id90 => Anaglyph_TextureFX.MapBlur
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Anaglyph_TextureFX => b475e45d11309c526620577174a0fbc5
...
//
#line 181 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_58dc279930bed1399e27021744976e84.hlsl"
...
@G    Pixel => f9cc7db3eb59bd4c73750cb444fede98
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x3f800000 
//   float Distance_id89;               // Offset:   84 Size:     4
//      = 0x3dcccccd 
//   float MapBlur_id90;                // Offset:   88 Size:     4
//      = 0x3dcccccd 
//
// }
//
...
//
#line 149 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_58dc279930bed1399e27021744976e84.hlsl"
max r0.x, cb1[1].y, cb1[1].x
log r0.x, r0.x
mov_sat r0.y, cb2[5].z
mad r0.x, r0.y, r0.x, l(1.000000)  // r0.x <- lod

#line 151
sample_l_indexable(texture2d)(float,float,float,float) r0.x, v1.xyxx, t1.xyzw, s1, r0.x  // r0.x <- map.x

#line 152
add r0.x, r0.x, -cb2[5].y  // r0.x <- depth

#line 150
mul r1.x, cb2[5].x, l(0.003906)  // r1.x <- off.x
...
cbuffer Globals 
{
    ...
    float Distance_id89 = 0.1f;
    float MapBlur_id90 = 0.1f;
};
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float lod = 1 + saturate(MapBlur_id90) * log2(max(R.x, R.y));
    float2 off = float2(Boost_id88, 0) / 256.;
    float4 map = Texture1_id16.SampleLevel(Sampler1_id53, uv, lod);
    float depth = map.x - Distance_id89;
    float4 col = 0;
