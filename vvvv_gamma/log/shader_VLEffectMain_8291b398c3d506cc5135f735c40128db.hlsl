...
@S    SMBoxImpostor_ShaderFX => 9c6169c77037774425d1dc7a36e79243
...
//
#line 1435 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_8291b398c3d506cc5135f735c40128db.hlsl"
mov o0.xy, v0.xxxx
mov o1.xyzw, v1.xyzw
mov o2.xyzw, v1.xyzw
ret 
// Approximately 4 instruction slots used
@G    Geometry => 358f2ce140879f0081727238ba7481a7
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1400 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_8291b398c3d506cc5135f735c40128db.hlsl"
...
add r0.yzw, -r0.yyzw, cb2[21].xxyz  // r0.y <- viewDir.x; r0.z <- viewDir.y; r0.w <- viewDir.z
...
@G    Pixel => bfbebcffab77c890e8088a86164c3c55
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1384 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_8291b398c3d506cc5135f735c40128db.hlsl"
...
#line 498
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.z, r12.xyxx, t2.xxxx, s1, r8.z  // r9.z <- <SampleTextureAndCompare_id128 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r12.zwzz, t2.xxxx, s1, r8.z  // r9.w <- <SampleTextureAndCompare_id128 return value>
...
#line 498
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id128 return value>
...
#line 498
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.xyxx, t2.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id128 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r12.zwzz, t2.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id128 return value>
...
#line 498
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t2.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id128 return value>
...
#line 550
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id212 return value>.x; r8.y <- <FresnelSchlick_id212 return value>.y; r8.z <- <FresnelSchlick_id212 return value>.z
...
#line 546
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id228 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id228 return value>

#line 648
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id230 return value>
...
#line 644
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id242 return value>
...
#line 958
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id283 return value>
...
#line 550
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id212 return value>.x; r13.y <- <FresnelSchlick_id212 return value>.y; r13.z <- <FresnelSchlick_id212 return value>.z
...
#line 546
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id228 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id228 return value>
...
#line 550
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id212 return value>.x; r16.y <- <FresnelSchlick_id212 return value>.y; r16.z <- <FresnelSchlick_id212 return value>.z
...
#line 546
  ...
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id228 return value>
...
#line 723
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id366 return value>.x; r0.z <- <Compute_id366 return value>.y; r0.w <- <Compute_id366 return value>.z
...
#line 708
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t7.xyzw, s0, r0.x  // r1.x <- <Compute_id316 return value>.x; r1.y <- <Compute_id316 return value>.y; r1.z <- <Compute_id316 return value>.z
...
float SampleAndFilter_id135(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[9];
        normalizationFactor = Get5x5FilterKernel_id129(base_uv, st, kernel);
...
float FilterShadow_id121(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[9];
        float normalizationFactor = Get5x5FilterKernel_id129(base_uv, st, kernel);
...
{
    streams.Input_2_id224 = Compute_id354();
}
void Compute_id345(inout PS_STREAMS streams)
{
    streams.Input_1_id215 = Compute_id342();
}
void Compute_id333(inout PS_STREAMS streams)
{
    streams.ColorPerParticle_ShaderFXResult_0_id207 = Compute_id330(streams);
}
float4 EvaluateSphericalHarmonics_id166(float3 sphericalColors[TOrder_id197 * TOrder_id197], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
{
    return EvaluateSphericalHarmonics_id166(SphericalColors_id200, direction);
}
...
void PrepareEnvironmentLight_id326(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id311(sampleDirection).rgb * Intensity_id204 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id316(streams, sampleDirection).rgb * Intensity_id204 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id545(inout PS_STREAMS streams)
{
    ...
    return Compute_id366(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
void GSMain(point GS_INPUT input[1], inout TriangleStream<GS_OUTPUT> triangleStream)
{
    ...
    float3 AxisY = or[1];
    float3 AxisZ = or[2];
    float3 viewDir = Eye_id31.xyz - (p.Pos + World_id32._m30_m31_m32);
