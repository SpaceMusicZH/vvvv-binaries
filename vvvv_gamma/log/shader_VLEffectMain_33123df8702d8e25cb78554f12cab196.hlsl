...
//
#line 1369 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_33123df8702d8e25cb78554f12cab196.hlsl"
...
@G    Pixel => 3b7337b04c04066a7caafb0157d30c67
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1431 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_33123df8702d8e25cb78554f12cab196.hlsl"
...
#line 643
  add r9.xyz, -r0.yzwy, cb0[28].xyzx  // r9.x <- lightVector.x; r9.y <- lightVector.y; r9.z <- lightVector.z
...
#line 645
  div r9.xyz, r9.xyzx, r6.wwww  // r9.x <- lightVectorNorm.x; r9.y <- lightVectorNorm.y; r9.z <- lightVectorNorm.z
...
#line 1041
  dp3 r6.w, r6.xyzx, r9.xyzx
  max r6.w, r6.w, l(0.000100)  // r6.w <- streams.NdotL_id48

#line 838
  add r2.xyz, r0.yzwy, -cb0[28].xyzx  // r2.x <- lightDelta.x; r2.y <- lightDelta.y; r2.z <- lightDelta.z

#line 839
  dp3 r7.w, r2.xyzx, r2.xyzx
  sqrt r7.w, r7.w  // r7.w <- distanceToLight

#line 840
  div r9.xyz, r2.xyzx, r7.wwww  // r9.x <- direction.x; r9.y <- direction.y; r9.z <- direction.z

#line 842
  max r7.w, |r9.z|, |r9.y|
  max r7.w, r7.w, |r9.x|  // r7.w <- longestAxis

#line 851
  eq r9.xy, r7.wwww, |r9.xyxx|
...
#line 617
    ...
    sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.zwzz, t0.xxxx, s0, r2.z  // r7.w <- <SampleTextureAndCompare_id109 return value>

#line 743
    mul r7.w, r7.w, r9.z
    mad r2.x, r2.x, r5.z, r7.w  // r2.x <- shadow
...
#line 874
  else   // Prior locations: r9.z <- direction.z; r7.w <- longestAxis; r2.x <- faceIndex; r2.z <- depth
...
#line 1043
  ...
  mul r2.xyz, r2.xyzx, r5.xyzx
  mul r2.xyz, r6.wwww, r2.xyzx  // r2.x <- streams.lightColorNdotL_id43.x; r2.y <- streams.lightColorNdotL_id43.y; r2.z <- streams.lightColorNdotL_id43.z
