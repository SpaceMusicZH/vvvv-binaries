...
@R    DynamicTexture_id130 => ObjectTexture_fx7 [Stage: Compute, Slot: (3-3)]
...
*****     Stages      *****
***************************
@G    Compute => dca83dcb564c5dfab133abd90e126c00
//
...
//
#line 1397 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ComputeFXEffect_fbc568ec3c6964a3c4d0984f6ca6d63f.hlsl"
...
struct CS_STREAMS 
{
    ...
    float4 TextureValue_32_id129;
    float SMCalcLuminance_ShaderFXResult_34_id137;
    float Multiply_35_id148;
    float Multiply_36_id152;
    float Multiply_37_id156;
    float3 SMVector3Join_ShaderFXResult_38_id160;
    float3 Input_39_id165;
    float3 Multiply_40_id168;
    float3 Plus_41_id172;
    float3 Input_42_id176;
    float3 Multiply_43_id179;
    float r_44_id187;
    float Input_45_id190;
    float Multiply_46_id193;
    float g_47_id197;
    float Multiply_48_id200;
    float Multiply_49_id204;
    float3 SMVector3Join_ShaderFXResult_50_id208;
    float3 Input_51_id213;
    float3 Multiply_52_id216;
    float3 Input_53_id220;
    float3 Plus_54_id223;
    uint Input_3_id316;
...
{
    return streams.Multiply_52_id216;
}
float3 Compute_id380(inout CS_STREAMS streams)
{
    return streams.Input_51_id213;
}
float3 Compute_id378(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_50_id208;
}
...
{
    return streams.Multiply_40_id168;
}
...
{
    return streams.Input_39_id165;
}
float3 Compute_id243(inout CS_STREAMS streams)
{
    return streams.SMVector3Join_ShaderFXResult_38_id160;
}
float Compute_id237(inout CS_STREAMS streams)
{
    return streams.Multiply_37_id156;
}
float Compute_id235(inout CS_STREAMS streams)
{
    return streams.Multiply_36_id152;
}
float Compute_id233(inout CS_STREAMS streams)
{
    return streams.Multiply_35_id148;
}
float Compute_id229(inout CS_STREAMS streams)
{
    return streams.SMCalcLuminance_ShaderFXResult_34_id137;
}
...
{
    return streams.TextureValue_32_id129;
}
float Compute_id186()
{
    return Value_id331;
...
{
    return DynamicTexture_id130.SampleLevel(DynamicSampler_id131, Compute_id115(streams), Compute_id113());
}
...
{
    streams.Plus_54_id223 = Compute_id391(streams);
}
void Compute_id413(inout CS_STREAMS streams)
{
    streams.Input_53_id220 = Compute_id384();
}
void Compute_id411(inout CS_STREAMS streams)
{
    streams.Multiply_52_id216 = Compute_id383(streams);
}
void Compute_id409(inout CS_STREAMS streams)
{
    streams.Input_51_id213 = Compute_id376();
}
void Compute_id407(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_50_id208 = Compute_id375(streams);
}
void Compute_id405(inout CS_STREAMS streams)
{
    streams.Multiply_49_id204 = Compute_id367(streams);
}
void Compute_id403(inout CS_STREAMS streams)
{
    streams.Multiply_48_id200 = Compute_id361(streams);
}
void Compute_id401(inout CS_STREAMS streams)
{
    streams.g_47_id197 = Compute_id355(streams);
}
void Compute_id399(inout CS_STREAMS streams)
{
    streams.Multiply_46_id193 = Compute_id351(streams);
}
void Compute_id397(inout CS_STREAMS streams)
{
    streams.Input_45_id190 = Compute_id344();
}
void Compute_id395(inout CS_STREAMS streams)
{
    streams.r_44_id187 = Compute_id343(streams);
}
...
{
    streams.Multiply_43_id179 = Compute_id262(streams);
}
...
{
    streams.Multiply_40_id168 = Compute_id248(streams);
}
void Compute_id286(inout CS_STREAMS streams)
{
    streams.Input_39_id165 = Compute_id241();
}
void Compute_id284(inout CS_STREAMS streams)
{
    streams.SMVector3Join_ShaderFXResult_38_id160 = Compute_id240(streams);
}
void Compute_id282(inout CS_STREAMS streams)
{
    streams.Multiply_37_id156 = Compute_id232(streams);
}
void Compute_id280(inout CS_STREAMS streams)
{
    streams.Multiply_36_id152 = Compute_id226(streams);
}
void Compute_id278(inout CS_STREAMS streams)
{
    streams.Multiply_35_id148 = Compute_id220(streams);
}
void Compute_id276(inout CS_STREAMS streams)
{
    streams.SMCalcLuminance_ShaderFXResult_34_id137 = Compute_id214(streams);
}
void Compute_id274(inout CS_STREAMS streams)
{
    streams.TextureValue_32_id129 = Compute_id191(streams);
}
void Compute_id272()
{
}
...
{
    return streams.Multiply_43_id179;
}
