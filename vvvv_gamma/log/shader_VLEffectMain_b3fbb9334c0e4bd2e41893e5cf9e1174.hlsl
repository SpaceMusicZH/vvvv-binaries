...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,5>, mixin LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightPointGroup<8>
...
//   float4 _padding_PerDraw_Lighting;  // Offset:  720 Size:    16 [unused]
//
// }
//
// cbuffer PerView
...
//
#line 1346 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_b3fbb9334c0e4bd2e41893e5cf9e1174.hlsl"
...
@G    Pixel => 9b2e72b39b77b54b8adb255d071513ad
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1413 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_b3fbb9334c0e4bd2e41893e5cf9e1174.hlsl"
...
float4 EvaluateSphericalHarmonics_id115(float3 sphericalColors[TOrder_id187 * TOrder_id187], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
{
    return EvaluateSphericalHarmonics_id115(SphericalColors_id190, direction);
}
