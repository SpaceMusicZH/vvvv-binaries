...
//
#line 273 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_cfe11b679a61017b2f84728db1160ccf.hlsl"
mov o0.xyzw, v0.xyzw
mov o1.x, v1.x
ret 
// Approximately 3 instruction slots used
@G    Geometry => 715f027c61038f5b42ff231ac7a187b5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 252 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_ShadowMapCaster_cfe11b679a61017b2f84728db1160ccf.hlsl"
...
#line 222
  add r8.x, r6.z, l(0.001000)  // r8.x <- streams.DepthVS_id22
...
#line 222
  add r5.z, r5.y, l(0.001000)  // r5.z <- streams.DepthVS_id22
...
#line 222
  add r5.x, r4.w, l(0.001000)  // r5.x <- streams.DepthVS_id22
...
void SpawnQuad_id38(inout GS_STREAMS streams, uint start, inout TriangleStream<GS_OUTPUT> triangleStream, float3 normal, Particle p)
{
    ...
    for (uint i = start; i < start + 4; i++)
    {
        ...
        streams.DepthVS_id22 = streams.ShadingPosition_id0.w + 0.001;
