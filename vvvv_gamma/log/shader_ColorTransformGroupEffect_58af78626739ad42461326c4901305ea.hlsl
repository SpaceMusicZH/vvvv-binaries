...
@C    KeyValue_id81 => ToneMapShader.KeyValue.Transforms[0]
@C    LuminanceLocalFactor_id82 => ToneMapShader.LuminanceLocalFactor.Transforms[0]
@C    LuminanceAverageGlobal_id83 => ToneMapShader.LuminanceAverageGlobal.Transforms[0]
@C    Contrast_id84 => ToneMapShader.Contrast.Transforms[0]
@C    Brightness_id85 => ToneMapShader.Brightness.Transforms[0]
@C    Exposure_id86 => ToneMapShader.Exposure.Transforms[0]
***************************
******  Resources    ******
***************************
...
@S    ToneMapACESOperatorShader => 09722401a760af03412e7b4239f7f26f
...
//
#line 215 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_58af78626739ad42461326c4901305ea.hlsl"
...
@G    Pixel => c2e1d7bf715408fb380617b452f45fb7
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x40a00000 
//   float KeyValue_id81;               // Offset:   88 Size:     4 [unused]
//      = 0x3e3851ec 
//   float LuminanceLocalFactor_id82;   // Offset:   92 Size:     4 [unused]
//      = 0x00000000 
//   float LuminanceAverageGlobal_id83; // Offset:   96 Size:     4
//   float Contrast_id84;               // Offset:  100 Size:     4
//      = 0x00000000 
//   float Brightness_id85;             // Offset:  104 Size:     4
//      = 0x00000000 
//   float Exposure_id86;               // Offset:  108 Size:     4 [unused]
//      = 0x3f800000 
//
// }
//
...
//
#line 184 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_ColorTransformGroupEffect_58af78626739ad42461326c4901305ea.hlsl"
add r0.x, cb0[6].y, l(1.000000)
...
#line 180
exp r0.y, cb0[6].x  // r0.y <- avgLuminance

#line 183
mad r1.xyz, r0.yyyy, cb0[6].zzzz, r1.xyzx
...
#line 150
mad r1.xy, r0.wwww, l(2.510000, 2.430000, 0.000000, 0.000000), l(0.030000, 0.590000, 0.000000, 0.000000)
mul r1.x, r0.w, r1.x
mad r1.y, r0.w, r1.y, l(0.140000)
...
#line 150
div r0.w, r1.x, r1.y  // r0.w <- toneMappedLuminance

#line 151
mad r1.xy, cb0[5].yyyy, l(2.510000, 2.430000, 0.000000, 0.000000), l(0.030000, 0.590000, 0.000000, 0.000000)
mul r1.x, r1.x, cb0[5].y
mad r1.y, cb0[5].y, r1.y, l(0.140000)
div r1.x, r1.x, r1.y  // r1.x <- whiteLuminance
...
***************************
*************************/
const static bool TAutoKeyValue_id77 = true;
const static bool TAutoExposure_id78 = true;
const static bool TUseLocalLuminance_id79 = false;
struct PS_STREAMS 
{
...
cbuffer Globals 
{
    ...
    float KeyValue_id81 = 0.18f;
    float LuminanceLocalFactor_id82 = 0.0f;
    float LuminanceAverageGlobal_id83;
    float Contrast_id84 = 0.0f;
    float Brightness_id85 = 0.0f;
    float Exposure_id86 = 1.0f;
};
...
Texture2D LuminanceTexture_id80;
...
float4 Compute_id8(float4 color)
{
    ...
    float whiteLuminance = (WhiteLevel_id76 * (a * WhiteLevel_id76 + b)) / (WhiteLevel_id76 * (c * WhiteLevel_id76 + d) + e);
    return toneMappedLuminance / whiteLuminance * pow(color / pixelLuminance, LuminanceSaturation_id75);
}
...
float4 Compute_id4(inout PS_STREAMS streams, float4 inputColor)
{
    ...
    float avgLuminance = LuminanceAverageGlobal_id83;
    avgLuminance = exp2(avgLuminance);
    avgLuminance = max(avgLuminance, 0.0001f);
    float globalAverageLum = exp2(LuminanceAverageGlobal_id83);
    color = max(color + globalAverageLum.xxx * Brightness_id85, 0.0001);
    color = max(lerp(globalAverageLum.xxx, color, Contrast_id84 + 1.0f), 0.0001);
