...
//
#line 1481 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_7ab029f77923b1e2064675a2bc7784d3.hlsl"
...
@G    Pixel => bcc9267bb0dfb4ab8ce1c8bef35d90b1
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1548 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_7ab029f77923b1e2064675a2bc7784d3.hlsl"
...
#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.y, r11.xyxx, t2.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r11.zwzz, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id68 return value>
...
#line 568
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t2.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id68 return value>
...
#line 568
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r11.xyxx, t2.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.y, r11.zwzz, t2.xxxx, s1, r7.z  // r7.y <- <SampleTextureAndCompare_id68 return value>
...
#line 568
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t2.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id68 return value>
...
float SampleAndFilter_id75(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[4];
        normalizationFactor = Get3x3FilterKernel_id70(base_uv, st, kernel);
...
float FilterShadow_id61(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[4];
        float normalizationFactor = Get3x3FilterKernel_id70(base_uv, st, kernel);
