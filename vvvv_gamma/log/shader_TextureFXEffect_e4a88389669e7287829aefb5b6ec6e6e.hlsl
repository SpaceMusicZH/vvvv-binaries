...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Erode_Color_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Size_id88 => Erode_Color_TextureFX.Size
@C    Separation_id89 => Erode_Color_TextureFX.Separation
@C    MinThreshold_id90 => Erode_Color_TextureFX.MinThreshold
@C    MaxThreshold_id91 => Erode_Color_TextureFX.MaxThreshold
@C    Shape_id92 => Erode_Color_TextureFX.Shape
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Erode_Color_TextureFX => 13dd47ad13bb21c528e0bb0146627cab
...
//
#line 218 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_e4a88389669e7287829aefb5b6ec6e6e.hlsl"
...
@G    Pixel => c44bc717152e9a0deb6314564ffeaa81
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 197 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_e4a88389669e7287829aefb5b6ec6e6e.hlsl"
...
#line 193
  ...
  mad r1.xyz, r1.xxxx, r1.yzwy, r2.xyzx  // r1.x <- <Filter_id29 return value>.x; r1.y <- <Filter_id29 return value>.y; r1.z <- <Filter_id29 return value>.z
else 
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    return float4(lerp(cmx.rgb, tex0col.rgb, smoothstep(MinThreshold_id90, MaxThreshold_id91, mx)), tex0col.a);
}
