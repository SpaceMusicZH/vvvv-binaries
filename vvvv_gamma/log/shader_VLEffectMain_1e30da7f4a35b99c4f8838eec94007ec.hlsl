...
@P Lighting.DirectLightGroups: mixin LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightSpotGroup<1>, ShadowMapReceiverSpot<1,false>, ShadowMapFilterPcf<PerDraw.Lighting,5>, TextureProjectionReceiverSpot<PerDraw.Lighting,1,0>, LightSpotAttenuationRectangular
...
@C    UVScale_id177 => TextureProjection.UVScale.directLightGroups[2]
@C    UVOffset_id178 => TextureProjection.UVOffset.directLightGroups[2]
@C    WorldToProjectiveTextureUV_id187 => TextureProjectionReceiverBase.WorldToProjectiveTextureUV.directLightGroups[2]
@C    ProjectorPlaneMatrices_id188 => TextureProjectionReceiverBase.ProjectorPlaneMatrices.directLightGroups[2]
@C    ProjectionTextureMipMapLevels_id189 => TextureProjectionReceiverBase.ProjectionTextureMipMapLevels.directLightGroups[2]
@C    TransitionAreas_id190 => TextureProjectionReceiverBase.TransitionAreas.directLightGroups[2]
...
@C    AmbientLight_id193 => LightSimpleAmbient.AmbientLight.environmentLights[0]
...
@R    ShadowMapTexture_id104 => ShadowMap.ShadowMapTexture.directLightGroups[2] [Stage: None, Slot: (-1--1)]
@R    ProjectionTexture_id179 => TextureProjection.ProjectionTexture.directLightGroups[2] [Stage: None, Slot: (-1--1)]
@R    ProjectionTexture_id179 => TextureProjection.ProjectionTexture.directLightGroups[2] [Stage: None, Slot: (-1--1)]
...
@R    LinearClampCompareLessEqualSampler_id139 => Texturing.LinearClampCompareLessEqualSampler [Stage: Pixel, Slot: (1-1)]
@R    ShadowMapTexture_id104 => ShadowMap.ShadowMapTexture.directLightGroups[2] [Stage: Pixel, Slot: (0-0)]
@R    ProjectionTexture_id179 => TextureProjection.ProjectionTexture.directLightGroups[2] [Stage: Pixel, Slot: (1-1)]
...
@S    LightSpotAttenuationRectangular => d409364ffb5e1ab26d89a989636f8270
...
@S    TextureProjectionReceiverSpot => 06b69371f78c650fc572871ec2b7dd8f
@S    TextureProjectionReceiverBase => 2dd9f5faa5b2fb670f768e6deaa2d263
@S    TextureProjectionCommon => e6213a7ea9e63b5ce679f9e05f188278
@S    TextureProjectionFilterDefault => 2ae2a1940a54caa3b91f5938118173ac
...
//   float2 UVScale_id177;              // Offset:  772 Size:     8 [unused]
//   float2 UVOffset_id178;             // Offset:  784 Size:     8 [unused]
//   float4x4 WorldToProjectiveTextureUV_id187;// Offset:  800 Size:    64 [unused]
//   float4x4 ProjectorPlaneMatrices_id188;// Offset:  864 Size:    64 [unused]
//   float ProjectionTextureMipMapLevels_id189;// Offset:  928 Size:     4 [unused]
//   float TransitionAreas_id190;       // Offset:  944 Size:     4 [unused]
...
//   float3 AmbientLight_id193;         // Offset:  416 Size:    12 [unused]
...
//
#line 964 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_1e30da7f4a35b99c4f8838eec94007ec.hlsl"
...
@G    Pixel => 6c8a79237363c82d860f698572214160
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 UVScale_id177;              // Offset:  772 Size:     8
//   float2 UVOffset_id178;             // Offset:  784 Size:     8
//   float4x4 WorldToProjectiveTextureUV_id187;// Offset:  800 Size:    64
//   float4x4 ProjectorPlaneMatrices_id188;// Offset:  864 Size:    64 [unused]
//   float ProjectionTextureMipMapLevels_id189;// Offset:  928 Size:     4
//   float TransitionAreas_id190;       // Offset:  944 Size:     4
//   float4 _padding_PerDraw_Lighting;  // Offset:  960 Size:    16 [unused]
//
// }
//
...
//   float3 AmbientLight_id193;         // Offset:  416 Size:    12
//   float4 _padding_PerView_Lighting;  // Offset:  432 Size:    16 [unused]
//
// }
//
...
// LinearClampCompareLessEqualSampler_id139  sampler_c      NA          NA             s1      1 
// ShadowMapTexture_id104            texture  float4          2d             t0      1 
// ProjectionTexture_id179           texture  float4          2d             t1      1 
...
//
#line 1030 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_1e30da7f4a35b99c4f8838eec94007ec.hlsl"
...
#line 657
mov r2.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r2.xyzw, t2.xyzw  // r0.x <- streams.lightData_id92.x; r0.y <- streams.lightData_id92.y

#line 756
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id133 return value>
...
#line 641
  ld_indexable(buffer)(uint,uint,uint,uint) r1.w, r6.xxxx, t3.yzwx  // r1.w <- realLightIndex
...
#line 644
  ishl r3.w, r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r7.xyzw, r3.wwww, t4.xyzw  // r7.x <- pointLight1.x; r7.y <- pointLight1.y; r7.z <- pointLight1.z; r7.w <- pointLight1.w

#line 645
  bfi r1.w, l(31), l(1), r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r6.yzw, r1.wwww, t4.wxyz  // r6.y <- pointLight2.x; r6.z <- pointLight2.y; r6.w <- pointLight2.z
...
#line 722
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id145 return value>

#line 837
mov r0.yzw, r1.xxyz  // r0.y <- streams.normalWS_id19.x; r0.z <- streams.normalWS_id19.y; r0.w <- streams.normalWS_id19.z
mov r2.xyz, cb1[0].xyzx  // r2.x <- streams.matDiffuseVisible_id69.x; r2.y <- streams.matDiffuseVisible_id69.y; r2.z <- streams.matDiffuseVisible_id69.z
mov r3.xyz, v0.xyzx  // r3.x <- streams.PositionWS_id22.x
...
#line 616
  ishl r4.w, r3.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r6.yzw, r4.wwww, t5.wxyz  // r6.y <- spotLight1.x; r6.z <- spotLight1.y; r6.w <- spotLight1.z

#line 619
  bfi r7.xyz, l(30, 30, 30, 0), l(2, 2, 2, 0), r3.wwww, l(1, 2, 3, 0)

#line 617
  ld_indexable(buffer)(float,float,float,float) r8.xyz, r7.xxxx, t5.xyzw  // r8.x <- spotLight2.x; r8.y <- spotLight2.y; r8.z <- spotLight2.z

#line 618
  ld_indexable(buffer)(float,float,float,float) r7.xyw, r7.yyyy, t5.xywz  // r7.x <- spotLight3.x; r7.y <- spotLight3.y; r7.w <- spotLight3.z

#line 619
  ld_indexable(buffer)(float,float,float,float) r9.xyz, r7.zzzz, t5.xyzw  // r9.x <- spotLight4.x; r9.y <- spotLight4.y; r9.z <- spotLight4.z
...
#line 303
div r0.y, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[59].x
add r0.z, -cb0[59].x, l(1.000000)
...
#line 857
mov r5.xyz, r1.xyzx  // r5.x <- streams.normalWS_id19.x; r5.y <- streams.normalWS_id19.y; r5.z <- streams.normalWS_id19.z
mov r6.xyz, cb1[0].xyzx  // r6.x <- streams.matDiffuseVisible_id69.x; r6.y <- streams.matDiffuseVisible_id69.y; r6.z <- streams.matDiffuseVisible_id69.z
mov r3.xyz, v0.xyzx
mov r7.xyz, r4.xyzx  // r7.x <- directLightingContribution.x; r7.y <- directLightingContribution.y; r7.z <- directLightingContribution.z
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r4.w, r1.w, l(1)
  breakc_nz r4.w
...
#line 457
  add r8.xyz, -r3.xyzx, cb0[29].xyzx  // r8.x <- lightVector.x; r8.y <- lightVector.y; r8.z <- lightVector.z
...
#line 580
  mad r2.xyz, r6.wwww, r5.xyzx, r3.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 529
  dp4 r8.x, r2.xyzw, cb0[34].xyzw  // r8.x <- shadowPosition.x
  dp4 r8.y, r2.xyzw, cb0[35].xyzw  // r8.y <- shadowPosition.y
  dp4 r6.w, r2.xyzw, cb0[36].xyzw  // r6.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb0[37].xyzw  // r2.x <- shadowPosition.w

#line 530
  add r8.z, r6.w, -cb0[47].x  // r8.z <- shadowPosition.z
...
#line 372
  ...
  round_ni r8.xy, r2.xyxx  // r8.x <- base_uv.x; r8.y <- base_uv.y

#line 373
  add r2.xy, r2.xyxx, -r8.xyxx  // r2.x <- st.x; r2.y <- st.y
...
#line 320
  mad r8.zw, -r2.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r8.z <- uvW0.y; r8.w <- uvW0.x
...
#line 327
  mad r12.xyzw, r10.xwzw, cb0[33].zwzw, r8.xyxy
...
#line 330
  mad r13.xyzw, r10.xyzy, cb0[33].zwzw, r8.xyxy

#line 331
  mad r14.xyzw, r11.xzxw, cb0[33].zwzw, r8.xyxy
...
#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r12.xyxx, t0.xxxx, s1, r2.z  // r6.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.zwzz, t0.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id86 return value>
...
#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r14.xyxx, t0.xxxx, s1, r2.z  // r6.w <- <SampleTextureAndCompare_id86 return value>

#line 449
  mad r2.x, r8.z, r6.w, r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r13.xyxx, t0.xxxx, s1, r2.z

#line 449
  mad r2.x, r9.w, r6.w, r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r13.zwzz, t0.xxxx, s1, r2.z

#line 449
  mad r2.x, r6.w, l(49.000000), r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r14.zwzz, t0.xxxx, s1, r2.z

#line 449
  mad r2.x, r11.z, r6.w, r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r10.xyxx, t0.xxxx, s1, r2.z

#line 449
  mad r2.x, r8.w, r6.w, r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r10.zwzz, t0.xxxx, s1, r2.z

#line 449
  mad r2.x, r11.w, r6.w, r2.x

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r8.xyxx, t0.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id86 return value>
...
#line 688
  mul r8.xyz, r4.wwww, cb0[32].xyzx
...
#line 517
  dp4 r8.x, r3.xyzw, cb0[50].xyzw  // r8.x <- clipSpaceCoordinate.x
  dp4 r8.y, r3.xyzw, cb0[51].xyzw  // r8.y <- clipSpaceCoordinate.y
  dp4 r4.w, r3.xyzw, cb0[52].xyzw  // r4.w <- clipSpaceCoordinate.z
  dp4 r5.w, r3.xyzw, cb0[53].xyzw  // r5.w <- clipSpaceCoordinate.w

#line 518
  div r8.xy, r8.xyxx, r5.wwww  // r8.x <- projectedTextureCoordinate.x; r8.y <- projectedTextureCoordinate.y
...
#line 303
  ...
  mul_sat r8.yw, r0.yyyy, r8.xxxz
  mad r9.xy, r8.ywyy, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r8.yw, r8.yyyw, r8.yyyw
  add r9.zw, -r0.zzzz, r8.xxxz
  mul_sat r9.zw, r0.wwww, r9.zzzw
  mad r10.xy, r9.zwzz, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r9.zw, r9.zzzw, r9.zzzw
  mul r9.zw, r9.zzzw, r10.xxxy
  mad r8.yw, r9.xxxy, r8.yyyw, -r9.zzzw  // r8.y <- s.x; r8.w <- s.y

#line 304
  mul r5.w, r8.w, r8.y  // r5.w <- <insideOfRectangleSmooth_id94 return value>

#line 412
  ge r4.w, r4.w, l(0.000000)
  and r4.w, r4.w, l(0x3f800000)
  mul r4.w, r4.w, r5.w  // r4.w <- mask

#line 407
  mad r8.xy, r8.xzxx, cb0[48].yzyy, cb0[49].xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r8.xyxx, t1.xyzw, s0, cb0[58].x  // r8.x <- <FilterProjectedTexture_id97 return value>.x; r8.y <- <FilterProjectedTexture_id97 return value>.y; r8.z <- <FilterProjectedTexture_id97 return value>.z

#line 525
  mul r8.xyz, r4.wwww, r8.xyzx  // r8.x <- <ComputeTextureProjectionFromCascade_id99 return value>.x; r8.y <- <ComputeTextureProjectionFromCascade_id99 return value>.y; r8.z <- <ComputeTextureProjectionFromCascade_id99 return value>.z
...
#line 674
mul r0.xyz, cb1[0].xyzx, cb2[26].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id187 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id187 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id187 return value>.z
...
const static int TCascadeCountBase_id180 = 1;
const static int TLightCountBase_id181 = 1;
const static int TFlipMode_id182 = 0;
const int FlipModeX_id184 = 1;
const int FlipModeY_id185 = 2;
const int FlipModeXY_id186 = 3;
...
cbuffer PerDraw 
{
    ...
    float2 UVScale_id177;
    float2 UVOffset_id178;
    float4x4 WorldToProjectiveTextureUV_id187[TCascadeCountBase_id180 * TLightCountBase_id181];
    float4x4 ProjectorPlaneMatrices_id188[TCascadeCountBase_id180 * TLightCountBase_id181];
    float ProjectionTextureMipMapLevels_id189[TLightCountBase_id181];
    float TransitionAreas_id190[TLightCountBase_id181];
...
Texture2D ProjectionTexture_id179;
...
float insideOfRectangleSmooth_id94(float2 p, float2 bottomLeft, float2 topRight, float transitionArea)
{
    float2 s = smoothstep(bottomLeft, bottomLeft + transitionArea, p) - smoothstep(topRight - transitionArea, topRight, p);
    return (s.x * s.y);
}
...
float3 FilterProjectedTexture_id97(float2 textureCoordinate, float mipMapLevel)
{
    return ProjectionTexture_id179.SampleLevel(LinearSampler_id137, textureCoordinate * UVScale_id177 + UVOffset_id178, mipMapLevel).rgb;
}
float CalculateRectangularMask_id96(float2 projectedTextureCoordinate, float clipSpaceZ, float transitionArea)
{
    float mask = insideOfRectangleSmooth_id94(projectedTextureCoordinate, 0.0f, 1.0f, transitionArea);
    mask *= step(0.0f, clipSpaceZ);
    return mask;
}
bool IntersectPlane_id95(float3 rayOrigin, float3 rayDirection, float3 planeNormal, float3 planeOrigin, out float3 pointOfIntersection)
{
    ...
    if ((planeDotRayDirection > -epsilon) && (planeDotRayDirection < epsilon))
    {
        return (false);
    }
...
void ModifyTextureCoordinate_id98(inout float2 textureCoordinate)
{
}
...
float3 ComputeSpecularTextureProjectionFromCascade_id100(float3 positionWS, float3 reflectionWS, int cascadeIndex, int lightIndex)
{
    int matrixIndex = cascadeIndex + lightIndex * TCascadeCountBase_id180;
    float3 rayOrigin = positionWS;
    float3 rayDirection = reflectionWS;
    float4x4 projectorPlaneMatrix = ProjectorPlaneMatrices_id188[matrixIndex];
    ...
    float3 planeNormal = float3(projectorPlaneMatrix._m20, projectorPlaneMatrix._m21, projectorPlaneMatrix._m22);
    float3 planeOrigin = float3(projectorPlaneMatrix._m30, projectorPlaneMatrix._m31, projectorPlaneMatrix._m32);
    float3 pointOfIntersection;
    bool intersectionFound = IntersectPlane_id95(rayOrigin, rayDirection, planeNormal, planeOrigin, pointOfIntersection);
    if (intersectionFound)
    {
        float mipMapLevel = ProjectionTextureMipMapLevels_id189[lightIndex];
        float transitionArea = TransitionAreas_id190[lightIndex];
        ...
        float planeReflectionMask = CalculateRectangularMask_id96(planeTextureCoordinate, dot(planeNormal, rayDirection), transitionArea);
        return FilterProjectedTexture_id97(planeTextureCoordinate, mipMapLevel) * planeReflectionMask;
    }
    return 0.0f;
}
float3 ComputeTextureProjectionFromCascade_id99(float3 positionWS, int cascadeIndex, int lightIndex)
{
    int matrixIndex = cascadeIndex + lightIndex * TCascadeCountBase_id180;
    float4 clipSpaceCoordinate = mul(float4(positionWS, 1.0), WorldToProjectiveTextureUV_id187[matrixIndex]);
    float2 projectedTextureCoordinate = clipSpaceCoordinate.xy / clipSpaceCoordinate.w;
    projectedTextureCoordinate.xy = projectedTextureCoordinate.xy * 0.5 + 0.5;
    projectedTextureCoordinate.y = 1.0f - projectedTextureCoordinate.y;
    ModifyTextureCoordinate_id98(projectedTextureCoordinate);
    float mipMapLevel = ProjectionTextureMipMapLevels_id189[lightIndex];
    float transitionArea = TransitionAreas_id190[lightIndex];
    float mask = CalculateRectangularMask_id96(projectedTextureCoordinate, clipSpaceCoordinate.z, transitionArea);
    return FilterProjectedTexture_id97(projectedTextureCoordinate, mipMapLevel) * mask;
}
...
{
    return ComputeSpecularTextureProjectionFromCascade_id100(positionWS, reflectionWS, 0, lightIndex);
}
float3 ComputeTextureProjection_id70(float3 positionWS, int lightIndex)
{
    return ComputeTextureProjectionFromCascade_id99(positionWS, 0, lightIndex);
}
...
void AfterLightingAndShading_id194()
{
}
...
float3 ComputeEnvironmentLightContribution_id187(inout PS_STREAMS streams)
{
...
void PrepareEnvironmentLight_id180(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id193 * streams.matAmbientOcclusion_id57;
...
int GetLightCount_id146(inout PS_STREAMS streams)
{
    return streams.lightData_id92.y >> 16;
}
int GetMaxLightCount_id145(inout PS_STREAMS streams)
{
    return streams.lightData_id92.y >> 16;
}
void PrepareDirectLights_id140()
{
}
float3 ComputeDirectLightContribution_id186(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareForLightingAndShading_id191()
{
}
...
void Compute_id228(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id191();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id186(streams);
            }
        }
    }

    {
        PrepareDirectLights_id140();
        const int maxLightCount = GetMaxLightCount_id145(streams);
        int count = GetLightCount_id146(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id160();
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id187(streams);
        }
    }
