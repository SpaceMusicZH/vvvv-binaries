...
@G    Pixel => 55811c577057b4ecbfc3739d1fde8101
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t0.xxxx, s1, r1.z  // r1.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r6.zwzz, t0.xxxx, s1, r1.z  // r2.z <- <SampleTextureAndCompare_id86 return value>
...
#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r9.xyxx, t0.xxxx, s1, r1.z  // r1.w <- <SampleTextureAndCompare_id86 return value>

#line 449
  mad r0.y, r2.x, r1.w, r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t0.xxxx, s1, r1.z

#line 449
  mad r0.y, r7.y, r1.w, r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r8.zwzz, t0.xxxx, s1, r1.z

#line 449
  mad r0.y, r1.w, l(49.000000), r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r9.zwzz, t0.xxxx, s1, r1.z

#line 449
  mad r0.y, r5.z, r1.w, r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t0.xxxx, s1, r1.z

#line 449
  mad r0.y, r2.y, r1.w, r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r3.zwzz, t0.xxxx, s1, r1.z

#line 449
  mad r0.y, r5.w, r1.w, r0.y

#line 339
  sample_c_lz_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t0.xxxx, s1, r1.z  // r1.x <- <SampleTextureAndCompare_id86 return value>
...
#line 517
  mov r1.xyz, v0.xyzx
  mov r1.w, l(1.000000)
  dp4 r2.x, r1.xyzw, cb0[50].xyzw  // r2.x <- clipSpaceCoordinate.x
  dp4 r2.y, r1.xyzw, cb0[51].xyzw  // r2.y <- clipSpaceCoordinate.y
  dp4 r0.w, r1.xyzw, cb0[52].xyzw  // r0.w <- clipSpaceCoordinate.z
  dp4 r1.x, r1.xyzw, cb0[53].xyzw  // r1.x <- clipSpaceCoordinate.w

#line 518
  div r1.xy, r2.xyxx, r1.xxxx  // r1.x <- projectedTextureCoordinate.x; r1.y <- projectedTextureCoordinate.y

#line 519
  mad r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)

#line 303
  div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[59].x
  add r1.z, -r1.y, l(1.000000)
  mul_sat r1.yw, r1.wwww, r1.xxxz
  mad r2.xy, r1.ywyy, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r1.yw, r1.yyyw, r1.yyyw
  add r2.z, -cb0[59].x, l(1.000000)
  add r2.w, -r2.z, l(1.000000)
  add r3.xy, r1.xzxx, -r2.zzzz
  div r2.z, l(1.000000, 1.000000, 1.000000, 1.000000), r2.w
  mul_sat r2.zw, r2.zzzz, r3.xxxy
  ...
  mad r1.yw, r2.xxxy, r1.yyyw, -r2.zzzw  // r1.y <- s.x; r1.w <- s.y

#line 304
  mul r1.y, r1.w, r1.y  // r1.y <- <insideOfRectangleSmooth_id94 return value>

#line 412
  ge r0.w, r0.w, l(0.000000)
  and r0.w, r0.w, l(0x3f800000)
  mul r0.w, r0.w, r1.y  // r0.w <- mask

#line 407
  mad r1.xy, r1.xzxx, cb0[48].yzyy, cb0[49].xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t1.xyzw, s0, cb0[58].x  // r1.x <- <FilterProjectedTexture_id97 return value>.x; r1.y <- <FilterProjectedTexture_id97 return value>.y; r1.z <- <FilterProjectedTexture_id97 return value>.z

#line 525
  mul r1.xyz, r0.wwww, r1.xyzx  // r1.x <- <ComputeTextureProjectionFromCascade_id99 return value>.x; r1.y <- <ComputeTextureProjectionFromCascade_id99 return value>.y; r1.z <- <ComputeTextureProjectionFromCascade_id99 return value>.z
