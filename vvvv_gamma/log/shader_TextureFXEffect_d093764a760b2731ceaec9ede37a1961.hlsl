...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Neurons_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
@C    Time_id87 => Neurons_TextureFX.Time
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Neurons_TextureFX => 2a529f23adfb34c14c694e0792152cc3
...
//
#line 166 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_d093764a760b2731ceaec9ede37a1961.hlsl"
...
@G    Pixel => 93b62137178737af30db36e1a7b12a9a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 144 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_TextureFXEffect_d093764a760b2731ceaec9ede37a1961.hlsl"
mul r0.xy, v1.xyxx, cb0[1].xyxx  // r0.x <- uv.x; r0.y <- uv.y

#line 145
mov r0.z, l(1.000000)
div r0.xyz, r0.xyzx, cb0[1].yyyy
...
#line 137
  add r1.w, r1.z, -cb1[5].x  // r1.w <- p.z
...
#line 139
  ...
  mov r2.y, r4.x
  dp2 r2.x, r1.yxyy, r2.xyxx  // r2.x <- p.x
  mov r2.z, r3.x
  dp2 r2.y, r1.yxyy, r2.yzyy  // r2.y <- p.y

#line 140
  sincos null, r3.xy, r2.xyxx
  sincos r2.x, null, r2.y
  sincos r2.y, null, r1.w
  add r2.xy, r2.xyxx, r3.xyxx
  dp2 r1.w, r2.xyxx, r2.xyxx
  sqrt r1.w, r1.w
  add r1.w, -r1.w, l(0.100000)  // r1.w <- <f_id28 return value>
