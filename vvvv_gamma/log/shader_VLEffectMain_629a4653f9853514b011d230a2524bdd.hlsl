...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<4,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,5>, mixin LightClusteredPointGroup, LightClusteredSpotGroup, mixin LightPointGroup<8>, mixin LightSpotGroup<8>
...
@C    LightCount_id186 => DirectLightGroupPerDraw.LightCount.directLightGroups[4]
@C    Lights_id188 => LightSpotGroup.Lights.directLightGroups[4]
@C    _padding_PerDraw_Lighting => _padding_PerDraw_Lighting
cbuffer PerMaterial [Size: 32]
@C    InputValue_id202 => ShaderFX.InputValueFloat4
...
@R    EnvironmentLightingDFG_LUT_id231 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
@R    CubeMap_id196 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (6-6)]
...
//
//   } Lights_id185[8];                 // Offset:  464 Size:   252 [unused]
//   int LightCount_id186;              // Offset:  716 Size:     4 [unused]
//   
//   struct SpotLightData
//   {
//       
//       float3 PositionWS;             // Offset:  720
//       float3 DirectionWS;            // Offset:  736
//       float3 AngleOffsetAndInvSquareRadius;// Offset:  752
//       float3 Color;                  // Offset:  768
//
//   } Lights_id188[8];                 // Offset:  720 Size:   508 [unused]
//   float4 _padding_PerDraw_Lighting;  // Offset: 1232 Size:    16 [unused]
//
// }
//
// cbuffer PerView
...
//
#line 1464 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_629a4653f9853514b011d230a2524bdd.hlsl"
...
@G    Pixel => 66977733205694de5aecd9dc7d2c79e0
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  480
//
//   } Lights_id185[8];                 // Offset:  464 Size:   252
//   int LightCount_id186;              // Offset:  716 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset:  768
//
//   } Lights_id188[8];                 // Offset:  720 Size:   508
//   float4 _padding_PerDraw_Lighting;  // Offset: 1232 Size:    16 [unused]
//
// }
//
...
// {
//
//   float4 InputValue_id202;           // Offset:    0 Size:    16
//   float InputValue_id210;            // Offset:   16 Size:     4
//   float InputValue_id219;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id231    texture  float4          2d             t0      1 
...
// CubeMap_id196                     texture  float4        cube             t6      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 1536 "H:\JHH_SpaceMusic\SpaceMusicZH\vvvv-binaries\vvvv_gamma\log\shader_VLEffectMain_629a4653f9853514b011d230a2524bdd.hlsl"
...
#line 502
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.z, r12.xyxx, t1.xxxx, s1, r8.z  // r9.z <- <SampleTextureAndCompare_id73 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r12.zwzz, t1.xxxx, s1, r8.z  // r9.w <- <SampleTextureAndCompare_id73 return value>
...
#line 502
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id73 return value>
...
#line 502
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.xyxx, t1.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id73 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r12.zwzz, t1.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id73 return value>
...
#line 502
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t1.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id73 return value>
...
#line 573
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id178 return value>.x; r8.y <- <FresnelSchlick_id178 return value>.y; r8.z <- <FresnelSchlick_id178 return value>.z
...
#line 569
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id194 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id194 return value>

#line 688
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id196 return value>
...
#line 684
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id208 return value>
...
#line 1098
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id535 return value>.x; r7.y <- <ComputeDirectLightContribution_id535 return value>.y; r7.z <- <ComputeDirectLightContribution_id535 return value>.z
...
#line 1085
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id249 return value>
...
#line 573
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id178 return value>.x; r13.y <- <FresnelSchlick_id178 return value>.y; r13.z <- <FresnelSchlick_id178 return value>.z
...
#line 569
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id194 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id194 return value>

#line 688
  mul r4.w, r4.w, r10.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id196 return value>
...
#line 684
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id208 return value>
...
#line 1063
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id261 return value>
...
#line 573
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id178 return value>.x; r16.y <- <FresnelSchlick_id178 return value>.y; r16.z <- <FresnelSchlick_id178 return value>.z
...
#line 569
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id194 return value>
  mad r3.w, r11.z, r4.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id194 return value>

#line 688
  mul r3.w, r3.w, r5.w
  mul r2.w, r11.z, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id196 return value>
...
#line 684
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id208 return value>
...
#line 573
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id178 return value>.x; r15.y <- <FresnelSchlick_id178 return value>.y; r15.z <- <FresnelSchlick_id178 return value>.z
...
#line 569
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id194 return value>
  mad r3.w, r10.z, r5.w, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id194 return value>

#line 688
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id196 return value>
...
#line 526
  add r13.xyz, -r0.xyzx, cb0[r2.w + 45].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 314
  mul r3.w, r3.w, cb0[r2.w + 47].z  // r3.w <- factor
...
#line 412
  dp3 r4.w, -cb0[r2.w + 46].xyzx, r13.xyzx  // r4.w <- cd

#line 413
  mad_sat r4.w, r4.w, cb0[r2.w + 47].x, cb0[r2.w + 47].y  // r4.w <- attenuation
...
#line 1007
  mul r14.xyz, r3.wwww, cb0[r2.w + 48].xyzx
  mul r14.xyz, r4.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id45.x; r14.y <- streams.lightColorNdotL_id45.y; r14.z <- streams.lightColorNdotL_id45.z
...
#line 763
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id357 return value>.x; r0.z <- <Compute_id357 return value>.y; r0.w <- <Compute_id357 return value>.z

#line 988
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id536 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id536 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id536 return value>.z
...
#line 748
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r6.xyzx, t6.xyzw, s0, r0.x  // r3.x <- <Compute_id307 return value>.x; r3.y <- <Compute_id307 return value>.y; r3.z <- <Compute_id307 return value>.z
...
mov o1.w, l(1.000000)
ret 
// Approximately 558 instruction slots used
***************************
*************************/
...
float VisibilityhSchlickGGX_id194(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
    return nDotX / (nDotX * (1.0f - k) + k);
}
float3 FresnelSchlick_id178(float3 f0, float3 f90, float lOrVDotH)
{
...
{
    streams.Input_2_id218 = Compute_id345();
}
void Compute_id336(inout PS_STREAMS streams)
{
    streams.Input_1_id209 = Compute_id333();
}
void Compute_id324(inout PS_STREAMS streams)
{
    streams.Input_0_id201 = Compute_id321();
}
float4 EvaluateSphericalHarmonics_id132(float3 sphericalColors[TOrder_id191 * TOrder_id191], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id123(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id122(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id23.xyz, lightVectorNorm);
...
float VisibilitySmithSchlickGGX_id196(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id194(alphaR, nDotL) * VisibilityhSchlickGGX_id194(alphaR, nDotV) / (nDotL * nDotV);
}
float3 FresnelSchlick_id184(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id178(f0, 1.0f, lOrVDotH);
}
...
float4 Compute_id307(inout PS_STREAMS streams, float3 direction)
{
    ...
    return CubeMap_id196.SampleLevel(LinearSampler_id123, direction, mipLevel);
}
float4 Compute_id302(float3 direction)
{
    return EvaluateSphericalHarmonics_id132(SphericalColors_id194, direction);
}
...
float3 Compute_id357(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id231.SampleLevel(LinearSampler_id123, float2(glossiness, nDotV), 0);
...
{
    return NormalDistributionGGX_id208(streams.alphaRoughness_id71, streams.NdotH_id77);
}
float Compute_id419(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id196(streams.alphaRoughness_id71, streams.NdotL_id50, streams.NdotV_id73);
}
float3 Compute_id389(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id184(f0, streams.LdotH_id78);
}
...
void PrepareEnvironmentLight_id317(inout PS_STREAMS streams)
{
    ...
    float3 sampleDirection = mul(streams.normalWS_id20, (float3x3)SkyMatrix_id197);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id48 = Compute_id302(sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id49 = Compute_id307(streams, sampleDirection).rgb * Intensity_id198 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id66.y;
}
float3 ComputeEnvironmentLightContribution_id536(inout PS_STREAMS streams)
{
    ...
    return Compute_id357(specularColor, streams.alphaRoughness_id71, streams.NdotV_id73) * streams.envLightSpecularColor_id49;
}
...
void PrepareEnvironmentLight_id312(inout PS_STREAMS streams)
{
    ...
    float3 lightColor = AmbientLight_id189 * streams.matAmbientOcclusion_id58;
...
void PrepareDirectLight_id283(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id85 = ComputeShadow_id116(streams, streams.PositionWS_id23.xyz, lightIndex);
...
int GetLightCount_id250(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y & 0xFFFF;
}
int GetMaxLightCount_id249(inout PS_STREAMS streams)
{
    return streams.lightData_id174.y & 0xFFFF;
}
void PrepareDirectLights_id248(inout PS_STREAMS streams)
{
...
int GetLightCount_id223()
{
    return LightCount_id87;
}
int GetMaxLightCount_id224()
{
...
void Compute_id567(inout PS_STREAMS streams)
{
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id224();
        int count = GetLightCount_id223();
    ...
    {
        PrepareDirectLights_id248(streams);
        const int maxLightCount = GetMaxLightCount_id249(streams);
        int count = GetLightCount_id250(streams);
